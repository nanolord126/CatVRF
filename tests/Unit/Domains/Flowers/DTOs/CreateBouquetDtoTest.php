...
namespace Tests\Unit\Domains\Flowers\DTOs;

use PHPUnit\Framework\TestCase;

/**
 * Unit tests for CreateBouquetDto.
 *
 * @covers \App\Domains\Flowers\DTOs\CreateBouquetDto
 */
final class CreateBouquetDtoTest extends TestCase
{
    public function test_class_is_final_readonly(): void
    {
        $reflection = new \ReflectionClass(
            \App\Domains\Flowers\DTOs\CreateBouquetDto::class
        );
        $this->assertTrue($reflection->isFinal(), 'CreateBouquetDto must be final');
        $this->assertTrue($reflection->isReadOnly(), 'CreateBouquetDto must be readonly');
    }
    ...
    {
        return \App\Domains\Flowers\DTOs\CreateBouquetDto::class;
    }
}
