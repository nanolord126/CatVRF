 ...
 *
 * @covers \App\Domains\Advertising\DTOs\CreateCampaignDto
 */
final class CreateCampaignDtoTest extends TestCase
{
    public function test_class_is_final_readonly(): void
    {
        $reflection = new \ReflectionClass(
            \App\Domains\Advertising\DTOs\CreateCampaignDto::class
        );
    ...
    {
        return \App\Domains\Advertising\DTOs\CreateCampaignDto::class;
    }
}
