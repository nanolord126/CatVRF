...
/**
 * Unit tests for CreateAIModelDto.
 *
 * @covers \App\Domains\AI\DTOs\CreateAIModelDto
 */
final class CreateAIModelDtoTest extends TestCase
{
    public function test_class_is_final_readonly(): void
    {
        $reflection = new \ReflectionClass(
            \App\Domains\AI\DTOs\CreateAIModelDto::class
        );
        $this->assertTrue($reflection->isFinal(), 'CreateAIModelDto must be final');
        $this->assertTrue($reflection->isReadOnly(), 'CreateAIModelDto must be readonly');
    }
    ...
    {
        return \App\Domains\AI\DTOs\CreateAIModelDto::class;
    }
}
