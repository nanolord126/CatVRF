...
namespace Tests\Unit\Domains\Marketplace\DTOs;

use PHPUnit\Framework\TestCase;
use App\Domains\Marketplace\DTOs\CreateMarketplaceListingDto;

/**
 * Unit tests for CreateMarketplaceListingDto.
 *
 * @covers \App\Domains\Marketplace\DTOs\CreateMarketplaceListingDto
 */
final class CreateMarketplaceListingDtoTest extends TestCase
{
    public function test_class_is_final_readonly(): void
    {
        $reflection = new \ReflectionClass(
            CreateMarketplaceListingDto::class
        );
        $this->assertTrue($reflection->isFinal(), 'CreateMarketplaceListingDto must be final');
        $this->assertTrue($reflection->isReadOnly(), 'CreateMarketplaceListingDto must be readonly');
    }
    ...
    {
        return CreateMarketplaceListingDto::class;
    }
}
