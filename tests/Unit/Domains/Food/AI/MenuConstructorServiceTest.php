...
namespace Tests\Unit\Domains\Food\AI;

use PHPUnit\Framework\TestCase;

/**
 * Unit tests for MenuConstructorService.
 *
 * @covers \App\Domains\Food\Services\AI\MenuConstructorService
...
final class MenuConstructorServiceTest extends TestCase
{
    ...
    public function test_has_analyze_method(): void
    {
        ...
        $this->assertTrue($hasAnalyze, 'MenuConstructorService must have analyze/recommend/generate method');
    }
    ...
    {
        $paths = [
            'App\Domains\Food\Services\AI\MenuConstructorService',
            'App\Domains\Food\Domain\Services\AI\MenuConstructorService',
        ];
        foreach ($paths as $p) {
