...
namespace Tests\Unit\Domains\Content\DTOs;
 ...
 *
 * @covers \App\Domains\Content\DTOs\CreateCampaignDto
 */
final class CreateCampaignDtoTest extends TestCase
{
    public function test_class_is_final_readonly(): void
    {
        $reflection = new \ReflectionClass(
            \App\Domains\Content\DTOs\CreateCampaignDto::class
        );
    ...
    {
        return \App\Domains\Content\DTOs\CreateCampaignDto::class;
    }
}
