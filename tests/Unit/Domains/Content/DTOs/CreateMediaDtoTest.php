...
/**
 * Unit tests for CreateMediaDto.
 *
 * @covers \App\Domains\Content\DTOs\CreateMediaDto
 */
final class CreateMediaDtoTest extends TestCase
{
    public function test_class_is_final_readonly(): void
    {
        $reflection = new \ReflectionClass(
            \App\Domains\Content\DTOs\CreateMediaDto::class
        );
        $this->assertTrue($reflection->isFinal(), 'CreateMediaDto must be final');
        $this->assertTrue($reflection->isReadOnly(), 'CreateMediaDto must be readonly');
    }
    ...
    {
        return \App\Domains\Content\DTOs\CreateMediaDto::class;
    }
}
