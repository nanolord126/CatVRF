...
namespace Tests\Unit\Domains\Confectionery\DTOs;

use PHPUnit\Framework\TestCase;

/**
 * Unit tests for CreateCustomDto.
 *
 * @covers \App\Domains\Confectionery\DTOs\CreateCustomDto
 */
final class CreateCustomDtoTest extends TestCase
{
    public function test_class_is_final_readonly(): void
    {
        $reflection = new \ReflectionClass(
            \App\Domains\Confectionery\DTOs\CreateCustomDto::class
        );
        $this->assertTrue($reflection->isFinal(), 'CreateCustomDto must be final');
        $this->assertTrue($reflection->isReadOnly(), 'CreateCustomDto must be readonly');
    }
    ...
    {
        return \App\Domains\Confectionery\DTOs\CreateCustomDto::class;
    }
}
