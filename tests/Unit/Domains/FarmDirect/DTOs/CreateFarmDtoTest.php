...
namespace Tests\Unit\Domains\FarmDirect\DTOs;

use PHPUnit\Framework\TestCase;

/**
 * Unit tests for CreateFarmDto.
 *
 * @covers \App\Domains\FarmDirect\DTOs\CreateFarmDto
 */
final class CreateFarmDtoTest extends TestCase
{
    public function test_class_is_final_readonly(): void
    {
        $reflection = new \ReflectionClass(
            \App\Domains\FarmDirect\DTOs\CreateFarmDto::class
        );
        $this->assertTrue($reflection->isFinal(), 'CreateFarmDto must be final');
        $this->assertTrue($reflection->isReadOnly(), 'CreateFarmDto must be readonly');
    }
    ...
    {
        return \App\Domains\FarmDirect\DTOs\CreateFarmDto::class;
    }
}
