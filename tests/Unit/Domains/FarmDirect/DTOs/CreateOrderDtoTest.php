 ...
 *
 * @covers \App\Domains\FarmDirect\DTOs\CreateOrderDto
 */
final class CreateOrderDtoTest extends TestCase
{
    public function test_class_is_final_readonly(): void
    {
        $reflection = new \ReflectionClass(
            \App\Domains\FarmDirect\DTOs\CreateOrderDto::class
        );
    ...
    {
        return \App\Domains\FarmDirect\DTOs\CreateOrderDto::class;
    }
}
