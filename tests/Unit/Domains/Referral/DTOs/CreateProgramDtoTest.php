...
/**
 * Unit tests for CreateProgramDto.
 *
 * @covers \App\Domains\Referral\DTOs\CreateProgramDto
 */
final class CreateProgramDtoTest extends TestCase
{
    public function test_class_is_final_readonly(): void
    {
        $reflection = new \ReflectionClass(
            \App\Domains\Referral\DTOs\CreateProgramDto::class
        );
        $this->assertTrue($reflection->isFinal(), 'CreateProgramDto must be final');
        $this->assertTrue($reflection->isReadOnly(), 'CreateProgramDto must be readonly');
    }
    ...
    {
        return \App\Domains\Referral\DTOs\CreateProgramDto::class;
    }
}
