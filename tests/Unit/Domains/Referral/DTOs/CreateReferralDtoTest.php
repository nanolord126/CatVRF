...
namespace Tests\Unit\Domains\Referral\DTOs;

use PHPUnit\Framework\TestCase;

/**
 * Unit tests for CreateReferralDto.
 *
 * @covers \App\Domains\Referral\DTOs\CreateReferralDto
 */
final class CreateReferralDtoTest extends TestCase
{
    public function test_class_is_final_readonly(): void
    {
        $reflection = new \ReflectionClass(
            \App\Domains\Referral\DTOs\CreateReferralDto::class
        );
        $this->assertTrue($reflection->isFinal(), 'CreateReferralDto must be final');
        $this->assertTrue($reflection->isReadOnly(), 'CreateReferralDto must be readonly');
    }
    ...
    {
        return \App\Domains\Referral\DTOs\CreateReferralDto::class;
    }
}
