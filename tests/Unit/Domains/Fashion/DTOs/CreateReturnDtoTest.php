...
namespace Tests\Unit\Domains\Fashion\DTOs;

use PHPUnit\Framework\TestCase;

/**
 * Unit tests for CreateReturnDto.
 *
 * @covers \App\Domains\Fashion\DTOs\CreateReturnDto
 */
final class CreateReturnDtoTest extends TestCase
{
    public function test_class_is_final_readonly(): void
    {
        $reflection = new \ReflectionClass(
            \App\Domains\Fashion\DTOs\CreateReturnDto::class
        );
        $this->assertTrue($reflection->isFinal(), 'CreateReturnDto must be final');
        $this->assertTrue($reflection->isReadOnly(), 'CreateReturnDto must be readonly');
    }
    ...
    {
        return \App\Domains\Fashion\DTOs\CreateReturnDto::class;
    }
}
