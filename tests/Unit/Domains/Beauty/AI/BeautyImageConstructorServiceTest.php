...
namespace Tests\Unit\Domains\Beauty\AI;

use PHPUnit\Framework\TestCase;

/**
 * Unit tests for BeautyImageConstructorService.
 *
 * @covers \App\Domains\Beauty\Services\AI\BeautyImageConstructorService
...
final class BeautyImageConstructorServiceTest extends TestCase
{
    ...
    public function test_has_analyze_method(): void
    {
        ...
        $this->assertTrue($hasAnalyze, 'BeautyImageConstructorService must have analyze/recommend/generate method');
    }
    ...
    {
        $paths = [
            'App\Domains\Beauty\Services\AI\BeautyImageConstructorService',
            'App\Domains\Beauty\Domain\Services\AI\BeautyImageConstructorService',
        ];
        foreach ($paths as $p) {
