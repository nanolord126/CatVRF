...
namespace Tests\Unit\Domains\Logistics\DTOs;

use PHPUnit\Framework\TestCase;

/**
 * Unit tests for CreateShipmentDto.
 *
 * @covers \App\Domains\Logistics\DTOs\CreateShipmentDto
 */
final class CreateShipmentDtoTest extends TestCase
{
    public function test_class_is_final_readonly(): void
    {
        $reflection = new \ReflectionClass(
            \App\Domains\Logistics\DTOs\CreateShipmentDto::class
        );
        $this->assertTrue($reflection->isFinal(), 'CreateShipmentDto must be final');
        $this->assertTrue($reflection->isReadOnly(), 'CreateShipmentDto must be readonly');
    }
    ...
    {
        return \App\Domains\Logistics\DTOs\CreateShipmentDto::class;
    }
}
