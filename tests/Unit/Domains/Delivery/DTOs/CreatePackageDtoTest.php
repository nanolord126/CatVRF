...
namespace Tests\Unit\Domains\Delivery\DTOs;
 ...
 *
 * @covers \App\Domains\Delivery\DTOs\CreatePackageDto
 */
final class CreatePackageDtoTest extends TestCase
{
    public function test_class_is_final_readonly(): void
    {
        $reflection = new \ReflectionClass(
            \App\Domains\Delivery\DTOs\CreatePackageDto::class
        );
    ...
    {
        return \App\Domains\Delivery\DTOs\CreatePackageDto::class;
    }
}
