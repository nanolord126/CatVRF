...
namespace Tests\Unit\Domains\CRM\AI;

use PHPUnit\Framework\TestCase;

/**
 * Unit tests for CrmConstructorService.
 *
 * @covers \App\Domains\CRM\Services\AI\CrmConstructorService
 * @group ai-constructors
 */
final class CrmConstructorServiceTest extends TestCase
{
    ...
    public function test_has_analyze_method(): void
    {
        ...
        $this->assertTrue($hasAnalyze, 'CrmConstructorService must have analyze/recommend/generate method');
    }
    ...
    {
        $paths = [
            'App\Domains\CRM\Services\AI\CrmConstructorService',
            'App\Domains\CRM\Domain\Services\AI\CrmConstructorService',
        ];
        foreach ($paths as $p) {
