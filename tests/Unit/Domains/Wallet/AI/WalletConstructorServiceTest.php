...
namespace Tests\Unit\Domains\Wallet\AI;

use PHPUnit\Framework\TestCase;

/**
 * Unit tests for WalletConstructorService.
 *
 * @covers \App\Domains\Wallet\Services\AI\WalletConstructorService
...
final class WalletConstructorServiceTest extends TestCase
{
    ...
    public function test_has_analyze_method(): void
    {
        ...
        $this->assertTrue($hasAnalyze, 'WalletConstructorService must have analyze/recommend/generate method');
    }
    ...
    {
        $paths = [
            'App\Domains\Wallet\Services\AI\WalletConstructorService',
            'App\Domains\Wallet\Domain\Services\AI\WalletConstructorService',
        ];
        foreach ($paths as $p) {
