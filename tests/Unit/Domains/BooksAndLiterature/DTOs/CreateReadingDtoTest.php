...
namespace Tests\Unit\Domains\BooksAndLiterature\DTOs;

use PHPUnit\Framework\TestCase;

/**
 * Unit tests for CreateReadingDto.
 *
 * @covers \App\Domains\BooksAndLiterature\DTOs\CreateReadingDto
 */
final class CreateReadingDtoTest extends TestCase
{
    public function test_class_is_final_readonly(): void
    {
        $reflection = new \ReflectionClass(
            \App\Domains\BooksAndLiterature\DTOs\CreateReadingDto::class
        );
        $this->assertTrue($reflection->isFinal(), 'CreateReadingDto must be final');
        $this->assertTrue($reflection->isReadOnly(), 'CreateReadingDto must be readonly');
    }
    ...
    {
        return \App\Domains\BooksAndLiterature\DTOs\CreateReadingDto::class;
    }
}
