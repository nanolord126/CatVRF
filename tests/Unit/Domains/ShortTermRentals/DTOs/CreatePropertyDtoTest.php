...
namespace Tests\Unit\Domains\ShortTermRentals\DTOs;

use PHPUnit\Framework\TestCase;

/**
 * Unit tests for CreatePropertyDto.
 *
 * @covers \App\Domains\ShortTermRentals\DTOs\CreatePropertyDto
 */
final class CreatePropertyDtoTest extends TestCase
{
    public function test_class_is_final_readonly(): void
    {
        $reflection = new \ReflectionClass(
            \App\Domains\ShortTermRentals\DTOs\CreatePropertyDto::class
        );
        $this->assertTrue($reflection->isFinal(), 'CreatePropertyDto must be final');
        $this->assertTrue($reflection->isReadOnly(), 'CreatePropertyDto must be readonly');
    }
    ...
    {
        return \App\Domains\ShortTermRentals\DTOs\CreatePropertyDto::class;
    }
}
