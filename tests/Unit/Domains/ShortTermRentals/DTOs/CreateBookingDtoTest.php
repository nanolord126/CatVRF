 ...
 *
 * @covers \App\Domains\ShortTermRentals\DTOs\CreateBookingDto
 */
final class CreateBookingDtoTest extends TestCase
{
    public function test_class_is_final_readonly(): void
    {
        $reflection = new \ReflectionClass(
            \App\Domains\ShortTermRentals\DTOs\CreateBookingDto::class
        );
    ...
    {
        return \App\Domains\ShortTermRentals\DTOs\CreateBookingDto::class;
    }
}
