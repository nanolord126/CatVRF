...
use App\Domains\Furniture\Domain\Services\AIInteriorConstructorService;
...
final class AIInteriorConstructorServiceTest extends TestCase
{
    public function test_class_is_final(): void
    {
        $reflection = new \ReflectionClass(
            AIInteriorConstructorService::class
        );
    ...
    public function test_generate_interior_setup_method_exists(): void
    {
        $this->assertTrue(
            method_exists(AIInteriorConstructorService::class, 'generateInteriorSetup'),
