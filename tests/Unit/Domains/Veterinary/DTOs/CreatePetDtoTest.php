...
/**
 * Unit tests for CreatePetDto.
 *
 * @covers \App\Domains\Veterinary\DTOs\CreatePetDto
 */
final class CreatePetDtoTest extends TestCase
{
    public function test_class_is_final_readonly(): void
    {
        $reflection = new \ReflectionClass(
            \App\Domains\Veterinary\DTOs\CreatePetDto::class
        );
        $this->assertTrue($reflection->isFinal(), 'CreatePetDto must be final');
        $this->assertTrue($reflection->isReadOnly(), 'CreatePetDto must be readonly');
    }
    ...
    {
        return \App\Domains\Veterinary\DTOs\CreatePetDto::class;
    }
}
