...
namespace Tests\Unit\Domains\Veterinary\DTOs;

use PHPUnit\Framework\TestCase;

/**
 * Unit tests for CreateAppointmentDto.
 *
 * @covers \App\Domains\Veterinary\DTOs\CreateAppointmentDto
 */
final class CreateAppointmentDtoTest extends TestCase
{
    public function test_class_is_final_readonly(): void
    {
        $reflection = new \ReflectionClass(
            \App\Domains\Veterinary\DTOs\CreateAppointmentDto::class
        );
        $this->assertTrue($reflection->isFinal(), 'CreateAppointmentDto must be final');
        $this->assertTrue($reflection->isReadOnly(), 'CreateAppointmentDto must be readonly');
    }
    ...
    {
        return \App\Domains\Veterinary\DTOs\CreateAppointmentDto::class;
    }
}
