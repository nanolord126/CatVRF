...
namespace Tests\Unit\Domains\Gardening\DTOs;

use PHPUnit\Framework\TestCase;

/**
 * Unit tests for CreatePlantDto.
 *
 * @covers \App\Domains\Gardening\DTOs\CreatePlantDto
 */
final class CreatePlantDtoTest extends TestCase
{
    public function test_class_is_final_readonly(): void
    {
        $reflection = new \ReflectionClass(
            \App\Domains\Gardening\DTOs\CreatePlantDto::class
        );
        $this->assertTrue($reflection->isFinal(), 'CreatePlantDto must be final');
        $this->assertTrue($reflection->isReadOnly(), 'CreatePlantDto must be readonly');
    }
    ...
    {
        return \App\Domains\Gardening\DTOs\CreatePlantDto::class;
    }
}
