...
namespace Tests\Unit\Domains\HomeServices\DTOs;

use PHPUnit\Framework\TestCase;

/**
 * Unit tests for CreateProviderDto.
 *
 * @covers \App\Domains\HomeServices\DTOs\CreateProviderDto
 */
final class CreateProviderDtoTest extends TestCase
{
    public function test_class_is_final_readonly(): void
    {
        $reflection = new \ReflectionClass(
            \App\Domains\HomeServices\DTOs\CreateProviderDto::class
        );
        $this->assertTrue($reflection->isFinal(), 'CreateProviderDto must be final');
        $this->assertTrue($reflection->isReadOnly(), 'CreateProviderDto must be readonly');
    }
    ...
    {
        return \App\Domains\HomeServices\DTOs\CreateProviderDto::class;
    }
}
