 ...
 *
 * @covers \App\Domains\HomeServices\DTOs\CreateOrderDto
 */
final class CreateOrderDtoTest extends TestCase
{
    public function test_class_is_final_readonly(): void
    {
        $reflection = new \ReflectionClass(
            \App\Domains\HomeServices\DTOs\CreateOrderDto::class
        );
    ...
    {
        return \App\Domains\HomeServices\DTOs\CreateOrderDto::class;
    }
}
