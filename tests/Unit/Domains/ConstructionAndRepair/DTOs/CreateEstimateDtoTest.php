...
/**
 * Unit tests for CreateEstimateDto.
 *
 * @covers \App\Domains\ConstructionAndRepair\DTOs\CreateEstimateDto
 */
final class CreateEstimateDtoTest extends TestCase
{
    public function test_class_is_final_readonly(): void
    {
        $reflection = new \ReflectionClass(
            \App\Domains\ConstructionAndRepair\DTOs\CreateEstimateDto::class
        );
        $this->assertTrue($reflection->isFinal(), 'CreateEstimateDto must be final');
        $this->assertTrue($reflection->isReadOnly(), 'CreateEstimateDto must be readonly');
    }
    ...
    {
        return \App\Domains\ConstructionAndRepair\DTOs\CreateEstimateDto::class;
    }
}
