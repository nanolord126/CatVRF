...
namespace Tests\Unit\Domains\ConstructionAndRepair\DTOs;

use PHPUnit\Framework\TestCase;

/**
 * Unit tests for CreateMaterialDto.
 *
 * @covers \App\Domains\ConstructionAndRepair\DTOs\CreateMaterialDto
 */
final class CreateMaterialDtoTest extends TestCase
{
    public function test_class_is_final_readonly(): void
    {
        $reflection = new \ReflectionClass(
            \App\Domains\ConstructionAndRepair\DTOs\CreateMaterialDto::class
        );
        $this->assertTrue($reflection->isFinal(), 'CreateMaterialDto must be final');
        $this->assertTrue($reflection->isReadOnly(), 'CreateMaterialDto must be readonly');
    }
    ...
    {
        return \App\Domains\ConstructionAndRepair\DTOs\CreateMaterialDto::class;
    }
}
