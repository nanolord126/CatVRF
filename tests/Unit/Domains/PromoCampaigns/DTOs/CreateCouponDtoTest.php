...
/**
 * Unit tests for CreateCouponDto.
 *
 * @covers \App\Domains\PromoCampaigns\DTOs\CreateCouponDto
 */
final class CreateCouponDtoTest extends TestCase
{
    public function test_class_is_final_readonly(): void
    {
        $reflection = new \ReflectionClass(
            \App\Domains\PromoCampaigns\DTOs\CreateCouponDto::class
        );
        $this->assertTrue($reflection->isFinal(), 'CreateCouponDto must be final');
        $this->assertTrue($reflection->isReadOnly(), 'CreateCouponDto must be readonly');
    }
    ...
    {
        return \App\Domains\PromoCampaigns\DTOs\CreateCouponDto::class;
    }
}
