...
namespace Tests\Unit\Domains\PromoCampaigns\DTOs;

use PHPUnit\Framework\TestCase;

/**
 * Unit tests for CreateCampaignDto.
 *
 * @covers \App\Domains\PromoCampaigns\DTOs\CreateCampaignDto
 */
final class CreateCampaignDtoTest extends TestCase
{
    public function test_class_is_final_readonly(): void
    {
        $reflection = new \ReflectionClass(
            \App\Domains\PromoCampaigns\DTOs\CreateCampaignDto::class
        );
        $this->assertTrue($reflection->isFinal(), 'CreateCampaignDto must be final');
        $this->assertTrue($reflection->isReadOnly(), 'CreateCampaignDto must be readonly');
    }
    ...
    {
        return \App\Domains\PromoCampaigns\DTOs\CreateCampaignDto::class;
    }
}
