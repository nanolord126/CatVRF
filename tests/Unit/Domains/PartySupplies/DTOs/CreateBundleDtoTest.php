...
/**
 * Unit tests for CreateBundleDto.
 *
 * @covers \App\Domains\PartySupplies\DTOs\CreateBundleDto
 */
final class CreateBundleDtoTest extends TestCase
{
    public function test_class_is_final_readonly(): void
    {
        $reflection = new \ReflectionClass(
            \App\Domains\PartySupplies\DTOs\CreateBundleDto::class
        );
        $this->assertTrue($reflection->isFinal(), 'CreateBundleDto must be final');
        $this->assertTrue($reflection->isReadOnly(), 'CreateBundleDto must be readonly');
    }
    ...
    {
        return \App\Domains\PartySupplies\DTOs\CreateBundleDto::class;
    }
}
