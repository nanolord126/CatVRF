...
namespace Tests\Unit\Domains\Payment\AI;

use PHPUnit\Framework\TestCase;

/**
 * Unit tests for PaymentConstructorService.
 *
 * @covers \App\Domains\Payment\Services\AI\PaymentConstructorService
...
final class PaymentConstructorServiceTest extends TestCase
{
    ...
    public function test_has_analyze_method(): void
    {
        ...
        $this->assertTrue($hasAnalyze, 'PaymentConstructorService must have analyze/recommend/generate method');
    }
    ...
    {
        $paths = [
            'App\Domains\Payment\Services\AI\PaymentConstructorService',
            'App\Domains\Payment\Domain\Services\AI\PaymentConstructorService',
        ];
        foreach ($paths as $p) {
