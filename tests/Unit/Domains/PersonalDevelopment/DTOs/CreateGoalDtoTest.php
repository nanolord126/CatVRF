...
/**
 * Unit tests for CreateGoalDto.
 *
 * @covers \App\Domains\PersonalDevelopment\DTOs\CreateGoalDto
 */
final class CreateGoalDtoTest extends TestCase
{
    public function test_class_is_final_readonly(): void
    {
        $reflection = new \ReflectionClass(
            \App\Domains\PersonalDevelopment\DTOs\CreateGoalDto::class
        );
        $this->assertTrue($reflection->isFinal(), 'CreateGoalDto must be final');
        $this->assertTrue($reflection->isReadOnly(), 'CreateGoalDto must be readonly');
    }
    ...
    {
        return \App\Domains\PersonalDevelopment\DTOs\CreateGoalDto::class;
    }
}
