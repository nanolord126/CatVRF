...
namespace Tests\Unit\Domains\PersonalDevelopment\DTOs;

use PHPUnit\Framework\TestCase;

/**
 * Unit tests for CreateProgressDto.
 *
 * @covers \App\Domains\PersonalDevelopment\DTOs\CreateProgressDto
 */
final class CreateProgressDtoTest extends TestCase
{
    public function test_class_is_final_readonly(): void
    {
        $reflection = new \ReflectionClass(
            \App\Domains\PersonalDevelopment\DTOs\CreateProgressDto::class
        );
        $this->assertTrue($reflection->isFinal(), 'CreateProgressDto must be final');
        $this->assertTrue($reflection->isReadOnly(), 'CreateProgressDto must be readonly');
    }
    ...
    {
        return \App\Domains\PersonalDevelopment\DTOs\CreateProgressDto::class;
    }
}
