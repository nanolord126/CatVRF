...
/**
 * Unit tests for CreateEquipmentDto.
 *
 * @covers \App\Domains\Sports\DTOs\CreateEquipmentDto
 */
final class CreateEquipmentDtoTest extends TestCase
{
    public function test_class_is_final_readonly(): void
    {
        $reflection = new \ReflectionClass(
            \App\Domains\Sports\DTOs\CreateEquipmentDto::class
        );
        $this->assertTrue($reflection->isFinal(), 'CreateEquipmentDto must be final');
        $this->assertTrue($reflection->isReadOnly(), 'CreateEquipmentDto must be readonly');
    }
    ...
    {
        return \App\Domains\Sports\DTOs\CreateEquipmentDto::class;
    }
}
