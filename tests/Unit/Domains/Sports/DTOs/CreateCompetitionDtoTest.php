...
namespace Tests\Unit\Domains\Sports\DTOs;

use PHPUnit\Framework\TestCase;

/**
 * Unit tests for CreateCompetitionDto.
 *
 * @covers \App\Domains\Sports\DTOs\CreateCompetitionDto
 */
final class CreateCompetitionDtoTest extends TestCase
{
    public function test_class_is_final_readonly(): void
    {
        $reflection = new \ReflectionClass(
            \App\Domains\Sports\DTOs\CreateCompetitionDto::class
        );
        $this->assertTrue($reflection->isFinal(), 'CreateCompetitionDto must be final');
        $this->assertTrue($reflection->isReadOnly(), 'CreateCompetitionDto must be readonly');
    }
    ...
    {
        return \App\Domains\Sports\DTOs\CreateCompetitionDto::class;
    }
}
