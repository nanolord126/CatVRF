...
namespace Tests\Unit\Domains\HobbyAndCraft\DTOs;

use PHPUnit\Framework\TestCase;

/**
 * Unit tests for CreateKitDto.
 *
 * @covers \App\Domains\HobbyAndCraft\DTOs\CreateKitDto
 */
final class CreateKitDtoTest extends TestCase
{
    public function test_class_is_final_readonly(): void
    {
        $reflection = new \ReflectionClass(
            \App\Domains\HobbyAndCraft\DTOs\CreateKitDto::class
        );
        $this->assertTrue($reflection->isFinal(), 'CreateKitDto must be final');
        $this->assertTrue($reflection->isReadOnly(), 'CreateKitDto must be readonly');
    }
    ...
    {
        return \App\Domains\HobbyAndCraft\DTOs\CreateKitDto::class;
    }
}
