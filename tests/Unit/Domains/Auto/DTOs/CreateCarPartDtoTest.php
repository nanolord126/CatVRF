...
namespace Tests\Unit\Domains\Auto\DTOs;

use PHPUnit\Framework\TestCase;

/**
 * Unit tests for CreateCarPartDto.
 *
 * @covers \App\Domains\Auto\DTOs\CreateCarPartDto
 */
final class CreateCarPartDtoTest extends TestCase
{
    public function test_class_is_final_readonly(): void
    {
        $reflection = new \ReflectionClass(
            \App\Domains\Auto\DTOs\CreateCarPartDto::class
        );
        $this->assertTrue($reflection->isFinal(), 'CreateCarPartDto must be final');
        $this->assertTrue($reflection->isReadOnly(), 'CreateCarPartDto must be readonly');
    }
    ...
    {
        return \App\Domains\Auto\DTOs\CreateCarPartDto::class;
    }
}
