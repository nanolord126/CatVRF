...
/**
 * Unit tests for CreateCarDto.
 *
 * @covers \App\Domains\Auto\DTOs\CreateCarDto
 */
final class CreateCarDtoTest extends TestCase
{
    public function test_class_is_final_readonly(): void
    {
        $reflection = new \ReflectionClass(
            \App\Domains\Auto\DTOs\CreateCarDto::class
        );
        $this->assertTrue($reflection->isFinal(), 'CreateCarDto must be final');
        $this->assertTrue($reflection->isReadOnly(), 'CreateCarDto must be readonly');
    }
    ...
    {
        return \App\Domains\Auto\DTOs\CreateCarDto::class;
    }
}
