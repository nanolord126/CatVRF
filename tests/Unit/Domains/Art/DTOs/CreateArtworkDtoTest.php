...
/**
 * Unit tests for CreateArtworkDto.
 *
 * @covers \App\Domains\Art\DTOs\CreateArtworkDto
 */
final class CreateArtworkDtoTest extends TestCase
{
    public function test_class_is_final_readonly(): void
    {
        $reflection = new \ReflectionClass(
            \App\Domains\Art\DTOs\CreateArtworkDto::class
        );
        $this->assertTrue($reflection->isFinal(), 'CreateArtworkDto must be final');
        $this->assertTrue($reflection->isReadOnly(), 'CreateArtworkDto must be readonly');
    }
    ...
    {
        return \App\Domains\Art\DTOs\CreateArtworkDto::class;
    }
}
