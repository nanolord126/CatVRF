...
namespace Tests\Unit\Domains\Art\DTOs;

use PHPUnit\Framework\TestCase;
use App\Domains\Art\DTOs\CreateExhibitionDto;

/**
 * Unit tests for CreateExhibitionDto.
 *
 * @covers \App\Domains\Art\DTOs\CreateExhibitionDto
 */
final class CreateExhibitionDtoTest extends TestCase
{
    public function test_class_is_final_readonly(): void
    {
        $reflection = new \ReflectionClass(
            CreateExhibitionDto::class
        );
        $this->assertTrue($reflection->isFinal(), 'CreateExhibitionDto must be final');
        $this->assertTrue($reflection->isReadOnly(), 'CreateExhibitionDto must be readonly');
    }
    ...
    {
        return CreateExhibitionDto::class;
    }
}
