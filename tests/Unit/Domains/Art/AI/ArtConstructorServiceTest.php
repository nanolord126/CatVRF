...
namespace Tests\Unit\Domains\Art\AI;

use PHPUnit\Framework\TestCase;

/**
 * Unit tests for ArtConstructorService.
 *
 * @covers \App\Domains\Art\Services\AI\ArtConstructorService
 * @group ai-constructors
 */
final class ArtConstructorServiceTest extends TestCase
{
    ...
    public function test_has_analyze_method(): void
    {
        ...
        $this->assertTrue($hasAnalyze, 'ArtConstructorService must have analyze/recommend/generate method');
    }
    ...
    {
        $paths = [
            'App\Domains\Art\Services\AI\ArtConstructorService',
            'App\Domains\Art\Domain\Services\AI\ArtConstructorService',
        ];
        foreach ($paths as $p) {
