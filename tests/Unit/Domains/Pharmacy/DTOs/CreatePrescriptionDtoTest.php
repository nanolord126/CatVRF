...
namespace Tests\Unit\Domains\Pharmacy\DTOs;

use PHPUnit\Framework\TestCase;

/**
 * Unit tests for CreatePrescriptionDto.
 *
 * @covers \App\Domains\Pharmacy\DTOs\CreatePrescriptionDto
 */
final class CreatePrescriptionDtoTest extends TestCase
{
    public function test_class_is_final_readonly(): void
    {
        $reflection = new \ReflectionClass(
            \App\Domains\Pharmacy\DTOs\CreatePrescriptionDto::class
        );
        $this->assertTrue($reflection->isFinal(), 'CreatePrescriptionDto must be final');
        $this->assertTrue($reflection->isReadOnly(), 'CreatePrescriptionDto must be readonly');
    }
    ...
    {
        return \App\Domains\Pharmacy\DTOs\CreatePrescriptionDto::class;
    }
}
