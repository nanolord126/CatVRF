...
/**
 * Unit tests for CreateMetricDto.
 *
 * @covers \App\Domains\Analytics\DTOs\CreateMetricDto
 */
final class CreateMetricDtoTest extends TestCase
{
    public function test_class_is_final_readonly(): void
    {
        $reflection = new \ReflectionClass(
            \App\Domains\Analytics\DTOs\CreateMetricDto::class
        );
        $this->assertTrue($reflection->isFinal(), 'CreateMetricDto must be final');
        $this->assertTrue($reflection->isReadOnly(), 'CreateMetricDto must be readonly');
    }
    ...
    {
        return \App\Domains\Analytics\DTOs\CreateMetricDto::class;
    }
}
