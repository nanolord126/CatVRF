...
namespace Tests\Unit\Domains\Analytics\DTOs;

use PHPUnit\Framework\TestCase;

/**
 * Unit tests for CreateDashboardDto.
 *
 * @covers \App\Domains\Analytics\DTOs\CreateDashboardDto
 */
final class CreateDashboardDtoTest extends TestCase
{
    public function test_class_is_final_readonly(): void
    {
        $reflection = new \ReflectionClass(
            \App\Domains\Analytics\DTOs\CreateDashboardDto::class
        );
        $this->assertTrue($reflection->isFinal(), 'CreateDashboardDto must be final');
        $this->assertTrue($reflection->isReadOnly(), 'CreateDashboardDto must be readonly');
    }
    ...
    {
        return \App\Domains\Analytics\DTOs\CreateDashboardDto::class;
    }
}
