...
namespace Tests\Unit\Domains\OfficeCatering\DTOs;

use PHPUnit\Framework\TestCase;

/**
 * Unit tests for CreateMenuDto.
 *
 * @covers \App\Domains\OfficeCatering\DTOs\CreateMenuDto
 */
final class CreateMenuDtoTest extends TestCase
{
    public function test_class_is_final_readonly(): void
    {
        $reflection = new \ReflectionClass(
            \App\Domains\OfficeCatering\DTOs\CreateMenuDto::class
        );
        $this->assertTrue($reflection->isFinal(), 'CreateMenuDto must be final');
        $this->assertTrue($reflection->isReadOnly(), 'CreateMenuDto must be readonly');
    }
    ...
    {
        return \App\Domains\OfficeCatering\DTOs\CreateMenuDto::class;
    }
}
