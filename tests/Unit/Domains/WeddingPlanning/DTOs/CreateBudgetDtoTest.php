...
namespace Tests\Unit\Domains\WeddingPlanning\DTOs;

use PHPUnit\Framework\TestCase;

/**
 * Unit tests for CreateBudgetDto.
 *
 * @covers \App\Domains\WeddingPlanning\DTOs\CreateBudgetDto
 */
final class CreateBudgetDtoTest extends TestCase
{
    public function test_class_is_final_readonly(): void
    {
        $reflection = new \ReflectionClass(
            \App\Domains\WeddingPlanning\DTOs\CreateBudgetDto::class
        );
        $this->assertTrue($reflection->isFinal(), 'CreateBudgetDto must be final');
        $this->assertTrue($reflection->isReadOnly(), 'CreateBudgetDto must be readonly');
    }
    ...
    {
        return \App\Domains\WeddingPlanning\DTOs\CreateBudgetDto::class;
    }
}
