...
/**
 * Unit tests for CreateEventDto.
 *
 * @covers \App\Domains\WeddingPlanning\DTOs\CreateEventDto
 */
final class CreateEventDtoTest extends TestCase
{
    public function test_class_is_final_readonly(): void
    {
        $reflection = new \ReflectionClass(
            \App\Domains\WeddingPlanning\DTOs\CreateEventDto::class
        );
        $this->assertTrue($reflection->isFinal(), 'CreateEventDto must be final');
        $this->assertTrue($reflection->isReadOnly(), 'CreateEventDto must be readonly');
    }
    ...
    {
        return \App\Domains\WeddingPlanning\DTOs\CreateEventDto::class;
    }
}
