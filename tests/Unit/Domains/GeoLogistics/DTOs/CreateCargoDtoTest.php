...
namespace Tests\Unit\Domains\GeoLogistics\DTOs;

use PHPUnit\Framework\TestCase;

/**
 * Unit tests for CreateCargoDto.
 *
 * @covers \App\Domains\GeoLogistics\DTOs\CreateCargoDto
 */
final class CreateCargoDtoTest extends TestCase
{
    public function test_class_is_final_readonly(): void
    {
        $reflection = new \ReflectionClass(
            \App\Domains\GeoLogistics\DTOs\CreateCargoDto::class
        );
        $this->assertTrue($reflection->isFinal(), 'CreateCargoDto must be final');
        $this->assertTrue($reflection->isReadOnly(), 'CreateCargoDto must be readonly');
    }
    ...
    {
        return \App\Domains\GeoLogistics\DTOs\CreateCargoDto::class;
    }
}
