...
/**
 * Unit tests for CreateRouteDto.
 *
 * @covers \App\Domains\GeoLogistics\DTOs\CreateRouteDto
 */
final class CreateRouteDtoTest extends TestCase
{
    public function test_class_is_final_readonly(): void
    {
        $reflection = new \ReflectionClass(
            \App\Domains\GeoLogistics\DTOs\CreateRouteDto::class
        );
        $this->assertTrue($reflection->isFinal(), 'CreateRouteDto must be final');
        $this->assertTrue($reflection->isReadOnly(), 'CreateRouteDto must be readonly');
    }
    ...
    {
        return \App\Domains\GeoLogistics\DTOs\CreateRouteDto::class;
    }
}
