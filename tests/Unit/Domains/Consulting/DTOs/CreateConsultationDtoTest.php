...
namespace Tests\Unit\Domains\Consulting\DTOs;

use PHPUnit\Framework\TestCase;

/**
 * Unit tests for CreateConsultationDto.
 *
 * @covers \App\Domains\Consulting\DTOs\CreateConsultationDto
 */
final class CreateConsultationDtoTest extends TestCase
{
    public function test_class_is_final_readonly(): void
    {
        $reflection = new \ReflectionClass(
            \App\Domains\Consulting\DTOs\CreateConsultationDto::class
        );
        $this->assertTrue($reflection->isFinal(), 'CreateConsultationDto must be final');
        $this->assertTrue($reflection->isReadOnly(), 'CreateConsultationDto must be readonly');
    }
    ...
    {
        return \App\Domains\Consulting\DTOs\CreateConsultationDto::class;
    }
}
