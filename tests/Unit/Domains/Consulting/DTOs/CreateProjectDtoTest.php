...
/**
 * Unit tests for CreateProjectDto.
 *
 * @covers \App\Domains\Consulting\DTOs\CreateProjectDto
 */
final class CreateProjectDtoTest extends TestCase
{
    public function test_class_is_final_readonly(): void
    {
        $reflection = new \ReflectionClass(
            \App\Domains\Consulting\DTOs\CreateProjectDto::class
        );
        $this->assertTrue($reflection->isFinal(), 'CreateProjectDto must be final');
        $this->assertTrue($reflection->isReadOnly(), 'CreateProjectDto must be readonly');
    }
    ...
    {
        return \App\Domains\Consulting\DTOs\CreateProjectDto::class;
    }
}
