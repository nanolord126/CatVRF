 ...
 *
 * @covers \App\Domains\CleaningServices\DTOs\CreateOrderDto
 */
final class CreateOrderDtoTest extends TestCase
{
    public function test_class_is_final_readonly(): void
    {
        $reflection = new \ReflectionClass(
            \App\Domains\CleaningServices\DTOs\CreateOrderDto::class
        );
    ...
    {
        return \App\Domains\CleaningServices\DTOs\CreateOrderDto::class;
    }
}
