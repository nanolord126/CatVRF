...
namespace Tests\Unit\Domains\CleaningServices\DTOs;

use PHPUnit\Framework\TestCase;

/**
 * Unit tests for CreateScheduleDto.
 *
 * @covers \App\Domains\CleaningServices\DTOs\CreateScheduleDto
 */
final class CreateScheduleDtoTest extends TestCase
{
    public function test_class_is_final_readonly(): void
    {
        $reflection = new \ReflectionClass(
            \App\Domains\CleaningServices\DTOs\CreateScheduleDto::class
        );
        $this->assertTrue($reflection->isFinal(), 'CreateScheduleDto must be final');
        $this->assertTrue($reflection->isReadOnly(), 'CreateScheduleDto must be readonly');
    }
    ...
    {
        return \App\Domains\CleaningServices\DTOs\CreateScheduleDto::class;
    }
}
