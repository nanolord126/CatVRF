 ...
 *
 * @covers \App\Domains\EventPlanning\DTOs\CreateBookingDto
 */
final class CreateBookingDtoTest extends TestCase
{
    public function test_class_is_final_readonly(): void
    {
        $reflection = new \ReflectionClass(
            \App\Domains\EventPlanning\DTOs\CreateBookingDto::class
        );
    ...
    {
        return \App\Domains\EventPlanning\DTOs\CreateBookingDto::class;
    }
}
