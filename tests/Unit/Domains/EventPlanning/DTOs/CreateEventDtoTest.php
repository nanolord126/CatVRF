...
namespace Tests\Unit\Domains\EventPlanning\DTOs;
 ...
 *
 * @covers \App\Domains\EventPlanning\DTOs\CreateEventDto
 */
final class CreateEventDtoTest extends TestCase
{
    public function test_class_is_final_readonly(): void
    {
        $reflection = new \ReflectionClass(
            \App\Domains\EventPlanning\DTOs\CreateEventDto::class
        );
    ...
    {
        return \App\Domains\EventPlanning\DTOs\CreateEventDto::class;
    }
}
