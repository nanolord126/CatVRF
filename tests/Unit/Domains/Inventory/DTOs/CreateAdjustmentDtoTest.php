 ...
 *
 * @covers \App\Domains\Inventory\DTOs\CreateAdjustmentDto
 */
final class CreateAdjustmentDtoTest extends TestCase
{
    ...
    public function test_constructor_properties(): void
    {
        ...
        $this->assertContains('newQuantity', $params, 'Constructor must have newQuantity');
        $this->assertContains('reason', $params, 'Constructor must have reason');
