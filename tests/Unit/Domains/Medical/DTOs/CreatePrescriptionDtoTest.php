...
namespace Tests\Unit\Domains\Medical\DTOs;
 ...
 *
 * @covers \App\Domains\Medical\DTOs\CreatePrescriptionDto
 */
final class CreatePrescriptionDtoTest extends TestCase
{
    public function test_class_is_final_readonly(): void
    {
        $reflection = new \ReflectionClass(
            \App\Domains\Medical\DTOs\CreatePrescriptionDto::class
        );
    ...
    {
        return \App\Domains\Medical\DTOs\CreatePrescriptionDto::class;
    }
}
