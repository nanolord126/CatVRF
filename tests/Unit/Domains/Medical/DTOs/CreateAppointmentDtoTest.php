 ...
 *
 * @covers \App\Domains\Medical\DTOs\CreateAppointmentDto
 */
final class CreateAppointmentDtoTest extends TestCase
{
    public function test_class_is_final_readonly(): void
    {
        $reflection = new \ReflectionClass(
            \App\Domains\Medical\DTOs\CreateAppointmentDto::class
        );
    ...
    {
        return \App\Domains\Medical\DTOs\CreateAppointmentDto::class;
    }
}
