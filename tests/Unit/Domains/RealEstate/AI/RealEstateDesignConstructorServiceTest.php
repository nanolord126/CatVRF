...
namespace Tests\Unit\Domains\RealEstate\AI;

use PHPUnit\Framework\TestCase;

/**
 * Unit tests for RealEstateDesignConstructorService.
 *
 * @covers \App\Domains\RealEstate\Services\AI\RealEstateDesignConstructorService
...
final class RealEstateDesignConstructorServiceTest extends TestCase
{
    ...
    public function test_has_analyze_method(): void
    {
        ...
        $this->assertTrue($hasAnalyze, 'RealEstateDesignConstructorService must have analyze/recommend/generate method');
    }
    ...
    {
        $paths = [
            'App\Domains\RealEstate\Services\AI\RealEstateDesignConstructorService',
            'App\Domains\RealEstate\Domain\Services\AI\RealEstateDesignConstructorService',
        ];
        foreach ($paths as $p) {
