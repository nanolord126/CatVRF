...
namespace Tests\Unit\Domains\RealEstate\DTOs;
 ...
 *
 * @covers \App\Domains\RealEstate\DTOs\CreatePropertyDto
 */
final class CreatePropertyDtoTest extends TestCase
{
    public function test_class_is_final_readonly(): void
    {
        $reflection = new \ReflectionClass(
            \App\Domains\RealEstate\DTOs\CreatePropertyDto::class
        );
    ...
    {
        return \App\Domains\RealEstate\DTOs\CreatePropertyDto::class;
    }
}
