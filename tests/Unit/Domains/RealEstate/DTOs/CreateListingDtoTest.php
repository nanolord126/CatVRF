...
/**
 * Unit tests for CreateListingDto.
 *
 * @covers \App\Domains\RealEstate\DTOs\CreateListingDto
 */
final class CreateListingDtoTest extends TestCase
{
    public function test_class_is_final_readonly(): void
    {
        $reflection = new \ReflectionClass(
            \App\Domains\RealEstate\DTOs\CreateListingDto::class
        );
        $this->assertTrue($reflection->isFinal(), 'CreateListingDto must be final');
        $this->assertTrue($reflection->isReadOnly(), 'CreateListingDto must be readonly');
    }
    ...
    {
        return \App\Domains\RealEstate\DTOs\CreateListingDto::class;
    }
}
