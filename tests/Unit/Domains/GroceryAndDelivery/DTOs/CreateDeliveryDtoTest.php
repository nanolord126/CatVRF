...
namespace Tests\Unit\Domains\GroceryAndDelivery\DTOs;

use PHPUnit\Framework\TestCase;

/**
 * Unit tests for CreateDeliveryDto.
 *
 * @covers \App\Domains\GroceryAndDelivery\DTOs\CreateDeliveryDto
 */
final class CreateDeliveryDtoTest extends TestCase
{
    public function test_class_is_final_readonly(): void
    {
        $reflection = new \ReflectionClass(
            \App\Domains\GroceryAndDelivery\DTOs\CreateDeliveryDto::class
        );
        $this->assertTrue($reflection->isFinal(), 'CreateDeliveryDto must be final');
        $this->assertTrue($reflection->isReadOnly(), 'CreateDeliveryDto must be readonly');
    }
    ...
    {
        return \App\Domains\GroceryAndDelivery\DTOs\CreateDeliveryDto::class;
    }
}
