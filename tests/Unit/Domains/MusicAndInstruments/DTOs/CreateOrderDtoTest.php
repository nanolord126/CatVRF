 ...
 *
 * @covers \App\Domains\MusicAndInstruments\DTOs\CreateOrderDto
 */
final class CreateOrderDtoTest extends TestCase
{
    public function test_class_is_final_readonly(): void
    {
        $reflection = new \ReflectionClass(
            \App\Domains\MusicAndInstruments\DTOs\CreateOrderDto::class
        );
    ...
    {
        return \App\Domains\MusicAndInstruments\DTOs\CreateOrderDto::class;
    }
}
