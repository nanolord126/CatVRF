...
namespace Tests\Unit\Domains\MusicAndInstruments\DTOs;

use PHPUnit\Framework\TestCase;

/**
 * Unit tests for CreateLessonDto.
 *
 * @covers \App\Domains\MusicAndInstruments\DTOs\CreateLessonDto
 */
final class CreateLessonDtoTest extends TestCase
{
    public function test_class_is_final_readonly(): void
    {
        $reflection = new \ReflectionClass(
            \App\Domains\MusicAndInstruments\DTOs\CreateLessonDto::class
        );
        $this->assertTrue($reflection->isFinal(), 'CreateLessonDto must be final');
        $this->assertTrue($reflection->isReadOnly(), 'CreateLessonDto must be readonly');
    }
    ...
    {
        return \App\Domains\MusicAndInstruments\DTOs\CreateLessonDto::class;
    }
}
