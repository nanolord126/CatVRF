...
use App\Domains\DemandForecast\Domain\Services\DemandForecastService;
...
final class DemandForecastServiceTest extends TestCase
{
    ...
    public function test_forecast_for_item_method_exists(): void
    {
        $this->assertTrue(
            method_exists(DemandForecastService::class, 'forecastForItem'),
    ...
    {
        $this->assertTrue(
            method_exists(DemandForecastService::class, 'invalidateCache'),
