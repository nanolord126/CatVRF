...
namespace Tests\Unit\Domains\Geo\AI;

use PHPUnit\Framework\TestCase;

/**
 * Unit tests for GeoConstructorService.
 *
 * @covers \App\Domains\Geo\Services\AI\GeoConstructorService
 * @group ai-constructors
 */
final class GeoConstructorServiceTest extends TestCase
{
    ...
    public function test_has_analyze_method(): void
    {
        ...
        $this->assertTrue($hasAnalyze, 'GeoConstructorService must have analyze/recommend/generate method');
    }
    ...
    {
        $paths = [
            'App\Domains\Geo\Services\AI\GeoConstructorService',
            'App\Domains\Geo\Domain\Services\AI\GeoConstructorService',
        ];
        foreach ($paths as $p) {
