...
namespace Tests\Unit\Domains\Geo\DTOs;

use PHPUnit\Framework\TestCase;
use App\Domains\Geo\DTOs\CreateGeoLocationDto;

/**
 * Unit tests for CreateGeoLocationDto.
 *
 * @covers \App\Domains\Geo\DTOs\CreateGeoLocationDto
 */
final class CreateGeoLocationDtoTest extends TestCase
{
    public function test_class_is_final_readonly(): void
    {
        $reflection = new \ReflectionClass(
            CreateGeoLocationDto::class
        );
        $this->assertTrue($reflection->isFinal(), 'CreateGeoLocationDto must be final');
        $this->assertTrue($reflection->isReadOnly(), 'CreateGeoLocationDto must be readonly');
    }
    ...
    {
        return CreateGeoLocationDto::class;
    }
}
