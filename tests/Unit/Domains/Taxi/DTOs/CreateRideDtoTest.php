...
/**
 * Unit tests for CreateRideDto.
 *
 * @covers \App\Domains\Taxi\DTOs\CreateRideDto
 */
final class CreateRideDtoTest extends TestCase
{
    public function test_class_is_final_readonly(): void
    {
        $reflection = new \ReflectionClass(
            \App\Domains\Taxi\DTOs\CreateRideDto::class
        );
        $this->assertTrue($reflection->isFinal(), 'CreateRideDto must be final');
        $this->assertTrue($reflection->isReadOnly(), 'CreateRideDto must be readonly');
    }
    ...
    {
        return \App\Domains\Taxi\DTOs\CreateRideDto::class;
    }
}
