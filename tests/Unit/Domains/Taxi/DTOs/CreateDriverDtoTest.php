...
namespace Tests\Unit\Domains\Taxi\DTOs;

use PHPUnit\Framework\TestCase;

/**
 * Unit tests for CreateDriverDto.
 *
 * @covers \App\Domains\Taxi\DTOs\CreateDriverDto
 */
final class CreateDriverDtoTest extends TestCase
{
    public function test_class_is_final_readonly(): void
    {
        $reflection = new \ReflectionClass(
            \App\Domains\Taxi\DTOs\CreateDriverDto::class
        );
        $this->assertTrue($reflection->isFinal(), 'CreateDriverDto must be final');
        $this->assertTrue($reflection->isReadOnly(), 'CreateDriverDto must be readonly');
    }
    ...
    {
        return \App\Domains\Taxi\DTOs\CreateDriverDto::class;
    }
}
