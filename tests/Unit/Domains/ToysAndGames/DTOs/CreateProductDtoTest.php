...
namespace Tests\Unit\Domains\ToysAndGames\DTOs;
 ...
 *
 * @covers \App\Domains\ToysAndGames\DTOs\CreateProductDto
 */
final class CreateProductDtoTest extends TestCase
{
    public function test_class_is_final_readonly(): void
    {
        $reflection = new \ReflectionClass(
            \App\Domains\ToysAndGames\DTOs\CreateProductDto::class
        );
        $this->assertTrue($reflection->isFinal(), 'CreateProductDto must be final');
        $this->assertTrue($reflection->isReadOnly(), 'CreateProductDto must be readonly');
    }
    ...
    {
        return \App\Domains\ToysAndGames\DTOs\CreateProductDto::class;
    }
}
