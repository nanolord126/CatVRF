...
/**
 * Unit tests for CreateClaimDto.
 *
 * @covers \App\Domains\Insurance\DTOs\CreateClaimDto
 */
final class CreateClaimDtoTest extends TestCase
{
    public function test_class_is_final_readonly(): void
    {
        $reflection = new \ReflectionClass(
            \App\Domains\Insurance\DTOs\CreateClaimDto::class
        );
        $this->assertTrue($reflection->isFinal(), 'CreateClaimDto must be final');
        $this->assertTrue($reflection->isReadOnly(), 'CreateClaimDto must be readonly');
    }
    ...
    {
        return \App\Domains\Insurance\DTOs\CreateClaimDto::class;
    }
}
