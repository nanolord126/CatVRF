...
namespace Tests\Unit\Domains\Insurance\DTOs;

use PHPUnit\Framework\TestCase;

/**
 * Unit tests for CreatePolicyDto.
 *
 * @covers \App\Domains\Insurance\DTOs\CreatePolicyDto
 */
final class CreatePolicyDtoTest extends TestCase
{
    public function test_class_is_final_readonly(): void
    {
        $reflection = new \ReflectionClass(
            \App\Domains\Insurance\DTOs\CreatePolicyDto::class
        );
        $this->assertTrue($reflection->isFinal(), 'CreatePolicyDto must be final');
        $this->assertTrue($reflection->isReadOnly(), 'CreatePolicyDto must be readonly');
    }
    ...
    {
        return \App\Domains\Insurance\DTOs\CreatePolicyDto::class;
    }
}
