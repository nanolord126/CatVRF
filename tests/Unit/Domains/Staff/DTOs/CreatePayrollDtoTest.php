...
/**
 * Unit tests for CreatePayrollDto.
 *
 * @covers \App\Domains\Staff\DTOs\CreatePayrollDto
 */
final class CreatePayrollDtoTest extends TestCase
{
    public function test_class_is_final_readonly(): void
    {
        $reflection = new \ReflectionClass(
            \App\Domains\Staff\DTOs\CreatePayrollDto::class
        );
        $this->assertTrue($reflection->isFinal(), 'CreatePayrollDto must be final');
        $this->assertTrue($reflection->isReadOnly(), 'CreatePayrollDto must be readonly');
    }
    ...
    {
        return \App\Domains\Staff\DTOs\CreatePayrollDto::class;
    }
}
