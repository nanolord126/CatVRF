...
namespace Tests\Unit\Domains\Staff\DTOs;

use PHPUnit\Framework\TestCase;

/**
 * Unit tests for CreateEmployeeDto.
 *
 * @covers \App\Domains\Staff\DTOs\CreateEmployeeDto
 */
final class CreateEmployeeDtoTest extends TestCase
{
    public function test_class_is_final_readonly(): void
    {
        $reflection = new \ReflectionClass(
            \App\Domains\Staff\DTOs\CreateEmployeeDto::class
        );
        $this->assertTrue($reflection->isFinal(), 'CreateEmployeeDto must be final');
        $this->assertTrue($reflection->isReadOnly(), 'CreateEmployeeDto must be readonly');
    }
    ...
    {
        return \App\Domains\Staff\DTOs\CreateEmployeeDto::class;
    }
}
