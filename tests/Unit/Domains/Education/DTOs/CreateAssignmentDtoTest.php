...
/**
 * Unit tests for CreateAssignmentDto.
 *
 * @covers \App\Domains\Education\DTOs\CreateAssignmentDto
 */
final class CreateAssignmentDtoTest extends TestCase
{
    public function test_class_is_final_readonly(): void
    {
        $reflection = new \ReflectionClass(
            \App\Domains\Education\DTOs\CreateAssignmentDto::class
        );
        $this->assertTrue($reflection->isFinal(), 'CreateAssignmentDto must be final');
        $this->assertTrue($reflection->isReadOnly(), 'CreateAssignmentDto must be readonly');
    }
    ...
    {
        return \App\Domains\Education\DTOs\CreateAssignmentDto::class;
    }
}
