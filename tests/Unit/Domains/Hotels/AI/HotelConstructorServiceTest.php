...
/**
 * Unit tests for HotelConstructorService.
 *
 * @covers \App\Domains\Hotels\Services\AI\HotelConstructorService
 * @group ai-constructors
 */
final class HotelConstructorServiceTest extends TestCase
{
    ...
    public function test_has_analyze_method(): void
    {
        ...
        $this->assertTrue($hasAnalyze, 'HotelConstructorService must have analyze/recommend/generate method');
    }
    ...
    {
        $paths = [
            'App\Domains\Hotels\Services\AI\HotelConstructorService',
            'App\Domains\Hotels\Domain\Services\AI\HotelConstructorService',
        ];
        foreach ($paths as $p) {
