...
namespace Tests\Unit\Domains\Luxury\DTOs;

use PHPUnit\Framework\TestCase;

/**
 * Unit tests for CreateExperienceDto.
 *
 * @covers \App\Domains\Luxury\DTOs\CreateExperienceDto
 */
final class CreateExperienceDtoTest extends TestCase
{
    public function test_class_is_final_readonly(): void
    {
        $reflection = new \ReflectionClass(
            \App\Domains\Luxury\DTOs\CreateExperienceDto::class
        );
        $this->assertTrue($reflection->isFinal(), 'CreateExperienceDto must be final');
        $this->assertTrue($reflection->isReadOnly(), 'CreateExperienceDto must be readonly');
    }
    ...
    {
        return \App\Domains\Luxury\DTOs\CreateExperienceDto::class;
    }
}
