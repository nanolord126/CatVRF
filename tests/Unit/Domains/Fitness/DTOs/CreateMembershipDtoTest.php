...
namespace Tests\Unit\Domains\Fitness\DTOs;

use PHPUnit\Framework\TestCase;

/**
 * Unit tests for CreateMembershipDto.
 *
 * @covers \App\Domains\Fitness\DTOs\CreateMembershipDto
 */
final class CreateMembershipDtoTest extends TestCase
{
    public function test_class_is_final_readonly(): void
    {
        $reflection = new \ReflectionClass(
            \App\Domains\Fitness\DTOs\CreateMembershipDto::class
        );
        $this->assertTrue($reflection->isFinal(), 'CreateMembershipDto must be final');
        $this->assertTrue($reflection->isReadOnly(), 'CreateMembershipDto must be readonly');
    }
    ...
    {
        return \App\Domains\Fitness\DTOs\CreateMembershipDto::class;
    }
}
