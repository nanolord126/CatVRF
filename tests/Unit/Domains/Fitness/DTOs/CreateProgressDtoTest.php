 ...
 *
 * @covers \App\Domains\Fitness\DTOs\CreateProgressDto
 */
final class CreateProgressDtoTest extends TestCase
{
    public function test_class_is_final_readonly(): void
    {
        $reflection = new \ReflectionClass(
            \App\Domains\Fitness\DTOs\CreateProgressDto::class
        );
    ...
    {
        return \App\Domains\Fitness\DTOs\CreateProgressDto::class;
    }
}
