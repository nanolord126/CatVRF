...
namespace Tests\Unit\Domains\CarRental\DTOs;

use PHPUnit\Framework\TestCase;

/**
 * Unit tests for CreateRentalDto.
 *
 * @covers \App\Domains\CarRental\DTOs\CreateRentalDto
 */
final class CreateRentalDtoTest extends TestCase
{
    public function test_class_is_final_readonly(): void
    {
        $reflection = new \ReflectionClass(
            \App\Domains\CarRental\DTOs\CreateRentalDto::class
        );
        $this->assertTrue($reflection->isFinal(), 'CreateRentalDto must be final');
        $this->assertTrue($reflection->isReadOnly(), 'CreateRentalDto must be readonly');
    }
    ...
    {
        return \App\Domains\CarRental\DTOs\CreateRentalDto::class;
    }
}
