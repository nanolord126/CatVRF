...
namespace Tests\Unit\Domains\Photography\DTOs;

use PHPUnit\Framework\TestCase;

/**
 * Unit tests for CreatePackageDto.
 *
 * @covers \App\Domains\Photography\DTOs\CreatePackageDto
 */
final class CreatePackageDtoTest extends TestCase
{
    public function test_class_is_final_readonly(): void
    {
        $reflection = new \ReflectionClass(
            \App\Domains\Photography\DTOs\CreatePackageDto::class
        );
        $this->assertTrue($reflection->isFinal(), 'CreatePackageDto must be final');
        $this->assertTrue($reflection->isReadOnly(), 'CreatePackageDto must be readonly');
    }
    ...
    {
        return \App\Domains\Photography\DTOs\CreatePackageDto::class;
    }
}
