...
/**
 * Unit tests for CreateGalleryDto.
 *
 * @covers \App\Domains\Photography\DTOs\CreateGalleryDto
 */
final class CreateGalleryDtoTest extends TestCase
{
    public function test_class_is_final_readonly(): void
    {
        $reflection = new \ReflectionClass(
            \App\Domains\Photography\DTOs\CreateGalleryDto::class
        );
        $this->assertTrue($reflection->isFinal(), 'CreateGalleryDto must be final');
        $this->assertTrue($reflection->isReadOnly(), 'CreateGalleryDto must be readonly');
    }
    ...
    {
        return \App\Domains\Photography\DTOs\CreateGalleryDto::class;
    }
}
