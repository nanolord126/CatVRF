...
use App\Domains\Photography\Domain\Services\PhotographyB2BService;
...
final class PhotographyB2BServiceTest extends TestCase
{
    ...
    public function test_create_batch_corporate_booking_method_exists(): void
    {
        $this->assertTrue(
            method_exists(PhotographyB2BService::class, 'createBatchCorporateBooking'),
