...
namespace Tests\Unit\Domains\Freelance\DTOs;

use PHPUnit\Framework\TestCase;

/**
 * Unit tests for CreateContractDto.
 *
 * @covers \App\Domains\Freelance\DTOs\CreateContractDto
 */
final class CreateContractDtoTest extends TestCase
{
    public function test_class_is_final_readonly(): void
    {
        $reflection = new \ReflectionClass(
            \App\Domains\Freelance\DTOs\CreateContractDto::class
        );
        $this->assertTrue($reflection->isFinal(), 'CreateContractDto must be final');
        $this->assertTrue($reflection->isReadOnly(), 'CreateContractDto must be readonly');
    }
    ...
    {
        return \App\Domains\Freelance\DTOs\CreateContractDto::class;
    }
}
