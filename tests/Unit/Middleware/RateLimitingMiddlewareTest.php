...
final class RateLimitingMiddlewareTest extends TestCase
{
    ...
    {
        $this->assertTrue(class_exists(RateLimitingMiddleware::class));
    }

    public function test_has_handle_method(): void
    {
        $this->assertTrue(
            method_exists(RateLimitingMiddleware::class, 'handle'),
    ...
    {
        $reflection = new \ReflectionMethod(RateLimitingMiddleware::class, 'handle');
