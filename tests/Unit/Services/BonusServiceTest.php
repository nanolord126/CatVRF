...
final class BonusServiceTest extends TestCase
{
    ...
    {
        $reflection = new \ReflectionClass(BonusService::class);
    ...
    public function test_expire_old_bonuses_method_exists(): void
    {
        $this->assertTrue(
            method_exists(BonusService::class, 'expireOldBonuses'),
