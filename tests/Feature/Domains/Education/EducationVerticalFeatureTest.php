...
/**
 * EducationVerticalFeatureTest
 *
 * Feature-тест для вертикали Education — CatVRF 2026.
 ...
 */
final class EducationVerticalFeatureTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function ai_constructor_service_can_be_resolved_from_container(): void
    {
        ...
        $this->assertTrue(
            class_exists('App\Domains\Education\Services\AI\RoadmapConstructor'),
            'AI-конструктор App\Domains\Education\Services\AI\RoadmapConstructor должен существовать'
        );
    }
    ...
    public function service_class_exists_in_container(): void
    {
        ...
        $this->assertTrue(
            class_exists('App\Domains\Education\Services\EducationService'),
            'Сервис App\Domains\Education\Services\EducationService должен существовать'
        );
    }
    ...
    {
        $aiClass = 'App\Domains\Education\Services\AI\RoadmapConstructor';
    ...
    public function b2b_mode_is_detected_correctly(): void
    {
        ...
        $response = $this->getJson('/api/Education/b2b-check', [
            'inn'            => '1234567890',
            'business_card_id' => '42',
            'X-Correlation-ID' => $this->correlationId,
        ]);
    ...
    {
        $serviceClass = 'App\Domains\Education\Services\EducationService';
