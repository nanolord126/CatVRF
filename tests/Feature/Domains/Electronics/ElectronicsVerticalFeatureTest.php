...
/**
 * ElectronicsVerticalFeatureTest
 *
 * Feature-тест для вертикали Electronics — CatVRF 2026.
 ...
 */
final class ElectronicsVerticalFeatureTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function correlation_id_is_required_in_all_responses(): void
    {
        ...
        $response = $this->getJson('/api/Electronics', [
    ...
    public function ai_constructor_service_can_be_resolved_from_container(): void
    {
        ...
        $this->assertTrue(
            class_exists('App\Domains\Electronics\Services\AI\ElectronicsAIConstructorService'),
            'AI-конструктор App\Domains\Electronics\Services\AI\ElectronicsAIConstructorService должен существовать'
        );
    }
    ...
    public function service_class_exists_in_container(): void
    {
        ...
        $this->assertTrue(
            class_exists('App\Domains\Electronics\Services\ElectronicsService'),
            'Сервис App\Domains\Electronics\Services\ElectronicsService должен существовать'
        );
    }
    ...
    {
        $aiClass = 'App\Domains\Electronics\Services\AI\ElectronicsAIConstructorService';
    ...
    public function b2b_mode_is_detected_correctly(): void
    {
        ...
        $response = $this->getJson('/api/Electronics/b2b-check', [
            'inn'            => '1234567890',
            'business_card_id' => '42',
            'X-Correlation-ID' => $this->correlationId,
        ]);
    ...
    {
        $serviceClass = 'App\Domains\Electronics\Services\ElectronicsService';
