...
/**
 * TicketsVerticalFeatureTest
 *
 * Feature-тест для вертикали Tickets — CatVRF 2026.
 ...
 */
final class TicketsVerticalFeatureTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function ai_constructor_service_can_be_resolved_from_container(): void
    {
        ...
        $this->assertTrue(
            class_exists('App\Domains\Tickets\Services\AI\TicketRecommendationService'),
            'AI-конструктор App\Domains\Tickets\Services\AI\TicketRecommendationService должен существовать'
        );
    }
    ...
    public function service_class_exists_in_container(): void
    {
        ...
        $this->assertTrue(
            class_exists('App\Domains\Tickets\Services\TicketService'),
            'Сервис App\Domains\Tickets\Services\TicketService должен существовать'
        );
    }
    ...
    {
        $aiClass = 'App\Domains\Tickets\Services\AI\TicketRecommendationService';
    ...
    public function b2b_mode_is_detected_correctly(): void
    {
        ...
        $response = $this->getJson('/api/Tickets/b2b-check', [
            'inn'            => '1234567890',
            'business_card_id' => '42',
            'X-Correlation-ID' => $this->correlationId,
        ]);
    ...
    {
        $serviceClass = 'App\Domains\Tickets\Services\TicketService';
