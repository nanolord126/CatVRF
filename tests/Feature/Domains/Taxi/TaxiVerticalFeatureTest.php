...
/**
 * TaxiVerticalFeatureTest
 *
 * Feature-тест для вертикали Taxi — CatVRF 2026.
 ...
 */
final class TaxiVerticalFeatureTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function correlation_id_is_required_in_all_responses(): void
    {
        ...
        $response = $this->getJson('/api/Taxi', [
    ...
    public function ai_constructor_service_can_be_resolved_from_container(): void
    {
        ...
        $this->assertTrue(
            class_exists('App\Domains\Taxi\Services\AI\TaxiAIConstructorService'),
            'AI-конструктор App\Domains\Taxi\Services\AI\TaxiAIConstructorService должен существовать'
        );
    }
    ...
    public function service_class_exists_in_container(): void
    {
        ...
        $this->assertTrue(
            class_exists('App\Domains\Taxi\Services\TaxiService'),
            'Сервис App\Domains\Taxi\Services\TaxiService должен существовать'
        );
    }
    ...
    {
        $aiClass = 'App\Domains\Taxi\Services\AI\TaxiAIConstructorService';
    ...
    public function b2b_mode_is_detected_correctly(): void
    {
        ...
        $response = $this->getJson('/api/Taxi/b2b-check', [
            'inn'            => '1234567890',
            'business_card_id' => '42',
            'X-Correlation-ID' => $this->correlationId,
        ]);
    ...
    {
        $serviceClass = 'App\Domains\Taxi\Services\TaxiService';
