...
namespace Tests\Feature\Domains\Freelance;
...
/**
 * FreelanceVerticalFeatureTest
 *
 * Feature-тест для вертикали Freelance — CatVRF 2026.
 ...
 */
final class FreelanceVerticalFeatureTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function correlation_id_is_required_in_all_responses(): void
    {
        ...
        $response = $this->getJson('/api/Freelance', [
    ...
    public function ai_constructor_service_can_be_resolved_from_container(): void
    {
        ...
        $this->assertTrue(
            class_exists('App\Domains\Freelance\Services\AI\FreelanceProjectConstructorService'),
            'AI-конструктор App\Domains\Freelance\Services\AI\FreelanceProjectConstructorService должен существовать'
        );
    }
    ...
    public function service_class_exists_in_container(): void
    {
        ...
        $this->assertTrue(
            class_exists('App\Domains\Freelance\Services\FreelanceService'),
            'Сервис App\Domains\Freelance\Services\FreelanceService должен существовать'
        );
    }
    ...
    {
        $aiClass = 'App\Domains\Freelance\Services\AI\FreelanceProjectConstructorService';
    ...
    public function b2b_mode_is_detected_correctly(): void
    {
        ...
        $response = $this->getJson('/api/Freelance/b2b-check', [
            'inn'            => '1234567890',
            'business_card_id' => '42',
            'X-Correlation-ID' => $this->correlationId,
        ]);
    ...
    {
        $serviceClass = 'App\Domains\Freelance\Services\FreelanceService';
