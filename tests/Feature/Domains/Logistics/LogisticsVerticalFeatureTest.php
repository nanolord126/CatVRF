...
namespace Tests\Feature\Domains\Logistics;
...
/**
 * LogisticsVerticalFeatureTest
 *
 * Feature-тест для вертикали Logistics — CatVRF 2026.
 ...
 */
final class LogisticsVerticalFeatureTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function correlation_id_is_required_in_all_responses(): void
    {
        ...
        $response = $this->getJson('/api/Logistics', [
    ...
    public function ai_constructor_service_can_be_resolved_from_container(): void
    {
        ...
        $this->assertTrue(
            class_exists('App\Domains\Logistics\Services\AI\LogisticsRouteConstructorService'),
            'AI-конструктор App\Domains\Logistics\Services\AI\LogisticsRouteConstructorService должен существовать'
        );
    }
    ...
    public function service_class_exists_in_container(): void
    {
        ...
        $this->assertTrue(
            class_exists('App\Domains\Logistics\Services\LogisticsService'),
            'Сервис App\Domains\Logistics\Services\LogisticsService должен существовать'
        );
    }
    ...
    {
        $aiClass = 'App\Domains\Logistics\Services\AI\LogisticsRouteConstructorService';
    ...
    public function b2b_mode_is_detected_correctly(): void
    {
        ...
        $response = $this->getJson('/api/Logistics/b2b-check', [
            'inn'            => '1234567890',
            'business_card_id' => '42',
            'X-Correlation-ID' => $this->correlationId,
        ]);
    ...
    {
        $serviceClass = 'App\Domains\Logistics\Services\LogisticsService';
