...
namespace Tests\Feature\Domains\ConstructionAndRepair;
...
/**
 * ConstructionAndRepairVerticalFeatureTest
 *
 * Feature-тест для вертикали ConstructionAndRepair — CatVRF 2026.
 ...
 */
final class ConstructionAndRepairVerticalFeatureTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function ai_constructor_service_can_be_resolved_from_container(): void
    {
        ...
        $this->assertTrue(
            class_exists('App\Domains\ConstructionAndRepair\Services\AI\ConstructionProjectConstructorService'),
            'AI-конструктор App\Domains\ConstructionAndRepair\Services\AI\ConstructionProjectConstructorService должен существовать'
        );
    }
    ...
    public function service_class_exists_in_container(): void
    {
        ...
        $this->assertTrue(
            class_exists('App\Domains\ConstructionAndRepair\Services\ConstructionService'),
            'Сервис App\Domains\ConstructionAndRepair\Services\ConstructionService должен существовать'
        );
    }
    ...
    public function b2b_mode_is_detected_correctly(): void
    {
        ...
        $response = $this->getJson('/api/ConstructionAndRepair/b2b-check', [
            'inn'            => '1234567890',
            'business_card_id' => '42',
            'X-Correlation-ID' => $this->correlationId,
        ]);
