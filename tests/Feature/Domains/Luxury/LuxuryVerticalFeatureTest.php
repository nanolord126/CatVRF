...
namespace Tests\Feature\Domains\Luxury;
...
/**
 * LuxuryVerticalFeatureTest
 *
 * Feature-тест для вертикали Luxury — CatVRF 2026.
 ...
 */
final class LuxuryVerticalFeatureTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function correlation_id_is_required_in_all_responses(): void
    {
        ...
        $response = $this->getJson('/api/Luxury', [
    ...
    public function ai_constructor_service_can_be_resolved_from_container(): void
    {
        ...
        $this->assertTrue(
            class_exists('App\Domains\Luxury\Services\AI\AIJewelryConstructor'),
            'AI-конструктор App\Domains\Luxury\Services\AI\AIJewelryConstructor должен существовать'
        );
    }
    ...
    public function service_class_exists_in_container(): void
    {
        ...
        $this->assertTrue(
            class_exists('App\Domains\Luxury\Services\LuxuryService'),
            'Сервис App\Domains\Luxury\Services\LuxuryService должен существовать'
        );
    }
    ...
    {
        $aiClass = 'App\Domains\Luxury\Services\AI\AIJewelryConstructor';
    ...
    public function b2b_mode_is_detected_correctly(): void
    {
        ...
        $response = $this->getJson('/api/Luxury/b2b-check', [
            'inn'            => '1234567890',
            'business_card_id' => '42',
            'X-Correlation-ID' => $this->correlationId,
        ]);
    ...
    {
        $serviceClass = 'App\Domains\Luxury\Services\LuxuryService';
