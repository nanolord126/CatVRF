...
namespace Tests\Feature\Domains\CleaningServices;
...
/**
 * CleaningServicesVerticalFeatureTest
 *
 * Feature-тест для вертикали CleaningServices — CatVRF 2026.
 ...
 */
final class CleaningServicesVerticalFeatureTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function correlation_id_is_required_in_all_responses(): void
    {
        ...
        $response = $this->getJson('/api/CleaningServices', [
    ...
    public function ai_constructor_service_can_be_resolved_from_container(): void
    {
        ...
        $this->assertTrue(
            class_exists('App\Domains\CleaningServices\Services\AI\CleaningPlanConstructorService'),
            'AI-конструктор App\Domains\CleaningServices\Services\AI\CleaningPlanConstructorService должен существовать'
        );
    }
    ...
    public function service_class_exists_in_container(): void
    {
        ...
        $this->assertTrue(
            class_exists('App\Domains\CleaningServices\Services\CleaningService'),
            'Сервис App\Domains\CleaningServices\Services\CleaningService должен существовать'
        );
    }
    ...
    {
        $aiClass = 'App\Domains\CleaningServices\Services\AI\CleaningPlanConstructorService';
    ...
    public function b2b_mode_is_detected_correctly(): void
    {
        ...
        $response = $this->getJson('/api/CleaningServices/b2b-check', [
            'inn'            => '1234567890',
            'business_card_id' => '42',
            'X-Correlation-ID' => $this->correlationId,
        ]);
    ...
    {
        $serviceClass = 'App\Domains\CleaningServices\Services\CleaningService';
