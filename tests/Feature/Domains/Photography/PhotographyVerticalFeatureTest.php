...
namespace Tests\Feature\Domains\Photography;
...
/**
 * PhotographyVerticalFeatureTest
 *
 * Feature-тест для вертикали Photography — CatVRF 2026.
 ...
 */
final class PhotographyVerticalFeatureTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function correlation_id_is_required_in_all_responses(): void
    {
        ...
        $response = $this->getJson('/api/Photography', [
    ...
    public function ai_constructor_service_can_be_resolved_from_container(): void
    {
        ...
        $this->assertTrue(
            class_exists('App\Domains\Photography\Services\AI\AIPhotoSessionConstructor'),
            'AI-конструктор App\Domains\Photography\Services\AI\AIPhotoSessionConstructor должен существовать'
        );
    }
    ...
    public function service_class_exists_in_container(): void
    {
        ...
        $this->assertTrue(
            class_exists('App\Domains\Photography\Services\PhotographyService'),
            'Сервис App\Domains\Photography\Services\PhotographyService должен существовать'
        );
    }
    ...
    {
        $aiClass = 'App\Domains\Photography\Services\AI\AIPhotoSessionConstructor';
    ...
    public function b2b_mode_is_detected_correctly(): void
    {
        ...
        $response = $this->getJson('/api/Photography/b2b-check', [
            'inn'            => '1234567890',
            'business_card_id' => '42',
            'X-Correlation-ID' => $this->correlationId,
        ]);
    ...
    {
        $serviceClass = 'App\Domains\Photography\Services\PhotographyService';
