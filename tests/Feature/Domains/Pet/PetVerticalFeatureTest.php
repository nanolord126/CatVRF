...
namespace Tests\Feature\Domains\Pet;
...
/**
 * PetVerticalFeatureTest
 *
 * Feature-тест для вертикали Pet — CatVRF 2026.
 ...
 */
final class PetVerticalFeatureTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function ai_constructor_service_can_be_resolved_from_container(): void
    {
        ...
        $this->assertTrue(
            class_exists('App\Domains\Pet\Services\AI\PetCareConstructorService'),
            'AI-конструктор App\Domains\Pet\Services\AI\PetCareConstructorService должен существовать'
        );
    }
    ...
    public function service_class_exists_in_container(): void
    {
        ...
        $this->assertTrue(
            class_exists('App\Domains\Pet\Services\PetService'),
            'Сервис App\Domains\Pet\Services\PetService должен существовать'
        );
    }
    ...
    {
        $aiClass = 'App\Domains\Pet\Services\AI\PetCareConstructorService';
    ...
    public function b2b_mode_is_detected_correctly(): void
    {
        ...
        $response = $this->getJson('/api/Pet/b2b-check', [
            'inn'            => '1234567890',
            'business_card_id' => '42',
            'X-Correlation-ID' => $this->correlationId,
        ]);
    ...
    {
        $serviceClass = 'App\Domains\Pet\Services\PetService';
