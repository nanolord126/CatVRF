...
namespace Tests\Feature\Domains\Legal;
...
/**
 * LegalVerticalFeatureTest
 *
 * Feature-тест для вертикали Legal — CatVRF 2026.
 ...
 */
final class LegalVerticalFeatureTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function ai_constructor_service_can_be_resolved_from_container(): void
    {
        ...
        $this->assertTrue(
            class_exists('App\Domains\Legal\Services\AI\LegalDocumentConstructorService'),
            'AI-конструктор App\Domains\Legal\Services\AI\LegalDocumentConstructorService должен существовать'
        );
    }
    ...
    public function service_class_exists_in_container(): void
    {
        ...
        $this->assertTrue(
            class_exists('App\Domains\Legal\Services\LegalService'),
            'Сервис App\Domains\Legal\Services\LegalService должен существовать'
        );
    }
    ...
    {
        $aiClass = 'App\Domains\Legal\Services\AI\LegalDocumentConstructorService';
    ...
    public function b2b_mode_is_detected_correctly(): void
    {
        ...
        $response = $this->getJson('/api/Legal/b2b-check', [
            'inn'            => '1234567890',
            'business_card_id' => '42',
            'X-Correlation-ID' => $this->correlationId,
        ]);
    ...
    {
        $serviceClass = 'App\Domains\Legal\Services\LegalService';
