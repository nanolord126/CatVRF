...
/**
 * TravelVerticalFeatureTest
 *
 * Feature-тест для вертикали Travel — CatVRF 2026.
 ...
 */
final class TravelVerticalFeatureTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function ai_constructor_service_can_be_resolved_from_container(): void
    {
        ...
        $this->assertTrue(
            class_exists('App\Domains\Travel\Services\AI\TravelConstructorService'),
            'AI-конструктор App\Domains\Travel\Services\AI\TravelConstructorService должен существовать'
        );
    }
    ...
    public function service_class_exists_in_container(): void
    {
        ...
        $this->assertTrue(
            class_exists('App\Domains\Travel\Services\TravelService'),
            'Сервис App\Domains\Travel\Services\TravelService должен существовать'
        );
    }
    ...
    {
        $aiClass = 'App\Domains\Travel\Services\AI\TravelConstructorService';
    ...
    public function b2b_mode_is_detected_correctly(): void
    {
        ...
        $response = $this->getJson('/api/Travel/b2b-check', [
            'inn'            => '1234567890',
            'business_card_id' => '42',
            'X-Correlation-ID' => $this->correlationId,
        ]);
    ...
    {
        $serviceClass = 'App\Domains\Travel\Services\TravelService';
