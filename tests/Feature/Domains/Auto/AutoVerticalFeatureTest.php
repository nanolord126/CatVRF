...
/**
 * AutoVerticalFeatureTest
 *
 * Feature-тест для вертикали Auto — CatVRF 2026.
 ...
 */
final class AutoVerticalFeatureTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function correlation_id_is_required_in_all_responses(): void
    {
        ...
        $response = $this->getJson('/api/Auto', [
    ...
    public function ai_constructor_service_can_be_resolved_from_container(): void
    {
        ...
        $this->assertTrue(
            class_exists('App\Domains\Auto\Services\AI\AutoTuningConstructorService'),
            'AI-конструктор App\Domains\Auto\Services\AI\AutoTuningConstructorService должен существовать'
        );
    }
    ...
    public function service_class_exists_in_container(): void
    {
        ...
        $this->assertTrue(
            class_exists('App\Domains\Auto\Services\AutoService'),
            'Сервис App\Domains\Auto\Services\AutoService должен существовать'
        );
    }
    ...
    {
        $aiClass = 'App\Domains\Auto\Services\AI\AutoTuningConstructorService';
    ...
    public function b2b_mode_is_detected_correctly(): void
    {
        ...
        $response = $this->getJson('/api/Auto/b2b-check', [
            'inn'            => '1234567890',
            'business_card_id' => '42',
            'X-Correlation-ID' => $this->correlationId,
        ]);
    ...
    {
        $serviceClass = 'App\Domains\Auto\Services\AutoService';
