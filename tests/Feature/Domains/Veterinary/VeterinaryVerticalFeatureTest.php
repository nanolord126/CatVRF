...
namespace Tests\Feature\Domains\Veterinary;
...
/**
 * VeterinaryVerticalFeatureTest
 *
 * Feature-тест для вертикали Veterinary — CatVRF 2026.
 ...
 */
final class VeterinaryVerticalFeatureTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function correlation_id_is_required_in_all_responses(): void
    {
        ...
        $response = $this->getJson('/api/Veterinary', [
    ...
    public function ai_constructor_service_can_be_resolved_from_container(): void
    {
        ...
        $this->assertTrue(
            class_exists('App\Domains\Veterinary\Services\AI\PetHealthConstructor'),
            'AI-конструктор App\Domains\Veterinary\Services\AI\PetHealthConstructor должен существовать'
        );
    }
    ...
    public function service_class_exists_in_container(): void
    {
        ...
        $this->assertTrue(
            class_exists('App\Domains\Veterinary\Services\VeterinaryService'),
            'Сервис App\Domains\Veterinary\Services\VeterinaryService должен существовать'
        );
    }
    ...
    {
        $aiClass = 'App\Domains\Veterinary\Services\AI\PetHealthConstructor';
    ...
    public function b2b_mode_is_detected_correctly(): void
    {
        ...
        $response = $this->getJson('/api/Veterinary/b2b-check', [
            'inn'            => '1234567890',
            'business_card_id' => '42',
            'X-Correlation-ID' => $this->correlationId,
        ]);
    ...
    {
        $serviceClass = 'App\Domains\Veterinary\Services\VeterinaryService';
