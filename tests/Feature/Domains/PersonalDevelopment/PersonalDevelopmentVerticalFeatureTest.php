...
namespace Tests\Feature\Domains\PersonalDevelopment;
...
/**
 * PersonalDevelopmentVerticalFeatureTest
 *
 * Feature-тест для вертикали PersonalDevelopment — CatVRF 2026.
 ...
 */
final class PersonalDevelopmentVerticalFeatureTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function correlation_id_is_required_in_all_responses(): void
    {
        ...
        $response = $this->getJson('/api/PersonalDevelopment', [
    ...
    public function ai_constructor_service_can_be_resolved_from_container(): void
    {
        ...
        $this->assertTrue(
            class_exists('App\Domains\PersonalDevelopment\Services\AI\AIGrowthConstructor'),
            'AI-конструктор App\Domains\PersonalDevelopment\Services\AI\AIGrowthConstructor должен существовать'
        );
    }
    ...
    public function service_class_exists_in_container(): void
    {
        ...
        $this->assertTrue(
            class_exists('App\Domains\PersonalDevelopment\Services\PersonalDevelopmentService'),
            'Сервис App\Domains\PersonalDevelopment\Services\PersonalDevelopmentService должен существовать'
        );
    }
    ...
    {
        $aiClass = 'App\Domains\PersonalDevelopment\Services\AI\AIGrowthConstructor';
    ...
    public function b2b_mode_is_detected_correctly(): void
    {
        ...
        $response = $this->getJson('/api/PersonalDevelopment/b2b-check', [
            'inn'            => '1234567890',
            'business_card_id' => '42',
            'X-Correlation-ID' => $this->correlationId,
        ]);
    ...
    {
        $serviceClass = 'App\Domains\PersonalDevelopment\Services\PersonalDevelopmentService';
