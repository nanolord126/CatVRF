...
/**
 * RealEstateVerticalFeatureTest
 *
 * Feature-тест для вертикали RealEstate — CatVRF 2026.
 ...
 */
final class RealEstateVerticalFeatureTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function correlation_id_is_required_in_all_responses(): void
    {
        ...
        $response = $this->getJson('/api/RealEstate', [
    ...
    public function ai_constructor_service_can_be_resolved_from_container(): void
    {
        ...
        $this->assertTrue(
            class_exists('App\Domains\RealEstate\Services\AI\RealEstateDesignConstructorService'),
            'AI-конструктор App\Domains\RealEstate\Services\AI\RealEstateDesignConstructorService должен существовать'
        );
    }
    ...
    public function service_class_exists_in_container(): void
    {
        ...
        $this->assertTrue(
            class_exists('App\Domains\RealEstate\Services\RealEstateService'),
            'Сервис App\Domains\RealEstate\Services\RealEstateService должен существовать'
        );
    }
    ...
    {
        $aiClass = 'App\Domains\RealEstate\Services\AI\RealEstateDesignConstructorService';
    ...
    public function b2b_mode_is_detected_correctly(): void
    {
        ...
        $response = $this->getJson('/api/RealEstate/b2b-check', [
            'inn'            => '1234567890',
            'business_card_id' => '42',
            'X-Correlation-ID' => $this->correlationId,
        ]);
    ...
    {
        $serviceClass = 'App\Domains\RealEstate\Services\RealEstateService';
