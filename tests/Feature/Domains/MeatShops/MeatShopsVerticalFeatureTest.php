...
/**
 * MeatShopsVerticalFeatureTest
 *
 * Feature-тест для вертикали MeatShops — CatVRF 2026.
 ...
 */
final class MeatShopsVerticalFeatureTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function correlation_id_is_required_in_all_responses(): void
    {
        ...
        $response = $this->getJson('/api/MeatShops', [
    ...
    public function ai_constructor_service_can_be_resolved_from_container(): void
    {
        ...
        $this->assertTrue(
            class_exists('App\Domains\MeatShops\Services\AI\MeatCutConstructorService'),
            'AI-конструктор App\Domains\MeatShops\Services\AI\MeatCutConstructorService должен существовать'
        );
    }
    ...
    public function service_class_exists_in_container(): void
    {
        ...
        $this->assertTrue(
            class_exists('App\Domains\MeatShops\Services\MeatShopService'),
            'Сервис App\Domains\MeatShops\Services\MeatShopService должен существовать'
        );
    }
    ...
    {
        $aiClass = 'App\Domains\MeatShops\Services\AI\MeatCutConstructorService';
    ...
    public function b2b_mode_is_detected_correctly(): void
    {
        ...
        $response = $this->getJson('/api/MeatShops/b2b-check', [
            'inn'            => '1234567890',
            'business_card_id' => '42',
            'X-Correlation-ID' => $this->correlationId,
        ]);
    ...
    {
        $serviceClass = 'App\Domains\MeatShops\Services\MeatShopService';
