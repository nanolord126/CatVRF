...
namespace Tests\Feature\Domains\Insurance;
...
/**
 * InsuranceVerticalFeatureTest
 *
 * Feature-тест для вертикали Insurance — CatVRF 2026.
 ...
 */
final class InsuranceVerticalFeatureTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function correlation_id_is_required_in_all_responses(): void
    {
        ...
        $response = $this->getJson('/api/Insurance', [
    ...
    public function ai_constructor_service_can_be_resolved_from_container(): void
    {
        ...
        $this->assertTrue(
            class_exists('App\Domains\Insurance\Services\AI\InsuranceRiskConstructorService'),
            'AI-конструктор App\Domains\Insurance\Services\AI\InsuranceRiskConstructorService должен существовать'
        );
    }
    ...
    public function service_class_exists_in_container(): void
    {
        ...
        $this->assertTrue(
            class_exists('App\Domains\Insurance\Services\InsuranceService'),
            'Сервис App\Domains\Insurance\Services\InsuranceService должен существовать'
        );
    }
    ...
    {
        $aiClass = 'App\Domains\Insurance\Services\AI\InsuranceRiskConstructorService';
    ...
    public function b2b_mode_is_detected_correctly(): void
    {
        ...
        $response = $this->getJson('/api/Insurance/b2b-check', [
            'inn'            => '1234567890',
            'business_card_id' => '42',
            'X-Correlation-ID' => $this->correlationId,
        ]);
    ...
    {
        $serviceClass = 'App\Domains\Insurance\Services\InsuranceService';
