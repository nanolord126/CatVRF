...
namespace Tests\Feature\Domains\Fitness;
...
/**
 * FitnessVerticalFeatureTest
 *
 * Feature-тест для вертикали Fitness — CatVRF 2026.
 ...
 */
final class FitnessVerticalFeatureTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function correlation_id_is_required_in_all_responses(): void
    {
        ...
        $response = $this->getJson('/api/Fitness', [
    ...
    public function ai_constructor_service_can_be_resolved_from_container(): void
    {
        ...
        $this->assertTrue(
            class_exists('App\Domains\Fitness\Services\AI\FitnessConstructorService'),
            'AI-конструктор App\Domains\Fitness\Services\AI\FitnessConstructorService должен существовать'
        );
    }
    ...
    public function service_class_exists_in_container(): void
    {
        ...
        $this->assertTrue(
            class_exists('App\Domains\Fitness\Services\FitnessService'),
            'Сервис App\Domains\Fitness\Services\FitnessService должен существовать'
        );
    }
    ...
    {
        $aiClass = 'App\Domains\Fitness\Services\AI\FitnessConstructorService';
    ...
    public function b2b_mode_is_detected_correctly(): void
    {
        ...
        $response = $this->getJson('/api/Fitness/b2b-check', [
            'inn'            => '1234567890',
            'business_card_id' => '42',
            'X-Correlation-ID' => $this->correlationId,
        ]);
    ...
    {
        $serviceClass = 'App\Domains\Fitness\Services\FitnessService';
