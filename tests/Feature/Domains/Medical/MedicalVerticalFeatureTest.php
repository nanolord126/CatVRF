...
/**
 * MedicalVerticalFeatureTest
 *
 * Feature-тест для вертикали Medical — CatVRF 2026.
 ...
 */
final class MedicalVerticalFeatureTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function correlation_id_is_required_in_all_responses(): void
    {
        ...
        $response = $this->getJson('/api/Medical', [
    ...
    public function ai_constructor_service_can_be_resolved_from_container(): void
    {
        ...
        $this->assertTrue(
            class_exists('App\Domains\Medical\Services\AI\AITherapyConstructorService'),
            'AI-конструктор App\Domains\Medical\Services\AI\AITherapyConstructorService должен существовать'
        );
    }
    ...
    public function service_class_exists_in_container(): void
    {
        ...
        $this->assertTrue(
            class_exists('App\Domains\Medical\Services\MedicalService'),
            'Сервис App\Domains\Medical\Services\MedicalService должен существовать'
        );
    }
    ...
    {
        $aiClass = 'App\Domains\Medical\Services\AI\AITherapyConstructorService';
    ...
    public function b2b_mode_is_detected_correctly(): void
    {
        ...
        $response = $this->getJson('/api/Medical/b2b-check', [
            'inn'            => '1234567890',
            'business_card_id' => '42',
            'X-Correlation-ID' => $this->correlationId,
        ]);
    ...
    {
        $serviceClass = 'App\Domains\Medical\Services\MedicalService';
