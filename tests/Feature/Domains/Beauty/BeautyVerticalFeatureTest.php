...
final class BeautyVerticalFeatureTest extends TestCase
{
    ...
    {
        self::assertDirectoryExists(base_path('app/Domains/Beauty'));
    }
    ...
    public function test_correlation_id_header_is_supported(): void
    {
        ...
        $response = $this->getJson('/__health_Beauty', ['X-Correlation-ID' => 'test-Beauty']);
        $response->assertStatus(200)->assertJsonPath('correlation_id', 'test-Beauty');
    }
