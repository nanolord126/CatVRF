...
/**
 * SportsVerticalFeatureTest
 *
 * Feature-тест для вертикали Sports — CatVRF 2026.
 ...
 */
final class SportsVerticalFeatureTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function ai_constructor_service_can_be_resolved_from_container(): void
    {
        ...
        $this->assertTrue(
            class_exists('App\Domains\Sports\Services\AI\SportsTrainingConstructorService'),
            'AI-конструктор App\Domains\Sports\Services\AI\SportsTrainingConstructorService должен существовать'
        );
    }
    ...
    public function service_class_exists_in_container(): void
    {
        ...
        $this->assertTrue(
            class_exists('App\Domains\Sports\Services\SportsService'),
            'Сервис App\Domains\Sports\Services\SportsService должен существовать'
        );
    }
    ...
    {
        $aiClass = 'App\Domains\Sports\Services\AI\SportsTrainingConstructorService';
    ...
    public function b2b_mode_is_detected_correctly(): void
    {
        ...
        $response = $this->getJson('/api/Sports/b2b-check', [
            'inn'            => '1234567890',
            'business_card_id' => '42',
            'X-Correlation-ID' => $this->correlationId,
        ]);
    ...
    {
        $serviceClass = 'App\Domains\Sports\Services\SportsService';
