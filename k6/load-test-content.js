...
const requestDuration = new Trend('content_request_duration');
const requestCounter = new Counter('content_requests');
...
export default function () {
  ...
  const token = 'content-token-' + agencyId;
  ...
  group('Get Campaigns', () => {
    let response = http.get(
      `${BASE_URL}/api/content/campaigns`,
  ...
  group('Create Campaign', () => {
    ...
    let response = http.post(`${BASE_URL}/api/content/campaigns`, {
      client_id: clientId,
