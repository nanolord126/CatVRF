...
<template>
    <section class="space-y-4">
        <header>
            <h2 class="text-xl font-bold" style="color: var(--t-text);">Security Panel</h2>
            <p class="text-sm" style="color: var(--t-text-3);">Мониторинг безопасности, события, оповещения и аудит.</p>
        </header>
        ...
        <SecurityDashboard v-if="activeTab === 'dashboard'" />
