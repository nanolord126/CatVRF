<script setup>
import { ref } from 'vue';
import NotificationsDashboard from './NotificationsDashboard.vue';
...
<template>
    <section class="space-y-4">
        <header>
            <h2 class="text-xl font-bold" style="color: var(--t-text);">Notifications Panel</h2>
            <p class="text-sm" style="color: var(--t-text-3);">Управление уведомлениями, каналами и шаблонами.</p>
        </header>
        ...
        <NotificationsDashboard v-if="activeTab === 'dashboard'" />
