<script setup>
const metrics = [
    { label: 'Shared modules', value: '62', trend: '+4', icon: '🧩' },
    { label: 'Reuse rate', value: '71%', trend: '+3%', icon: '🔁' },
    { label: 'Ошибки интеграций', value: '0.6%', trend: '-0.2%', icon: '🛠️' },
    { label: 'Latency shared APIs', value: '120ms', trend: '-8ms', icon: '⚡' },
];
</script>
