<script setup>
import { ref } from 'vue';
import FraudMLDashboard from './FraudMLDashboard.vue';
...
<template>
    <section class="space-y-4">
        <header>
            <h2 class="text-xl font-bold" style="color: var(--t-text);">FraudML Panel</h2>
            <p class="text-sm" style="color: var(--t-text-3);">Стартовый UI для anti-fraud мониторинга.</p>
        </header>
        ...
        <FraudMLDashboard v-if="activeTab === 'dashboard'" />
