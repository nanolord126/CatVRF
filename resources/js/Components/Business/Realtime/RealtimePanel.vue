...
<template>
    <section class="space-y-4">
        <header>
            <h2 class="text-xl font-bold" style="color: var(--t-text);">Realtime Panel</h2>
            <p class="text-sm" style="color: var(--t-text-3);">Мониторинг WebSocket соединений, каналов и событий в реальном времени.</p>
        </header>
        ...
        <RealtimeDashboard v-if="activeTab === 'dashboard'" />
