 ...
 * Согласно КАНОН 2026: управление салонами, услугами, бронированиями, мастерами.
 *
 * @property int $id
 * @property int $tenant_id
 * @property string|null $uuid
 * @property string $name Название салона
 ...
 * @property string|null $category (hair, nails, massage, skin_care, all)
 * @property float $rating Рейтинг (0-5)
 * @property int $review_count Количество отзывов
 * @property bool $is_verified Проверен ли салон
 * @property bool $is_active Активен ли салон
 * @property array|null $schedule_json График работы (JSON)
 * @property int|null $commission_percent Комиссия платформы (в процентах)
