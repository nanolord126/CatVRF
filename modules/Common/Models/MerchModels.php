...
final class ExclusiveMerch extends Model
{
    use HasFactory;

    // TODO: Проверить и восстановить содержимое класса, если оно было утеряно
    HasEcosystemFeatures, HasEcosystemAuth, HasEcosystemMedia};
    use Illuminate\Database\Eloquent\Model;
    ...
    class ExclusiveMerch extends Model implements HasMedia
    {
        use HasEcosystemFeatures, HasEcosystemAuth, HasEcosystemMedia;
