...
use Modules\Commissions\Services\CommissionCalculator;
 ...
 * Согласно КАНОН 2026: платежи, холды, захваты, возвраты, фискализация.
 *
 * Поддерживает:
 * - Инициализацию платежей с FraudControl::check() перед каждой операцией
 * - Idempotency проверку через payment_idempotency_records
 * - Холды и захваты (двухэтапная авторизация)
 * - Распределение средств между участниками (seller, platform, affiliates)
 * - Фискализацию чеков (54-ФЗ)
 * - Обработку вебхуков платежных систем с верификацией подписи
 * - Отслеживание статуса платежей
 * - Возвраты (refund) с возвратом средств в кошелёк
 */
