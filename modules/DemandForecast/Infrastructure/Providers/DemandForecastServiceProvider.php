...
namespace Modules\DemandForecast\Infrastructure\Providers;

use Illuminate\Support\ServiceProvider;
use Modules\DemandForecast\Domain\Repositories\DemandForecastRepositoryInterface;
use Modules\DemandForecast\Infrastructure\Adapters\EloquentDemandForecastRepository;

/**
 * Class DemandForecastServiceProvider
 *
 ...
 */
class DemandForecastServiceProvider extends ServiceProvider
{
    /**
    ...
    {
        $this->app->bind(
            DemandForecastRepositoryInterface::class,
            EloquentDemandForecastRepository::class
        );
    }
