...
final class BeautyCertificationResource extends Resource
{
    protected static ?string $model = BeautyCertificationModel::class;
        ...
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('certification_type')
                    ->label('Type')
                    ->badge()
                    ->color(fn (string $state): string => $state === 'internal' ? 'success' : 'info'),
    ...
    {
        return [
            'index' => \Modules\BeautyMasters\Filament\Resources\BeautyCertificationResource\Pages\ListBeautyCertifications::route('/'),
            'create' => \Modules\BeautyMasters\Filament\Resources\BeautyCertificationResource\Pages\CreateBeautyCertification::route('/create'),
            'edit' => \Modules\BeautyMasters\Filament\Resources\BeautyCertificationResource\Pages\EditBeautyCertification::route('/{record}/edit'),
        ];
    }
}
