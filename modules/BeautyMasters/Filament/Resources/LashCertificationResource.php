...
final class LashCertificationResource extends Resource
{
    protected static ?string $model = LashCertificationModel::class;
    ...
    {
        return [
            'index' => \Modules\BeautyMasters\Filament\Resources\LashCertificationResource\Pages\ListLashCertifications::route('/'),
            'create' => \Modules\BeautyMasters\Filament\Resources\LashCertificationResource\Pages\CreateLashCertification::route('/create'),
            'edit' => \Modules\BeautyMasters\Filament\Resources\LashCertificationResource\Pages\EditLashCertification::route('/{record}/edit'),
        ];
    }
}
