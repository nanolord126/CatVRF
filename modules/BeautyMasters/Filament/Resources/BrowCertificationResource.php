...
final class BrowCertificationResource extends Resource
{
    protected static ?string $model = BrowCertificationModel::class;
    ...
    {
        return [
            'index' => \Modules\BeautyMasters\Filament\Resources\BrowCertificationResource\Pages\ListBrowCertifications::route('/'),
            'create' => \Modules\BeautyMasters\Filament\Resources\BrowCertificationResource\Pages\CreateBrowCertification::route('/create'),
            'edit' => \Modules\BeautyMasters\Filament\Resources\BrowCertificationResource\Pages\EditBrowCertification::route('/{record}/edit'),
        ];
    }
}
