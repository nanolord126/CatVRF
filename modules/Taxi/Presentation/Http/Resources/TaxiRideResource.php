...
final class TaxiRideResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'tracking' => [
                'tracking_enabled' => in_array($this->status, [TaxiRide::STATUS_ACCEPTED, TaxiRide::STATUS_STARTED], true),
                'tracking_url' => in_array($this->status, [TaxiRide::STATUS_ACCEPTED, TaxiRide::STATUS_STARTED], true)
