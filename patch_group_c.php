...
$groupC = ["Books", "ConstructionMaterials", "Cosmetics", "Jewelry", "MeatShops", "MedicalHealthcare", "MedicalSupplies", "PetServices", "ToysKids", "TravelTourism"];

foreach ($groupC as $vertical) {
            ...
            $content = preg_replace_callback(
                ...
                function($matches) {
                    ...
                    if (strpos($params, '$correlationId') === false) {
                        // If no correlation ID is passed, we might just use a placeholder or check
