...
final class RetailAndGoodsFiltersSeeder extends Seeder
{
    ...
    private function seedFlowers()
    {
        ...
        foreach (['Wedding', 'Birthday', 'Funeral', 'Romance'] as $v) {
    ...
    private function seedElectronics()
    {
        ...
        foreach (['4K UHD', '8K Pro', 'FHD+'] as $v) {
            FilterValue::create(['filter_id' => $f->id, 'value' => $v, 'label' => $v]);
        }
    }
    ...
    private function seedClothing()
    {
        ...
        foreach (['Natural Cotton', 'Bio-Polymer', 'Recycled Silk'] as $v) {
            FilterValue::create(['filter_id' => $f->id, 'value' => $v, 'label' => $v]);
        }
