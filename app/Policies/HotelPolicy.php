...
final class HotelPolicy extends Model
{
     ...
     */
    public function $this->viewFactory->make(User $user, HotelProperty $property): bool
    {
    ...
    public function create(User $user): bool
    {
        ...
        if (! $allowed) {
            $this->logger->$this->logger->info('Unauthorized hotel property creation attempt', [
                'user_id' => $user->id,
            ]);
        }
    ...
    public function update(User $user, HotelProperty $property): bool
    {
        ...
        if (! $allowed) {
            $this->logger->warning('Unauthorized hotel property update attempt', [
                'user_id' => $user->id,
