...
final class CommissionPolicy
{
    ...
    public function view(User $user, CommissionTransaction $commission): bool
    {
        ...
        if (!$allowed) {
            $this->log->warning('Unauthorized commission view attempt', [
                'user_id' => $user->id,
    ...
    public function viewAudit(User $user, CommissionTransaction $commission): bool
    {
        ...
        if (!$allowed) {
            $this->log->warning('Unauthorized commission audit view attempt', [
                'user_id' => $user->id,
            ]);
        }
    ...
    public function update(User $user, CommissionTransaction $commission): bool
    {
        ...
        if (!$allowed) {
            $this->log->warning('Unauthorized commission update attempt', [
                'user_id' => $user->id,
