...
final class SportProductResource extends Resource
{
    ...
    {
        return [
            'index' => Pages\ListSportProductResource::route('/'),
            'create' => Pages\CreateSportProductResource::route('/create'),
            'edit' => Pages\EditSportProductResource::route('/{record}/edit'),
            'view' => Pages\ViewSportProductResource::route('/{record}'),
        ];
    }
