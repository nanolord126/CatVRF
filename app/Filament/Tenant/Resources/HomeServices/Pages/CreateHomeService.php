...
final class CreateHomeService extends CreateRecord
{
    ...
    protected function mutateFormDataBeforeCreate(array $data): array
    {
        ...
        $this->db->transaction(function () use (&$data, $correlationId) {
            ...
            $this->log->channel('audit')->$this->logger->info('HomeServices creation form submitted', [
    ...
    {
        $this->log->channel('audit')->$this->logger->info('HomeServices record created successfully', [
