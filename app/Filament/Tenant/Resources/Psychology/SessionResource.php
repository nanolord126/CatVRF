...
final class SessionResource extends Model
{
    ...
    protected static ?string $model = PsychologicalSession::class;
        ...
        {
            return [
                'index' => Pages\ListSessionResource::route('/'),
                'create' => Pages\CreateSessionResource::route('/create'),
                'edit' => Pages\EditSessionResource::route('/{record}/edit'),
                'view' => Pages\ViewSessionResource::route('/{record}'),
            ];
        }
