        ...
        return $table
            ...
            ->actions([
                    ...
                    ->action(function (Property $record) {
                        ...
                        $this->logger->$this->logger->info('Property status toggled', [
        ...
        return $table
            ...
            ->actions([
                    ...
                    ->action(function (PropertyBooking $record) {
                        ...
                        $this->logger->$this->logger->info('Booking approved', [
                    ...
                    ->label('Отменить')
                    ->visible(fn (PropertyBooking $record) => ! in_array($record->status, ['cancelled', 'checked_out'], true))
                    ->action(function (PropertyBooking $record) {
