...
use App\Filament\Tenant\Resources\Cleaning\Pages\CreateCleaningOrder;
use App\Filament\Tenant\Resources\Cleaning\Pages\EditCleaningOrder;
use App\Filament\Tenant\Resources\Cleaning\Pages\ListCleaningOrders;
    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            ->filters([
                ...
                TernaryFilter::make('is_commercial')
                    ->label('B2B Order'),
            ])
            ->actions([
                EditAction::make(),
