...
use App\Filament\Tenant\Resources\Sports\Pages\CreateEquipment;
use App\Filament\Tenant\Resources\Sports\Pages\EditEquipment;
use App\Filament\Tenant\Resources\Sports\Pages\ListEquipment;
                ...
                Tables\Actions\ActionGroup::make([
                    ...
                    Action::make('feature')
                        ...
                        ->action(function ($record) {
                            ...
                            $this->logger->$this->logger->info('Sport equipment featured', ['equipment_id' => $record->id, 'correlation_id' => $record->correlation_id]);
                        })
                        ->successNotification(),
                ]),
                ])
                    ...
                    BulkActionGroup::make([
                        ...
                        ->action(function ($records) {
                            $records->each(function ($record) {
                                ...
                                $this->logger->$this->logger->info('Sport equipment bulk activated', ['equipment_id' => $record->id, 'correlation_id' => $record->correlation_id]);
                            });
                        })
