...
use App\Filament\Tenant\Resources\Sports\SportProductResource\Pages\CreateSportProduct;
use App\Filament\Tenant\Resources\Sports\SportProductResource\Pages\EditSportProduct;
use App\Filament\Tenant\Resources\Sports\SportProductResource\Pages\ListSportProducts;
use App\Filament\Tenant\Resources\Sports\SportProductResource\Pages\ViewSportProduct;
...
final class SportProductResource extends Resource
{
                ...
                ActionGroup::make([
                    ...
                    Action::make('verify')
                        ...
                        ->action(function ($record) {
                            ...
                            $this->logger->$this->logger->info('Sport product verified', [
                    ...
                    Action::make('feature')
                        ...
                        ->action(function ($record) {
                            ...
                            $this->logger->$this->logger->info('Sport product featured', [
                                'product_id' => $record->id,
                                'user_id' => $this->guard->id(),
                                'correlation_id' => $record->correlation_id,
                            ]);
                    ...
                    Action::make('mark_bestseller')
                        ...
                        ->action(function ($record) {
                            ...
                            $this->logger->$this->logger->info('Sport product marked as bestseller', [
                                'product_id' => $record->id,
                                'user_id' => $this->guard->id(),
                                'correlation_id' => $record->correlation_id,
                            ]);
                    ...
                    BulkActionGroup::make([
                        ...
                        ->action(function ($records) {
                            $records->each(function ($record) {
                                $this->logger->$this->logger->info('Sport product bulk deleted', [
                                    'product_id' => $record->id,
                                    'user_id' => $this->guard->id(),
                                    'correlation_id' => $record->correlation_id,
                                ]);
                        ...
                        ->action(function ($records) {
                            $records->each(function ($record) {
                                ...
                                $this->logger->$this->logger->info('Sport product activated', [
                                    'product_id' => $record->id,
                                    'user_id' => $this->guard->id(),
                                    'correlation_id' => $record->correlation_id,
                                ]);
                        ...
                        ->action(function ($records) {
                            $records->each(function ($record) {
                                $record->update(['is_verified' => true]);
                                $this->logger->$this->logger->info('Sport product bulk verified', [
                                    'product_id' => $record->id,
                                    'user_id' => $this->guard->id(),
                                    'correlation_id' => $record->correlation_id,
                                ]);
    ...
    {
        return [
            'index' => ListSportProducts::route('/'),
            'create' => CreateSportProduct::route('/create'),
            'view' => ViewSportProduct::route('/{record}'),
            'edit' => EditSportProduct::route('/{record}/edit'),
        ];
    }
