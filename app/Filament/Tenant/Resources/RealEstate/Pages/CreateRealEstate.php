...
final class CreateRealEstate extends CreateRecord
{
    ...
    protected function mutateFormDataBeforeCreate(array $data): array
    {
        ...
        $this->db->transaction(function () use (&$data, $correlationId) {
            ...
            $this->log->channel('audit')->$this->logger->info('RealEstate creation form submitted', [
    ...
    {
        $this->log->channel('audit')->$this->logger->info('RealEstate record created successfully', [
