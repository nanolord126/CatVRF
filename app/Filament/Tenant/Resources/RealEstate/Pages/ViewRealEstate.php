...
/**
 * ViewRealEstate — CatVRF 2026 Component.
 *
 ...
 *
 * @see https://catvrf.ru/docs/viewrealestate
 * @see https://catvrf.ru/docs/viewrealestate
 * @see https://catvrf.ru/docs/viewrealestate
 */
...
final class ViewRealEstate extends ViewRecord
{
    ...
    {
        $this->log->channel('audit')->$this->logger->info('RealEstate record viewed', [
            'record_id' => $this->record->id,
