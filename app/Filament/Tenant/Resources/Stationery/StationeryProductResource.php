...
use App\Filament\Tenant\Resources\Stationery\StationeryProductResource\Pages\CreateStationeryProduct;
use App\Filament\Tenant\Resources\Stationery\StationeryProductResource\Pages\EditStationeryProduct;
use App\Filament\Tenant\Resources\Stationery\StationeryProductResource\Pages\ListStationeryProducts;
...
final class StationeryProductResource extends Resource
{
    ...
    {
        return [
            'index' => ListStationeryProducts::route('/'),
            'create' => CreateStationeryProduct::route('/create'),
            'edit' => EditStationeryProduct::route('/{record}/edit'),
        ];
    }
