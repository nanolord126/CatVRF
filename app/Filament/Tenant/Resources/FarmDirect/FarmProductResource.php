...
use App\Filament\Tenant\Resources\FarmDirect\FarmProductResource\Pages\CreateFarmProduct;
use App\Filament\Tenant\Resources\FarmDirect\FarmProductResource\Pages\EditFarmProduct;
use App\Filament\Tenant\Resources\FarmDirect\FarmProductResource\Pages\ListFarmProducts;
...
final class FarmProductResource extends Resource
{
    ...
    {
        return [
            'index' => ListFarmProducts::route('/'),
            'create' => CreateFarmProduct::route('/create'),
            'edit' => EditFarmProduct::route('/{record}/edit'),
        ];
    }
