...
final class CreateFarmDirect extends CreateRecord
{
    ...
    protected function mutateFormDataBeforeCreate(array $data): array
    {
        ...
        $this->db->transaction(function () use (&$data, $correlationId) {
            ...
            $this->log->channel('audit')->$this->logger->info('FarmDirect creation form submitted', [
    ...
    {
        $this->log->channel('audit')->$this->logger->info('FarmDirect record created successfully', [
