...
final class CreateFarmDirect extends CreateRecord
{
    ...
    protected function mutateFormDataBeforeCreate(array $data): array
    {
        ...
        $this->db->transaction(function () use (&$data, $correlationId) {
            ...
            \Illuminate\Support\Facades\Log::channel('audit')->info('FarmDirect creation form submitted', [
    ...
    {
        \Illuminate\Support\Facades\Log::channel('audit')->info('FarmDirect record created successfully', [
