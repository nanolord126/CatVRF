...
final class ListCommerce extends ListRecords
{
    ...
    protected function getTableQuery(): Builder
    {
        ...
        \Illuminate\Support\Facades\Log::channel('audit')->info('Commerce ListRecords accessed', [
            'tenant_id' => $tenantId,
            'user_id' => $userId,
    ...
    public function render(): \Illuminate\Contracts\View\View {
        \Illuminate\Support\Facades\Log::channel('audit')->info('ListCommerce page rendered', [
            'user_id' => auth()->id(),
