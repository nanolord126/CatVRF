...
final class MedicalSupplyResource extends Model
{
    use HasFactory;
    ...
    protected static ?string $model = MedicalSupply::class;
        ...
        {
            return [
                'index' => Pages\ListMedicalSupplyResource::route('/'),
                'create' => Pages\CreateMedicalSupplyResource::route('/create'),
                'edit' => Pages\EditMedicalSupplyResource::route('/{record}/edit'),
                'view' => Pages\ViewMedicalSupplyResource::route('/{record}'),
            ];
        }
