...
namespace App\Filament\Tenant\Resources\ConfectioneryResource;
...
final class ConfectioneryResource extends Model
{
    ...
    protected static ?string $model = ConfectioneryShop::class;
        ...
        {
            return [
                'index' => Pages\ListConfectioneryResource::route('/'),
                'create' => Pages\CreateConfectioneryResource::route('/create'),
                'edit' => Pages\EditConfectioneryResource::route('/{record}/edit'),
                'view' => Pages\ViewConfectioneryResource::route('/{record}'),
            ];
        }
