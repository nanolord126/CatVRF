...
final class CreatePhotography extends CreateRecord
{
    ...
    protected function mutateFormDataBeforeCreate(array $data): array
    {
        ...
        $this->db->transaction(function () use (&$data, $correlationId) {
            ...
            $this->log->channel('audit')->$this->logger->info('Photography creation form submitted', [
    ...
    {
        $this->log->channel('audit')->$this->logger->info('Photography record created successfully', [
