...
final class EditManufacturing extends EditRecord
{
    ...
    protected function mutateFormDataBeforeSave(array $data): array
    {
        $this->db->transaction(function () use (&$data) {
            ...
            $this->log->channel('audit')->$this->logger->info('Manufacturing updated', [
                'user_id' => auth()->id(),
    ...
    {
        $this->log->channel('audit')->$this->logger->info('Manufacturing edit page saved', [
            'record_id' => $this->record->id,
            'user_id' => auth()->id(),
