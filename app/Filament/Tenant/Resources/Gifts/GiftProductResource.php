...
final class GiftProductResource extends Model
{
    use HasFactory;
    ...
    protected static ?string $model = GiftProduct::class;
        ...
        {
            return [
                'index' => Pages\ListGiftProductResource::route('/'),
                'create' => Pages\CreateGiftProductResource::route('/create'),
                'edit' => Pages\EditGiftProductResource::route('/{record}/edit'),
                'view' => Pages\ViewGiftProductResource::route('/{record}'),
            ];
        }
