...
/**
 * ApplianceRepairResource — Канон 2026.
 * Админка для управления мастерами и заказами.
 * Scoping: tenant_id, dynamic status badges, filtered reports.
 */
class ApplianceRepairResource extends Resource
{
