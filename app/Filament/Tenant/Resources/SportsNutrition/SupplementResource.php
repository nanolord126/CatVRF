...
use App\Filament\Tenant\Resources\SportsNutrition\Pages\CreateSupplement;
use App\Filament\Tenant\Resources\SportsNutrition\Pages\EditSupplement;
use App\Filament\Tenant\Resources\SportsNutrition\Pages\ListSupplements;
...
final class SupplementResource extends Resource
{
    ...
    public static function table(Table $table): Table
    {
        return $table->columns([
            ...
            BadgeColumn::make('type')->label('Тип')->color(fn ($state) => match($state) {
                'protein' => 'blue', 'creatine' => 'red', 'bcaa' => 'green', 'pre_workout' => 'purple', 'multivitamin' => 'orange', 'fat_burner' => 'yellow', 'gainer' => 'cyan'
            }),
