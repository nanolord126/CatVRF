...
use App\Services\CarRental\PricingService;

/**
 * BookingResource (CarRental).
 * Implementation: Layer 6 (UI/UX Layer).
 * Dynamic rental lifecycle management: from selection to return photos.
 * Implements Layer 4 (Business Logic) via reactive pricing.
 */
