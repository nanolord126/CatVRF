...
use App\Filament\Tenant\Resources\ConstructionAndRepair\Pages\CreateProvider;
use App\Filament\Tenant\Resources\ConstructionAndRepair\Pages\EditProvider;
use App\Filament\Tenant\Resources\ConstructionAndRepair\Pages\ListProviders;
...
final class ServiceProviderResource extends Resource
{
    ...
    public static function table(Table $table): Table
    {
        return $table->columns([
            ...
            BadgeColumn::make('service_type')->label('Услуга')->formatStateUsing(fn ($state) => match($state) {
                'renovation' => 'Ремонт', 'plumbing' => 'Сантехника', 'electrical' => 'Электрика', default => 'Прочее'
            })->color(fn ($state) => match($state) {
                'renovation' => 'blue', 'plumbing' => 'cyan', 'electrical' => 'yellow', default => 'gray'
            }),
