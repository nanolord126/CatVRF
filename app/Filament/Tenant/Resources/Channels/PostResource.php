...
use Filament\Forms;
use Filament\Tables;
use App\Filament\Tenant\Resources\Channels\Pages\CreatePost;
use App\Filament\Tenant\Resources\Channels\Pages\EditPost;
use App\Filament\Tenant\Resources\Channels\Pages\ListPosts;
            ...
            Forms\Components\Section::make('Публикация')
                ->schema([
                    Forms\Components\Select::make('status')
                        ...
                        ->default('draft')
                        ->required()
                        ->disabled(fn ($record) => $record !== null && in_array($record?->status, ['published', 'rejected'], true)),

                    Forms\Components\DateTimePicker::make('scheduled_at')
                        ->label('Отложенная публикация')
                        ->helperText('Доступно только в тарифе "Расширенный"')
                        ->minDate(CarbonImmutable::now()->addMinutes(5)),
                ])
                ->columns(2),
        ...
        return $table
            ...
            ->actions([
                    ...
                    ->action(function (Post $record): void {
                        $this->postService /* TODO: inject via constructor DI */ /* TODO: inject via DI */->archivePost($record, Str::uuid()->toString());
