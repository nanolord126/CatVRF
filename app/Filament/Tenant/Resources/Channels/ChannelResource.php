...
use Filament\Forms;
use Filament\Tables;
use App\Filament\Tenant\Resources\Channels\Pages\CreateChannel;
use App\Filament\Tenant\Resources\Channels\Pages\EditChannel;
use App\Filament\Tenant\Resources\Channels\Pages\ListChannels;
                    ...
                    Forms\Components\Actions::make([
                        Forms\Components\Actions\Action::make('subscribe_to_plan')
                            ...
                            ->action(function (Forms\Get $get, ?BusinessChannel $record): void {
                                ...
                                try {
                                    $this->channelTariffService /* TODO: inject via constructor DI */ /* TODO: inject via DI */->subscribe(
                                        $record,
                                        $planSlug,
                                        Str::uuid()->toString()
                                    );
        ...
        return $table
            ...
            ->actions([
                    ...
                    ->action(function (BusinessChannel $record): void {
                        $this->channelService /* TODO: inject via constructor DI */ /* TODO: inject via DI */->restoreChannel($record);
