...
use App\Filament\Tenant\Resources\HobbyAndCraft\Pages\CreateSupply;
use App\Filament\Tenant\Resources\HobbyAndCraft\Pages\EditSupply;
use App\Filament\Tenant\Resources\HobbyAndCraft\Pages\ListSupplies;
    ...
    public static function table(Table $table): Table
    {
        return $table->columns([
            ...
            BadgeColumn::make('category')->label('Категория')->color(fn ($state) => match($state) {
                'painting' => 'blue', 'knitting' => 'purple', 'sewing' => 'pink', 'jewelry' => 'yellow', 'woodwork' => 'orange', default => 'gray'
            }),
