...
/**
 * FashionResource Resource
 * 
 * Production-ready Filament 3.x Resource
 * КАНОН 2026 compliant
 */
final class FashionResource extends Resource
{
    protected static ?string $model = B2BFashionOrder::class;
    ...
    public static function getPages(): array
    {
        return [
            ...
            'view' => Pages\\ViewFashion::route('/{record}'),
        ];
