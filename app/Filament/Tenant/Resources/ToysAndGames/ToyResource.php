...
use App\Filament\Tenant\Resources\ToysAndGames\Pages\CreateToy;
use App\Filament\Tenant\Resources\ToysAndGames\Pages\EditToy;
use App\Filament\Tenant\Resources\ToysAndGames\Pages\ListToys;
    ...
    public static function table(Table $table): Table
    {
        return $table->columns([
            ...
            BadgeColumn::make('category')->label('Категория')->color(fn ($state) => match($state) {
                'action_figures' => 'blue', 'building_blocks' => 'orange', 'dolls' => 'pink', 'puzzles' => 'purple', 'games' => 'green', default => 'gray'
            }),
