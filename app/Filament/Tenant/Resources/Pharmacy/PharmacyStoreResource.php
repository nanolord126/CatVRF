...
use Filament\Tables;
use Filament\Tables\{Table, Columns\TextColumn, Columns\BooleanColumn, Filters\SelectFilter, Filters\TernaryFilter, Filters\TrashedFilter, Filters\Filter};
...
use App\Filament\Tenant\Resources\Pharmacy\Pages\CreateStore;
use App\Filament\Tenant\Resources\Pharmacy\Pages\EditStore;
use App\Filament\Tenant\Resources\Pharmacy\Pages\ListStores;
use App\Filament\Tenant\Resources\Pharmacy\Pages\ViewStore;
                ...
                Tables\Actions\ActionGroup::make([
                    ...
                    Action::make('verify')
                        ...
                        ->action(function ($record) {
                            ...
                            $this->logger->$this->logger->info('Pharmacy verified', [
                    ...
                    Action::make('feature')
                        ...
                        ->action(function ($record) {
                            ...
                            $this->logger->$this->logger->info('Pharmacy featured', [
                                'pharmacy_id' => $record->id,
                                'user_id' => $this->guard->id(),
                                'correlation_id' => $record->correlation_id,
                            ]);
                    ...
                    BulkActionGroup::make([
                        ...
                        ->action(function ($records) {
                            $records->each(function ($record) {
                                ...
                                $this->logger->$this->logger->info('Pharmacy bulk activated', [
                                    'pharmacy_id' => $record->id,
                                    'user_id' => $this->guard->id(),
                                    'correlation_id' => $record->correlation_id,
                                ]);
                        ...
                        ->action(function ($records) {
                            $records->each(function ($record) {
                                $record->update(['is_verified' => true]);
                                $this->logger->$this->logger->info('Pharmacy bulk verified', [
                                    'pharmacy_id' => $record->id,
                                    'user_id' => $this->guard->id(),
                                    'correlation_id' => $record->correlation_id,
                                ]);
