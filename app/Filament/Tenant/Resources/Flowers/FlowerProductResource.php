...
use Filament\Forms\Components\{FileUpload, Hidden, RichEditor, Section, Select, TextInput, Toggle};
...
use App\Filament\Tenant\Resources\Flowers\Pages\CreateFlowerProduct;
use App\Filament\Tenant\Resources\Flowers\Pages\EditFlowerProduct;
use App\Filament\Tenant\Resources\Flowers\Pages\ListFlowerProducts;
...
final class FlowerProductResource extends Resource
{
    ...
    {
        return [
            'index' => ListFlowerProducts::route('/'),
            'create' => CreateFlowerProduct::route('/create'),
            'edit' => EditFlowerProduct::route('/{record}/edit'),
        ];
    }
