...
use App\Filament\Tenant\Resources\Gardening\Pages\CreateService;
use App\Filament\Tenant\Resources\Gardening\Pages\EditService;
use App\Filament\Tenant\Resources\Gardening\Pages\ListServices;
...
final class GardenServiceResource extends Resource
{
    ...
    public static function table(Table $table): Table
    {
        return $table->columns([
            ...
            BadgeColumn::make('service_category')->label('Категория')->color(fn ($state) => match($state) {
                'landscaping' => 'green', 'lawn_care' => 'cyan', 'pruning' => 'blue', default => 'gray'
            }),
