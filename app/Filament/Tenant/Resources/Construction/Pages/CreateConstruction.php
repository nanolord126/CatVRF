...
final class CreateConstruction extends CreateRecord
{
    ...
    protected function mutateFormDataBeforeCreate(array $data): array
    {
        ...
        $this->db->transaction(function () use (&$data, $correlationId) {
            ...
            $this->log->channel('audit')->$this->logger->info('Construction project creation form submitted', [
    ...
    {
        $this->log->channel('audit')->$this->logger->info('Construction project created successfully', [
