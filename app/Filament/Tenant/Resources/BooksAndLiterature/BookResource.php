...
use App\Filament\Tenant\Resources\BooksAndLiterature\Pages\CreateBook;
use App\Filament\Tenant\Resources\BooksAndLiterature\Pages\EditBook;
use App\Filament\Tenant\Resources\BooksAndLiterature\Pages\ListBooks;
...
final class BookResource extends Resource
{
    ...
    public static function table(Table $table): Table
    {
        return $table->columns([
            ...
            BadgeColumn::make('genre')->label('Жанр')->color(fn ($state) => match($state) {
                'fiction' => 'blue', 'nonfiction' => 'green', 'science' => 'purple', 'history' => 'orange', 'children' => 'pink', default => 'gray'
            }),
