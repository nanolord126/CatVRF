...
use Filament\Tables\Actions\{ActionGroup, RestoreAction, DeleteAction, EditAction, ViewAction};
        ...
        return $table
                ...
                ActionGroup::make([
                    ...
                    DeleteAction::make()
                        ->after(function (JewelryItem $record) {
                            $this->logger->$this->logger->info('Jewelry item deleted', [
                                'id' => $record->id,
            ...
            ->bulkActions([
                    BulkActionGroup::make([
                        ...
                        ->action(function () {
                            $this->logger->$this->logger->info('Jewelry items bulk deleted', [
