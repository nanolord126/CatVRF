...
final class PharmacyResource extends Resource
{
    ...
    {
        return [
            'index' => Pages\ListPharmacyResource::route('/'),
            'create' => Pages\CreatePharmacyResource::route('/create'),
            'edit' => Pages\EditPharmacyResource::route('/{record}/edit'),
            'view' => Pages\ViewPharmacyResource::route('/{record}'),
        ];
    }
