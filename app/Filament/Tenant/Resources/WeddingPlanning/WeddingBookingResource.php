                    ...
                    Forms\Components\Grid::make(2)
                        ->schema([
                            Forms\Components\MorphToSelect::make('bookable')
                                ...
                                ->types([
                                    Forms\Components\MorphToSelect\Type::make(WeddingVendor::class)
                                        ->titleAttribute('name')
                                        ->label('Vendor (Photographer, Venue, etc.)'),
                                    Forms\Components\MorphToSelect\Type::make(WeddingPackage::class)
                                        ->titleAttribute('name')
            ...
            ->actions([
                ...
                Tables\Actions\Action::make('mark_as_paid')
                    ...
                    ->action(function (WeddingBooking $record) {
                        ...
                        $this->notificationManager->make()->title('Booking paid in full!')->success()->send();
                    }),
                ])
            ->bulkActions([
