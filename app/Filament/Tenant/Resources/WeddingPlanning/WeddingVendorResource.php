...
use App\Domains\WeddingPlanning\Services\VendorManagementService;
use Illuminate\Database\Eloquent\Builder;
use Filament\Notifications\Notification;

/**
 * WeddingVendorResource
 *
 * Layer 4: Admin UI (Filament)
 * Предоставляет полный интерфейс управления контрагентами (вендорами).
 *
 * @version 1.0.0
 * @author CatVRF
 */
class WeddingVendorResource extends Resource
{
