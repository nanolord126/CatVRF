...
final class ListGroceryAndDelivery extends ListRecords
{
    ...
    {
        $this->log->channel('audit')->$this->logger->info('ListGroceryAndDelivery page rendered', [
            'user_id' => auth()->id(),
    ...
    protected function getTableQuery(): Builder
    {
        ...
        $this->log->channel('audit')->$this->logger->info('GroceryAndDelivery ListRecords accessed', [
            'tenant_id' => $tenantId,
            'user_id' => $userId,
