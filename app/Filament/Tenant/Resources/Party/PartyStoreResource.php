...
use App\Filament\Tenant\Resources\Party\PartyStoreResource\Pages\CreatePartyStore;
use App\Filament\Tenant\Resources\Party\PartyStoreResource\Pages\EditPartyStore;
use App\Filament\Tenant\Resources\Party\PartyStoreResource\Pages\ListPartyStores;
...
final class PartyStoreResource extends Resource
{
    ...
    {
        return [
            'index' => ListPartyStores::route('/'),
            'create' => CreatePartyStore::route('/create'),
            'edit' => EditPartyStore::route('/{record}/edit'),
        ];
    }
}
