...
use App\Filament\Tenant\Resources\Party\PartyProductResource\Pages\CreatePartyProduct;
use App\Filament\Tenant\Resources\Party\PartyProductResource\Pages\EditPartyProduct;
use App\Filament\Tenant\Resources\Party\PartyProductResource\Pages\ListPartyProducts;
...
final class PartyProductResource extends Resource
{
    ...
    {
        return [
            'index' => ListPartyProducts::route('/'),
            'create' => CreatePartyProduct::route('/create'),
            'edit' => EditPartyProduct::route('/{record}/edit'),
        ];
    }
}
