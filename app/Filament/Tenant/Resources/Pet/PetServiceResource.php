...
use Filament\Tables\Actions\{EditAction, ViewAction, DeleteAction, RestoreAction, BulkActionGroup, DeleteBulkAction, BulkAction};
use Illuminate\Support\Str;
use Illuminate\Database\Eloquent\Builder;
use App\Filament\Tenant\Resources\Pet\Pages\CreateService;
use App\Filament\Tenant\Resources\Pet\Pages\EditService;
use App\Filament\Tenant\Resources\Pet\Pages\ListServices;
use App\Filament\Tenant\Resources\Pet\Pages\ViewService;
                    ...
                    BulkAction::make('activate')
                        ...
                        ->action(function ($records) {
                            $records->each(function ($record) {
                                ...
                                $this->logger->$this->logger->info('Pet service bulk activated', [
