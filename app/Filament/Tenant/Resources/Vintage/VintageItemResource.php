...
use App\Domains\Vintage\Models\VintageItem;
use App\Filament\Tenant\Resources\Vintage\VintageItemResource\Pages\CreateVintageItem;
use App\Filament\Tenant\Resources\Vintage\VintageItemResource\Pages\EditVintageItem;
use App\Filament\Tenant\Resources\Vintage\VintageItemResource\Pages\ListVintageItems;

final class VintageItemResource extends Resource
{
    protected static ?string $model = VintageItem::class;
    ...
    {
        return [
            'index' => ListVintageItems::route('/'),
            'create' => CreateVintageItem::route('/create'),
            'edit' => EditVintageItem::route('/{record}/edit'),
        ];
    }
