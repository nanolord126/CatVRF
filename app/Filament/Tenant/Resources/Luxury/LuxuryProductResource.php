...
use App\Filament\Tenant\Resources\Luxury\LuxuryProductResource\Pages\CreateLuxuryProduct;
use App\Filament\Tenant\Resources\Luxury\LuxuryProductResource\Pages\EditLuxuryProduct;
use App\Filament\Tenant\Resources\Luxury\LuxuryProductResource\Pages\ListLuxuryProducts;
...
final class LuxuryProductResource extends Resource
{
    ...
    {
        return [
            'index' => ListLuxuryProducts::route('/'),
            'create' => CreateLuxuryProduct::route('/create'),
            'edit' => EditLuxuryProduct::route('/{record}/edit'),
        ];
    }
