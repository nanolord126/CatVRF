...
final class EditBooks extends EditRecord
{
    ...
    protected function getHeaderActions(): array
    {
        return [
            ...
            DeleteAction::make()
                ...
                ->modalHeading('Удалить книгу?')
                ->modalDescription('Книга будет удалена без возможности восстановления.')
    ...
    {
        \Illuminate\Support\Facades\Log::channel('audit')->info('Book updated', [
