...
final class EditAutoParts extends EditRecord
{
    ...
    {
        return 'Редактирование запчасти';
    }
    ...
    protected function getHeaderActions(): array
    {
        return [
            ...
            DeleteAction::make()
                ...
                ->modalHeading('Удалить запчасть?')
                ->modalDescription('Запчасть будет удалена без возможности восстановления.')
    ...
    {
        $this->log->channel('audit')->$this->logger->info('Auto part updated', [
