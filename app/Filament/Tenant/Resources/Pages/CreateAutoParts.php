...
final class CreateAutoParts extends CreateRecord
{
    ...
    protected function mutateFormDataBeforeCreate(array $data): array
    {
        ...
        $data['wholesale_price_kopecks'] = $data['wholesale_price_kopecks'] ?? 0;
    ...
    {
        $this->log->channel('audit')->$this->logger->info('Auto part created', [
