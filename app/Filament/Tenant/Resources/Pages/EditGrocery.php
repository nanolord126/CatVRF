...
final class EditGrocery extends EditRecord
{
    ...
    {
        return 'Редактирование магазина';
    }
    ...
    protected function getHeaderActions(): array
    {
        return [
            ...
            DeleteAction::make()
                ...
                ->modalDescription('Магазин будет удалён без возможности восстановления.')
    ...
    {
        $this->log->channel('audit')->$this->logger->info('Grocery store updated', [
