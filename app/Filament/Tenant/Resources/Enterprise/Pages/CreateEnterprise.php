...
final class CreateEnterprise extends CreateRecord
{
    ...
    protected function mutateFormDataBeforeCreate(array $data): array
    {
        ...
        $this->db->transaction(function () use (&$data, $correlationId) {
            ...
            \Illuminate\Support\Facades\Log::channel('audit')->info('Enterprise creation form submitted', [
    ...
    {
        \Illuminate\Support\Facades\Log::channel('audit')->info('Enterprise record created successfully', [
