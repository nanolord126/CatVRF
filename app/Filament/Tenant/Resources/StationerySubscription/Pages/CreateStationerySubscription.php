...
/**
 * CreateStationerySubscription — CatVRF 2026 Component.
 *
 ...
 * @see https://catvrf.ru/docs/createstationerysubscription
 * @see https://catvrf.ru/docs/createstationerysubscription
 * @see https://catvrf.ru/docs/createstationerysubscription
 */
...
/**
 * Class CreateStationerySubscription
 *
 * Filament admin panel component.
 * Tenant-scoped: all data filtered by current tenant.
 * Follows CatVRF 9-layer architecture (Layer 9: Filament).
 *
 * @package App\Filament\Tenant\Resources\StationerySubscription\Pages
 */
