...
use App\Domains\HouseholdGoods\Models\HouseholdGoods;
use App\Filament\Tenant\Resources\HouseholdGoods\HouseholdGoodsResource\Pages\CreateHouseholdGoods;
use App\Filament\Tenant\Resources\HouseholdGoods\HouseholdGoodsResource\Pages\EditHouseholdGoods;
use App\Filament\Tenant\Resources\HouseholdGoods\HouseholdGoodsResource\Pages\ListHouseholdGoods;

final class HouseholdGoodsResource extends Resource
{
    protected static ?string $model = HouseholdGoods::class;
                    ...
                    DeleteBulkAction::make()
                        ->action(function ($records) {
                            $records->each(function ($record) {
                                $this->logger->$this->logger->info('Household good bulk deleted', [
                                    'good_id' => $record->id,
                    ...
                    BulkAction::make('activate')
                        ...
                        ->action(function ($records) {
                            $records->each(function ($record) {
                                ...
                                $this->logger->$this->logger->info('Household good activated', [
                                    'good_id' => $record->id,
                                    'correlation_id' => $record->correlation_id,
                                ]);
                            });
    ...
    {
        return [
            'index' => ListHouseholdGoods::route('/'),
            'create' => CreateHouseholdGoods::route('/create'),
            'edit' => EditHouseholdGoods::route('/{record}/edit'),
        ];
    }
