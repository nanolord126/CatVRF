...
use App\Filament\Tenant\Resources\Furniture\FurnitureProductResource\Pages\CreateFurnitureProduct;
use App\Filament\Tenant\Resources\Furniture\FurnitureProductResource\Pages\EditFurnitureProduct;
use App\Filament\Tenant\Resources\Furniture\FurnitureProductResource\Pages\ListFurnitureProducts;
...
final class FurnitureProductResource extends Resource
{
    ...
    {
        return [
            'index' => ListFurnitureProducts::route('/'),
            'create' => CreateFurnitureProduct::route('/create'),
            'edit' => EditFurnitureProduct::route('/{record}/edit'),
        ];
    }
