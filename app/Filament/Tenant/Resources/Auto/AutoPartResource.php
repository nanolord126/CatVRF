...
use App\Filament\Tenant\Resources\Auto\AutoPartResource\Pages\CreateAutoPart;
use App\Filament\Tenant\Resources\Auto\AutoPartResource\Pages\EditAutoPart;
use App\Filament\Tenant\Resources\Auto\AutoPartResource\Pages\ListAutoParts;
use App\Filament\Tenant\Resources\Auto\AutoPartResource\Pages\ViewAutoPart;
...
final class AutoPartResource extends Resource
{
        ...
        return $table
            ...
            ->actions([
                    ...
                    Tables\Actions\DeleteAction::make()
                        ->after(function () {
                            $this->logger->$this->logger->info('AutoPart deleted', [
                                'resource' => 'AutoPart',
                    ...
                    Tables\Actions\RestoreAction::make()
                        ->after(function () {
                            $this->logger->$this->logger->info('AutoPart restored', [
                                'resource' => 'AutoPart',
                                'user_id' => $this->guard->id(),
                                'correlation_id' => Str::uuid(),
                            ]);
            ...
            ->bulkActions([
                    Tables\Actions\BulkActionGroup::make([
                        ...
                        ->after(function () {
                            $this->logger->$this->logger->info('AutoParts bulk deleted', [
                                'resource' => 'AutoPart',
                                'user_id' => $this->guard->id(),
                                'correlation_id' => Str::uuid(),
                            ]);
                        ...
                        ->action(function (Collection $records) {
                            foreach ($records as $record) {
                                $record->update(['last_reorder_date' => CarbonImmutable::now()]);
                                $this->logger->$this->logger->info('AutoPart reorder marked', [
                                    'resource' => 'AutoPart',
    ...
    {
        return [
            'index' => ListAutoParts::route('/'),
            'create' => CreateAutoPart::route('/create'),
            'view' => ViewAutoPart::route('/{record}'),
            'edit' => EditAutoPart::route('/{record}/edit'),
        ];
    }
