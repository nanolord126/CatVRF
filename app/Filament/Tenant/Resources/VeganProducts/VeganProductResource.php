...
use App\Filament\Tenant\Resources\VeganProducts\Pages\CreateProduct;
use App\Filament\Tenant\Resources\VeganProducts\Pages\EditProduct;
use App\Filament\Tenant\Resources\VeganProducts\Pages\ListProducts;
...
final class VeganProductResource extends Resource
{
    ...
    public static function table(Table $table): Table
    {
        return $table->columns([
            ...
            BadgeColumn::make('category')->label('Категория')->color(fn ($state) => match($state) {
                'meat_substitute' => 'red', 'dairy' => 'blue', 'snacks' => 'yellow', 'baking' => 'orange', 'sauces' => 'green', 'beverages' => 'cyan'
            }),
