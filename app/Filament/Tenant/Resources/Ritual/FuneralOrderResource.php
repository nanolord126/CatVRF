...
use App\Filament\Tenant\Resources\Ritual\FuneralOrderResource\Pages\CreateFuneralOrder;
use App\Filament\Tenant\Resources\Ritual\FuneralOrderResource\Pages\EditFuneralOrder;
use App\Filament\Tenant\Resources\Ritual\FuneralOrderResource\Pages\ListFuneralOrders;
use App\Filament\Tenant\Resources\Ritual\FuneralOrderResource\Pages\ViewFuneralOrder;

final class FuneralOrderResource extends Resource
{
    ...
    {
        return [
            'index' => ListFuneralOrders::route('/'),
            'create' => CreateFuneralOrder::route('/create'),
            'edit' => EditFuneralOrder::route('/{record}/edit'),
            'view' => ViewFuneralOrder::route('/{record}'),
        ];
    }
}
