...
/**
 * OfficeCateringResource Resource
 * 
...
final class OfficeCateringResource extends Resource
{
    ...
    {
        return [
            'index' => Pages\ListOfficeCateringResource::route('/'),
            'create' => Pages\CreateOfficeCateringResource::route('/create'),
            'edit' => Pages\EditOfficeCateringResource::route('/{record}/edit'),
            'view' => Pages\ViewOfficeCateringResource::route('/{record}'),
        ];
    }
