...
use App\Domains\PartySupplies\Models\PartySupply;
use App\Filament\Tenant\Resources\PartySupplies\PartySuppiesResource\Pages\CreatePartySuppies;
use App\Filament\Tenant\Resources\PartySupplies\PartySuppiesResource\Pages\EditPartySuppies;
use App\Filament\Tenant\Resources\PartySupplies\PartySuppiesResource\Pages\ListPartySuppies;

final class PartySuppiesResource extends Resource
{
    protected static ?string $model = PartySupply::class;
    ...
    {
        return [
            'index' => ListPartySuppies::route('/'),
            'create' => CreatePartySuppies::route('/create'),
            'edit' => EditPartySuppies::route('/{record}/edit'),
        ];
    }
