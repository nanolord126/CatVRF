...
final class AutoPartResource extends Resource
{
    ...
    {
        return [
            'index' => Pages\ListAutoPartResource::route('/'),
            'create' => Pages\CreateAutoPartResource::route('/create'),
            'edit' => Pages\EditAutoPartResource::route('/{record}/edit'),
            'view' => Pages\ViewAutoPartResource::route('/{record}'),
        ];
    }
