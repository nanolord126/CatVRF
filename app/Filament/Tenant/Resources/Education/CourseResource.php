...
use Filament\Forms;
use Filament\Tables;
use App\Filament\Tenant\Resources\Education\CourseResource\Pages\CreateCourse;
use App\Filament\Tenant\Resources\Education\CourseResource\Pages\EditCourse;
use App\Filament\Tenant\Resources\Education\CourseResource\Pages\ListCourses;
            ...
            ->actions([
                Tables\Actions\EditAction::make()
                    ->before(function (Course $record) {
                        ...
                        $this->fraudControlService /* TODO: inject via constructor DI */ /* TODO: inject via DI */->checkOperation('edit_course', [
                            'course_id' => $record->id,
                        ]);
                    }),
