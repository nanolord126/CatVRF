...
final class CreateEducation extends CreateRecord
{
    ...
    protected function mutateFormDataBeforeCreate(array $data): array
    {
        ...
        $this->db->transaction(function () use (&$data, $correlationId) {
            ...
            \Illuminate\Support\Facades\Log::channel('audit')->info('Education creation form submitted', [
    ...
    {
        \Illuminate\Support\Facades\Log::channel('audit')->info('Education record created successfully', [
