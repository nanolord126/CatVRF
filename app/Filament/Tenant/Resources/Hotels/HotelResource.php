...
use App\Filament\Tenant\Resources\Hotels\HotelResource\Pages\CreateHotel;
use App\Filament\Tenant\Resources\Hotels\HotelResource\Pages\EditHotel;
use App\Filament\Tenant\Resources\Hotels\HotelResource\Pages\ListHotels;
use App\Filament\Tenant\Resources\Hotels\HotelResource\Pages\ViewHotel;
                ...
                Tables\Actions\ActionGroup::make([
                    ...
                    Tables\Actions\Action::make('verify')
                        ...
                        ->action(function ($record) {
                            ...
                            $this->loggerInterface /* TODO: inject via constructor DI */ /* TODO: inject via DI */->$this->logger->info('Hotel verified', [
                                'hotel_id' => $record->id,
                    ...
                    Tables\Actions\Action::make('feature')
                        ...
                        ->action(function ($record) {
                            ...
                            $this->loggerInterface /* TODO: inject via constructor DI */ /* TODO: inject via DI */->$this->logger->info('Hotel featured', [
                                'hotel_id' => $record->id,
                                'user_id' => filament()->auth()->id(),
                                'correlation_id' => $record->correlation_id,
                            ]);
                    ...
                    Tables\Actions\BulkActionGroup::make([
                        ...
                        ->action(function ($records) {
                            $records->each(function ($record) {
                                $this->loggerInterface /* TODO: inject via constructor DI */ /* TODO: inject via DI */->$this->logger->info('Hotel bulk deleted', [
                                    'hotel_id' => $record->id,
                                    'user_id' => filament()->auth()->id(),
                                    'correlation_id' => $record->correlation_id,
                                ]);
                        ...
                        ->action(function ($records) {
                            $records->each(function ($record) {
                                ...
                                $this->loggerInterface /* TODO: inject via constructor DI */ /* TODO: inject via DI */->$this->logger->info('Hotel activated', [
                                    'hotel_id' => $record->id,
                                    'user_id' => filament()->auth()->id(),
                                    'correlation_id' => $record->correlation_id,
                                ]);
                        ...
                        ->action(function ($records) {
                            $records->each(function ($record) {
                                ...
                                $this->loggerInterface /* TODO: inject via constructor DI */ /* TODO: inject via DI */->$this->logger->info('Hotel deactivated', [
                                    'hotel_id' => $record->id,
                                    'user_id' => filament()->auth()->id(),
                                    'correlation_id' => $record->correlation_id,
                                ]);
                        ...
                        ->action(function ($records) {
                            $records->each(function ($record) {
                                $record->update(['is_verified' => true]);
                                $this->loggerInterface /* TODO: inject via constructor DI */ /* TODO: inject via DI */->$this->logger->info('Hotel bulk verified', [
                                    'hotel_id' => $record->id,
                                    'user_id' => filament()->auth()->id(),
                                    'correlation_id' => $record->correlation_id,
                                ]);
