...
use App\Domains\Food\Confectionery\Models\ConfectioneryProduct;
...
/**
 * ConfectioneryProductResource Resource
 * 
...
final class ConfectioneryProductResource extends Resource
{
    ...
    {
        return [
            'index' => Pages\ListConfectioneryProductResource::route('/'),
            'create' => Pages\CreateConfectioneryProductResource::route('/create'),
            'edit' => Pages\EditConfectioneryProductResource::route('/{record}/edit'),
            'view' => Pages\ViewConfectioneryProductResource::route('/{record}'),
        ];
    }
