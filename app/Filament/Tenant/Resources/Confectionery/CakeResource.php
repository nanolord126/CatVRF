...
use App\Filament\Tenant\Resources\Confectionery\Pages\CreateCake;
use App\Filament\Tenant\Resources\Confectionery\Pages\EditCake;
use App\Filament\Tenant\Resources\Confectionery\Pages\ListCakes;
...
final class CakeResource extends Resource
{
    ...
    public static function table(Table $table): Table
    {
        return $table->columns([
            ...
            BadgeColumn::make('cake_type')->label('Тип')->color(fn ($state) => match($state) {
                'classic' => 'blue', 'modern' => 'purple', 'artistic' => 'pink', 'custom' => 'orange', default => 'gray'
            }),
