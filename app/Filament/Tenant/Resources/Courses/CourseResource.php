...
final class CourseResource extends Model
{
    ...
    protected static ?string $model = Course::class;
        ...
        {
            return [
                'index' => Pages\ListCourseResource::route('/'),
                'create' => Pages\CreateCourseResource::route('/create'),
                'edit' => Pages\EditCourseResource::route('/{record}/edit'),
                'view' => Pages\ViewCourseResource::route('/{record}'),
            ];
        }
