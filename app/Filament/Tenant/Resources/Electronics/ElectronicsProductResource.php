...
use App\Filament\Tenant\Resources\Electronics\ElectronicsProductResource\Pages\CreateElectronicsProduct;
use App\Filament\Tenant\Resources\Electronics\ElectronicsProductResource\Pages\EditElectronicsProduct;
use App\Filament\Tenant\Resources\Electronics\ElectronicsProductResource\Pages\ListElectronicsProducts;
...
final class ElectronicsProductResource extends Resource
{
    ...
    {
        return [
            'index' => ListElectronicsProducts::route('/'),
            'create' => CreateElectronicsProduct::route('/create'),
            'edit' => EditElectronicsProduct::route('/{record}/edit'),
        ];
    }
