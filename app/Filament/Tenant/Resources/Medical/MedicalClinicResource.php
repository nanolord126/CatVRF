...
use App\Filament\Tenant\Resources\Medical\Pages\CreateClinic;
use App\Filament\Tenant\Resources\Medical\Pages\EditClinic;
use App\Filament\Tenant\Resources\Medical\Pages\ListClinics;
use App\Filament\Tenant\Resources\Medical\Pages\ViewClinic;
                ...
                Tables\Actions\ActionGroup::make([
                    ...
                    Action::make('verify')
                        ...
                        ->action(function ($record) {
                            ...
                            $this->logger->$this->logger->info('Clinic verified', [
                                'clinic_id' => $record->id,
                    ...
                    Action::make('feature')
                        ...
                        ->action(function ($record) {
                            ...
                            $this->logger->$this->logger->info('Clinic featured', [
                                'clinic_id' => $record->id,
                                'user_id' => $this->guard->id(),
                                'correlation_id' => $record->correlation_id,
                            ]);
                    ...
                    BulkActionGroup::make([
                        ...
                        ->action(function ($records) {
                            $records->each(function ($record) {
                                ...
                                $this->logger->$this->logger->info('Clinic bulk activated', [
                                    'clinic_id' => $record->id,
                                    'user_id' => $this->guard->id(),
                                    'correlation_id' => $record->correlation_id,
                                ]);
                        ...
                        ->action(function ($records) {
                            $records->each(function ($record) {
                                $record->update(['is_verified' => true]);
                                $this->logger->$this->logger->info('Clinic bulk verified', [
                                    'clinic_id' => $record->id,
                                    'user_id' => $this->guard->id(),
                                    'correlation_id' => $record->correlation_id,
                                ]);
