...
/**
 * ViewMedical — CatVRF 2026 Component.
 *
 ...
 * @see https://catvrf.ru/docs/viewmedical
 * @see https://catvrf.ru/docs/viewmedical
 * @see https://catvrf.ru/docs/viewmedical
 */
 ...
 *
 * @package App\Filament\Tenant\Resources\Medical\Pages
 */
final class ViewMedical extends ViewRecord
{
    ...
    {
        $this->logger->info('Medical record viewed', [
    ...
    public function render(): \Illuminate\Contracts\View\View {
        $this->logger->debug('ViewMedical page rendered', [
            'record_id' => $this->record->id,
            'user_id' => auth()->id(),
        ]);
