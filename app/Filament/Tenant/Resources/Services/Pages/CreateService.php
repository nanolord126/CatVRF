...
final class CreateService extends CreateRecord
{
    ...
    protected function mutateFormDataBeforeCreate(array $data): array
    {
        ...
        $this->db->transaction(function () use (&$data, $correlationId) {
            ...
            \Illuminate\Support\Facades\Log::channel('audit')->info('Services creation form submitted', [
    ...
    {
        \Illuminate\Support\Facades\Log::channel('audit')->info('Services record created successfully', [
