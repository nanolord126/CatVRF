...
final class CreateEntertainment extends CreateRecord
{
    ...
    protected function mutateFormDataBeforeCreate(array $data): array
    {
        ...
        $this->db->transaction(function () use (&$data, $correlationId) {
            ...
            $this->log->channel('audit')->$this->logger->info('Entertainment creation form submitted', [
    ...
    {
        $this->log->channel('audit')->$this->logger->info('Entertainment record created successfully', [
