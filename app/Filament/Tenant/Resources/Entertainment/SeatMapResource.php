...
final class SeatMapResource extends Model
{
    use HasFactory;
    ...
    protected static ?string $model = SeatMap::class;
        ...
        {
            return [
                'index' => Pages\ListSeatMapResource::route('/'),
                'create' => Pages\CreateSeatMapResource::route('/create'),
                'edit' => Pages\EditSeatMapResource::route('/{record}/edit'),
                'view' => Pages\ViewSeatMapResource::route('/{record}'),
            ];
        }
