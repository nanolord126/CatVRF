...
final class ReviewResource extends Resource
{
    ...
    {
        return [
            'index' => Pages\ListReviewResource::route('/'),
            'create' => Pages\CreateReviewResource::route('/create'),
            'edit' => Pages\EditReviewResource::route('/{record}/edit'),
            'view' => Pages\ViewReviewResource::route('/{record}'),
        ];
    }
