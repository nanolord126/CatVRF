...
use App\Filament\Tenant\Resources\MeatShops\Pages\CreateProduct;
use App\Filament\Tenant\Resources\MeatShops\Pages\EditProduct;
use App\Filament\Tenant\Resources\MeatShops\Pages\ListProducts;
...
final class MeatProductResource extends Resource
{
    ...
    public static function table(Table $table): Table
    {
        return $table->columns([
            ...
            BadgeColumn::make('meat_type')->label('Тип')->formatStateUsing(fn ($state) => match($state) {
                'beef' => 'Говядина', 'pork' => 'Свинина', 'chicken' => 'Курица', default => 'Прочее'
            })->color(fn ($state) => match($state) {
                'beef' => 'red', 'pork' => 'orange', 'chicken' => 'yellow', default => 'gray'
            }),
