...
use App\Filament\Tenant\Resources\CleaningServices\Pages\CreateService;
use App\Filament\Tenant\Resources\CleaningServices\Pages\EditService;
use App\Filament\Tenant\Resources\CleaningServices\Pages\ListServices;
...
final class CleaningServiceResource extends Resource
{
    ...
    public static function table(Table $table): Table
    {
        return $table->columns([
            ...
            BadgeColumn::make('service_type')->label('Тип')->color(fn ($state) => match($state) {
                'general' => 'blue', 'deep' => 'purple', 'window' => 'cyan', 'carpet' => 'orange', 'post_repair' => 'red', 'commercial' => 'green'
            }),
