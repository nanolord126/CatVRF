...
use App\Filament\Tenant\Resources\OfficeCatering\Pages\CreateMenu;
use App\Filament\Tenant\Resources\OfficeCatering\Pages\EditMenu;
use App\Filament\Tenant\Resources\OfficeCatering\Pages\ListMenus;
...
final class CorporateMenuResource extends Resource
{
    ...
    public static function table(Table $table): Table
    {
        return $table->columns([
            ...
            BadgeColumn::make('menu_type')->label('Тип')->color(fn ($state) => match($state) {
                'breakfast' => 'yellow', 'lunch' => 'blue', 'dinner' => 'purple', 'snacks' => 'orange', 'combined' => 'green'
            }),
            ...
            BadgeColumn::make('diet_type')->label('Диета')->color(fn ($state) => match($state) {
                'vegetarian' => 'green', 'vegan' => 'cyan', 'keto' => 'orange', default => 'blue'
            }),
