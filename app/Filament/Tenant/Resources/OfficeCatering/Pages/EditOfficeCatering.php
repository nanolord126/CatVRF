...
final class EditOfficeCatering extends EditRecord
{
    ...
    protected function mutateFormDataBeforeSave(array $data): array
    {
        $this->db->transaction(function () use (&$data) {
            ...
            \Illuminate\Support\Facades\Log::channel('audit')->info('OfficeCatering updated', [
                'user_id' => auth()->id(),
    ...
    {
        \Illuminate\Support\Facades\Log::channel('audit')->info('OfficeCatering edit page saved', [
            'record_id' => $this->record->id,
            'user_id' => auth()->id(),
