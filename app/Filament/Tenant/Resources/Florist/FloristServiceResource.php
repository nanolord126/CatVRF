...
use App\Domains\Florist\Models\FloristService;
use App\Filament\Tenant\Resources\Florist\FloristServiceResource\Pages\CreateFloristService;
use App\Filament\Tenant\Resources\Florist\FloristServiceResource\Pages\EditFloristService;
use App\Filament\Tenant\Resources\Florist\FloristServiceResource\Pages\ListFloristServices;

final class FloristServiceResource extends Resource
{
    protected static ?string $model = FloristService::class;
    ...
    {
        return [
            'index' => ListFloristServices::route('/'),
            'create' => CreateFloristService::route('/create'),
            'edit' => EditFloristService::route('/{record}/edit'),
        ];
    }
