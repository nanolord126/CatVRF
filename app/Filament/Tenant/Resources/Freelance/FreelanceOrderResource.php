        ...
        return $table
            ...
            ->actions([
                    ...
                    ->action(function (FreelanceOrder $record, ContractService $service) {
                        ...
                        $this->notificationManager->make()->title('Средства успешно заморожены на Эскроу')->success()->send();
                    }),
                    ...
                    ->action(function (FreelanceOrder $record, FreelanceService $service) {
                        ...
                        $this->notificationManager->make()->title('Работа принята, гонорар выплачен')->success()->send();
                    }),
                    ...
                    ->visible(fn (FreelanceOrder $record) => in_array($record->status, ['in_progress', 'escrow_hold'], true))
                    ->color('danger')
                    ->form([
                    ...
                    ->action(function (FreelanceOrder $record, array $data) {
                        ...
                        $this->notificationManager->make()->title('Арбитраж CAT-VRF уведомлен о споре')->warning()->send();
                    }),
