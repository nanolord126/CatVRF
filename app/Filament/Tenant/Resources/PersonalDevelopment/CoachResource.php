...
use App\Filament\Tenant\Resources\PersonalDevelopment\Pages\CreateCoach;
use App\Filament\Tenant\Resources\PersonalDevelopment\Pages\EditCoach;
use App\Filament\Tenant\Resources\PersonalDevelopment\Pages\ListCoaches;
...
final class CoachResource extends Resource
{
    ...
    public static function table(Table $table): Table
    {
        return $table->columns([
            ...
            BadgeColumn::make('specialization')->label('Спец.')->color(fn ($state) => match($state) {
                'life_coach' => 'blue', 'career_coach' => 'purple', 'business_coach' => 'green', 'health_coach' => 'red', 'relationships' => 'pink', 'public_speaking' => 'orange'
            }),
