...
final class GroceryStoreResource extends Resource
{
    ...
    {
        return [
            'index' => Pages\ListGroceryStoreResource::route('/'),
            'create' => Pages\CreateGroceryStoreResource::route('/create'),
            'edit' => Pages\EditGroceryStoreResource::route('/{record}/edit'),
            'view' => Pages\ViewGroceryStoreResource::route('/{record}'),
        ];
    }
