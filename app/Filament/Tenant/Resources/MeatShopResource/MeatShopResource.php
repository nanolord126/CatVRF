...
final class MeatShopResource extends Resource
{
    ...
    {
        return [
            'index' => Pages\ListMeatShopResource::route('/'),
            'create' => Pages\CreateMeatShopResource::route('/create'),
            'edit' => Pages\EditMeatShopResource::route('/{record}/edit'),
            'view' => Pages\ViewMeatShopResource::route('/{record}'),
        ];
    }
