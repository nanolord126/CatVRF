...
final class ListDelivery extends ListRecords
{
    ...
    protected function getTableQuery(): Builder
    {
        ...
        \Illuminate\Support\Facades\Log::channel('audit')->info('Delivery ListRecords accessed', [
            'tenant_id' => $tenantId,
            'user_id' => $userId,
    ...
    public function render(): \Illuminate\Contracts\View\View {
        \Illuminate\Support\Facades\Log::channel('audit')->info('ListDelivery page rendered', [
            'user_id' => auth()->id(),
