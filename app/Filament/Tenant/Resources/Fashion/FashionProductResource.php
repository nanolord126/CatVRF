...
use Filament\Tables\{Table, Columns\TextColumn, Columns\BooleanColumn, Filters\Filter, Filters\SelectFilter, Filters\TernaryFilter, Filters\TrashedFilter};
...
use App\Filament\Tenant\Resources\Fashion\FashionProductResource\Pages\CreateFashionProduct;
use App\Filament\Tenant\Resources\Fashion\FashionProductResource\Pages\EditFashionProduct;
use App\Filament\Tenant\Resources\Fashion\FashionProductResource\Pages\ListFashionProducts;
use App\Filament\Tenant\Resources\Fashion\FashionProductResource\Pages\ViewFashionProduct;
...
final class FashionProductResource extends Resource
{
                ...
                ActionGroup::make([
                    ...
                    Action::make('verify')
                        ...
                        ->action(function ($record) {
                            ...
                            $this->logger->$this->logger->info('Fashion product verified', [
                    ...
                    Action::make('feature')
                        ...
                        ->action(function ($record) {
                            ...
                            $this->logger->$this->logger->info('Fashion product featured', [
                                'product_id' => $record->id,
                                'user_id' => $this->guard->id(),
                                'correlation_id' => $record->correlation_id,
                            ]);
                    ...
                    BulkActionGroup::make([
                        ...
                        ->action(function ($records) {
                            $records->each(function ($record) {
                                $this->logger->$this->logger->info('Fashion product bulk deleted', [
                                    'product_id' => $record->id,
                                    'user_id' => $this->guard->id(),
                                    'correlation_id' => $record->correlation_id,
                                ]);
                        ...
                        ->action(function ($records) {
                            $records->each(function ($record) {
                                ...
                                $this->logger->$this->logger->info('Fashion product activated', [
                                    'product_id' => $record->id,
                                    'user_id' => $this->guard->id(),
                                    'correlation_id' => $record->correlation_id,
                                ]);
                        ...
                        ->action(function ($records) {
                            $records->each(function ($record) {
                                $record->update(['is_verified' => true]);
                                $this->logger->$this->logger->info('Fashion product bulk verified', [
                                    'product_id' => $record->id,
                                    'user_id' => $this->guard->id(),
                                    'correlation_id' => $record->correlation_id,
                                ]);
    ...
    {
        return [
            'index' => ListFashionProducts::route('/'),
            'create' => CreateFashionProduct::route('/create'),
            'view' => ViewFashionProduct::route('/{record}'),
            'edit' => EditFashionProduct::route('/{record}/edit'),
        ];
    }
