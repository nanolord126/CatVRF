...
use App\Filament\Tenant\Resources\Fashion\Pages\CreateItem;
use App\Filament\Tenant\Resources\Fashion\Pages\EditItem;
use App\Filament\Tenant\Resources\Fashion\Pages\ListItems;
                ...
                Tables\Actions\ActionGroup::make([
                    ...
                    Action::make('feature')
                        ...
                        ->action(function ($record) {
                            ...
                            $this->logger->$this->logger->info('Clothing featured', ['item_id' => $record->id, 'correlation_id' => $record->correlation_id]);
                        })
                        ->successNotification(),
                ]),
                ])
                    ...
                    BulkActionGroup::make([
                        ...
                        ->action(function ($records) {
                            $records->each(function ($record) {
                                ...
                                $this->logger->$this->logger->info('Clothing bulk activated', ['item_id' => $record->id, 'correlation_id' => $record->correlation_id]);
                            });
                        })
