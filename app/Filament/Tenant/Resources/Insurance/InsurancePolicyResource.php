...
/**
 * InsurancePolicyResource (Filament Tenant Admin Panel).
 * Implementation: Layer 7 (UI/UX Layer).
 * Requirements: >60 lines, correlation_id, audit-log.
 * Logic: Allows business owners to manage, view, and manually issue tenant policies.
 */
