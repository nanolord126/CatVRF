...
final class CreateEventVenue extends CreateRecord
{
    ...
    protected function mutateFormDataBeforeCreate(array $data): array
    {
        ...
        $this->db->transaction(function () use (&$data, $correlationId) {
            ...
            $this->log->channel('audit')->$this->logger->info('EventVenues creation form submitted', [
    ...
    {
        $this->log->channel('audit')->$this->logger->info('EventVenues record created successfully', [
