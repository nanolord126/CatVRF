...
final class CreateEventManagement extends CreateRecord
{
    ...
    protected function mutateFormDataBeforeCreate(array $data): array
    {
        ...
        $this->db->transaction(function () use (&$data, $correlationId) {
            ...
            $this->log->channel('audit')->$this->logger->info('EventManagement creation form submitted', [
    ...
    {
        $this->log->channel('audit')->$this->logger->info('EventManagement record created successfully', [
