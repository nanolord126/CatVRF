...
use App\Filament\Tenant\Resources\EventPlanning\EventProjectResource\Pages\CreateEventProject;
use App\Filament\Tenant\Resources\EventPlanning\EventProjectResource\Pages\EditEventProject;
use App\Filament\Tenant\Resources\EventPlanning\EventProjectResource\Pages\ListEventProjects;
...
final class EventProjectResource extends Resource
{
    ...
    {
        return [
            'index' => ListEventProjects::route('/'),
            'create' => CreateEventProject::route('/create'),
            'edit' => EditEventProject::route('/{record}/edit'),
        ];
    }
}
