...
final class CreateMarketing extends CreateRecord
{
    ...
    protected function mutateFormDataBeforeCreate(array $data): array
    {
        ...
        $this->db->transaction(function () use (&$data, $correlationId) {
            ...
            $this->log->channel('audit')->$this->logger->info('Marketing creation form submitted', [
    ...
    {
        $this->log->channel('audit')->$this->logger->info('Marketing record created successfully', [
