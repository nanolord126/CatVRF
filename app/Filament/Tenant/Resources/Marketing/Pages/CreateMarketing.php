...
final class CreateMarketing extends CreateRecord
{
    ...
    protected function mutateFormDataBeforeCreate(array $data): array
    {
        ...
        $this->db->transaction(function () use (&$data, $correlationId) {
            ...
            \Illuminate\Support\Facades\Log::channel('audit')->info('Marketing creation form submitted', [
    ...
    {
        \Illuminate\Support\Facades\Log::channel('audit')->info('Marketing record created successfully', [
