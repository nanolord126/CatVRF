...
/**
 * Filament Action для запуска AI-конструктора из админки
 * CANON 2026: Dependency Injection, audit-log, user feedback
 */
final class RunAIConstructorAction extends Action
{
