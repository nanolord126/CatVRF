...
use App\Domains\Luxury\Exceptions\LuxuryServiceException;
use Illuminate\Validation\Rule;

/**
 * LuxuryBookingRequest
 *
 * Layer 4: Validation Layer (FormRequest)
 * Валидация запроса на бронирование с фрод-чеком на уровне авторизации.
 *
 * @version 1.0.0
 * @author CatVRF
 */
