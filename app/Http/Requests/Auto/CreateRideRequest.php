 ...
 * Валидация данных для создания поездки на такси.
 *
 * Rules:
 * - driver_id: required, exists in drivers/taxis table
 * - vehicle_id: required, exists in vehicles table
 * - pickup_address: required, string, max 500
 * - dropoff_address: required, string, max 500
 * - distance_km: required, integer, >= 1, <= 5000 (max 5000 км)
 * - base_price: sometimes, integer, >= 1000 (min 10₽)
 * - price_per_km: sometimes, integer, >= 100 (min 1₽)
 */
final class CreateRideRequest extends BaseApiRequest
{
