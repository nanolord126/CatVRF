...
final class ConfiguratorController extends Controller
{
    ...
    public function dashboard(): View
    {
        ...
        return $this->viewFactory->make('account.constructor.dashboard', compact('templates'));
    }
    ...
    public function show(string $slug): View
    {
        ...
        return $this->viewFactory->make('account.constructor.show', compact('template'));
    }
    ...
    public function save(Request $request): JsonResponse
    {
        ...
        try {
            ...
            $this->logger->channel('audit')->$this->logger->info('Configurator project saved', [
                'user_id' => $this->guard->id(),
