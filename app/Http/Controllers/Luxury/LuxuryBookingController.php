...
final class LuxuryBookingController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        try {
            ...
            $concierge = new ConciergeService($this->fraudControlService /* TODO: inject via constructor DI */ /* TODO: inject via DI */, $correlationId);
            ...
            $bookable = match ($validated['bookable_type']) {
                ...
                default => throw new HttpException(422'Invalid bookable type'),
            };
