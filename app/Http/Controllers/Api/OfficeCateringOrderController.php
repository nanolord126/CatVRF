...
final class OfficeCateringOrderController extends Controller
{
    ...
    public function store(StoreOrderRequest $request): JsonResponse
    {
        ...
        try {
            ...
            $this->logger->channel('audit')->$this->logger->info('OfficeCatering order created', ['order_id' => $order->id]);
    ...
    public function setupRecurring(int $id): JsonResponse
    {
        try {
            ...
            $this->logger->channel('audit')->$this->logger->info('OfficeCatering recurring setup', ['order_id' => $id]);
