...
final class ElectronicsOrderController extends Controller
{
    ...
    public function store(StoreOrderRequest $request): JsonResponse
    {
        ...
        try {
            ...
            $order->save();
            $this->logger->channel('audit')->$this->logger->info('Electronics order created', ['order_id' => $order->id]);
    ...
    public function claimWarranty(StoreWarrantyClaimRequest $request): JsonResponse
    {
        try {
            ...
            $this->logger->channel('audit')->$this->logger->info('Warranty claim created', ['claim_id' => $claim->id]);
