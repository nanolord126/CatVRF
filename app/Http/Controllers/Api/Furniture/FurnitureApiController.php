...
use App\Domains\Furniture\Services\AIInteriorConstructorService;
use App\Domains\Furniture\Services\FurnitureDomainService;
use App\Http\Requests\Furniture\FurnitureSearchRequest;
...
use Exception;
/**
 * FurnitureApiController (Layer 7/9)
 * Production API for catalog exploration and AI-powered interior construction.
 */
