...
use App\Domains\Fashion\Services\AIOutfitConstructor;
...
/**
 * FashionB2CController
 * 
 * API для конечных покупателей (B2C).
 * Реализует канон 2026: Swagger, Correlation-ID, Rate-Limiting.
 */
class FashionB2CController extends BaseApiV1Controller
{
