...
use App\Services\Legal\ConsultationService;
use App\Services\Legal\ContractService;
use App\Services\Legal\AILegalAdvisorConstructor;
use Illuminate\Http\JsonResponse;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Log;
use Illuminate\Support\Str;
/**
 * LegalApiController - Vertical LegalServices (CAR 2026)
 * Public API for legal consultations, contracts, and AI advisor matching.
 * Implements full 9-layer security and audit requirements.
 */
