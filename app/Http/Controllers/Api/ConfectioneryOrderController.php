...
final class ConfectioneryOrderController extends Controller
{
    ...
    public function store(StoreOrderRequest $request): JsonResponse
    {
        ...
        try {
            ...
            $this->logger->channel('audit')->$this->logger->info('Confectionery order created', [
                'order_id' => $order->id,
    ...
    public function markReady(int $id): JsonResponse
    {
        try {
            ...
            $this->logger->channel('audit')->$this->logger->info('Confectionery order marked ready', ['order_id' => $id]);
