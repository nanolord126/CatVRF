...
final class PharmacyOrderController extends Controller
{
    ...
    public function store(StoreOrderRequest $request): JsonResponse
    {
        ...
        try {
            ...
            $this->logger->channel('audit')->$this->logger->info('Pharmacy order created', ['order_id' => $order->id]);
    ...
    public function verifyPrescription(VerifyPrescriptionRequest $request): JsonResponse
    {
        try {
            ...
            $this->logger->channel('audit')->$this->logger->info('Prescription verified', ['prescription_id' => $request->integer('prescription_id')]);
