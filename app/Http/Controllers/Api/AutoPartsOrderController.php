...
final class AutoPartsOrderController extends Controller
{
    public function __construct(private readonly LoggerInterface $logger,
        ...
        private readonly VINCompatibilityService $service,
    ...
    public function store(StoreOrderRequest $request): JsonResponse
    {
        ...
        try {
            ...
            $this->logger->channel('audit')->$this->logger->info('AutoParts order created', ['order_id' => $order->id]);
    ...
    public function findCompatible(string $vin): JsonResponse
    {
        try {
            ...
            $this->logger->channel('audit')->$this->logger->info('AutoParts compatible search', ['vin' => $vin]);
