...
final class CarRentalApiController extends Controller
{
    ...
    public function getFleet(Request $request): JsonResponse
    {
        ...
        $this->logger->channel('audit')->$this->logger->info('[CarRentalAPI] Fleet requested', [
    ...
    public function recommend(Request $request): JsonResponse
    {
        ...
        try {
            ...
            // 3. Audit Log
            $this->logger->channel('audit')->$this->logger->info('[CarRentalAPI] AI Recommendations generated', [
                'correlation_id' => $correlationId,
