...
final class SubscriptionController extends Controller
{
    ...
    public function subscribe(Request $request): JsonResponse
    {
        ...
        try {
            ...
            $this->logger->channel('audit')->$this->logger->info('Channel subscription', [
    ...
    public function unsubscribe(Request $request): JsonResponse
    {
        ...
        try {
            ...
            $this->logger->channel('audit')->$this->logger->info('Channel unsubscription', [
                'user_id' => $this->guard->id(),
                'channel' => $channel,
                'action' => 'unsubscribe',
                'correlation_id' => $correlationId,
    ...
    public function getChannels(): JsonResponse
    {
        ...
        try {
            ...
            $this->logger->channel('audit')->$this->logger->info('Channels retrieved', [
                'user_id' => $userId,
