 ...
 * 
 * Endpoints:
 * - POST /api/v2/realtime/presence - Track presence
 * - GET /api/v2/realtime/online - Get online users
 * - DELETE /api/v2/realtime/presence - Stop tracking
 * 
 * @package App\Http\Controllers\Api\V2\Realtime
 */
final class PresenceController extends BaseApiV2Controller
{
