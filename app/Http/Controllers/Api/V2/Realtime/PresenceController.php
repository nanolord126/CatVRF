...
final class PresenceController extends Controller
{
    ...
    public function track(Request $request): JsonResponse
    {
        ...
        try {
            ...
            $this->logger->channel('audit')->$this->logger->info('Presence tracked', [
    ...
    public function getOnline(): JsonResponse
    {
        ...
        try {
            ...
            $this->logger->channel('audit')->$this->logger->info('Online users retrieved', [
                'tenant_id' => $tenantId,
    ...
    public function stopTracking(): JsonResponse
    {
        ...
        try {
            ...
            $this->logger->channel('audit')->$this->logger->info('Presence tracking stopped', [
                'user_id' => $this->guard->id(),
                'correlation_id' => $correlationId,
            ]);
