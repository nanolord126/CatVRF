...
final class MusicInstrumentController extends Controller
{
    ...
    public function store(MusicInstrumentRequest $request): JsonResponse
    {
        ...
        try {
            ...
            $this->logger->channel('audit')->$this->logger->info('New music instrument created via API', [
    ...
    public function update(MusicInstrumentRequest $request, int $id): JsonResponse
    {
        ...
        try {
            ...
            $this->logger->channel('audit')->$this->logger->info('Music instrument updated via API', [
                'instrument_id' => $id,
                'correlation_id' => $correlationId,
            ]);
    ...
    public function destroy(int $id): JsonResponse
    {
        ...
        try {
            ...
            $this->logger->channel('audit')->$this->logger->info('Music instrument deleted via API', [
                'instrument_id' => $id,
                'correlation_id' => $correlationId,
            ]);
