...
use App\Domains\Gardening\Models\GardenReview;
...
final class GardeningApiController extends Controller
{
    ...
    public function getCatalog(Request $request): JsonResponse
    {
        ...
        try {
            $this->logger->channel('audit')->$this->logger->info('Catalog requested', [
                'cid' => $correlationId,
                'ip' => $request->ip(),
    ...
    public function consultAI(Request $request): JsonResponse
    {
        ...
        try {
            ...
            $this->logger->channel('audit')->$this->logger->info('AI Consultation Success', [
                'cid' => $correlationId,
                'user_id' => $this->guard->id(),
