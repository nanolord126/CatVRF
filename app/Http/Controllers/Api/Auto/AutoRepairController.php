...
final class AutoRepairController extends Controller
{
    public function __construct(private readonly LoggerInterface $logger,
        private readonly AutoRepairService $repairService,
    ...
    public function createOrder(Request $request): JsonResponse
    {
        ...
        try {
            $this->logger->channel('audit')->$this->logger->info('Repair Order Request Received', [
                'ip' => $request->ip(),
            ...
            $this->logger->channel('audit')->error('Repair Order Creation Failed', [
                'correlation_id' => $correlationId,
                'error' => $e->getMessage(),
