...
{
    private readonly TimeSeriesHeatmapService $timeSeriesService;

    public function __construct(private readonly LoggerInterface $logger,
        TimeSeriesHeatmapService $timeSeriesService,
    ...
    public function geoTimeSeries(Request $request): JsonResponse
    {
        try {
            ...
            $this->logger->channel('audit')->$this->logger->info('[TimeSeriesHeatmap] Geo heatmap requested', [
                'tenant_id' => $tenantId,
                'vertical' => $vertical,
                'aggregation' => $aggregation,
                'correlation_id' => $correlationId,
    ...
    public function clickTimeSeries(Request $request): JsonResponse
    {
        try {
            ...
            $this->logger->channel('audit')->$this->logger->info('[TimeSeriesHeatmap] Click heatmap requested', [
                'tenant_id' => $tenantId,
                'vertical' => $vertical,
