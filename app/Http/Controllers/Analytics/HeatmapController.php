...
final class HeatmapController extends Controller
{
    ...
    public function __construct(private readonly Gate $gate,
        ...
        HeatmapGeneratorService $heatmapService,
    ...
    public function geoHeatmap(Request $request): JsonResponse
    {
        ...
        try {
            ...
            $this->logger->channel('audit')->$this->logger->info('Гео-тепловая карта запрошена', [
                'correlation_id' => (string) $correlationId,
                'user_id' => $this->guard->id(),
    ...
    public function clickHeatmap(Request $request): JsonResponse
    {
        ...
        try {
            ...
            $this->logger->channel('audit')->$this->logger->info('Клик-тепловая карта запрошена', [
                'correlation_id' => (string) $correlationId,
                'user_id' => $this->guard->id(),
