...
final class AppointmentController extends Controller
{
    ...
    public function cancel(Request $request, string $uuid): JsonResponse
    {
        ...
        try {
            ...
            $result = $this->cancellationService->calculateRefund($appointment, CarbonImmutable::now());
    ...
    public function getPolicySummary(Request $request, string $uuid): JsonResponse
    {
        try {
            ...
            $cancelPreview = $this->cancellationService->calculateRefund($appointment, CarbonImmutable::now());
