...
/**
 * CleanupExpiredCleaningOrdersJob.
 * Automated maintenance of cleaning reservations (Layer 9: Automation).
 * Releases stock and holds if final confirmation/payment is missing.
 */
