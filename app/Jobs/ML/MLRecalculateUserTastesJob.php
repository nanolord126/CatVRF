...
final class MLRecalculateUserTastesJob implements ShouldQueue
{
    ...
    {
        try {
            $this->logger->channel('audit')->$this->logger->info('Starting daily user taste profiles recalculation');
            ...
            $this->logger->channel('audit')->$this->logger->info('Daily user taste profiles recalculation completed successfully');
        } catch (Throwable $e) {
