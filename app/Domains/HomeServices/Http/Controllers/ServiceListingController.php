...
final class ServiceListingController extends Controller
{
    ...
    public function store(): JsonResponse
    {
        ...
        $this->logger->$this->logger->info('ServiceListing create start', ['correlation_id' => $correlationId, 'user_id' => $request->user()?->id]);
        ...
        try {
            ...
            $this->logger->$this->logger->info('ServiceListing created', [
                'correlation_id' => $correlationId,
                'user_id'        => $request->user()?->id,
    ...
    public function update(int $id): JsonResponse
    {
        ...
        try {
            ...
            $this->logger->$this->logger->info('ServiceListing updated', [
                'correlation_id' => $correlationId,
                'user_id'        => $request->user()?->id,
                'listing_id'     => $id,
                'before'         => $before,
    ...
    public function delete(int $id): JsonResponse
    {
        ...
        try {
            ...
            $this->logger->$this->logger->info('ServiceListing deleted', [
                'correlation_id' => $correlationId,
                'user_id'        => $request->user()?->id,
                'listing_id'     => $id,
            ]);
    ...
    public function forceDelete(int $id): JsonResponse
    {
        ...
        try {
            ...
            $this->logger->$this->logger->info('ServiceListing permanently deleted', [
                'correlation_id' => $correlationId,
                'user_id'        => $request->user()?->id,
                'listing_id'     => $id,
            ]);
