...
namespace App\Domains\HomeServices\Requests\B2B;

use Illuminate\Foundation\Http\FormRequest;

/**
 * B2B Form Request: обновление B2BHomeServiceOrder.
 *
 * CANON 2026 — Layer 7: Requests (B2B namespace).
 */
final class UpdateB2BHomeServiceOrderRequest extends FormRequest
{
