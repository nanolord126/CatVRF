...
final readonly class OrderService
{
    ...
    public function validateOrder(array $data, string $correlationId): array
    {
        ...
        if ($fraudScore > 75) {
            $this->logger->warning('HomeServices order rejected due to high fraud score', [
    ...
    {
        // HomeServices: service-based, technician scheduling
        return 'Technician scheduled within 24-48 hours';
    }
}
