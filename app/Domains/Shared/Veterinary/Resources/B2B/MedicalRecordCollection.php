...
namespace App\Domains\Veterinary\Resources\B2B;
...
/**
 * B2B API Collection: MedicalRecords.
 *
 * CANON 2026 — Layer 8: Resources (B2B namespace).
 */
final class MedicalRecordCollection extends ResourceCollection
{
    public $collects = MedicalRecordResource::class;
