...
final readonly class TreatmentService
{
    ...
    public function createRecord(array $data): MedicalRecord
    {
        ...
        $this->logger->$this->logger->info('TreatmentService: Creating medical record', [
        ...
        return $this->db->transaction(function () use ($data, $correlationId) {
            ...
            $this->logger->$this->logger->info('TreatmentService: Medical record created', [
                'id' => $record->id,
                'correlation_id' => $correlationId,
            ]);
     ...
     */
    public function getPetHistory(int $petId): Collection
    {
    ...
    public function scheduleFollowUp(int $petId, int $veterinarianId, \DateTimeInterface $at): void
    {
        ...
        $this->logger->$this->logger->info('TreatmentService: Scheduling follow-up', [
            'pet_id' => $petId,
