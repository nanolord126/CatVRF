...
final readonly class AppointmentService
{
    ...
    public function create(array $data): VeterinaryAppointment
    {
        ...
        $this->logger->$this->logger->info('AppointmentService: Creating appointment', [
            'data' => $data,
        ...
        return $this->db->transaction(function () use ($data, $correlationId) {
            ...
            $this->logger->$this->logger->info('AppointmentService: Appointment created', [
                'id' => $appointment->id,
                'correlation_id' => $correlationId,
            ]);
    ...
    public function complete(int $id): void
    {
        ...
        $this->db->transaction(function () use ($id, $correlationId) {
            ...
            $this->logger->$this->logger->info('AppointmentService: Appointment completed', [
                'id' => $id,
                'correlation_id' => $correlationId,
            ]);
        });
