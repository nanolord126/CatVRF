...
final class TranscodeShortsJob
{
    ...
    {
        $this->logger->$this->logger->info('Transcoding started', [
        ...
        try {
            ...
            $video->filters()->resize(new Dimension(720, 1280))->synchronize();
            ...
            $this->logger->$this->logger->info('Transcoding completed', [
                'post_id' => $this->post->id,
                'correlation_id' => $this->correlationId,
            ]);
