...
/**
 * KidsCenter — CatVRF 2026 Component.
 *
 ...
 *
 * @see https://catvrf.ru/docs/kidscenter
 */
...
final class KidsCenter extends Model
{
    ...
    protected $fillable = ['uuid', 'tenant_id', 'owner_id', 'correlation_id', 'name', 'address', 'age_group', 'price_kopecks_per_hour', 'rating', 'is_verified', 'tags'];

    protected $casts = ['price_kopecks_per_hour' => 'integer', 'rating' => 'float', 'is_verified' => 'boolean', 'tags' => 'json'];

    protected static function booted()
    {
        self::addGlobalScope('tenant', fn ($q) => $q->where('kids_centers.tenant_id', tenant()->id));
    }
