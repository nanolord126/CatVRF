...
/**
 * TutoringSession — CatVRF 2026 Component.
 *
 ...
 *
 * @see https://catvrf.ru/docs/tutoringsession
 */

namespace App\Domains\Education\Tutoring\Models;
...
final class TutoringSession extends Model
{
    use HasUuids;
    use SoftDeletes;
    use TenantScoped;
    ...
    protected $fillable = ['uuid', 'tenant_id', 'tutor_id', 'student_id', 'correlation_id', 'status', 'total_kopecks', 'payout_kopecks', 'payment_status', 'session_date', 'duration_hours', 'subject', 'tags'];
    ...
    {
        self::addGlobalScope('tenant', fn ($q) => $q->where('tutoring_sessions.tenant_id', tenant()->id));
    }
