 ...
 *
 * @see https://catvrf.ru/docs/tutor
 */
...
final class Tutor extends Model
{
    ...
    protected $fillable = ['uuid', 'tenant_id', 'user_id', 'correlation_id', 'name', 'subject', 'price_kopecks_per_hour', 'rating', 'is_verified', 'tags'];

    protected $casts = ['price_kopecks_per_hour' => 'integer', 'rating' => 'float', 'is_verified' => 'boolean', 'tags' => 'json'];

    protected static function booted()
    {
        self::addGlobalScope('tenant', fn ($q) => $q->where('tutors.tenant_id', tenant()->id));
    }
