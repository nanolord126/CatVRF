...
/**
 * LanguageTutor — CatVRF 2026 Component.
 *
 ...
 *
 * @see https://catvrf.ru/docs/languagetutor
 */
...
final class LanguageTutor extends Model
{
    ...
    protected $fillable = ['uuid', 'tenant_id', 'user_id', 'correlation_id', 'name', 'languages', 'price_kopecks_per_hour', 'rating', 'is_verified', 'tags'];

    protected $casts = ['languages' => 'json', 'price_kopecks_per_hour' => 'integer', 'rating' => 'float', 'is_verified' => 'boolean', 'tags' => 'json'];

    protected static function booted()
    {
        self::addGlobalScope('tenant', fn ($q) => $q->where('language_tutors.tenant_id', tenant()->id));
    }
