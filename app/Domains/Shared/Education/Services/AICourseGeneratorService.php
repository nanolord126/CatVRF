...
final readonly class AICourseGeneratorService
{
    ...
    public function generateCourseStructure(string $topic, string $level): array
    {
        ...
        $this->logger->$this->logger->info('AI Course Structure Generation Started', [
            'topic' => $topic,
            'level' => $level,
        ...
        $this->logger->$this->logger->info('AI Course Structure Generated', [
    ...
    public function generateLessonContent(int $lessonId): string
    {
        ...
        $this->logger->$this->logger->info('AI Lesson Content Generation', [
            'lesson_id' => $lessonId,
            'title' => $lesson->title,
            'correlation_id' => $correlationId,
        ]);
    ...
    public function generateQuizForStudent(int $userId, int $courseId): array
    {
        ...
        $this->logger->$this->logger->info('AI Quiz Generation for Student', [
            'user_id' => $userId,
            'course_id' => $courseId,
            'correlation_id' => $correlationId,
        ]);
