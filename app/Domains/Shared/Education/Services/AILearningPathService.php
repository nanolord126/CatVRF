...
final readonly class AILearningPathService
{
    ...
    public function constructPathForUser(int $userId, array $params): array
    {
        ...
        $this->logger->$this->logger->info('AI Learning Path Construction started', [
            'user_id' => $userId,
        ...
        $this->logger->$this->logger->info('AI Learning Path Construction completed', [
            'user_id' => $userId,
            'correlation_id' => $correlationId,
    ...
    public function enrollUserInSuggestedPath(int $userId, array $courseIds): void
    {
        ...
        $this->logger->$this->logger->info('User enrolled in AI suggested path', [
            'user_id' => $userId,
