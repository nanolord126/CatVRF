...
/**
 * DrivingLesson — CatVRF 2026 Component.
 *
 ...
 *
 * @see https://catvrf.ru/docs/drivinglesson
 */
...
final class DrivingLesson extends Model
{
    ...
    protected $fillable = ['uuid', 'tenant_id', 'school_id', 'student_id', 'correlation_id', 'status', 'total_kopecks', 'payout_kopecks', 'payment_status', 'lesson_date', 'duration_hours', 'category', 'tags'];

    protected $casts = ['total_kopecks' => 'integer', 'payout_kopecks' => 'integer', 'lesson_date' => 'datetime', 'duration_hours' => 'integer', 'tags' => 'json'];

    protected static function booted()
    {
        self::addGlobalScope('tenant', fn ($q) => $q->where('driving_lessons.tenant_id', tenant()->id));
    }
