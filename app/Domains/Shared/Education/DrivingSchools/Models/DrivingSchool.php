...
/**
 * DrivingSchool — CatVRF 2026 Component.
 *
 ...
 *
 * @see https://catvrf.ru/docs/drivingschool
 */
...
final class DrivingSchool extends Model
{
    ...
    protected $table = 'driving_schools';

    protected $fillable = ['uuid', 'tenant_id', 'owner_id', 'correlation_id', 'name', 'categories', 'price_kopecks_per_hour', 'rating', 'is_verified', 'tags'];

    protected $casts = ['categories' => 'json', 'price_kopecks_per_hour' => 'integer', 'rating' => 'float', 'is_verified' => 'boolean', 'tags' => 'json'];

    protected static function booted()
    {
        self::addGlobalScope('tenant', fn ($q) => $q->where('driving_schools.tenant_id', tenant()->id));
    }
