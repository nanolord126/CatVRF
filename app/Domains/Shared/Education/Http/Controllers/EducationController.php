...
final class EducationController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        ...
        $this->logger->$this->logger->info('Курс listed', [
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        $this->logger->$this->logger->info('Курс created', ['correlation_id' => $correlationId, 'id' => $id]);
    ...
    public function update(Request $request, int $id): JsonResponse
    {
        ...
        $this->logger->$this->logger->info('Курс updated', ['correlation_id' => $correlationId, 'id' => $id]);
    ...
    public function destroy(Request $request, int $id): JsonResponse
    {
        ...
        $this->logger->$this->logger->info('Курс deleted', ['correlation_id' => $correlationId, 'id' => $id]);
