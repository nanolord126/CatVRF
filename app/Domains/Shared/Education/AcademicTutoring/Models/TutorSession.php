...
/**
 * TutorSession — CatVRF 2026 Component.
 *
 ...
 *
 * @see https://catvrf.ru/docs/tutorsession
 */
...
final class TutorSession extends Model
{
    ...
    protected $fillable = ['uuid', 'tenant_id', 'tutor_id', 'student_id', 'correlation_id', 'status', 'total_kopecks', 'payout_kopecks', 'payment_status', 'subject', 'session_hours', 'due_date', 'tags'];

    protected $casts = ['total_kopecks' => 'integer', 'payout_kopecks' => 'integer', 'session_hours' => 'integer', 'due_date' => 'datetime', 'tags' => 'json'];

    protected static function booted()
    {
        self::addGlobalScope('tenant', fn ($q) => $q->where('tutor_sessions.tenant_id', tenant()->id));
    }
