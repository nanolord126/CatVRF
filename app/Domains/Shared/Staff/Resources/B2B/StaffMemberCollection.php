...
namespace App\Domains\Staff\Resources\B2B;
...
/**
 * B2B API Collection: StaffMembers.
 *
 * CANON 2026 — Layer 8: Resources (B2B namespace).
 */
final class StaffMemberCollection extends ResourceCollection
{
    public $collects = StaffMemberResource::class;
    ...
    public function paginationInformation(Request $request, array $paginated, array $default): array
    {
        return [
            'meta' => [
                ...
                'api_version'    => 'v1',
                'resource_type'  => 'staff_member_collection',
