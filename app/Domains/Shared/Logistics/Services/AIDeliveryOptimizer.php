...
{
    public function __construct(private readonly string $correlationId, private readonly LoggerInterface $logger)
    {
    ...
    {
        $this->logger->$this->logger->info('AI Route Optimization started', [
