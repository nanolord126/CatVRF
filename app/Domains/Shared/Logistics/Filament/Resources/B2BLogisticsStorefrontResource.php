...
final class B2BLogisticsStorefrontResource extends BaseOptimizedResource
{
    protected static ?string $model = B2BLogisticsStorefront::class;

    protected static ?string $navigationIcon = 'heroicon-o-truck';

    protected static ?string $navigationGroup = 'Logistics B2B';
