...
/**
 * ShipmentRatingPolicy — CatVRF 2026 Component.
 *
 ...
 *
 * @see https://catvrf.ru/docs/shipmentratingpolicy
 */
...
final class ShipmentRatingPolicy
{
    ...
    public function $this->viewFactory->make(User $user, ShipmentRating $rating): Response
    {
        return $this->response->allow();
    }
