...
/**
 * CourierRatingPolicy — CatVRF 2026 Component.
 *
 ...
 *
 * @see https://catvrf.ru/docs/courierratingpolicy
 */
...
final class CourierRatingPolicy
{
    ...
    public function $this->viewFactory->make(User $user, CourierRating $rating): Response
    {
        return $this->response->allow();
    }
