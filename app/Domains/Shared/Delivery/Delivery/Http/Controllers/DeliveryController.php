...
final class DeliveryController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        ...
        $this->logger->$this->logger->info('Доставка listed', [
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        $id = $this->db->transaction(function () use ($validated, $request, $correlationId) {
            ...
            if (isset($data['delivery_location'])) {
                $data['delivery_location'] = json_encode($data['delivery_location']);
            }

            return $this->db->table('delivery_orders')->insertGetId($data);
        });

        $this->logger->$this->logger->info('Доставка created', ['correlation_id' => $correlationId, 'id' => $id]);
    ...
    public function update(Request $request, int $id): JsonResponse
    {
        ...
        $this->logger->$this->logger->info('Доставка updated', ['correlation_id' => $correlationId, 'id' => $id]);
    ...
    public function destroy(Request $request, int $id): JsonResponse
    {
        ...
        $this->logger->$this->logger->info('Доставка deleted', ['correlation_id' => $correlationId, 'id' => $id]);
