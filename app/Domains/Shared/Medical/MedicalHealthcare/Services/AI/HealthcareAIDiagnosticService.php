...
use App\Domains\Shared\Medical\MedicalHealthcare\Jobs\AIDiagnosticJob;
use App\Domains\Shared\Medical\Models\MedicalAppointment;
use App\Domains\Shared\Medical\Models\Clinic;
use App\Domains\Shared\Medical\Models\Doctor;
use App\Domains\Shared\Medical\Models\MedicalRecord;
...
final class HealthcareAIDiagnosticService
{
    ...
    public function analyzeSymptomsAndDiagnose(AIDiagnosticRequestDto $dto): AIDiagnosticResultDto
    {
        ...
        // Dispatch async job for LLM call (production rule: LLM calls must be async/queued)
        $job = new AIDiagnosticJob(
            userId: $dto->userId,
            cacheKey: $cacheKey,
        ...
        // For now, keep synchronous response for backward compatibility
        // TODO: Refactor to fully async with callback/webhook
        try {
