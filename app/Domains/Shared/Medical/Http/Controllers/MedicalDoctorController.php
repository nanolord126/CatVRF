...
final class MedicalDoctorController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        try {
            ...
            $this->logger->$this->logger->info('Doctor created', ['doctor_id' => $doctor->id]);
    ...
    public function update(Request $request, int $id): JsonResponse
    {
        ...
        try {
            ...
            $this->logger->$this->logger->info('Doctor updated', ['doctor_id' => $doctor->id]);
    ...
    public function delete(int $id): JsonResponse
    {
        try {
            ...
            $this->logger->$this->logger->info('Doctor deactivated', ['doctor_id' => $doctor->id]);
