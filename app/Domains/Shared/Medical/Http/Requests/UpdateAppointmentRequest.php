...
namespace App\Domains\Shared\Medical\Http\Requests;

use Illuminate\Foundation\Http\FormRequest;
use Illuminate\Support\Str;

/**
 * Валидация запроса на обновление Appointment.
...
final class UpdateAppointmentRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'doctor_id' => 'sometimes|integer|min:1',
            'service_id' => 'sometimes|integer|min:1',
            'client_id' => 'sometimes|integer|min:1',
            'starts_at' => 'sometimes|date',
            'ends_at' => 'sometimes|date',
            'total_amount_kopecks' => 'sometimes|numeric|min:0',
        ];
    }
