...
namespace App\Domains\Shared\Medical\Filament\Resources;
...
final class B2BMedicalStorefrontResource extends BaseOptimizedResource
{
    protected static ?string $model = B2BMedicalStorefront::class;

    protected static ?string $navigationIcon = 'heroicon-o-rectangle-stack';

    protected static ?string $navigationGroup = 'Medical B2B';
