    ...
    public function createTestOrder(
        ...
        try {
            ...
            $this->db->transaction(function () use (
                ...
                TestOrderCreated::$this->bus->dispatch($testOrder, $correlationId);

                $this->logger->$this->logger->info('Medical test order created', [
    ...
    public function completeTestOrder(
        ...
        try {
            ...
            $this->db->transaction(function () use ($testOrder, $results, $correlationId) {
                ...
                $this->logger->$this->logger->info('Medical test order completed', [
                    'test_order_id' => $testOrder->id,
