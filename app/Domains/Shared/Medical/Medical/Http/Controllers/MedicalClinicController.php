...
final class MedicalClinicController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        try {
            ...
            $this->logger->$this->logger->info('Clinic created', ['clinic_id' => $clinic->id]);
    ...
    public function update(Request $request, int $id): JsonResponse
    {
        ...
        try {
            ...
            $this->logger->$this->logger->info('Clinic updated', ['clinic_id' => $clinic->id]);
    ...
    public function delete(int $id): JsonResponse
    {
        try {
            ...
            $this->logger->$this->logger->info('Clinic deleted', ['clinic_id' => $clinic->id]);
    ...
    public function verify(Request $request, int $id): JsonResponse
    {
        try {
            ...
            $this->logger->$this->logger->info('Clinic verified', ['clinic_id' => $clinic->id]);
