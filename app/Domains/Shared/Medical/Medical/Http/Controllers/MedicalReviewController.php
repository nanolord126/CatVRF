...
namespace App\Domains\Shared\Medical\Http\Controllers;
...
final class MedicalReviewController extends Controller
{
        ...
        try {
            ...
            $review = $this->db->transaction(function () use ($validated, $doctorId) {
                return MedicalReview::create([
                    ...
                    'verified_appointment' => (bool) ($validated['appointment_id'] ?? null),
                    'status' => 'pending',
                    'correlation_id' => $request->header('X-Correlation-ID') ?? \Illuminate\Support\Str::uuid(),
                ]);
            });

            $this->logger->$this->logger->info('Review created', ['review_id' => $review->id]);
    ...
    public function update(Request $request, int $id): JsonResponse
    {
        ...
        try {
            ...
            $this->logger->$this->logger->info('Review updated', ['review_id' => $review->id]);
    ...
    public function delete(int $id): JsonResponse
    {
        try {
            ...
            $this->logger->$this->logger->info('Review deleted', ['review_id' => $review->id]);
    ...
    public function markHelpful(int $id): JsonResponse
    {
        try {
            ...
            $this->logger->$this->logger->info('Review marked helpful', ['review_id' => $review->id]);
    ...
    public function approve(int $id): JsonResponse
    {
        try {
            ...
            $this->logger->$this->logger->info('Review approved', ['review_id' => $review->id]);
    ...
    public function reject(int $id): JsonResponse
    {
        try {
            ...
            $this->logger->$this->logger->info('Review rejected', ['review_id' => $review->id]);
