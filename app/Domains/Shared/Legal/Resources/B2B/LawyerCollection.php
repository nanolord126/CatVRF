...
namespace App\Domains\Legal\Resources\B2B;
...
/**
 * B2B API Collection: Lawyers.
 *
 * CANON 2026 — Layer 8: Resources (B2B namespace).
 */
final class LawyerCollection extends ResourceCollection
{
    public $collects = LawyerResource::class;
    ...
    public function paginationInformation(Request $request, array $paginated, array $default): array
    {
        return [
            'meta' => [
                ...
                'api_version'    => 'v1',
                'resource_type'  => 'lawyer_collection',
