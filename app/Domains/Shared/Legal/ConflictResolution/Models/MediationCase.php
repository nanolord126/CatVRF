...
final class MediationCase extends Model
{
    ...
    protected $fillable = ['uuid', 'tenant_id', 'specialist_id', 'client_id', 'correlation_id', 'status', 'total_kopecks', 'payout_kopecks', 'payment_status', 'case_type', 'hours_spent', 'due_date', 'tags'];
    ...
    {
        self::addGlobalScope('tenant', fn ($q) => $q->where('mediation_cases.tenant_id', tenant()->id));
    }
}
