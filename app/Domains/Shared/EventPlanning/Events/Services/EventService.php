...
namespace App\\Domains\\Shared\EventPlanning\Events\Services;
...
use Carbon\Carbon;
use App\\Domains\\Shared\EventPlanning\Events\Models\Event;
use App\\Domains\\Shared\EventPlanning\Events\Models\Ticket;
use App\\Domains\\Shared\EventPlanning\Events\Models\TicketOrder;
...
final readonly class EventService
{
    ...
    public function buyTickets(int $eventId, int $quantity, string $correlationId = ''): TicketOrder
    {
        ...
        return $this->db->transaction(function () use ($eventId, $quantity, $correlationId, $userId): TicketOrder {
            ...
            $this->logger->$this->logger->info('Tickets purchased', [
                'order_id' => $order->id,
                'event_id' => $eventId,
                'correlation_id' => $correlationId,
            ]);
    ...
    public function settleEventPayouts(int $eventId, string $correlationId = ''): void
    {
        ...
        $this->db->transaction(function () use ($eventId, $correlationId): void {
            ...
            $this->audit->log(
                ...
                subjectType: $this->eventDispatcher->class,
                subjectId: $eventId,
            ...
            $this->logger->$this->logger->info('Event payouts settled', [
                'event_id' => $eventId,
