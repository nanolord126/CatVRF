...
namespace App\\Domains\\Shared\EventPlanning\Karaoke\Services;

use App\\Domains\\Shared\EventPlanning\Karaoke\Models\KaraokeBooking;
...
final readonly class KaraokeService
{
    ...
    public function createBooking(
        ...
        return $this->db->transaction(function () use ($clubId, $bookingDate, $durationHours, $roomNumber, $priceKopecks, $correlationId, $userId): KaraokeBooking {
            ...
            $this->logger->$this->logger->info('Karaoke booking created', [
