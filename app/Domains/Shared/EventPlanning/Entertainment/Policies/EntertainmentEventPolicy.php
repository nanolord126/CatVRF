...
/**
 * EntertainmentEventPolicy — CatVRF 2026 Component.
 *
 ...
 *
 * @see https://catvrf.ru/docs/entertainmenteventpolicy
 */
...
final class EntertainmentEventPolicy
{
    ...
    public function $this->viewFactory->make(User $user, EntertainmentEvent $event): Response
    {
        return $this->response->allow();
    }
