...
/**
 * EventPlanner — CatVRF 2026 Component.
 *
 ...
 *
 * @see https://catvrf.ru/docs/eventplanner
 */
...
final class EventPlanner extends Model
{
    ...
    protected $fillable = ['uuid', 'tenant_id', 'user_id', 'correlation_id', 'name', 'event_types', 'price_kopecks_per_event', 'rating', 'is_verified', 'tags'];

    protected $casts = ['event_types' => 'json', 'price_kopecks_per_event' => 'integer', 'rating' => 'float', 'is_verified' => 'boolean', 'tags' => 'json'];

    protected static function booted()
    {
        self::addGlobalScope('tenant', fn ($q) => $q->where('event_planners.tenant_id', tenant()->id));
    }
