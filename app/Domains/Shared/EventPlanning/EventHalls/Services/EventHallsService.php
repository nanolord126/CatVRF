...
namespace App\\Domains\\Shared\EventPlanning\EventHalls\Services;

use App\\Domains\\Shared\EventPlanning\EventHalls\Models\HallBooking;
...
final readonly class EventHallsService
{
    ...
    public function createBooking(
        ...
        return $this->db->transaction(function () use ($hallId, $bookingDate, $durationHours, $eventType, $priceKopecks, $correlationId, $userId): HallBooking {
            ...
            $this->logger->$this->logger->info('Event hall booking created', [
     ...
     */
    public function getUserBookings(int $clientId, int $limit = 10): Collection
    {
