...
namespace App\Domains\Shared\Insurance\Requests\B2B;

use Illuminate\Foundation\Http\FormRequest;

/**
 * B2B Form Request: создание InsuranceCompany.
 *
 * CANON 2026 — Layer 7: Requests (B2B namespace).
 */
final class CreateInsuranceCompanyRequest extends FormRequest
{
