...
namespace App\Domains\Shared\Insurance\Services;
...
final readonly class OrderService
{
    ...
    {
        // Insurance vertical: 10% for B2C, 8% for B2B
    ...
    public function validateOrder(array $data, string $correlationId): array
    {
        ...
        if ($fraudScore > 90) {
            $this->logger->warning('Insurance order rejected due to high fraud score', [
    ...
    {
        // Insurance: service-based, instant digital policy
        return 'Instant digital policy activation';
    }
}
