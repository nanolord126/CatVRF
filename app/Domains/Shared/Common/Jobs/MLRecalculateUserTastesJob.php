...
final class MLRecalculateUserTastesJob
{
    ...
    public function handle(): void
    {
        try {
            ...
            $this->logger->$this->logger->info('MLRecalculateUserTastesJob started', [
            ...
            foreach ($profiles as $profile) {
                ...
                if ($processed % 100 === 0) {
                    $this->logger->$this->logger->info('MLRecalculateUserTastesJob progress', [
                        'processed' => $processed,
            ...
            // 3. Итоговый отчёт
            $this->logger->$this->logger->info('MLRecalculateUserTastesJob completed', [
                'processed' => $processed,
                'successful' => $successful,
                'failed' => $failed,
                'execution_time' => new DateTime()->diffInSeconds(new DateTime()),
                'correlation_id' => $correlationId,
            ]);
        } catch (Exception $e) {
