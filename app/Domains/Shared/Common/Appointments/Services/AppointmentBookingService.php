...
final readonly class AppointmentBookingService
{
    ...
    {
        $this->logger->$this->logger->info('Attempting to create appointment', [
        ...
        return $this->db->transaction(function () use ($data) {
            ...
            $this->logger->$this->logger->info('Appointment created successfully', [
    ...
    public function confirmAppointment(int $id): bool
    {
        return $this->db->transaction(function () use ($id) {
            ...
            $this->logger->$this->logger->info('Appointment confirmed', [
                'appointment_id' => $id,
                'correlation_id' => $this->correlationId,
            ]);
    ...
    public function completeAppointment(int $id): bool
    {
        return $this->db->transaction(function () use ($id) {
            ...
            $this->logger->$this->logger->info('Appointment completed', [
                'appointment_id' => $id,
                'correlation_id' => $this->correlationId,
            ]);
    ...
    public function cancelAppointment(int $id, string $reason = ''): bool
    {
        return $this->db->transaction(function () use ($id, $reason) {
            ...
            $this->logger->$this->logger->info('Appointment cancelled', [
                'appointment_id' => $id,
                'reason' => $reason,
                'correlation_id' => $this->correlationId,
            ]);
