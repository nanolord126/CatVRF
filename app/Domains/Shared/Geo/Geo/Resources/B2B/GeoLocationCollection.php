...
namespace App\Domains\Geo\Resources\B2B;
...
/**
 * B2B API Collection: GeoLocations.
 *
 * CANON 2026 — Layer 8: Resources (B2B namespace).
 */
final class GeoLocationCollection extends ResourceCollection
{
    public $collects = GeoLocationResource::class;
    ...
    public function paginationInformation(Request $request, array $paginated, array $default): array
    {
        return [
            'meta' => [
                ...
                'api_version'    => 'v1',
                'resource_type'  => 'geo_location_collection',
