...
final class GeoController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        ...
        $this->logger->$this->logger->info('Гео-зона listed', [
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        $this->logger->$this->logger->info('Гео-зона created', ['correlation_id' => $correlationId, 'id' => $id]);
    ...
    public function update(Request $request, int $id): JsonResponse
    {
        ...
        $this->logger->$this->logger->info('Гео-зона updated', ['correlation_id' => $correlationId, 'id' => $id]);
    ...
    public function destroy(Request $request, int $id): JsonResponse
    {
        ...
        $this->logger->$this->logger->info('Гео-зона deleted', ['correlation_id' => $correlationId, 'id' => $id]);
