...
final class SyncShipmentTrackingJob implements ShouldQueue
{
    ...
    {
        $this->logger->$this->logger->info('SyncShipmentTrackingJob запущен', [
        ...
        // $this->eventDispatcher->dispatch(new CourierLocationUpdatedEvent(...));

        $this->logger->$this->logger->info('SyncShipmentTrackingJob завершён', [
            'correlation_id' => $this->correlationId,
