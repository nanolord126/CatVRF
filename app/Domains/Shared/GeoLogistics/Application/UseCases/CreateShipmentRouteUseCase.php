...
final readonly class CreateShipmentRouteUseCase
{
    public function __construct(
        private readonly GeoRoutingServiceInterface $geoRoutingService,
    ...
    {
        $this->logger->$this->logger->info('Начало создания логистического маршрута', [
        ...
        return $this->db->transaction(function () use ($dto, $route, $cost) {
            ...
            $this->logger->$this->logger->info('Логистический маршрут успешно материализован', [
                'correlation_id' => $dto->correlationId,
