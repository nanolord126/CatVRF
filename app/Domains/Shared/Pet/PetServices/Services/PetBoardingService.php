...
final readonly class PetBoardingService
{
    ...
    {
        $this->logger->$this->logger->info('PetBoardingService: Creating boarding reservation', [
    ...
    public function confirmBoardingReservation(int $reservationId): bool
    {
        ...
        $this->logger->$this->logger->info('PetBoardingService: Confirming boarding reservation', [
    ...
    public function checkInPet(int $reservationId): bool
    {
        ...
        $this->logger->$this->logger->info('PetBoardingService: Pet check-in', [
            'correlation_id' => $reservation->correlation_id,
            'reservation_id' => $reservationId,
        ]);
        ...
        $this->db->transaction(function () use ($reservation) {
            $reservation->update([
                'status' => 'checked_in',
                'actual_check_in' => CarbonImmutable::now(),
            ]);
    ...
    public function checkOutPet(int $reservationId, array $notes = []): bool
    {
        ...
        $this->logger->$this->logger->info('PetBoardingService: Pet check-out', [
            'correlation_id' => $reservation->correlation_id,
            'reservation_id' => $reservationId,
        ]);
        ...
        $this->db->transaction(function () use ($reservation, $notes) {
            $reservation->update([
                'status' => 'completed',
                'actual_check_out' => CarbonImmutable::now(),
    ...
    public function cancelReservation(int $reservationId, string $reason = ''): bool
    {
        ...
        $this->logger->$this->logger->info('PetBoardingService: Cancelling reservation', [
            'correlation_id' => $reservation->correlation_id,
            'reservation_id' => $reservationId,
            'reason' => $reason,
        ]);
