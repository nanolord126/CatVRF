...
final class CalculateClinicEarningsJob implements ShouldQueue
{
    ...
    {
        $logger->$this->logger->info('CalculateClinicEarningsJob: Starting earnings calculation', [
        ...
        try {
            ...
            $logger->$this->logger->info('CalculateClinicEarningsJob: Earnings calculated successfully', [
                'clinic_id' => $this->clinicId,
    ...
    {
        $this->loggerInterface /* TODO: inject via constructor DI */ /* TODO: inject via DI */  // failed() no method injection->error('pet job failed', [
