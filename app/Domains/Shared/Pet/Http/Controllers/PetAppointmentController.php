...
final class PetAppointmentController extends Controller
{
    ...
    public function update(Request $request, $id): JsonResponse
    {
        ...
        try {
            ...
            $this->logger->$this->logger->info('Pet appointment updated', [
                'correlation_id' => $correlationId,
    ...
    public function destroy($id): JsonResponse
    {
        ...
        try {
            ...
            $this->logger->$this->logger->info('Pet appointment deleted', [
                'correlation_id' => $correlationId,
                'appointment_id' => $appointment->id,
                'tenant_id'      => $appointment->tenant_id,
                'user_id'        => $request->user()?->id,
    ...
    public function createMedicalRecord(Request $request): JsonResponse
    {
        try {
            ...
            $this->logger->$this->logger->info('Pet medical record created', [
                'correlation_id' => $correlationId,
                'record_id'      => $record->id,
