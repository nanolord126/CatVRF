...
final class Pet extends Model
{
    ...
    public function getAgeMonths(): int
    {
        ...
        return (int) Carbon::parse($this->birth_date)->diffInMonths(CarbonImmutable::now());
    }
    ...
    public function needsVaccination(): bool
    {
        ...
        $latest = new Collection($history)->sortByDesc('date')->first();
        if (! $latest) {
            return true;
        }
        ...
        return $vaccDate->diffInMonths(CarbonImmutable::now()) >= 12;
    }
    ...
    public function hasAllergy(string $ingredient): bool
    {
        ...
        return in_array($ingredient, $allergies, true);
    }
    ...
    protected static function booted(): void
    {
        ...
        self::creating(function (Pet $model) {
