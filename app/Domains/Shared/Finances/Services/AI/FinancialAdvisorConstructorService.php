 ...
 * correlation_id + fraud-check + $this->db->transaction + Redis TTL 3600
 */
final readonly class FinancialAdvisorConstructorService
{
    ...
    public function analyzeAndRecommend(
        ...
        $this->logger->$this->logger->info('FinancialAdvisorConstructorService used', [
            'user_id'        => $userId,
            'vertical'       => 'finances',
    ...
    private function parseAnalysis(string $analysisText): array
    {
        ...
        return [
            ...
            'parsed_at'    => CarbonImmutable::now()->toIso8601String(),
            'confidence'   => 0.85,
        ];
    }
