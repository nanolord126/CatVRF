 ...
 * Все мутации только через доменные сервисы с fraud-check + $this->db->transaction.
 */
final class Payout
{
    /**
    ...
    public function __construct(private readonly DatabaseManager $db,
        ...
        private readonly ?CarbonImmutable $processedAt,
    ...
    public function transitionTo(PayoutStatus $newStatus): void
    {
        ...
        if ($newStatus === PayoutStatus::COMPLETED) {
            $this->processedAt = CarbonImmutable::createFromTimestamp(CarbonImmutable::now()->getTimestamp());
        }
    }
