...
use App\Models\User;
use Modules\Bonuses\Interfaces\Filament\Resources\BonusResource\Pages\CreateBonus;
use Modules\Bonuses\Interfaces\Filament\Resources\BonusResource\Pages\EditBonus;
use Modules\Bonuses\Interfaces\Filament\Resources\BonusResource\Pages\ListBonuses;
...
final class BonusResource extends Resource
{
        ...
        return $form
            ->schema([
                Forms\Components\Select::make('user_id')
                    ->label('User')
                    ->options(User::query()->limit(1000)->pluck('name', 'id'))
                    ->searchable()
                    ->required()
    ...
    {
        return [
            'index' => ListBonuses::class,
            'create' => CreateBonus::class,
            'edit' => EditBonus::class,
        ];
    }
}
