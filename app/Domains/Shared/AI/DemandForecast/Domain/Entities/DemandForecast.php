...
final class DemandForecast
{
    ...
    public function getForecastDate(): DateTimeImmutable
    {
    ...
    {
        return $this->predictedDemand->getAmount();
    }

    public function getConfidenceIntervalLower(): int
    {
        return $this->confidenceIntervalLower;
    }

    public function getConfidenceIntervalUpper(): int
    {
