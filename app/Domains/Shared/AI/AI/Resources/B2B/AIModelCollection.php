...
namespace App\Domains\AI\Resources\B2B;
...
/**
 * B2B API Collection: AIModels.
 *
 * CANON 2026 — Layer 8: Resources (B2B namespace).
 */
final class AIModelCollection extends ResourceCollection
{
    ...
    public function paginationInformation(Request $request, array $paginated, array $default): array
    {
        return [
            'meta' => [
                ...
                'api_version'    => 'v1',
                'resource_type'  => 'a_i_model_collection',
