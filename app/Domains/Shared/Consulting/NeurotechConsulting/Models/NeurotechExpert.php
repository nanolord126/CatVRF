...
/**
 * NeurotechExpert — CatVRF 2026 Component.
 *
 ...
 *
 * @see https://catvrf.ru/docs/neurotechexpert
 */
...
final class NeurotechExpert extends Model
{
    use HasUuids;
    use SoftDeletes;
    use TenantScoped;
    ...
    protected $table = 'neurotech_experts';
    ...
    {
        self::addGlobalScope('tenant', fn ($q) => $q->where('neurotech_experts.tenant_id', tenant()->id));
    }
