...
/**
 * StorageSubscription — CatVRF 2026 Component.
 *
 ...
 *
 * @see https://catvrf.ru/docs/storagesubscription
 */
...
final class StorageSubscription extends Model
{
    ...
    protected $fillable = ['uuid', 'tenant_id', 'provider_id', 'user_id', 'correlation_id', 'status', 'total_kopecks', 'payout_kopecks', 'payment_status', 'plan_type', 'start_date', 'end_date', 'storage_gb', 'tags'];

    protected $casts = ['total_kopecks' => 'integer', 'payout_kopecks' => 'integer', 'start_date' => 'datetime', 'end_date' => 'datetime', 'storage_gb' => 'integer', 'tags' => 'json'];

    protected static function booted()
    {
        self::addGlobalScope('tenant', fn ($q) => $q->where('storage_subscriptions.tenant_id', tenant()->id));
    }
