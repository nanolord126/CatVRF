...
/**
 * StorageProvider — CatVRF 2026 Component.
 *
 ...
 *
 * @see https://catvrf.ru/docs/storageprovider
 */
...
final class StorageProvider extends Model
{
    ...
    protected $fillable = ['uuid', 'tenant_id', 'owner_id', 'correlation_id', 'name', 'storage_gb', 'price_kopecks_per_month', 'rating', 'is_verified', 'tags'];

    protected $casts = ['storage_gb' => 'integer', 'price_kopecks_per_month' => 'integer', 'rating' => 'float', 'is_verified' => 'boolean', 'tags' => 'json'];

    protected static function booted()
    {
        self::addGlobalScope('tenant', fn ($q) => $q->where('storage_providers.tenant_id', tenant()->id));
    }
