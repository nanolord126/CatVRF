...
/**
 * QAProject — CatVRF 2026 Component.
 *
 ...
 *
 * @see https://catvrf.ru/docs/qaproject
 */
...
final class QAProject extends Model
{
    ...
    protected $table = 'qa_projects';

    protected $fillable = ['uuid', 'tenant_id', 'tester_id', 'client_id', 'correlation_id', 'status', 'total_kopecks', 'payout_kopecks', 'payment_status', 'project_type', 'testing_hours', 'due_date', 'tags'];

    protected $casts = ['total_kopecks' => 'integer', 'payout_kopecks' => 'integer', 'testing_hours' => 'integer', 'due_date' => 'datetime', 'tags' => 'json'];

    protected static function booted()
    {
        self::addGlobalScope('tenant', fn ($q) => $q->where('qa_projects.tenant_id', tenant()->id));
    }
