...
/**
 * ConsultantSession — CatVRF 2026 Component.
 *
 ...
 *
 * @see https://catvrf.ru/docs/consultantsession
 */
...
final class ConsultantSession extends Model
{
    use HasUuids;
    use SoftDeletes;
    use TenantScoped;
    ...
    protected $table = 'consultant_sessions';

    protected $fillable = ['uuid', 'tenant_id', 'consultant_id', 'client_id', 'correlation_id', 'status', 'total_kopecks', 'payout_kopecks', 'payment_status', 'session_date', 'duration_hours', 'topic', 'tags'];
    ...
    {
        self::addGlobalScope('tenant', fn ($q) => $q->where('consultant_sessions.tenant_id', tenant()->id));
    }
