...
/**
 * BusinessConsultant — CatVRF 2026 Component.
 *
 ...
 *
 * @see https://catvrf.ru/docs/businessconsultant
 */
...
final class BusinessConsultant extends Model
{
    ...
    protected $table = 'business_consultants';

    protected $fillable = ['uuid', 'tenant_id', 'user_id', 'correlation_id', 'name', 'expertise', 'price_kopecks_per_hour', 'rating', 'is_verified', 'tags'];

    protected $casts = ['price_kopecks_per_hour' => 'integer', 'rating' => 'float', 'is_verified' => 'boolean', 'tags' => 'json'];

    protected static function booted()
    {
        self::addGlobalScope('tenant', fn ($q) => $q->where('business_consultants.tenant_id', tenant()->id));
    }
