...
/**
 * ConsultingEngagement — CatVRF 2026 Component.
 *
 ...
 *
 * @see https://catvrf.ru/docs/consultingengagement
 */
...
final class ConsultingEngagement extends Model
{
    ...
    protected $table = 'consulting_engagements';

    protected $fillable = ['uuid', 'tenant_id', 'consultant_id', 'client_id', 'correlation_id', 'status', 'total_kopecks', 'payout_kopecks', 'payment_status', 'engagement_type', 'consultation_hours', 'due_date', 'tags'];
    ...
    {
        self::addGlobalScope('tenant', fn ($q) => $q->where('consulting_engagements.tenant_id', tenant()->id));
    }
