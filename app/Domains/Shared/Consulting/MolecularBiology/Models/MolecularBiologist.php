...
/**
 * MolecularBiologist — CatVRF 2026 Component.
 *
 ...
 *
 * @see https://catvrf.ru/docs/molecularbiologist
 */
...
final class MolecularBiologist extends Model
{
    ...
    protected $table = 'molecular_biologists';
    ...
    {
        self::addGlobalScope('tenant', fn ($q) => $q->where('molecular_biologists.tenant_id', tenant()->id));
    }
