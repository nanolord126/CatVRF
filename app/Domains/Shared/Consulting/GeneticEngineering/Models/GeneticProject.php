...
/**
 * GeneticProject — CatVRF 2026 Component.
 *
 ...
 *
 * @see https://catvrf.ru/docs/geneticproject
 */

namespace App\Domains\Consulting\GeneticEngineering\Models;
...
final class GeneticProject extends Model
{
    use HasUuids;
    use SoftDeletes;
    use TenantScoped;
    ...
    protected $table = 'genetic_projects';
    ...
    {
        self::addGlobalScope('tenant', fn ($q) => $q->where('genetic_projects.tenant_id', tenant()->id));
    }
