...
/**
 * ImprovementInitiative — CatVRF 2026 Component.
 *
 ...
 *
 * @see https://catvrf.ru/docs/improvementinitiative
 */
...
final class ImprovementInitiative extends Model
{
    ...
    protected $table = 'improvement_initiatives';
    ...
    {
        self::addGlobalScope('tenant', fn ($q) => $q->where('improvement_initiatives.tenant_id', tenant()->id));
    }
