...
/**
 * FinancialPlan — CatVRF 2026 Component.
 *
 ...
 *
 * @see https://catvrf.ru/docs/financialplan
 */
...
final class FinancialPlan extends Model
{
    ...
    protected $fillable = ['uuid', 'tenant_id', 'advisor_id', 'client_id', 'correlation_id', 'status', 'total_kopecks', 'payout_kopecks', 'payment_status', 'plan_type', 'planning_hours', 'due_date', 'tags'];

    protected $casts = ['total_kopecks' => 'integer', 'payout_kopecks' => 'integer', 'planning_hours' => 'integer', 'due_date' => 'datetime', 'tags' => 'json'];

    protected static function booted()
    {
        self::addGlobalScope('tenant', fn ($q) => $q->where('financial_plans.tenant_id', tenant()->id));
    }
