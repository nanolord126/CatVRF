...
namespace App\Domains\Consulting\StrategicPlanning\Models;
...
final class StrategyProject extends Model
{
    ...
    protected $fillable = ['uuid', 'tenant_id', 'planner_id', 'client_id', 'correlation_id', 'status', 'total_kopecks', 'payout_kopecks', 'payment_status', 'project_type', 'hours_spent', 'due_date', 'tags'];
