...
/**
 * IoTProject — CatVRF 2026 Component.
 *
 ...
 *
 * @see https://catvrf.ru/docs/iotproject
 */

namespace App\Domains\Consulting\IoTConsulting\Models;
...
final class IoTProject extends Model
{
    use HasUuids;
    use SoftDeletes;
    use TenantScoped;
    ...
    {
        self::addGlobalScope('tenant', fn ($q) => $q->where('iot_projects.tenant_id', tenant()->id));
    }
