...
/**
 * PerformanceCoach — CatVRF 2026 Component.
 *
 ...
 *
 * @see https://catvrf.ru/docs/performancecoach
 */
...
final class PerformanceCoach extends Model
{
    ...
    protected $table = 'performance_coaches';
    ...
    {
        self::addGlobalScope('tenant', fn ($q) => $q->where('performance_coaches.tenant_id', tenant()->id));
    }
