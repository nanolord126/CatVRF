...
/**
 * ControlProject — CatVRF 2026 Component.
 *
 ...
 *
 * @see https://catvrf.ru/docs/controlproject
 */
...
final class ControlProject extends Model
{
    ...
    protected $table = 'control_projects';
    ...
    {
        self::addGlobalScope('tenant', fn ($q) => $q->where('control_projects.tenant_id', tenant()->id));
    }
