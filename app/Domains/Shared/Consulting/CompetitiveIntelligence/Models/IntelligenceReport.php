...
/**
 * IntelligenceReport — CatVRF 2026 Component.
 *
 ...
 *
 * @see https://catvrf.ru/docs/intelligencereport
 */
...
final class IntelligenceReport extends Model
{
    ...
    protected $fillable = ['uuid', 'tenant_id', 'analyst_id', 'client_id', 'correlation_id', 'status', 'total_kopecks', 'payout_kopecks', 'payment_status', 'report_type', 'analysis_hours', 'due_date', 'tags'];

    protected $casts = ['total_kopecks' => 'integer', 'payout_kopecks' => 'integer', 'analysis_hours' => 'integer', 'due_date' => 'datetime', 'tags' => 'json'];

    protected static function booted()
    {
        self::addGlobalScope('tenant', fn ($q) => $q->where('intelligence_reports.tenant_id', tenant()->id));
    }
