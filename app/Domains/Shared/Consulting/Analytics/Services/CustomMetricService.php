...
final readonly class CustomMetricService
{
    ...
    public function getGeoCustomMetric(
        ...
        try {
            ...
            $this->logger->$this->logger->info('Geo custom metric calculated', [
                'correlation_id' => $this->correlationId,
                'tenant_id' => $tenantId,
                'metric_type' => $metricType,
                'aggregation' => $aggregation,
    ...
    public function getClickCustomMetric(
        ...
        try {
            ...
            $this->logger->$this->logger->info('Click custom metric calculated', [
                'correlation_id' => $this->correlationId,
                'tenant_id' => $tenantId,
                'metric_type' => $metricType,
                'page_url' => $pageUrl,
    ...
    public function invalidateCache(int $tenantId): void
    {
        ...
        $this->logger->$this->logger->info('Custom metric cache invalidated', [
            'correlation_id' => $this->correlationId,
            'tenant_id' => $tenantId,
        ]);
    }
