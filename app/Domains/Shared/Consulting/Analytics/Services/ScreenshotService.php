...
final class ScreenshotService
{
     ...
     */
    private readonly int $puppeteerTimeout = 30000;
     ...
     */
    private readonly string $cacheTag = 'screenshots';

    /**
     * @var array URLs whitelist for security (SSRF prevention)
     */
    private readonly array $urlWhitelist = [];
    ...
    public function capturePageScreenshot(
        ...
        try {
            ...
            $this->logger->$this->logger->info('Capturing new page screenshot', [
                'url' => $url,
                'tenant_id' => $tenantId,
            ...
            $this->logger->$this->logger->info('Page screenshot captured and cached', [
                'url' => $url,
                'tenant_id' => $tenantId,
            ...
            return \array_merge($screenshotMetadata, [
                'cached' => false,
                'expires_at' => \CarbonImmutable::now()->addSeconds($this->cacheTtl)->toIso8601String(),
                'correlation_id' => $correlationId,
            ]);
    ...
    public function invalidateAllScreenshots(
        ...
        try {
            ...
            $this->logger->$this->logger->info('All tenant screenshots invalidated', [
                'tenant_id' => $tenantId,
                'correlation_id' => $correlationId,
            ]);
    ...
    private function validateUrl(string $url): void
    {
        ...
        // Prevent localhost/private readonly IPs
