...
final readonly class HeatmapGeneratorService
{
    ...
    public function generateGeoHeatmap(
        ...
        try {
            ...
            $this->logger->$this->logger->info('Гео-тепловая карта сгенерирована', [
                'tenant_id' => $tenantId,
                'vertical' => $vertical,
    ...
    public function generateClickHeatmap(
        ...
        try {
            ...
            $this->logger->$this->logger->info('Клик-тепловая карта сгенерирована', [
                'page_url' => $pageUrl,
    ...
    public function invalidateCache(?int $tenantId = null, ?string $vertical = null): void
    {
        ...
        $this->logger->$this->logger->info('Кэш тепловых карт инвалидирован', [
            'tenant_id' => $tenantId,
            'vertical' => $vertical,
            'correlation_id' => $this->request->header('X-Correlation-ID', $this->correlationId ?? ''),
        ]);
