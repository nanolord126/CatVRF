...
final class HeatmapController extends Controller
{
    ...
    public function geoHeatmap(Request $request): JsonResponse
    {
        ...
        try {
            ...
            $this->logger->$this->logger->info('Geo-heatmap data requested', [
    ...
    public function clickHeatmap(Request $request): JsonResponse
    {
        ...
        try {
            ...
            $this->logger->$this->logger->info('Click-heatmap data requested', [
                'tenant_id' => $validated['tenant_id'],
    ...
    public function getScreenshot(Request $request): JsonResponse
    {
        ...
        try {
            ...
            $this->logger->$this->logger->info('Page screenshot requested', [
                'tenant_id' => $validated['tenant_id'],
                'page_url' => $validated['page_url'],
                'correlation_id' => $correlationId,
            ]);
    ...
    public function exportGeoHeatmapPng(Request $request): JsonResponse
    {
        ...
        try {
            ...
            $this->logger->$this->logger->info('Geo-heatmap PNG export requested', [
                'tenant_id' => $validated['tenant_id'],
