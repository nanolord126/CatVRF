...
/**
 * BiotechProject — CatVRF 2026 Component.
 *
 ...
 *
 * @see https://catvrf.ru/docs/biotechproject
 */
...
final class BiotechProject extends Model
{
    use HasUuids;
    use SoftDeletes;
    use TenantScoped;
    ...
    protected $table = 'biotech_projects';
    ...
    {
        self::addGlobalScope('tenant', fn ($q) => $q->where('biotech_projects.tenant_id', tenant()->id));
    }
