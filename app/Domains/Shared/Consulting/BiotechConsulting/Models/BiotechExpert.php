...
/**
 * BiotechExpert — CatVRF 2026 Component.
 *
 ...
 *
 * @see https://catvrf.ru/docs/biotechexpert
 */
...
final class BiotechExpert extends Model
{
    ...
    protected $table = 'biotech_experts';
    ...
    {
        self::addGlobalScope('tenant', fn ($q) => $q->where('biotech_experts.tenant_id', tenant()->id));
    }
