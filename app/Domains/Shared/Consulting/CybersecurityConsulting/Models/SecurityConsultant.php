...
/**
 * SecurityConsultant — CatVRF 2026 Component.
 *
 ...
 *
 * @see https://catvrf.ru/docs/securityconsultant
 */
...
final class SecurityConsultant extends Model
{
    use HasUuids;
    use SoftDeletes;
    use TenantScoped;
    ...
    protected $table = 'security_consultants';
    ...
    {
        self::addGlobalScope('tenant', fn ($q) => $q->where('security_consultants.tenant_id', tenant()->id));
    }
