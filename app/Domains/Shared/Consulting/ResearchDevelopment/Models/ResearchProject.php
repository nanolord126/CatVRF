...
/**
 * ResearchProject — CatVRF 2026 Component.
 *
 ...
 *
 * @see https://catvrf.ru/docs/researchproject
 */

namespace App\Domains\Consulting\ResearchDevelopment\Models;
...
final class ResearchProject extends Model
{
    ...
    {
        self::addGlobalScope('tenant', fn ($q) => $q->where('research_projects.tenant_id', tenant()->id));
    }
