...
/**
 * HREngagement — CatVRF 2026 Component.
 *
 ...
 *
 * @see https://catvrf.ru/docs/hrengagement
 */
...
final class HREngagement extends Model
{
    ...
    protected $table = 'hr_engagements';

    protected $fillable = ['uuid', 'tenant_id', 'specialist_id', 'client_id', 'correlation_id', 'status', 'total_kopecks', 'payout_kopecks', 'payment_status', 'service_type', 'consultation_hours', 'due_date', 'tags'];
    ...
    {
        self::addGlobalScope('tenant', fn ($q) => $q->where('hr_engagements.tenant_id', tenant()->id));
    }
