...
/**
 * RoboticsProject — CatVRF 2026 Component.
 *
 ...
 *
 * @see https://catvrf.ru/docs/roboticsproject
 */

namespace App\Domains\Consulting\RoboticsSystems\Models;
...
final class RoboticsProject extends Model
{
    use HasUuids;
    use SoftDeletes;
    use TenantScoped;
    ...
    protected $table = 'robotics_projects';
    ...
    {
        self::addGlobalScope('tenant', fn ($q) => $q->where('robotics_projects.tenant_id', tenant()->id));
    }
