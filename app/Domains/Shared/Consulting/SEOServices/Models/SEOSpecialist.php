...
/**
 * SEOSpecialist — CatVRF 2026 Component.
 *
 ...
 *
 * @see https://catvrf.ru/docs/seospecialist
 */
...
final class SEOSpecialist extends Model
{
    ...
    protected $table = 'seo_specialists';

    protected $fillable = ['uuid', 'tenant_id', 'user_id', 'correlation_id', 'name', 'specialties', 'price_kopecks_per_month', 'rating', 'is_verified', 'tags'];

    protected $casts = ['specialties' => 'json', 'price_kopecks_per_month' => 'integer', 'rating' => 'float', 'is_verified' => 'boolean', 'tags' => 'json'];

    protected static function booted()
    {
        self::addGlobalScope('tenant', fn ($q) => $q->where('seo_specialists.tenant_id', tenant()->id));
    }
