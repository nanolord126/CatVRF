...
/**
 * BrandProject — CatVRF 2026 Component.
 *
 ...
 *
 * @see https://catvrf.ru/docs/brandproject
 */

namespace App\Domains\Consulting\BrandStrategy\Models;
...
final class BrandProject extends Model
{
    use HasUuids;
    use SoftDeletes;
    use TenantScoped;
    ...
    protected $table = 'brand_projects';

    protected $fillable = ['uuid', 'tenant_id', 'strategist_id', 'client_id', 'correlation_id', 'status', 'total_kopecks', 'payout_kopecks', 'payment_status', 'project_type', 'consultation_hours', 'due_date', 'tags'];
    ...
    {
        self::addGlobalScope('tenant', fn ($q) => $q->where('brand_projects.tenant_id', tenant()->id));
    }
