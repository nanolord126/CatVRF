...
/**
 * OperationsManager — CatVRF 2026 Component.
 *
 ...
 *
 * @see https://catvrf.ru/docs/operationsmanager
 */
...
final class OperationsManager extends Model
{
    ...
    protected $table = 'operations_managers';
    ...
    {
        self::addGlobalScope('tenant', fn ($q) => $q->where('operations_managers.tenant_id', tenant()->id));
    }
