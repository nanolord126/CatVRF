...
/**
 * InternetProject — CatVRF 2026 Component.
 *
 ...
 *
 * @see https://catvrf.ru/docs/internetproject
 */

namespace App\Domains\Consulting\InternetServices\Models;
...
final class InternetProject extends Model
{
    use HasUuids;
    use SoftDeletes;
    use TenantScoped;
    ...
    protected $table = 'internet_projects';

    protected $fillable = ['uuid', 'tenant_id', 'consultant_id', 'client_id', 'correlation_id', 'status', 'total_kopecks', 'payout_kopecks', 'payment_status', 'project_type', 'consultation_hours', 'due_date', 'tags'];
    ...
    {
        self::addGlobalScope('tenant', fn ($q) => $q->where('internet_projects.tenant_id', tenant()->id));
    }
