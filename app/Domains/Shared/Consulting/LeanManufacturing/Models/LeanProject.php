...
/**
 * LeanProject — CatVRF 2026 Component.
 *
 ...
 *
 * @see https://catvrf.ru/docs/leanproject
 */
...
final class LeanProject extends Model
{
    use HasUuids;
    use SoftDeletes;
    use TenantScoped;
    ...
    {
        self::addGlobalScope('tenant', fn ($q) => $q->where('lean_projects.tenant_id', tenant()->id));
    }
