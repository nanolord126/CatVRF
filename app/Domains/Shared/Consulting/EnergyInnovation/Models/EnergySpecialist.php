...
/**
 * EnergySpecialist — CatVRF 2026 Component.
 *
 ...
 *
 * @see https://catvrf.ru/docs/energyspecialist
 */
...
final class EnergySpecialist extends Model
{
    use HasUuids;
    use SoftDeletes;
    use TenantScoped;
    ...
    protected $table = 'energy_specialists';
    ...
    {
        self::addGlobalScope('tenant', fn ($q) => $q->where('energy_specialists.tenant_id', tenant()->id));
    }
