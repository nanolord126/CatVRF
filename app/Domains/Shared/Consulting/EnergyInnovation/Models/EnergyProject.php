...
/**
 * EnergyProject — CatVRF 2026 Component.
 *
 ...
 *
 * @see https://catvrf.ru/docs/energyproject
 */

namespace App\Domains\Consulting\EnergyInnovation\Models;
...
final class EnergyProject extends Model
{
    use HasUuids;
    use SoftDeletes;
    use TenantScoped;
    ...
    protected $table = 'energy_projects';
    ...
    {
        self::addGlobalScope('tenant', fn ($q) => $q->where('energy_projects.tenant_id', tenant()->id));
    }
