...
/**
 * MaterialsProject — CatVRF 2026 Component.
 *
 ...
 *
 * @see https://catvrf.ru/docs/materialsproject
 */
...
final class MaterialsProject extends Model
{
    use HasUuids;
    use SoftDeletes;
    use TenantScoped;
    ...
    {
        self::addGlobalScope('tenant', fn ($q) => $q->where('materials_projects.tenant_id', tenant()->id));
    }
