...
/**
 * MaterialsEngineer — CatVRF 2026 Component.
 *
 ...
 *
 * @see https://catvrf.ru/docs/materialsengineer
 */
...
final class MaterialsEngineer extends Model
{
    ...
    protected $table = 'materials_engineers';
    ...
    {
        self::addGlobalScope('tenant', fn ($q) => $q->where('materials_engineers.tenant_id', tenant()->id));
    }
