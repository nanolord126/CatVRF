...
/**
 * RetentionSpecialist — CatVRF 2026 Component.
 *
 ...
 *
 * @see https://catvrf.ru/docs/retentionspecialist
 */
...
final class RetentionSpecialist extends Model
{
    use HasUuids;
    use SoftDeletes;
    use TenantScoped;
    ...
    protected $table = 'retention_specialists';
    ...
    {
        self::addGlobalScope('tenant', fn ($q) => $q->where('retention_specialists.tenant_id', tenant()->id));
    }
