...
/**
 * StrategyProject — CatVRF 2026 Component.
 *
 ...
 *
 * @see https://catvrf.ru/docs/strategyproject
 */
...
final class StrategyProject extends Model
{
    ...
    protected $fillable = ['uuid', 'tenant_id', 'strategist_id', 'client_id', 'correlation_id', 'status', 'total_kopecks', 'payout_kopecks', 'payment_status', 'project_type', 'strategy_hours', 'due_date', 'tags'];

    protected $casts = ['total_kopecks' => 'integer', 'payout_kopecks' => 'integer', 'strategy_hours' => 'integer', 'due_date' => 'datetime', 'tags' => 'json'];

    protected static function booted()
    {
        self::addGlobalScope('tenant', fn ($q) => $q->where('strategy_projects.tenant_id', tenant()->id));
    }
