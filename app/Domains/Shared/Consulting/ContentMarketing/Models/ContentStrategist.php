...
/**
 * ContentStrategist — CatVRF 2026 Component.
 *
 ...
 *
 * @see https://catvrf.ru/docs/contentstrategist
 */
...
final class ContentStrategist extends Model
{
    ...
    protected $table = 'content_strategists';
    ...
    {
        self::addGlobalScope('tenant', fn ($q) => $q->where('content_strategists.tenant_id', tenant()->id));
    }
