...
/**
 * SuccessionPlan — CatVRF 2026 Component.
 *
 ...
 *
 * @see https://catvrf.ru/docs/successionplan
 */

namespace App\Domains\Consulting\SuccessionPlanning\Models;
...
final class SuccessionPlan extends Model
{
    ...
    protected $fillable = ['uuid', 'tenant_id', 'planner_id', 'client_id', 'correlation_id', 'status', 'total_kopecks', 'payout_kopecks', 'payment_status', 'plan_type', 'hours_spent', 'due_date', 'tags'];

    protected $casts = ['total_kopecks' => 'integer', 'payout_kopecks' => 'integer', 'hours_spent' => 'integer', 'due_date' => 'datetime', 'tags' => 'json'];

    protected static function booted()
    {
        self::addGlobalScope('tenant', fn ($q) => $q->where('succession_plans.tenant_id', tenant()->id));
    }
