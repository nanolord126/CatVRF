...
/**
 * ConsultingSession — CatVRF 2026 Component.
 *
 ...
 *
 * @see https://catvrf.ru/docs/consultingsession
 */
...
final class ConsultingSession extends Model
{
    ...
    {
        self::addGlobalScope('tenant', fn ($q) => $q->where('consulting_sessions.tenant_id', tenant()->id));
    }
