...
/**
 * BlockchainProject — CatVRF 2026 Component.
 *
 ...
 *
 * @see https://catvrf.ru/docs/blockchainproject
 */
...
final class BlockchainProject extends Model
{
    ...
    protected $table = 'blockchain_projects';
    ...
    {
        self::addGlobalScope('tenant', fn ($q) => $q->where('blockchain_projects.tenant_id', tenant()->id));
    }
