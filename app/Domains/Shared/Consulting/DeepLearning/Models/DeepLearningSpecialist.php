...
/**
 * DeepLearningSpecialist — CatVRF 2026 Component.
 *
 ...
 *
 * @see https://catvrf.ru/docs/deeplearningspecialist
 */
...
final class DeepLearningSpecialist extends Model
{
    use HasUuids;
    use SoftDeletes;
    use TenantScoped;
    ...
    protected $table = 'deep_learning_specialists';
    ...
    {
        self::addGlobalScope('tenant', fn ($q) => $q->where('deep_learning_specialists.tenant_id', tenant()->id));
    }
