...
/**
 * DeepLearningProject — CatVRF 2026 Component.
 *
 ...
 *
 * @see https://catvrf.ru/docs/deeplearningproject
 */
...
final class DeepLearningProject extends Model
{
    ...
    protected $table = 'deep_learning_projects';
    ...
    {
        self::addGlobalScope('tenant', fn ($q) => $q->where('deep_learning_projects.tenant_id', tenant()->id));
    }
