...
/**
 * HRProject — CatVRF 2026 Component.
 *
 ...
 *
 * @see https://catvrf.ru/docs/hrproject
 */
...
final class HRProject extends Model
{
    use HasUuids;
    use SoftDeletes;
    use TenantScoped;
    ...
    {
        self::addGlobalScope('tenant', fn ($q) => $q->where('hr_projects.tenant_id', tenant()->id));
    }
