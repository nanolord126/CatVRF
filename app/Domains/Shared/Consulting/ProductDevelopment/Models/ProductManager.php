...
/**
 * ProductManager — CatVRF 2026 Component.
 *
 ...
 *
 * @see https://catvrf.ru/docs/productmanager
 */
...
final class ProductManager extends Model
{
    ...
    {
        self::addGlobalScope('tenant', fn ($q) => $q->where('product_managers.tenant_id', tenant()->id));
    }
