...
/**
 * ProductProject — CatVRF 2026 Component.
 *
 ...
 *
 * @see https://catvrf.ru/docs/productproject
 */
...
final class ProductProject extends Model
{
    use HasUuids;
    use SoftDeletes;
    use TenantScoped;
    ...
    {
        self::addGlobalScope('tenant', fn ($q) => $q->where('product_projects.tenant_id', tenant()->id));
    }
