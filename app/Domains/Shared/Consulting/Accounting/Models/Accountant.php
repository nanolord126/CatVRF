...
/**
 * Accountant — CatVRF 2026 Component.
 *
 ...
 *
 * @see https://catvrf.ru/docs/accountant
 */
...
final class Accountant extends Model
{
    ...
    protected $fillable = ['uuid', 'tenant_id', 'user_id', 'correlation_id', 'name', 'specialization', 'price_kopecks_per_service', 'rating', 'is_verified', 'tags'];

    protected $casts = ['price_kopecks_per_service' => 'integer', 'rating' => 'float', 'is_verified' => 'boolean', 'tags' => 'json'];

    protected static function booted()
    {
        self::addGlobalScope('tenant', fn ($q) => $q->where('accountants.tenant_id', tenant()->id));
    }
