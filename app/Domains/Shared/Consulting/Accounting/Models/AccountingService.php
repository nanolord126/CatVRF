...
/**
 * AccountingService — CatVRF 2026 Component.
 *
 ...
 *
 * @see https://catvrf.ru/docs/accountingservice
 */
...
final class AccountingService extends Model
{
    ...
    protected $fillable = ['uuid', 'tenant_id', 'accountant_id', 'client_id', 'correlation_id', 'status', 'total_kopecks', 'payout_kopecks', 'payment_status', 'service_type', 'request_date', 'tags'];

    protected $casts = ['total_kopecks' => 'integer', 'payout_kopecks' => 'integer', 'request_date' => 'datetime', 'tags' => 'json'];

    protected static function booted()
    {
        self::addGlobalScope('tenant', fn ($q) => $q->where('accounting_services.tenant_id', tenant()->id));
    }
