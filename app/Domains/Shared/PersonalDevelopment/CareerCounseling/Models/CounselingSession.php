...
final class CounselingSession extends Model
{
    ...
    protected $fillable = ['uuid', 'tenant_id', 'counselor_id', 'client_id', 'correlation_id', 'status', 'total_kopecks', 'payout_kopecks', 'payment_status', 'session_type', 'session_hours', 'due_date', 'tags'];
    ...
    {
        self::addGlobalScope('tenant', fn ($q) => $q->where('counseling_sessions.tenant_id', tenant()->id));
    }
}
