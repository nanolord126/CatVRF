...
final readonly class PricingService
{
     ...
     * @return int Копейки
     */
    public function calculateFinalPrice(Program $program, User $user): int
    {
        ...
        $this->logger->$this->logger->info('PD Pricing: Final price calculated', [
     ...
     */
    private function isB2BUser(User $user): bool
    {
