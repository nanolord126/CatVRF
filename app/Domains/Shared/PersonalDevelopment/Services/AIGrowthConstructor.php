...
final readonly class AIGrowthConstructor
{
    ...
    {
        $this->logger->$this->logger->info('AI Growth Constructor: Starting roadmap generation', [
            'user_id' => $userId,
            'goals' => $goals,
        ...
        $this->logger->$this->logger->info('AI Growth Constructor: Roadmap generated successfully', [
            'user_id' => $userId,
            'correlation_id' => $this->correlationId,
        ]);
