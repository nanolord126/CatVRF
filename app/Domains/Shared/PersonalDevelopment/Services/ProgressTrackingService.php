...
final readonly class ProgressTrackingService
{
    ...
    {
        $this->logger->$this->logger->info('PD Progress: Adding new milestone', [
    ...
    public function completeMilestone(Milestone $milestone): void
    {
        ...
        $this->db->transaction(function () use ($milestone) {
            ...
            $this->logger->$this->logger->info('PD Progress: Milestone completed', [
            ...
            if ($milestone->enrollment->progress_percent >= 100) {
                ...
                $this->logger->$this->logger->info('PD Progress: Enrollment fully completed!', [
                    'enrollment_uuid' => $milestone->enrollment->uuid,
                    'correlation_id' => $this->correlationId,
                ]);
            }
