 ...
 * @version 2026.04.17
 */
final class HandleSignificantFeatureDrift implements ShouldQueue
{
    public int $tries = 3;
    ...
    public function handle(SignificantFeatureDriftDetected $event): void
    {
        ...
        $this->log->channel('audit')->critical('Significant feature drift detected', [
            'vertical' => $vertical,
        ...
        $this->log->$this->logger->info('Significant feature drift handled', [
            'vertical' => $vertical,
            'correlation_id' => $event->correlationId,
        ]);
    }
    ...
    private function sendAlert(array $driftResult, string $correlationId): void
    {
        ...
        $this->log->alert('ALERT: Significant feature drift detected', [
            'vertical' => $vertical,
    ...
    private function triggerShadowMode(string $vertical, string $correlationId): void
    {
        ...
        $this->log->$this->logger->info('Shadow mode triggered for vertical', [
            'vertical' => $vertical,
            'correlation_id' => $correlationId,
