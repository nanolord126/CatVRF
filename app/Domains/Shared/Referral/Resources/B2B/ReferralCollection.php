...
namespace App\Domains\Referral\Resources\B2B;
...
/**
 * B2B API Collection: Referrals.
 *
 * CANON 2026 — Layer 8: Resources (B2B namespace).
 */
final class ReferralCollection extends ResourceCollection
{
    ...
    public function paginationInformation(Request $request, array $paginated, array $default): array
    {
        return [
            'meta' => [
                ...
                'api_version'    => 'v1',
                'resource_type'  => 'referral_collection',
