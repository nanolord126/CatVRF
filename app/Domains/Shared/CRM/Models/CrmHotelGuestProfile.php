...
use Database\Factories\CRM\CrmHotelGuestProfileFactory;
...
final class CrmHotelGuestProfile extends Model
{
    ...
    protected static function newFactory(): CrmHotelGuestProfileFactory
    {
        return CrmHotelGuestProfileFactory::new();
    }
