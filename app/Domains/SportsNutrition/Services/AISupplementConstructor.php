...
use App\Domains\SportsNutrition\DTOs\AISupplementRequestDto;
...
/**
 * AISupplementConstructor (Layer 4/9).
 * AI-driven analysis for goal-based supplement recommendations.
 * Uses biometrics (weight, age), training goals, and dietary restrictions.
 */
class AISupplementConstructor
{
