...
namespace App\Domains\Sports\Resources\B2B;
...
/**
 * B2B API Collection: B2BModelses.
 *
 * CANON 2026 — Layer 8: Resources (B2B namespace).
 */
final class B2BModelsCollection extends ResourceCollection
{
    public $collects = B2BModelsResource::class;
    ...
    public function paginationInformation(Request $request, array $paginated, array $default): array
    {
        return [
            'meta' => [
                ...
                'api_version'    => 'v1',
                'resource_type'  => 'b2_b_models_collection',
