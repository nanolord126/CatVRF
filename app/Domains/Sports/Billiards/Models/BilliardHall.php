...
/**
 * BilliardHall — CatVRF 2026 Component.
 *
 ...
 * @see https://catvrf.ru/docs/billiardhall
 */
...
final class BilliardHall extends Model
{
    ...
    protected $casts = ['price_kopecks_per_hour' => 'integer', 'table_count' => 'integer', 'rating' => 'float', 'tags' => 'json'];

    protected static function booted()
    {
        static::addGlobalScope('tenant', fn ($q) => $q->where('billiard_halls.tenant_id', tenant()->id));
    }
