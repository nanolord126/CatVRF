...
/**
 * PersonalTrainer — CatVRF 2026 Component.
 *
 ...
 * @see https://catvrf.ru/docs/personaltrainer
 */
...
final class PersonalTrainer extends Model
{
    ...
    {
        static::addGlobalScope('tenant', fn ($q) => $q->where('personal_trainers.tenant_id', tenant()->id));
    }
