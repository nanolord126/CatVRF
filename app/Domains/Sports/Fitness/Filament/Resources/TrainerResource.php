...
final class TrainerResource extends Model
{
    use HasFactory;
    ...
    protected static ?string $model = Trainer::class;
        ...
        {
            return [
                'index' => \App\Domains\Sports\Fitness\Filament\Resources\TrainerResource\Pages\ListTrainers::route('/'),
                'create' => \App\Domains\Sports\Fitness\Filament\Resources\TrainerResource\Pages\CreateTrainer::route('/create'),
                'edit' => \App\Domains\Sports\Fitness\Filament\Resources\TrainerResource\Pages\EditTrainer::route('/{record}/edit'),
            ];
        }
