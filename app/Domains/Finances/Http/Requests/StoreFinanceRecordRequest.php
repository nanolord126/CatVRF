...
/**
 * Валидация создания финансовой записи.
 *
 * CANON CatVRF 2026 — Layer 4 (Requests).
 * final, authorize(), rules(), messages().
 */
final class StoreFinanceRecordRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'type'              => ['required', 'string', 'in:income,expense,transfer,payout,commission'],
    ...
    {
        return [
            'name.required'   => 'Название финансовой записи обязательно.',
            'name.max'        => 'Название не может быть длиннее 255 символов.',
            'type.required'   => 'Тип финансовой записи обязателен.',
