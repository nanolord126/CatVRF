...
final readonly class OrderService
{
    ...
    public function validateOrder(array $data, string $correlationId): array
    {
        ...
        if ($fraudScore > 90) {
            $this->logger->warning('Finances order rejected due to high fraud score', [
    ...
    {
        // Finances: service-based, instant digital processing
        return 'Instant digital financial processing';
    }
}
