...
final class TicketSaleController
{
    public function __construct(private readonly EventDispatcher $eventDispatcher,
        ...
        private readonly TicketSalesService $salesService,
    ...
    public function purchase(int $eventId): JsonResponse
    {
        try {
            ...
            TicketGenerationJob::$this->bus->dispatch($sale->id, $correlationId);

            $this->logger->$this->logger->info('Ticket purchase initiated', [
                'event_id' => $eventId,
    ...
    public function refund(int $id): JsonResponse
    {
        try {
            ...
            $this->logger->$this->logger->info('Ticket sale refunded', [
                'sale_id' => $id,
                'reason' => $reason,
                'correlation_id' => $correlationId,
            ]);
