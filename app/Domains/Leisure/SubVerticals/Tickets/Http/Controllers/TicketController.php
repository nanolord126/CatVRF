...
{
    public function __construct(private readonly TicketGenerationService $generationService, private readonly LoggerInterface $logger) {}
    ...
    public function checkin(int $eventId): JsonResponse
    {
        try {
            ...
            $this->logger->$this->logger->info('Ticket checked in', [
                'event_id' => $eventId,
