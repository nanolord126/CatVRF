...
final class EventController
{
    ...
    {
        try {
            $events = $this->eventDispatcher->where('status', 'published')
    ...
    {
        try {
            $event = $this->eventDispatcher->with(['organizer', 'ticketTypes', 'reviews', 'sales'])
                ->findOrFail($id);
    ...
    public function store(): JsonResponse
    {
        ...
        try {
            $this->authorize('create', $this->eventDispatcher->class);
            ...
            $this->logger->$this->logger->info('Event created', [
                'event_id' => $event->id,
                'correlation_id' => $correlationId,
            ]);
    ...
    public function update(int $id): JsonResponse
    {
        ...
        try {
            $event = $this->eventDispatcher->findOrFail($id);
            ...
            $this->logger->$this->logger->info('Event updated', [
                'event_id' => $event->id,
                'correlation_id' => $correlationId,
            ]);
    ...
    public function delete(int $id): JsonResponse
    {
        try {
            ...
            $this->logger->$this->logger->info('Event deleted', [
                'event_id' => $id,
                'correlation_id' => $correlationId,
            ]);
