...
namespace App\Domains\Leisure\SubVerticals\Tickets\Listeners;
...
final class DeductTicketSaleCommissionListener
{
    ...
    {
        try {
            $this->logger->$this->logger->info('Deducting ticket sale commission', [
            ...
            $this->db->transaction(function () use ($event) {
                $wallet = Wallet::where('tenant_id', $event->ticketSale->tenant_id)
                ...
                $this->logger->$this->logger->info('Ticket sale commission deducted', [
                    'wallet_id' => $wallet->id,
