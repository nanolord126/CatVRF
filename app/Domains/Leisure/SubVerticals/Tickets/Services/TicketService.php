...
use App\Services\PromoCampaignService;
...
final readonly class TicketService
{
    ...
    public function __construct(private readonly EventDispatcher $eventDispatcher,
        private readonly TicketFraudService $ticketFraud,
        private readonly FraudControlService $fraud,
        private readonly WalletService $wallet,
        private readonly PromoCampaignService $promo,
    ...
    {
        $this->logger->$this->logger->info('Ticket purchase initiated', $dto->toArray());
        ...
        return $this->db->transaction(function () use ($dto) {
            ...
            $event = $this->eventDispatcher->findOrFail($dto->eventId);
            ...
            $this->wallet->debit($dto->userId, $totalPrice, BalanceTransactionType::WITHDRAWAL, $dto, null, null, [
            ...
            $this->logger->$this->logger->info('Ticket purchase completed', [
    ...
    public function checkIn(string $qrCode, int $checkerUserId, array $requestData = []): array
    {
        ...
        return $this->db->transaction(function () use ($ticket, $checkerUserId, $requestData, $correlationId) {
            ...
            $this->logger->$this->logger->info('Ticket check-in success', [
                'ticket_id' => $ticket->id,
                'qr' => $ticket->qr_code,
    ...
    public function cancelTicket(int $ticketId, string $reason = 'manual'): void
    {
        $this->db->transaction(function () use ($ticketId, $reason) {
            ...
            $this->logger->$this->logger->info('Ticket cancelled', [
                'id' => $ticketId,
                'reason' => $reason,
