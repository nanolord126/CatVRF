...
final readonly class OrderService
{
    ...
    public function validateOrder(array $data, string $correlationId): array
    {
        ...
        if ($fraudScore > 85) {
            $this->logger->warning('Tickets order rejected due to high fraud score', [
    ...
    {
        // Tickets: service-based, instant digital e-ticket
        return 'Instant digital e-ticket delivery';
    }
}
