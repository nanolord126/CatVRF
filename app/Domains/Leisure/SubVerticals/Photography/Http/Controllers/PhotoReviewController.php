...
final class PhotoReviewController extends Controller
{
    ...
    public function store(int $sessionId, Request $request): JsonResponse
    {
        ...
        try {
            ...
            $this->db->transaction(function () use ($sessionId, $validated, $correlationId) {
                ...
                $this->logger->$this->logger->info('Photography: Review created', [
                    'review_id' => $review->id,
                    'rating' => $validated['rating'],
                    'correlation_id' => $correlationId,
                ]);
    ...
    public function update(int $id, Request $request): JsonResponse
    {
        ...
        try {
            ...
            $this->logger->$this->logger->info('Photography: Review updated', [
                'review_id' => $id,
                'correlation_id' => Str::uuid(),
            ]);
    ...
    public function destroy(int $id): JsonResponse
    {
        ...
        try {
            ...
            $this->logger->$this->logger->info('Photography: Review deleted', [
                'review_id' => $id,
                'correlation_id' => Str::uuid(),
            ]);
    ...
    public function markHelpful(int $id): JsonResponse
    {
        try {
            ...
            $this->db->transaction(function () use ($review) {
                ...
                $this->logger->$this->logger->info('Photography: Review marked helpful', [
                    'review_id' => $review->id,
                    'correlation_id' => Str::uuid(),
                ]);
            });
