...
final readonly class VendorManagementService
{
    ...
    {
        $this->logger->$this->logger->info('VendorMgmt: Registering vendor', [
    ...
    {
        $this->logger->$this->logger->info('VendorMgmt: Adding review', [
    ...
    {
        $this->logger->$this->logger->info('VendorMgmt: Verifying vendor', [
            'vendor_uuid' => $vendor->uuid,
