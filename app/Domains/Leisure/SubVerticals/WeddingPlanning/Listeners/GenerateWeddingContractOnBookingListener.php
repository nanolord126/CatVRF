...
final class GenerateWeddingContractOnBookingListener
{
    ...
    public function handle(object $event): void
    {
        ...
        $this->logger->$this->logger->info('Generating wedding contract [Listener Start]', [
        ...
        try {
            ...
            if ($existingContract) {
                $this->logger->$this->logger->info('Contract already exists for booking', [
                    'booking_id' => $booking->id,
            ...
            $this->logger->$this->logger->info('Wedding contract successfully generated (Draft)', [
