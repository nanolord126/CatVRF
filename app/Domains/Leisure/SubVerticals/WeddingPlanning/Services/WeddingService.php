...
namespace App\Domains\Leisure\SubVerticals\WeddingPlanning\Services;
...
final readonly class WeddingService
{
    ...
    {
        $this->logger->$this->logger->info('WeddingService: Initiating wedding creation', [
        ...
        return $this->db->transaction(function () use ($data) {
            ...
            $this->logger->$this->logger->info('WeddingService: Wedding created successfully', [
    ...
    {
        $this->logger->$this->logger->info('WeddingService: Booking service', [
            'event_uuid' => $event->uuid,
    ...
    {
        $this->logger->$this->logger->info('WeddingService: Status update', [
            'event_uuid' => $event->uuid,
