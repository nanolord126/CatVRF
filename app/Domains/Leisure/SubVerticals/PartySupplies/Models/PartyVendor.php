...
/**
 * PartyVendor — CatVRF 2026 Component.
 *
 ...
 *
 * @see https://catvrf.ru/docs/partyvendor
 */
...
final class PartyVendor extends Model
{
    ...
    {
        self::addGlobalScope('tenant', fn ($q) => $q->where('party_vendors.tenant_id', tenant()->id));
    }
}
