...
namespace App\Domains\Leisure\SubVerticals\Flowers\Services\AI;
...
final readonly class FlowersConstructorService
{
    ...
    public function analyzeAndRecommend(array $payload, int $userId): array
    {
        ...
        return $this->cache->remember($cacheKey, CarbonImmutable::now()->addHour(), function () use ($payload, $userId, $correlationId): array {
            ...
            $this->logger->$this->logger->info('Flowers AI constructor used', [
                'user_id'        => $userId,
