...
final readonly class AIBouquetConstructorService
{
    ...
    public function recommendBouquet(array $params, int $userId): array
    {
        ...
        $this->logger->$this->logger->info('AI Bouquet Recommendation Started', [
            'user_id' => $userId,
        ...
        $this->logger->$this->logger->info('AI Bouquet Recommendation Finished', [
            'user_id' => $userId,
    ...
    public function saveAIRecommendationAsTemplate(
        ...
        return $this->db->transaction(function () use ($aiResult, $shopId, $tenantId, $correlationId): Bouquet {
            ...
            $this->logger->$this->logger->info('AI Recommendation saved as template', [
    ...
    public function analyzeBouquetPhoto(
        ...
        $this->logger->$this->logger->info('Flower Bouquet Photo Analysis finished', [
            'user_id' => $userId,
            'correlation_id' => $correlationId,
        ]);
