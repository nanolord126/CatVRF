...
final class FlowerProductController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        ...
        try {
            ...
            $this->logger->$this->logger->info('Flower products listed', [
    ...
    public function show(int $id): JsonResponse
    {
        ...
        try {
            ...
            $this->logger->$this->logger->info('Flower product viewed', [
    ...
    public function search(Request $request): JsonResponse
    {
        ...
        try {
            ...
            $this->logger->$this->logger->info('Flower products searched', [
                'query' => $query,
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        try {
            ...
            $product = $this->db->transaction(function () use ($validated, $shop, $correlationId, $tenantId) {
                ...
                $this->logger->$this->logger->info('Flower product created', [
                    'product_id' => $product->id,
                    'shop_id' => $shop->id,
                    'correlation_id' => $correlationId,
                ]);
    ...
    public function update(int $id, Request $request): JsonResponse
    {
        ...
        try {
            ...
            $product = $this->db->transaction(function () use ($product, $validated, $correlationId) {
                ...
                $this->logger->$this->logger->info('Flower product updated', [
                    'product_id' => $product->id,
                    'correlation_id' => $correlationId,
                ]);
    ...
    public function destroy(int $id, Request $request): JsonResponse
    {
        ...
        try {
            ...
            $this->db->transaction(function () use ($product, $correlationId) {
                ...
                $this->logger->$this->logger->info('Flower product deleted', [
                    'product_id' => $product->id,
                    'correlation_id' => $correlationId,
                ]);
            });
