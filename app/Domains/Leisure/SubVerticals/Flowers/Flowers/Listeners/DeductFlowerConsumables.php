    ...
    public function handle(FlowerOrderCreated $event): void
    {
        ...
        $this->db->transaction(function () use ($order, $correlationId) {
            ...
            foreach ($items as $item) {
                if (isset($item['product_id'], $item['quantity'])) {
                    ...
                    if ($product) {
                        ...
                        $this->logger->$this->logger->info('Flower Inventory Deducted', [
            ...
            if ($packaging) {
                ...
                $this->logger->$this->logger->info('Flower Consumable Deducted', [
            ...
            if ($ribbon) {
                ...
                $this->logger->$this->logger->info('Flower Ribbon Consumable Deducted', [
