...
namespace App\Domains\Leisure\SubVerticals\Flowers\Requests\B2B;

use Illuminate\Foundation\Http\FormRequest;

/**
 * B2B Form Request: обновление B2BFlowerOrder.
 *
 * CANON 2026 — Layer 7: Requests (B2B namespace).
 */
final class UpdateB2BFlowerOrderRequest extends FormRequest
{
