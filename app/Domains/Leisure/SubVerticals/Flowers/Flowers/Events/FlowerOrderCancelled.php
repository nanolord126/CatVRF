...
/**
 * FlowerOrderCancelled — CatVRF 2026 Component.
 *
 ...
 *
 * @see https://catvrf.ru/docs/flowerordercancelled
 */

namespace App\Domains\Leisure\SubVerticals\Flowers\Events;

use Illuminate\Foundation\Events\Dispatchable;
use Illuminate\Queue\SerializesModels;

final class FlowerOrderCancelled
{
    use Dispatchable;
