...
namespace App\Domains\Leisure\SubVerticals\ToysAndGames\Jobs;
...
final class ProcessToyProductJob implements ShouldQueue
{
    ...
    {
        $ToyProduct::findOrFail($this->modelId);

        $this->logger->$this->logger->info('ProcessToyProductJob processed', [
            'model_id' => $model->id,
