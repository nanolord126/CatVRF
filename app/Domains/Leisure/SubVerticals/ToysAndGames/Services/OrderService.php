...
final readonly class OrderService
{
    ...
    public function validateOrder(array $data, string $correlationId): array
    {
        ...
        if ($fraudScore > 75) {
            $this->logger->warning('ToysAndGames order rejected due to high fraud score', [
    ...
    {
        // ToysAndGames: product-based, physical delivery
        return '3-7 business days (physical delivery)';
    }
}
