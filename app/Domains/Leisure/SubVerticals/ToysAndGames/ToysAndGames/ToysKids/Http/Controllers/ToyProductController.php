...
namespace App\Domains\Leisure\SubVerticals\ToysAndGames\ToysAndGames\ToysKids\Http\Controllers;
...
final class ToyProductController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        ...
        $this->logger->$this->logger->info('Toys listed', ['correlation_id' => $correlationId, 'count' => $toys->total()]);
    ...
    public function wishlist(Request $request): JsonResponse
    {
        ...
        $this->logger->$this->logger->info('Toy added to wishlist', ['correlation_id' => $correlationId, 'product_id' => $validated['product_id']]);
    ...
    public function order(Request $request): JsonResponse
    {
        ...
        $this->logger->$this->logger->info('Toy order created', ['correlation_id' => $correlationId, 'id' => $id]);
