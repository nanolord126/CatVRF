...
namespace App\Domains\Leisure\SubVerticals\ToysAndGames\Toys\Controllers;
...
final class ToyAPIController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        ...
        $this->logger->$this->logger->info('Toy Search Request', [
            'cid' => $correlationId,
            'params' => $request->all(),
    ...
    public function aiConsult(Request $request): JsonResponse
    {
        ...
        $this->logger->$this->logger->info('AI Consultation Started', [
            'cid' => $correlationId,
