...
namespace App\Domains\Leisure\SubVerticals\ToysAndGames\Toys\Jobs;
...
final class ToyStockSyncJob
{
    ...
    /**
     * @var int Max attempts for inventory sync.
     */
    public int $tries = 3;
    ...
    public function handle(): void
    {
        ...
        $this->logger->$this->logger->info('Toy Stock Sync Started', [
        ...
        $this->logger->$this->logger->info('Toy Stock Sync Completed Successfully', [
