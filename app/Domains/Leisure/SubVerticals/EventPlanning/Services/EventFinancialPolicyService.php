...
final readonly class EventFinancialPolicyService
{
    ...
    public function calculateRequiredPrepayment(Event $event): int
    {
        ...
        $this->logger->$this->logger->info('Financial: Prepayment calculated', [
    ...
    {
        $daysToEvent = CarbonImmutable::now()->diffInDays($event->event_date, false);
    ...
    public function distributeBudget(Event $event): void
    {
        ...
        $this->logger->$this->logger->info('Financial: Budget distributed to modules', [
            'event_uuid' => $event->uuid,
