...
final readonly class EventAIService
{
    public function __construct(
        private readonly AIConstructorService $aiBase,
    ...
    {
        $this->logger->$this->logger->info("EventAIService: Generating plan for {$eventType}", [
        ...
        $this->logger->$this->logger->info('EventAIService: Plan generated successfully', [
            'correlation_id' => $correlationId,
    ...
    {
        if ($guests > 200 || $budget > 2000000) {
            return 'Very High (Premium)';
        }
        if ($guests > 50 || $budget > 500000) {
            return 'Medium High';
        }
