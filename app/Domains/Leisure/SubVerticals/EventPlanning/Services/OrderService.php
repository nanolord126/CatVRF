...
final readonly class OrderService
{
    ...
    public function validateOrder(array $data, string $correlationId): array
    {
        ...
        if ($fraudScore > 80) {
            $this->logger->warning('EventPlanning order rejected due to high fraud score', [
    ...
    {
        // EventPlanning: service-based, digital planning initiation
        return 'Digital planning initiated within 24 hours';
    }
}
