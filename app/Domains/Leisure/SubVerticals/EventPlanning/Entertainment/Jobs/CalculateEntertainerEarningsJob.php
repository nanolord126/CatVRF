...
namespace App\Domains\Leisure\SubVerticals\EventPlanning\Entertainment\Jobs;
...
final class CalculateEntertainerEarningsJob
{
    ...
    public function handle(): void
    {
        try {
            ...
            $this->logger->$this->logger->info('Entertainer earnings calculated', [
                'month' => $month,
                'year' => $year,
    ...
    private function calculateEarnings(Entertainer $entertainer, int $month, int $year): void
    {
        ...
        foreach ($events as $event) {
            $this->logger->$this->logger->info('Entertainer earnings updated', [
