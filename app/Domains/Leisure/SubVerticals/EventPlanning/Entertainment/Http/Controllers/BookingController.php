    ...
    public function update(int $id): JsonResponse
    {
        ...
        try {
            ...
            $this->db->transaction(function () use ($booking, $correlationId) {
                ...
                $this->logger->$this->logger->info('Booking updated', ['booking_id' => $id, 'correlation_id' => $correlationId]);
            });
    ...
    public function confirm(int $id): JsonResponse
    {
        try {
            ...
            $this->db->transaction(function () use ($booking, $correlationId) {
                ...
                $this->logger->$this->logger->info('Booking confirmed', ['booking_id' => $id, 'correlation_id' => $correlationId]);
            });
    ...
    public function expire(int $id): JsonResponse
    {
        try {
            ...
            $this->db->transaction(function () use ($booking, $correlationId) {
                ...
                $this->logger->$this->logger->info('Booking completed', ['booking_id' => $id, 'correlation_id' => $correlationId]);
            });
