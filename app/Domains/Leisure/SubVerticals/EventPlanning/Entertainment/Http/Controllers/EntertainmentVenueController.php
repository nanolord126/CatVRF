...
final class EntertainmentVenueController extends Controller
{
    ...
    public function store(): JsonResponse
    {
        ...
        try {
            $this->db->transaction(function () {
                ...
                $this->logger->$this->logger->info('Entertainment venue created', [
                    'venue_id' => $venue->id,
                    'name' => $venue->name,
                    'correlation_id' => $correlationId,
                ]);
    ...
    public function update(int $id): JsonResponse
    {
        ...
        try {
            ...
            $this->db->transaction(function () use ($venue, $correlationId) {
                ...
                $this->logger->$this->logger->info('Entertainment venue updated', [
                    'venue_id' => $venue->id,
                    'correlation_id' => $correlationId,
                ]);
            });
    ...
    public function delete(int $id): JsonResponse
    {
        try {
            ...
            $this->db->transaction(function () use ($venue, $correlationId) {
                $venue->delete();
                $this->logger->$this->logger->info('Entertainment venue deleted', ['venue_id' => $id, 'correlation_id' => $correlationId]);
            });
