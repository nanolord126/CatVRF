...
namespace App\Domains\Leisure\SubVerticals\EventPlanning\Entertainment\Listeners;
    ...
    public function handle(BookingCreated $event): void
    {
        try {
            ...
            $this->db->transaction(function () use ($event) {
                ...
                $wallet = Wallet::lockForUpdate()->where('tenant_id', $event->booking->tenant_id)->firstOrFail();
                ...
                $this->logger->$this->logger->info('Booking commission deducted', [
