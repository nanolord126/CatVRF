...
final readonly class RecommendationService
{
    ...
    public function getRecommendationsForUser(int $userId, int $limit = 5): Collection
    {
        ...
        $this->logger->$this->logger->info('Generating entertainment recommendations', [
            'user_id' => $userId,
    ...
    public function getSimilarVenues(Venue $venue, int $limit = 3): Collection
    {
        ...
        $this->logger->$this->logger->info('Generating similar venues (Look-alike)', [
        ...
        $this->logger->$this->logger->info('Look-alike venues found', [
            'count' => $results->count(),
            'correlation_id' => $correlationId,
        ]);
