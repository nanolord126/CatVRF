...
final readonly class SeatMapService
{
    ...
    public function saveSeatMap(Venue $venue, string $name, array $layout, array $categories): SeatMap
    {
        ...
        $this->logger->$this->logger->info('Saving seat map', [
        ...
        return $this->db->transaction(function () use ($venue, $name, $layout, $categories, $correlationId) {
            ...
            $this->logger->$this->logger->info('Seat map saved successfully', [
    ...
    public function deleteSeatMap(SeatMap $seatMap): bool
    {
        ...
        return $this->db->transaction(function () use ($seatMap, $correlationId) {
            ...
            $this->logger->$this->logger->info('Seat map deleted successfully', [
                'correlation_id' => $correlationId,
            ]);
