...
/**
 * Главный сервис вертикали Cosmetics.
 *
 * Координирует косметику с интеграцией в Beauty как под-вертикаль.
 */
final readonly class CosmeticsService
{
    ...
    /**
     * Подготовить чекаут для косметики.
     *
    ...
    public function prepareCheckout(array $cartData): array
    {
        ...
        $this->logger->info('Cosmetics checkout preparation started', [
    ...
    public function createOrder(array $orderData): array
    {
        ...
        $this->logger->info('Cosmetics order creation started', [
            'correlation_id' => $correlationId,
        ...
        return $this->db->transaction(function () use ($orderData, $correlationId) {
            ...
            $orderId = $this->db->table('cosmetics_orders')->insertGetId([
