...
namespace App\Domains\ProcessImprovement\Services;
use App\Domains\ProcessImprovement\Models\ProcessConsultant;
use App\Domains\ProcessImprovement\Models\ProcessProject;
 ...
 * @version 1.0.0
 */
class ProcessImprovementService{public function __construct(private readonly FraudControlService $fraud,private readonly WalletService $wallet){
    /**
