...
namespace App\Domains\Content\Resources\B2B;
...
/**
 * B2B API Collection: ContentItems.
 *
 * CANON 2026 — Layer 8: Resources (B2B namespace).
 */
final class ContentItemCollection extends ResourceCollection
{
    ...
    public function paginationInformation(Request $request, array $paginated, array $default): array
    {
        return [
            'meta' => [
                ...
                'api_version'    => 'v1',
                'resource_type'  => 'content_item_collection',
