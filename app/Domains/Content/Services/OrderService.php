...
final readonly class OrderService
{
    ...
    public function validateOrder(array $data, string $correlationId): array
    {
        ...
        if ($fraudScore > 80) {
            $this->logger->warning('Content order rejected due to high fraud score', [
    ...
    {
        // Content: service-based, instant digital delivery
        return 'Instant digital content delivery';
    }
}
