...
final class PropertyBookingObserver
{
    ...
    {
        $this->log->channel('audit')->info('real_estate.booking.observed.created', [
    ...
    public function updated(PropertyBooking $booking): void
    {
        ...
        if ($oldStatus !== $newStatus) {
            $this->log->channel('audit')->info('real_estate.booking.observed.status_changed', [
                'booking_id' => $booking->id,
    ...
    {
        $this->log->channel('audit')->info('real_estate.booking.observed.deleted', [
            'booking_id' => $booking->id,
            'correlation_id' => $booking->correlation_id,
        ]);
    ...
    {
        $this->log->channel('audit')->info('real_estate.booking.observed.restored', [
            'booking_id' => $booking->id,
            'correlation_id' => $booking->correlation_id,
        ]);
    }
    ...
    {
        $this->log->channel('audit')->info('real_estate.booking.observed.force_deleted', [
            'booking_id' => $booking->id,
            'correlation_id' => $booking->correlation_id,
        ]);
    }
