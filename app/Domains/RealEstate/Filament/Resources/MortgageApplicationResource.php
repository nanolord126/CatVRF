...
use App\Domains\RealEstate\Filament\Resources\MortgageApplicationResource\Pages\ListMortgageApplications;

final class MortgageApplicationResource extends BaseOptimizedResource
{
    ...
    {
        return [
            'index' => ListMortgageApplications::route('/'),
        ];
    }
