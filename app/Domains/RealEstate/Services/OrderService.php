...
final readonly class OrderService
{
    ...
    {
        // RealEstate vertical: 5% for B2C, 3% for B2B
    ...
    public function validateOrder(array $data, string $correlationId): array
    {
        ...
        if ($fraudScore > 90) {
            $this->logger->warning('RealEstate order rejected due to high fraud score', [
    ...
    {
        // RealEstate: service-based, instant digital confirmation
        return 'Instant digital confirmation';
    }
}
