...
/**
 * B2B API Collection: B2BDeals.
 *
 * CANON 2026 — Layer 8: Resources (B2B namespace).
 */
final class B2BDealCollection extends ResourceCollection
{
    public $collects = B2BDealResource::class;
    ...
    public function paginationInformation(Request $request, array $paginated, array $default): array
    {
        return [
            'meta' => [
                ...
                'api_version'    => 'v1',
                'resource_type'  => 'b2_b_deal_collection',
