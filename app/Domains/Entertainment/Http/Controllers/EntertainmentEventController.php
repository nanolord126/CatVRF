...
use App\Domains\Entertainment\Services\EventService;
use Illuminate\Http\JsonResponse;
use Illuminate\Support\Facades\DB;
use Illuminate\Support\Facades\Log;
use Illuminate\Support\Str;

final class EntertainmentEventController
{
    ...
    {
        try {
            $reviews = \App\Domains\Entertainment\Models\EventReview::where('entertainment_event_id', $id)
                ->with('reviewer')
                ->paginate(20);
