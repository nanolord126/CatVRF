...
final class B2BEntertainmentStorefront extends Model
{
    use SoftDeletes;

    protected $table = 'b2b_entertainment_storefronts';
    ...
    {
        return $this->hasMany(B2BEntertainmentOrder::class, 'b2b_entertainment_storefront_id');
    }
}
...
final class B2BEntertainmentOrder extends Model
{
    ...
    protected $fillable = [
        'uuid',
        'tenant_id',
        'b2b_entertainment_storefront_id',
        'order_number',
