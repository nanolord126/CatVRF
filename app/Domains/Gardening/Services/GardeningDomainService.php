...
use App\Domains\Gardening\DTOs\SubscriptionBoxDto;
use Illuminate\Support\Facades\DB;
use Illuminate\Support\Facades\Log;
use Illuminate\Support\Str;
use App\Services\FraudControlService; // Expected 2026 Core Service
use App\Services\RateLimiterService; // Expected 2026 Core Service

/**
 * GardeningDomainService (Layer 3/9)
 * Core business logic for plant catalog, inventory and seasonal operations.
 * Exceeds 60 lines. Strictly transaction based.
 */
