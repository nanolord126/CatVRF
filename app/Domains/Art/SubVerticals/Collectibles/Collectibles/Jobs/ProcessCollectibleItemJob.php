...
namespace App\Domains\Art\SubVerticals\Collectibles\Jobs;
...
final class ProcessCollectibleItemJob implements ShouldQueue
{
    ...
    {
        $CollectibleItem::findOrFail($this->modelId);

        $this->logger->$this->logger->info('ProcessCollectibleItemJob processed', [
            'model_id' => $model->id,
