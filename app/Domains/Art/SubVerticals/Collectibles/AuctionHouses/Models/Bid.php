...
final class Bid extends Model
{
    ...
    protected $fillable = ['uuid', 'tenant_id', 'auction_id', 'bidder_id', 'correlation_id', 'bid_amount', 'payment_status', 'tags'];

    protected $casts = ['bid_amount' => 'integer', 'tags' => 'json'];

    protected static function booted()
    {
        self::addGlobalScope('tenant', fn ($q) => $q->where('bids.tenant_id', tenant()->id));
    }
