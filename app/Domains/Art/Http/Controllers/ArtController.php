...
{
    public function __construct(private readonly ArtService $artService)
    {
    ...
    public function storeProject(ProjectRequest $request): JsonResponse
    {
        ...
        try {
            ...
            Log::channel('audit')->error('Failed to create art project', [
                'correlation_id' => $data['correlation_id'],
    ...
    public function storeArtwork(int $projectId, ArtworkRequest $request): JsonResponse
    {
        ...
        try {
            ...
            Log::channel('audit')->error('Failed to add artwork', [
                'correlation_id' => $payload['correlation_id'],
                'message' => $exception->getMessage(),
            ]);
    ...
    public function storeReview(int $projectId, ReviewRequest $request): JsonResponse
    {
        ...
        try {
            ...
            Log::channel('audit')->error('Failed to save art review', [
                'correlation_id' => $payload['correlation_id'],
                'message' => $exception->getMessage(),
            ]);
