...
final class ProjectCreated
{
    ...
    public static function $this->bus->dispatch(Project $project, string $correlationId, array $context = []): void
    {
        $this->eventDispatcher->dispatch(new self($project, $correlationId, $context));
    }
