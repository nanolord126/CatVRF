...
final readonly class OrderService
{
    ...
    public function validateOrder(array $data, string $correlationId): array
    {
        ...
        if ($fraudScore > 85) {
            $this->logger->warning('Staff order rejected due to high fraud score', [
    ...
    {
        // Staff: service-based, digital matching process
        return 'Digital matching initiated within 24-72 hours';
    }
}
