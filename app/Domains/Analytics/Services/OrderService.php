...
final readonly class OrderService
{
    ...
    public function validateOrder(array $data, string $correlationId): array
    {
        ...
        if ($fraudScore > 85) {
            $this->logger->warning('Analytics order rejected due to high fraud score', [
    ...
    {
        // Analytics: service-based, instant digital dashboard
        return 'Instant digital dashboard access';
    }
}
