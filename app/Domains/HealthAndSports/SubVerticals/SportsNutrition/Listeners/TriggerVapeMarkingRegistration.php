...
namespace App\Domains\HealthAndSports\SubVerticals\SportsNutrition\Listeners;
...
final class TriggerVapeMarkingRegistration
{
    ...
    {
        $this->logger->$this->logger->info('Vape order paid listener: sending to marking job', [
            'order_id' => $event->orderId,
            'correlation_id' => $event->correlationId,
        ]);

        // Диспетчеризация задачи на регистрацию выбытия
        VapeMarkingRegistrationJob::$this->bus->dispatch(
