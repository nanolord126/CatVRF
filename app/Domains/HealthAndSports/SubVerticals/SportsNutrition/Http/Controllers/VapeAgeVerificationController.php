...
final class VapeAgeVerificationController extends Controller
{
    ...
    public function __construct(
        private readonly VapeAgeVerificationService $ageVerifier,
    ...
    public function initiate(Request $request): JsonResponse
    {
        ...
        try {
            ...
            // 2. Audit log
            $this->logger->$this->logger->info('Vape verification initiate controller', [
    ...
    public function complete(Request $request, string $uuid): JsonResponse
    {
        ...
        try {
            ...
            // 5. Audit log
            $this->logger->$this->logger->info('Vape verification complete controller results', [
                'verification_uuid' => $uuid,
                'is_adult' => $isAdult,
                'correlation_id' => $correlationId,
            ]);
