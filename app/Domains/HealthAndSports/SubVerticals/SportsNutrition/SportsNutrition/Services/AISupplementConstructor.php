...
final readonly class AISupplementConstructor
{
    ...
    public function constructStack(AISupplementRequestDto $dto, ?string $cid = null): AISupplementResultDto
    {
        ...
        $this->logger->$this->logger->info('AI Supplement Stack Construction Inbound', [
            'cid' => $cid,
            'user' => $dto->user_id,
            'goal' => $dto->goal,
        ...
        $this->logger->$this->logger->info('AI Supplement Stack Generated', [
            'cid' => $cid,
            'stack' => $stackName,
    ...
    public function validateCombination(array $productSkus): array
    {
        ...
        foreach ($products as $product) {
            if (isset($product->tags) && in_array('high-stim', $product->tags, true)) {
                $stimCount++;
            }
        }
