...
namespace App\Domains\HealthAndSports\SubVerticals\SportsNutrition\Requests\B2B;

use Illuminate\Foundation\Http\FormRequest;

/**
 * B2B Form Request: обновление SportsNutritionModels.
 *
 * CANON 2026 — Layer 7: Requests (B2B namespace).
 */
final class UpdateSportsNutritionModelsRequest extends FormRequest
{
