...
return new class extends Migration
{
    ...
    {
        Schema::create('fitness_prenatal_enrollments', function (Blueprint $table) {
            $table->id();
            $table->foreignId('tenant_id')->constrained()->onDelete('cascade');
            $table->foreignId('client_id')->constrained('fitness_clients')->onDelete('cascade');
            $table->foreignId('prenatal_program_id')->constrained('fitness_prenatal_programs')->onDelete('cascade');
            ...
            $table->index(['prenatal_program_id', 'status']);
            $table->unique(['client_id', 'prenatal_program_id']);
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('fitness_prenatal_enrollments');
    }
};
