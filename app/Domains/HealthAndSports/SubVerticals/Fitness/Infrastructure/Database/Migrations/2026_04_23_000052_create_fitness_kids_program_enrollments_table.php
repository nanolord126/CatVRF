...
return new class extends Migration
{
    ...
    {
        Schema::create('fitness_kids_program_enrollments', function (Blueprint $table) {
            $table->id();
            $table->foreignId('tenant_id')->constrained()->onDelete('cascade');
            $table->foreignId('client_id')->constrained('fitness_clients')->onDelete('cascade');
            $table->foreignId('kids_program_id')->constrained('fitness_kids_programs')->onDelete('cascade');
            ...
            $table->index(['kids_program_id', 'status']);
            $table->unique(['client_id', 'kids_program_id']);
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('fitness_kids_program_enrollments');
    }
};
