...
namespace App\Domains\HealthAndSports\SubVerticals\Fitness\Policies;
...
final class GymPolicy
{
     ...
     */
    public function $this->viewFactory->make(User $user, Gym $gym): bool
    {
        return $user->tenant_id === $gym->tenant_id;
    }
