...
final class PrenatalEnrollmentResource extends Resource
{
    protected static ?string $model = PrenatalEnrollmentModel::class;
            ...
            ->schema([
                Forms\Components\Section::make('Enrollment Details')
                    ->schema([
                        ...
                        Forms\Components\Select::make('prenatal_program_id')
                            ->relationship('prenatalProgram', 'name')
                            ->searchable()
                            ->required()
                            ->label('Program'),
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('prenatalProgram.name')
                    ->searchable()
                    ->label('Program'),
            ...
            ->actions([
                ...
                Tables\Actions\Action::make('approve_clearance')
                    ...
                    ->action(function ($record) {
                        $service = app(\Modules\Fitness\Application\Services\PrenatalFitnessService::class);
    ...
    {
        return [
            'index' => \Modules\Fitness\Filament\Resources\Prenatal\Pages\ListPrenatalEnrollments::route('/'),
            'create' => \Modules\Fitness\Filament\Resources\Prenatal\Pages\CreatePrenatalEnrollment::route('/create'),
            'edit' => \Modules\Fitness\Filament\Resources\Prenatal\Pages\EditPrenatalEnrollment::route('/{record}/edit'),
        ];
    }
}
