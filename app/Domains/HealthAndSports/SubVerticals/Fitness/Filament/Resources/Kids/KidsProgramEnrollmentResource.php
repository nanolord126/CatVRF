...
final class KidsProgramEnrollmentResource extends Resource
{
    protected static ?string $model = KidsProgramEnrollmentModel::class;
            ...
            ->schema([
                Forms\Components\Section::make('Enrollment Details')
                    ->schema([
                        ...
                        Forms\Components\Select::make('kids_program_id')
                            ->relationship('kidsProgram', 'name')
                            ->searchable()
                            ->required()
                            ->label('Program'),
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('kidsProgram.name')
                    ->searchable()
                    ->label('Program'),
            ...
            ->actions([
                ...
                Tables\Actions\Action::make('approve_clearance')
                    ...
                    ->action(function ($record) {
                        $service = app(\Modules\Fitness\Application\Services\KidsFitnessService::class);
    ...
    {
        return [
            'index' => \Modules\Fitness\Filament\Resources\Kids\Pages\ListKidsProgramEnrollments::route('/'),
            'create' => \Modules\Fitness\Filament\Resources\Kids\Pages\CreateKidsProgramEnrollment::route('/create'),
            'edit' => \Modules\Fitness\Filament\Resources\Kids\Pages\EditKidsProgramEnrollment::route('/{record}/edit'),
        ];
    }
}
