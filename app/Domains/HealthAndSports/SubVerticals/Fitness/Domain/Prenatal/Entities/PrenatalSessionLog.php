...
final readonly class PrenatalSessionLog
{
    ...
    {
        if ($this->heartRateAfter !== null && $this->heartRateAfter > 140) {
            return true;
        }

        if ($this->bloodPressureSystolic !== null && $this->bloodPressureSystolic > 140) {
            return true;
        }

        if ($this->bloodPressureDiastolic !== null && $this->bloodPressureDiastolic > 90) {
            return true;
        }
