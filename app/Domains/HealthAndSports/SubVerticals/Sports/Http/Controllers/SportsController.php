...
final class SportsController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        ...
        $this->logger->$this->logger->info('Спортивный объект listed', [
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        $this->logger->$this->logger->info('Спортивный объект created', ['correlation_id' => $correlationId, 'id' => $id]);
    ...
    public function update(Request $request, int $id): JsonResponse
    {
        ...
        $this->logger->$this->logger->info('Спортивный объект updated', ['correlation_id' => $correlationId, 'id' => $id]);
    ...
    public function destroy(Request $request, int $id): JsonResponse
    {
        ...
        $this->logger->$this->logger->info('Спортивный объект deleted', ['correlation_id' => $correlationId, 'id' => $id]);
