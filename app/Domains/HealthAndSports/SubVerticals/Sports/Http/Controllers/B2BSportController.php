...
final class B2BSportController extends Controller
{
    ...
    public function createStorefront(Request $request): JsonResponse
    {
        ...
        $this->logger->$this->logger->info('B2BSport storefront create start', ['correlation_id' => $correlationId, 'user_id' => $request->user()?->id]);
        ...
        try {
            ...
            $this->logger->$this->logger->info('B2BSport storefront created', ['correlation_id' => $correlationId, 'user_id' => $request->user()?->id]);
    ...
    public function createOrder(Request $request): JsonResponse
    {
        ...
        try {
            ...
            $this->logger->$this->logger->info('B2BSport order created', ['correlation_id' => $correlationId, 'user_id' => $request->user()?->id]);
    ...
    public function approveOrder(int $id): JsonResponse
    {
        try {
            ...
            $this->logger->$this->logger->info('B2BSport order approved', ['correlation_id' => $correlationId, 'user_id' => $request->user()?->id, 'order_id' => $id]);
    ...
    public function rejectOrder(int $id, Request $request): JsonResponse
    {
        try {
            ...
            $this->logger->$this->logger->info('B2BSport order rejected', ['correlation_id' => $correlationId, 'user_id' => $request->user()?->id, 'order_id' => $id, 'reason' => $reason]);
    ...
    public function verifyInn(int $id): JsonResponse
    {
        try {
            ...
            $this->logger->$this->logger->info('B2BSport storefront verified', ['correlation_id' => $correlationId, 'user_id' => $request->user()?->id, 'storefront_id' => $id]);
