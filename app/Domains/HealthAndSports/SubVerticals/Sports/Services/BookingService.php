...
final readonly class BookingService
{
    ...
    public function createBooking(
        ...
        try {
            ...
            $this->logger->$this->logger->info('Creating booking', [
                'class_id' => $classId,
                'member_id' => $memberId,
                'type' => $type,
            ...
            $this->logger->$this->logger->info('Booking created', [
    ...
    public function confirmBooking(Booking $booking, ?string $correlationId = null): void
    {
        ...
        try {
            ...
            $this->logger->$this->logger->info('Booking confirmed', [
                'booking_id' => $booking->id,
                'correlation_id' => $correlationId,
            ]);
        } catch (Throwable $e) {
    ...
    public function cancelBooking(Booking $booking, string $reason = '', ?string $correlationId = null): void
    {
        ...
        try {
            ...
            $this->logger->$this->logger->info('Booking cancelled', [
                'booking_id' => $booking->id,
                'correlation_id' => $correlationId,
            ]);
        } catch (Throwable $e) {
    ...
    public function markAsAttended(Booking $booking, ?string $correlationId = null): void
    {
        ...
        try {
            ...
            $this->logger->$this->logger->info('Booking marked as attended', [
                'booking_id' => $booking->id,
                'correlation_id' => $correlationId,
            ]);
        } catch (Throwable $e) {
