...
use App\Domains\Sports\Models\AdaptiveWorkoutPlan;

final class AdaptiveWorkoutPlanResource extends BaseOptimizedResource
{
    protected static ?string $model = AdaptiveWorkoutPlan::class;
