...
final class B2BSportStorefrontResource extends BaseOptimizedResource
{
    protected static ?string $model = B2BSportStorefront::class;

    protected static ?string $navigationIcon = 'heroicon-o-trophy';

    protected static ?string $navigationGroup = 'Sports B2B';
