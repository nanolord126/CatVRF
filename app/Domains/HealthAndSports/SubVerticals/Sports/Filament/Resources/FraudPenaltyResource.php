...
use App\Domains\Sports\Models\FraudPenalty;

final class FraudPenaltyResource extends BaseOptimizedResource
{
    protected static ?string $model = FraudPenalty::class;
