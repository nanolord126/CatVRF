...
final class FitnessClassController extends Controller
{
    ...
    public function delete(int $id): JsonResponse
    {
        ...
        try {
            ...
            $this->logger->$this->logger->info('Class deleted', ['class_id' => $id, 'correlation_id' => $correlationId]);
    ...
    public function addSchedule(int $classId): JsonResponse
    {
        ...
        try {
            ...
            $schedule = ClassSchedule::create([
                ...
                'day_of_week' => CarbonImmutable::now()->parse($request->input('scheduled_at'))->format('l'),
                'start_time' => CarbonImmutable::now()->parse($request->input('scheduled_at'))->format('H:i:s'),
                'end_time' => CarbonImmutable::now()->parse($request->input('scheduled_at'))->addMinutes(FitnessClass::find($classId)->duration_minutes)->format('H:i:s'),
