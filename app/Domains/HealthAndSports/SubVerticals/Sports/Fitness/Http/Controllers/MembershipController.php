...
final class MembershipController extends Controller
{
    ...
    public function update(int $id): JsonResponse
    {
        ...
        try {
            ...
            $this->logger->$this->logger->info('Membership updated', ['membership_id' => $id, 'correlation_id' => $correlationId]);
    ...
    public function cancel(int $id): JsonResponse
    {
        ...
        try {
            ...
            $this->logger->$this->logger->info('Membership cancelled', ['membership_id' => $id, 'correlation_id' => $correlationId]);
