...
final class TrainerController extends Controller
{
    ...
    public function register(): JsonResponse
    {
        ...
        try {
            ...
            $this->logger->$this->logger->info('Trainer registered', ['trainer_id' => $trainer->id, 'user_id' => $request->user()?->id, 'correlation_id' => $correlationId]);
    ...
    public function updateProfile(): JsonResponse
    {
        ...
        try {
            ...
            $this->logger->$this->logger->info('Trainer profile updated', ['trainer_id' => $trainer->id, 'correlation_id' => $correlationId]);
    ...
    public function updateSchedule(): JsonResponse
    {
        ...
        try {
            ...
            $this->logger->$this->logger->info('Trainer schedule updated', ['trainer_id' => $trainer->id, 'correlation_id' => $correlationId]);
