...
final class GymController extends Controller
{
    ...
    public function store(): JsonResponse
    {
        ...
        try {
            ...
            $this->logger->$this->logger->info('Gym created', ['gym_id' => $gym->id, 'correlation_id' => $correlationId]);
    ...
    public function update(int $id): JsonResponse
    {
        ...
        try {
            ...
            $this->logger->$this->logger->info('Gym updated', ['gym_id' => $gym->id, 'correlation_id' => $correlationId]);
    ...
    public function delete(int $id): JsonResponse
    {
        ...
        try {
            ...
            $this->logger->$this->logger->info('Gym deleted', ['gym_id' => $id, 'correlation_id' => $correlationId]);
