...
final class SportStore extends Model
{
    ...
    {
        return $this->hasMany(SportProduct::class, 'store_id');
    }
    ...
    {
        return $this->hasMany(SportOrder::class, 'store_id');
    }

    protected static function booted(): void
    {
        self::addGlobalScope('tenant', fn ($q) => $q->where('sport_stores.tenant_id', tenant()->id));
    }
}
