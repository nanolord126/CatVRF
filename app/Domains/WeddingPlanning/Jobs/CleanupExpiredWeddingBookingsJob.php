...
/**
 * CleanupExpiredWeddingBookingsJob
 *
 * Layer 6: Maintenance Job Layer
 * Автоматическая очистка просроченных бронирований (резервов).
 *
 * @version 1.1.0
 * @author CatVRF
 */
class CleanupExpiredWeddingBookingsJob implements ShouldQueue
{
