...
/**
 * РЕЖИМ ЛЮТЫЙ 2026: MEDICAL INVENTORY TRANSACTION DTO
 * 
 * Объект для учета движения медицинских материалов (Consumables).
 * Обеспечивает точность списания в копейках и штуках.
 * 
