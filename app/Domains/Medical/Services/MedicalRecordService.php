...
final readonly class MedicalRecordService
{
    ...
    public function createRecord(array $data, ?string $correlationId = null): MedicalRecord
    {
        ...
        return $this->db->transaction(function () use ($data, $appointment, $correlationId) {
            ...
            $this->logger->$this->logger->info('Medical record created', [
                'record_id' => $record->id,
    ...
    public function getRecordForView(int $recordId, int $userId): MedicalRecord
    {
        ...
        $this->logger->$this->logger->info('Medical record accessed (view)', [
            'record_id' => $record->id,
            'user_id' => $userId,
     ...
     */
    public function getPatientHistory(int $clientId, int $viewerId, array $filters = []): Collection
    {
