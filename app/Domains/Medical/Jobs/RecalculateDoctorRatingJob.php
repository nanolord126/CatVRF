...
/**
 * РЕЖИМ ЛЮТЫЙ 2026: DOCTOR RATING RECALCULATION JOB
 * 
 * Асинхронный пересчет рейтинга врача на основе:
 * - Средней оценки из отзывов (MedicalReview)
 * - Количества завершенных приемов (Appointments)
 * - Коэффициента возвращаемости пациентов (LTV-фактор)
 * - Штрафов за отмены со стороны врача
 * 
 * @package App\Domains\Medical\Jobs
 */
