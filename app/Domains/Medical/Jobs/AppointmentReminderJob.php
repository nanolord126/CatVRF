...
/**
 * РЕЖИМ ЛЮТЫЙ 2026: APPOINTMENT REMINDER JOB
 * 
 * Автоматическое уведомление пациента о предстоящем приеме к врачу.
 * Обязательные условия:
 * - Сквозной correlation_id для всех этапов отправки.
 * - Логирование в аудит (ФЗ-152: факт информирования пациента).
 * - Retry-логика (3 попытки с экспоненциальной задержкой).
 * - Отключение уведомления при отмене записи.
 * 
