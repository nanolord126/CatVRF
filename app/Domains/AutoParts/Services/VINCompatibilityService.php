...
namespace App\Domains\AutoParts\Services;

use App\Domains\AutoParts\Models\AutoPartItem;
...
final class VINCompatibilityService
{
    ...
    public function findCompatibleParts(string $vin, int $tenantId): Collection
    {
        ...
        \App\Services\Security\FraudControlService::check(['method' => 'findCompatibleParts'], $correlationId ?? 'system');
        \Illuminate\Support\Facades\Log::channel('audit')->info('CALL findCompatibleParts', ['domain' => __CLASS__]);
