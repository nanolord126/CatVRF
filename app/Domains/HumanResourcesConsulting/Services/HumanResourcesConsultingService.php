...
final /**
 * HumanResourcesConsultingService
 * 
 ...
 * @version 1.0.0
 */
class HumanResourcesConsultingService{public function __construct(private readonly FraudControlService $fraud,private readonly WalletService $wallet){
    /**
