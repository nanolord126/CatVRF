...
use App\Domains\Consulting\Analytics\Services\HeatmapExportService;
use App\Domains\Consulting\Analytics\Services\HeatmapGeneratorService;
use App\Domains\Consulting\Analytics\Services\ScreenshotService;
...
/**
 * HeatmapController - API endpoints for heatmap data and export
 *
 * Endpoints:
 * - GET /api/analytics/heatmaps/geo - Geo-heatmap data
 * - GET /api/analytics/heatmaps/click - Click-heatmap data
 * - GET /api/analytics/heatmaps/click/screenshot - Page screenshot
 * - POST /api/analytics/heatmaps/export/geo/png - Export geo-heatmap to PNG
 * - POST /api/analytics/heatmaps/export/geo/pdf - Export geo-heatmap to PDF
 * - POST /api/analytics/heatmaps/export/click/png - Export click-heatmap to PNG
 * - POST /api/analytics/heatmaps/export/click/pdf - Export click-heatmap to PDF
 *
 * Security:
 * - Tenant scoping on all queries
 * - Rate limiting middleware
 * - Authorization gates (view_analytics permission)
 * - Input validation via FormRequest
 * - Correlation ID tracking
 *
 * @package App\Domains\Consulting\Analytics\Http\Controllers
 */
