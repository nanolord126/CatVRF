...
/**
 * HeatmapUpdateEvent - Broadcasts heatmap data updates to subscribed clients
 *
 * This event is dispatched when heatmap data changes and needs to be pushed to real-time
 * subscribers via Reverb WebSocket. Used for geo-heatmap and click-heatmap live updates.
 *
 * @implements ShouldBroadcast
 * @uses Reverb WebSocket broadcasting
 *
 * Correlation ID: Generated automatically, included in event metadata for tracing
 *
 * @package App\Domains\Consulting\Analytics\Events
 */
final class HeatmapUpdateEvent implements ShouldBroadcast
{
    use Dispatchable;
