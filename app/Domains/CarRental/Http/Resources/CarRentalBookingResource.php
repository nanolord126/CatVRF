...
/**
 * CarRentalBookingResource — CatVRF 2026 Component.
 *
 ...
 * @see https://catvrf.ru/docs/carrentalbookingresource
 */
...
/**
 * Class CarRentalBookingResource
 *
 ...
 *
 * @package App\Domains\CarRental\Http\Resources
 */
final class CarRentalBookingResource extends JsonResource
{
    /**
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'uuid' => $this->uuid,
            'car_id' => $this->car_id,
            'pick_up_at' => $this->pick_up_at,
            'drop_off_at' => $this->drop_off_at,
