...
use App\Domains\CarRental\Models\RentalCar;
 ...
 * @version 1.0.0
 */
class CarRentalService{public function __construct(private readonly FraudControlService $fraud,private readonly WalletService $wallet){
    /**
