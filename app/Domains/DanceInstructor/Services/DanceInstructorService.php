...
namespace App\Domains\DanceInstructor\Services;
use App\Domains\DanceInstructor\Models\DanceTeacher;
use App\Domains\DanceInstructor\Models\DanceLesson;
 ...
 * @version 1.0.0
 */
class DanceInstructorService{public function __construct(private readonly FraudControlService $fraud,private readonly WalletService $wallet){
    /**
