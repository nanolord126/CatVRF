...
namespace App\Domains\PersonalDevelopment\Resources\B2B;
...
/**
 * B2B API Collection: Coaches.
 *
 * CANON 2026 — Layer 8: Resources (B2B namespace).
 */
final class CoachCollection extends ResourceCollection
{
    ...
    public function paginationInformation(Request $request, array $paginated, array $default): array
    {
        return [
            'meta' => [
                ...
                'api_version'    => 'v1',
                'resource_type'  => 'coach_collection',
