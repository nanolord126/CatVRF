...
final readonly class OrderService
{
    ...
    public function validateOrder(array $data, string $correlationId): array
    {
        ...
        if ($fraudScore > 80) {
            $this->logger->warning('PersonalDevelopment order rejected due to high fraud score', [
    ...
    {
        // PersonalDevelopment: service-based, instant digital access
        return 'Instant digital course access';
    }
}
