...
namespace App\Domains\PersonalDevelopment\DTOs;

use Illuminate\Http\Request;

/**
 * Class SearchProgressDto
 *
 ...
 * @package App\Domains\PersonalDevelopment\DTOs
 */
final readonly class SearchProgressDto
{
