...
/**
 * Material — CatVRF 2026 Component.
 *
 ...
 *
 * @see https://catvrf.ru/docs/material
 */
...
final class Material extends Model
{
    ...
    protected $fillable = ['uuid', 'tenant_id', 'supplier_id', 'correlation_id', 'name', 'price_kopecks', 'unit', 'stock', 'tags'];

    protected $casts = ['price_kopecks' => 'integer', 'stock' => 'integer', 'tags' => 'json'];

    protected static function booted()
    {
        self::addGlobalScope('tenant', fn ($q) => $q->where('construction_materials.tenant_id', tenant()->id));
    }
