...
final class MaterialController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        ...
        $this->logger->$this->logger->info('Materials listed', ['correlation_id' => $correlationId, 'count' => $materials->total()]);
    ...
    public function calculate(Request $request): JsonResponse
    {
        ...
        $this->logger->$this->logger->info('Material cost calculated', ['correlation_id' => $correlationId, 'total' => $totalCost]);
    ...
    public function order(Request $request): JsonResponse
    {
        ...
        $this->logger->$this->logger->info('Material order created', ['correlation_id' => $correlationId, 'id' => $id]);
