...
/**
 * EngineeringConsultant — CatVRF 2026 Component.
 *
 ...
 *
 * @see https://catvrf.ru/docs/engineeringconsultant
 */
...
final class EngineeringConsultant extends Model
{
    use HasUuids;
    use SoftDeletes;
    use TenantScoped;
    ...
    protected $table = 'engineering_consultants';
    ...
    {
        self::addGlobalScope('tenant', fn ($q) => $q->where('engineering_consultants.tenant_id', tenant()->id));
    }
