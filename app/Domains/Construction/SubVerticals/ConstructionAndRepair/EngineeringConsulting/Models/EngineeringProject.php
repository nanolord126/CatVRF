...
/**
 * EngineeringProject — CatVRF 2026 Component.
 *
 ...
 *
 * @see https://catvrf.ru/docs/engineeringproject
 */
...
final class EngineeringProject extends Model
{
    ...
    protected $table = 'engineering_projects';
    ...
    {
        self::addGlobalScope('tenant', fn ($q) => $q->where('engineering_projects.tenant_id', tenant()->id));
    }
