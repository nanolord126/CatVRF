...
/**
 * ManufacturingEngineer — CatVRF 2026 Component.
 *
 ...
 *
 * @see https://catvrf.ru/docs/manufacturingengineer
 */
...
final class ManufacturingEngineer extends Model
{
    use HasUuids;
    use SoftDeletes;
    use TenantScoped;
    ...
    protected $table = 'manufacturing_engineers';
    ...
    {
        self::addGlobalScope('tenant', fn ($q) => $q->where('manufacturing_engineers.tenant_id', tenant()->id));
    }
