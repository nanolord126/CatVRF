...
final readonly class OrderService
{
    ...
    public function validateOrder(array $data, string $correlationId): array
    {
        ...
        if ($fraudScore > 80) {
            $this->logger->warning('Photography order rejected due to high fraud score', [
    ...
    {
        // Photography: service-based, digital photo delivery
        return 'Digital photo delivery within 5-10 business days';
    }
}
