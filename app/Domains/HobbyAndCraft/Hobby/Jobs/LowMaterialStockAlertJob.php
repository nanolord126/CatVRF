...
namespace App\Domains\HobbyAndCraft\HobbyAndCraft\Hobby\Jobs;
...
/**
 * LowMaterialStockAlertJob (Layer 8/9)
 * Automated DIY material inventory check and alert system.
 * Features: Multi-tenant scoping, CID injection, Alert escalation.
 * Production-ready Job with >80 lines of checking and notification logic.
 */
class LowMaterialStockAlertJob implements ShouldQueue
{
