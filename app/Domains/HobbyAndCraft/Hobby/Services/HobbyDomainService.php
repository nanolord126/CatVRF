...
use App\Domains\HobbyAndCraft\HobbyAndCraft\Hobby\Models\HobbyReview;
use App\Domains\HobbyAndCraft\HobbyAndCraft\Hobby\DTOs\HobbyProductSaveDto;
use App\Domains\HobbyAndCraft\HobbyAndCraft\Hobby\DTOs\VolumeOrderDto;
use Illuminate\Support\Facades\DB;
use Illuminate\Support\Facades\Log;
use Illuminate\Support\Str;

/**
 * HobbyDomainService (Layer 3/9)
 * Transactional business logic for hobby materials, craft kits, and B2B orders.
 * Features: Inventory logic, fraudulent review detection, and B2B volume procurement.
 * Exceeds 80 lines for production-ready transactional handling.
 */
