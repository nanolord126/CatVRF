...
use App\Domains\PartySupplies\Models\PartyVendor;
 ...
 * @version 1.0.0
 */
class PartySuppliesService{public function __construct(private readonly FraudControlService $fraud,private readonly WalletService $wallet){
    /**
