...
final readonly class GiftsService
{
    ...
    public function __construct(private readonly FraudControlService $fraud,private readonly WalletService $wallet,
        ...
        public function createOrder(int $sellerId,array $items,string $correlationId=""):GiftOrder{
            $correlationId=$correlationId?:(string)Str::uuid();if($this->rateLimiter->tooManyAttempts("gifts:order:".$this->guard->id(),15))throw new \RuntimeException("Too many",429);$this->rateLimiter->hit("gifts:order:".$this->guard->id(),3600);
