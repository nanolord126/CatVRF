...
namespace App\Domains\Archived\GroceryAndDelivery\Jobs;
...

    {
...

        {
            ...
            try {
                ...
                $slots = \App\Domains\Archived\GroceryAndDelivery\Models\DeliverySlot::where('store_id', $this->storeId)
...

        {
            ...
            try {
                ...
                DB::transaction(function () {
                    ...
                    $service = app(\App\Domains\Archived\GroceryAndDelivery\Services\FastDeliveryService::class);
...

        {
            ...
            try {
                ...
                DB::transaction(function () {
                    ...
                    $expiredBookings = \App\Domains\Archived\GroceryAndDelivery\Models\SlotBooking::where('is_confirmed', false)
...

        {
            ...
            try {
                ...
                DB::transaction(function () use ($inventoryService) {
                    ...
                    $store = \App\Domains\Archived\GroceryAndDelivery\Models\GroceryStore::findOrFail($this->storeId);
