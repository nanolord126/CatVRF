    ...
    protected static ?string $model = ServiceJob::class;
...

        {
            ...
            return [
                ...
                'index' => \App\Domains\Archived\HomeServices\Filament\Resources\ServiceJobResource\Pages\ListServiceJobs::route('/'),


                'view' => \App\Domains\Archived\HomeServices\Filament\Resources\ServiceJobResource\Pages\ViewServiceJob::route('/{record}'),


                'edit' => \App\Domains\Archived\HomeServices\Filament\Resources\ServiceJobResource\Pages\EditServiceJob::route('/{record}/edit'),
