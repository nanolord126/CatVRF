    ...
    protected static ?string $model = ServiceReview::class;
...

        {
            ...
            return [
                ...
                'index' => \App\Domains\Archived\HomeServices\Filament\Resources\ServiceReviewResource\Pages\ListServiceReviews::route('/'),


                'create' => \App\Domains\Archived\HomeServices\Filament\Resources\ServiceReviewResource\Pages\CreateServiceReview::route('/create'),


                'edit' => \App\Domains\Archived\HomeServices\Filament\Resources\ServiceReviewResource\Pages\EditServiceReview::route('/{record}/edit'),
