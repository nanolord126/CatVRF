    ...
    protected static ?string $model = ServiceListing::class;
...

        {
            ...
            return [
                ...
                'index' => \App\Domains\Archived\HomeServices\Filament\Resources\ServiceListingResource\Pages\ListServiceListings::route('/'),


                'create' => \App\Domains\Archived\HomeServices\Filament\Resources\ServiceListingResource\Pages\CreateServiceListing::route('/create'),


                'edit' => \App\Domains\Archived\HomeServices\Filament\Resources\ServiceListingResource\Pages\EditServiceListing::route('/{record}/edit'),
