...
namespace App\Domains\Garden\SubVerticals\Gardening\Requests\B2B;

use Illuminate\Foundation\Http\FormRequest;

/**
 * B2B Form Request: обновление GardeningModels.
 *
 * CANON 2026 — Layer 7: Requests (B2B namespace).
 */
final class UpdateGardeningModelsRequest extends FormRequest
{
