...
final readonly class AIInteriorConstructorService
{
    ...
    public function generateInteriorSetup(AIInteriorRequestDto $dto): AIInteriorResultDto
    {
        ...
        $this->logger->$this->logger->info('LAYER-4: AI Interior Constructor Request', [
        ...
        try {
            ...
            $this->logger->$this->logger->info('LAYER-4: AI Interior Layout Generated Successfully', [
     ...
     */
    private function selectItemsWithinBudget(\Illuminate\Database\Eloquent\Collection $products, int $budget, array $excludeIds): Collection
    {
