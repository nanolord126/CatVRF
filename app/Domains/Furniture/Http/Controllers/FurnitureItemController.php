...
final class FurnitureItemController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        ...
        $items = $this->db->table('furniture_items')
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        $validated = $request->validate([
            'name' => 'required|string|max:255', 'category' => 'required|string', 'material' => 'nullable|string', 'dimensions' => 'nullable|array', 'price' => 'required|numeric|min:0',
        ]);
    ...
    public function show(Request $request, int $id): JsonResponse
    {
        ...
        $item = $this->db->table('furniture_items')
            ->where('id', $id)
            ->where('tenant_id', $request->get('tenant_id'))
            ->first();

        if ($item === null) {
            return new JsonResponse(['correlation_id' => $correlationId, 'message' => 'Мебель не найден(а)'], 404);
        }
    ...
    public function update(Request $request, int $id): JsonResponse
    {
        ...
        $validated = $request->validate([
            'name' => 'sometimes|string|max:255', 'category' => 'sometimes|string', 'material' => 'sometimes|string', 'dimensions' => 'sometimes|array', 'price' => 'sometimes|numeric|min:0',
        ]);
