...
/**
 * Class FurnitureOrderCollection
 *
 ...
 *
 * @package App\Domains\Furniture\Http\Resources
 */
final class FurnitureOrderCollection extends ResourceCollection
{
    private $collects = FurnitureOrderResource::class;
