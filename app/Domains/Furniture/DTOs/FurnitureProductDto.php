...
final readonly class FurnitureProductDto
{
    public function __construct(
        ...
        private readonly bool $isOversized = false,
        private readonly bool $requiresAssembly = false,
        private readonly int $assemblyCost = 0,
        private readonly ?string $threeDUrl = null,
        private readonly array $recommendedRooms = [],
