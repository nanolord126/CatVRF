...
/**
 * КАНОН 2026: Выплата владельцу апартаментов (через 4 дня после выезда)
 * 
 * Обязательно: DB::transaction, WalletService credit, audit log, correlation_id.
 */
final class StrPayoutJob implements ShouldQueue
{
