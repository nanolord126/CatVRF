...
use App\Domains\ShortTermRentals\Models\ApartmentRental;
 ...
 * @version 1.0.0
 */
class ShortTermRentalsService{public function __construct(private readonly FraudControlService $fraud,private readonly WalletService $wallet){
    /**
