...
use Filament\Forms;
use Filament\Tables;
use App\Domains\Auto\CarSales\Filament\Resources\CarDealerStorefrontResource\Pages\CreateCarDealerStorefront;
use App\Domains\Auto\CarSales\Filament\Resources\CarDealerStorefrontResource\Pages\EditCarDealerStorefront;
use App\Domains\Auto\CarSales\Filament\Resources\CarDealerStorefrontResource\Pages\ListCarDealerStorefronts;
...
final class CarDealerStorefrontResource extends Resource
{
    ...
    {
        return [
            'index'  => ListCarDealerStorefronts::route('/'),
            'create' => CreateCarDealerStorefront::route('/create'),
            'edit'   => EditCarDealerStorefront::route('/{record}/edit'),
        ];
    }
}
