...
/**
 * RentalCar — CatVRF 2026 Component.
 *
 ...
 *
 * @see https://catvrf.ru/docs/rentalcar
 */
...
final class RentalCar extends Model
{
    ...
    protected $fillable = ['uuid', 'tenant_id', 'owner_id', 'correlation_id', 'make', 'model', 'year', 'license_plate', 'price_kopecks_per_day', 'status', 'rating', 'tags'];

    protected $casts = ['price_kopecks_per_day' => 'integer', 'year' => 'integer', 'rating' => 'float', 'tags' => 'json'];

    protected static function booted()
    {
        self::addGlobalScope('tenant', fn ($q) => $q->where('rental_cars.tenant_id', tenant()->id));
    }
