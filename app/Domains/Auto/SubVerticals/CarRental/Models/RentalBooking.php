...
/**
 * RentalBooking — CatVRF 2026 Component.
 *
 ...
 *
 * @see https://catvrf.ru/docs/rentalbooking
 */
...
final class RentalBooking extends Model
{
    ...
    protected $fillable = ['uuid', 'tenant_id', 'car_id', 'renter_id', 'correlation_id', 'status', 'total_kopecks', 'payout_kopecks', 'payment_status', 'pickup_date', 'return_date', 'days_count', 'tags'];

    protected $casts = ['total_kopecks' => 'integer', 'payout_kopecks' => 'integer', 'pickup_date' => 'datetime', 'return_date' => 'datetime', 'days_count' => 'integer', 'tags' => 'json'];

    protected static function booted()
    {
        self::addGlobalScope('tenant', fn ($q) => $q->where('rental_bookings.tenant_id', tenant()->id));
    }
