 ...
 * @version 1.0.0
 */
class PartWarrantyClaimApproved implements ShouldBroadcast
{
    ...
    public function __construct(
        ...
        $this->log->channel('audit')->info('PartWarrantyClaimApproved event dispatched', [
