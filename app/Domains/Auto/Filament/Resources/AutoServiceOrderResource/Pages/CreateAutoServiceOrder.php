...
final class CreateAutoServiceOrder extends CreateRecord
{
    ...
    protected function mutateFormDataBeforeCreate(array $data): array
    {
        ...
        $this->logger->$this->logger->info('Creating auto service order', [
    ...
    protected function afterCreate(): void
    {
        $this->db->transaction(function () {
            ...
            $this->eventDispatcher->dispatch(new AutoServiceOrderCreated(
                $this->record,
                $this->record->correlation_id
            ));

            $this->logger->$this->logger->info('Auto service order created successfully', [
