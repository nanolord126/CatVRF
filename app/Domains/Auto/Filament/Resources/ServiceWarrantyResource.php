...
use Filament\Forms;
use Filament\Tables;
use App\Domains\Auto\Filament\Resources\ServiceWarrantyResource\Pages\CreateServiceWarranty;
use App\Domains\Auto\Filament\Resources\ServiceWarrantyResource\Pages\EditServiceWarranty;
use App\Domains\Auto\Filament\Resources\ServiceWarrantyResource\Pages\ListServiceWarranties;
use Illuminate\Database\Eloquent\Builder;

final class ServiceWarrantyResource extends BaseOptimizedResource
{
    ...
    {
        return [
            'index' => ListServiceWarranties::route('/'),
            'create' => CreateServiceWarranty::route('/create'),
            'edit' => EditServiceWarranty::route('/{record}/edit'),
        ];
    }
