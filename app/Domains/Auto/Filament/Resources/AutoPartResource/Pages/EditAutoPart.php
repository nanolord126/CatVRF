...
final class EditAutoPart extends EditRecord
{
    ...
    protected function getHeaderActions(): array
    {
        return [
            Actions\Action::make('restock')
                ...
                ->action(function (array $data) {
                    $this->db->transaction(function () use ($data) {
                        ...
                        $this->eventDispatcher->dispatch(new AutoPartStockUpdated(
                            $this->record,
                            $oldStock,
                        ...
                        $this->logger->$this->logger->info('Auto part stock updated (restock)', [
            ...
            Actions\DeleteAction::make()
                ->after(function () {
                    $this->logger->$this->logger->info('Auto part deleted', [
                        'correlation_id' => $this->record->correlation_id,
                        'part_id' => $this->record->id,
                        'sku' => $this->record->sku,
                        'user_id' => $this->guard->id(),
    ...
    {
        $this->logger->$this->logger->info('Auto part updated', [
            'correlation_id' => $this->record->correlation_id,
            'part_id' => $this->record->id,
            'sku' => $this->record->sku,
