...
final class B2BLogisticsPolicy extends Model
{
    use HasFactory;
    ...
    public function viewAny(User $user): Response
        ...
        public function viewStorefront(User $user, B2BLogisticsStorefront $storefront): Response
        {
        ...
        public function updateStorefront(User $user, B2BLogisticsStorefront $storefront): Response
        {
            return $user->tenant_id === $storefront->tenant_id || $user->is_admin
                ? $this->response->allow()
                : $this->response->deny('Нет доступа');
        ...
        public function viewOrder(User $user, B2BLogisticsOrder $order): Response
        {
        ...
        public function approveOrder(User $user, B2BLogisticsOrder $order): Response
        {
        ...
        public function rejectOrder(User $user, B2BLogisticsOrder $order): Response
        {
            return ($user->tenant_id === $order->tenant_id || $user->is_admin) && $order->status === 'pending'
                ? $this->response->allow()
