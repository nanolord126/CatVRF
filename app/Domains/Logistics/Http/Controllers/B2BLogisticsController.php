...
final class B2BLogisticsController extends Model
{
    use HasFactory;
    ...
    public function storefronts(): JsonResponse
        {
            try {
                ...
                Log::channel('audit')->error('Logistics B2B: Failed to fetch storefronts', [
                    'error' => $e->getMessage(),
                    'correlation_id' => Str::uuid(),
                ]);
        ...
        public function createStorefront(Request $request): JsonResponse
        {
            try {
                ...
                DB::transaction(function () use ($validated, $correlationId) {
                    ...
                    Log::channel('audit')->info('Logistics B2B: Storefront created', [
                        'inn' => $validated['inn'],
                        'correlation_id' => $correlationId,
                    ]);
                });
                ...
                Log::channel('audit')->error('Logistics B2B: Storefront creation failed', [
                    'error' => $e->getMessage(),
                    'correlation_id' => Str::uuid(),
                ]);
        ...
        public function createOrder(Request $request): JsonResponse
        {
            try {
                ...
                DB::transaction(function () use ($validated, $correlationId, $commission) {
                    ...
                    Log::channel('audit')->info('Logistics B2B: Order created', [
                ...
                Log::channel('audit')->error('Logistics B2B: Order creation failed', [
                    'error' => $e->getMessage(),
                    'correlation_id' => Str::uuid(),
                ]);
        ...
        public function myB2BOrders(): JsonResponse
        {
            try {
                ...
                Log::channel('audit')->error('Logistics B2B: Failed to fetch orders', [
                    'error' => $e->getMessage(),
                    'correlation_id' => Str::uuid(),
                ]);
        ...
        public function approveOrder(int $id): JsonResponse
        {
            try {
                ...
                DB::transaction(function () use ($order, $correlationId) {
                    ...
                    Log::channel('audit')->info('Logistics B2B: Order approved', [
                        'order_id' => $order->id,
                        'correlation_id' => $correlationId,
                    ]);
                });
                ...
                Log::channel('audit')->error('Logistics B2B: Order approval failed', [
                    'error' => $e->getMessage(),
                    'correlation_id' => Str::uuid(),
                ]);
        ...
        public function rejectOrder(int $id, Request $request): JsonResponse
        {
            try {
                ...
                DB::transaction(function () use ($order, $correlationId, $reason) {
                    ...
                    Log::channel('audit')->info('Logistics B2B: Order rejected', [
                        'order_id' => $order->id,
                        'reason' => $reason,
                        'correlation_id' => $correlationId,
                    ]);
                ...
                Log::channel('audit')->error('Logistics B2B: Order rejection failed', [
                    'error' => $e->getMessage(),
                    'correlation_id' => Str::uuid(),
                ]);
        ...
        public function verifyInn(int $id): JsonResponse
        {
            try {
                ...
                DB::transaction(function () use ($storefront, $correlationId) {
                    ...
                    Log::channel('audit')->info('Logistics B2B: Storefront verified', [
                ...
                Log::channel('audit')->error('Logistics B2B: Verification failed', [
                    'error' => $e->getMessage(),
                    'correlation_id' => Str::uuid(),
                ]);
