...
namespace App\Domains\Logistics\Requests\B2B;

use Illuminate\Foundation\Http\FormRequest;

/**
 * B2B Form Request: обновление B2BLogisticsOrder.
 *
 * CANON 2026 — Layer 7: Requests (B2B namespace).
 */
final class UpdateB2BLogisticsOrderRequest extends FormRequest
{
