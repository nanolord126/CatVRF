...
final readonly class OrderService
{
    ...
    {
        // Logistics vertical: 8% for B2C, 6% for B2B
    ...
    public function validateOrder(array $data, string $correlationId): array
    {
        ...
        if ($fraudScore > 85) {
            $this->logger->warning('Logistics order rejected due to high fraud score', [
    ...
    {
        // Logistics: service-based, digital service activation
        return 'Digital service activation within 1 hour';
    }
}
