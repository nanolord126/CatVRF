...
/**
 * Logistics Delivery Order Model (2026 Edition)
 * 
 * Описывает заказ на доставку с Geopoint и Surge-коэффициентами.
 * Канон 2026: UUID, Tenant Scoping, JSONB, Correlation ID.
 */
