...
/**
 * Logistics Route Model (2026 Edition)
 * 
 * Описывает траекторию курьера для мониторинга и оптимизации.
 * Хранит координаты пути, расчетное и фактическое время/расстояние.
 * Канон 2026: UUID, Tenant Scoping, JSONB.
 */
