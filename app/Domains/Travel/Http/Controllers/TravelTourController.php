...
final class TravelTourController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        try {
            ...
            $this->logger->$this->logger->info('Travel tour created', [
                'tour_id' => $tour->id,
                'agency_id' => $agency->id,
                'correlation_id' => $correlationId,
            ]);
    ...
    public function update(Request $request, int $id): JsonResponse
    {
        ...
        try {
            ...
            $this->logger->$this->logger->info('Travel tour updated', [
                'tour_id' => $tour->id,
                'correlation_id' => $correlationId,
            ]);
    ...
    public function destroy(int $id): JsonResponse
    {
        ...
        try {
            ...
            $this->logger->$this->logger->info('Travel tour deleted', [
                'tour_id' => $tour->id,
                'correlation_id' => $correlationId,
            ]);
    ...
    public function restore(int $id): JsonResponse
    {
        ...
        try {
            ...
            $this->logger->$this->logger->info('Travel tour restored', [
                'tour_id' => $tour->id,
                'correlation_id' => $correlationId,
            ]);
