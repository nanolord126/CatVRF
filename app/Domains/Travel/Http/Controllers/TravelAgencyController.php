...
final class TravelAgencyController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        try {
            ...
            $this->logger->$this->logger->info('Travel agency created', [
                'agency_id' => $agency->id,
                'name' => $agency->name,
                'owner_id' => $request->user()?->id,
                'correlation_id' => $correlationId,
    ...
    public function update(Request $request, int $id): JsonResponse
    {
        ...
        try {
            ...
            $this->logger->$this->logger->info('Travel agency updated', [
                'agency_id' => $agency->id,
                'correlation_id' => $correlationId,
            ]);
    ...
    public function destroy(int $id): JsonResponse
    {
        ...
        try {
            ...
            $this->db->transaction(function () use ($agency) {
                $agency->delete();
            });

            $this->logger->$this->logger->info('Travel agency deleted', [
                'agency_id' => $agency->id,
                'correlation_id' => $correlationId,
            ]);
        ...
        try {
            ...
            $results = match ($type) {
                'agencies' => \App\Domains\Travel\Models\TravelAgency::where('tenant_id', tenant()->id)
                    ...
                    ->paginate(20),
                'tours' => TravelTour::where('tenant_id', tenant()->id)
                    ->where('name', 'ilike', "%{$query}%")
                    ->paginate(20),
                'guides' => TravelGuide::where('tenant_id', tenant()->id)
            ...
            return new \Illuminate\Http\JsonResponse([
                'success' => true,
                'data' => $results instanceof Paginator ? $results->items() : $results,
                'correlation_id' => Str::uuid(),
            ]);
        } catch (Throwable $e) {
            return new \Illuminate\Http\JsonResponse([
    ...
    public function earnings(int $id): JsonResponse
    {
        try {
            ...
            $monthlyEarnings = $agency->bookings()
                ...
                ->whereBetween('booked_at', [CarbonImmutable::now()->startOfMonth(), CarbonImmutable::now()->endOfMonth()])
    ...
    public function verify(int $id): JsonResponse
    {
        ...
        try {
            ...
            $this->logger->$this->logger->info('Travel agency verified', [
                'agency_id' => $agency->id,
                'correlation_id' => $correlationId,
            ]);
    ...
    public function reject(int $id): JsonResponse
    {
        ...
        try {
            ...
            $this->logger->$this->logger->info('Travel agency rejected', [
                'agency_id' => $agency->id,
                'correlation_id' => $correlationId,
            ]);
    ...
    public function restore(int $id): JsonResponse
    {
        ...
        try {
            ...
            $this->logger->$this->logger->info('Travel agency restored', [
                'agency_id' => $agency->id,
                'correlation_id' => $correlationId,
            ]);
