...
final class TravelReviewController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        try {
            ...
            $this->logger->$this->logger->info('Review created', [
                'review_id' => $review->id,
                'reviewer_id' => $request->user()?->id,
                'correlation_id' => $correlationId,
            ]);
    ...
    public function destroy(int $id): JsonResponse
    {
        ...
        try {
            ...
            $this->logger->$this->logger->info('Review deleted', [
                'review_id' => $review->id,
                'correlation_id' => $correlationId,
            ]);
    ...
    public function approve(int $id): JsonResponse
    {
        ...
        try {
            ...
            $this->logger->$this->logger->info('Review approved', [
                'review_id' => $review->id,
                'correlation_id' => $correlationId,
            ]);
    ...
    public function rejectReview(int $id): JsonResponse
    {
        ...
        try {
            ...
            $this->logger->$this->logger->info('Review rejected', [
                'review_id' => $review->id,
                'correlation_id' => $correlationId,
            ]);
