...
namespace App\Domains\Travel\SubVerticals\Hotels\Presentation\Http\Controllers;
...
final class HotelController extends Controller
{
    ...
    public function search(SearchHotelsRequest $request): JsonResponse
    {
        ...
        try {
            ...
            $this->auditLogger->$this->logger->info('Hotels search performed.', [
    ...
    public function book(BookRoomRequest $request): JsonResponse
    {
        ...
        try {
            ...
            $this->auditLogger->$this->logger->info('Room booked successfully.', [
