...
namespace App\Domains\Travel\SubVerticals\Hotels\Presentation\Http\Resources;
...
final class BookingResource extends JsonResource
{
    ...
    {
        return $checkIn->diffInHours(CarbonImmutable::now(), false) < -self::FREE_CANCELLATION_HOURS;
    }
}
