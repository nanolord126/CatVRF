...
namespace App\Domains\Travel\SubVerticals\Hotels\Presentation\Filament\Resources\HotelResource\Pages;

use CreateHotelUseCase;
...
final class CreateHotel extends CreateRecord
{
    ...
    public function __construct(private readonly CreateHotelUseCase $createHotelUseCase,
    ...
    protected function handleRecordCreation(array $data): Model
    {
        ...
        try {
            return $this->db->transaction(function () use ($data, $correlationId) {
                ...
                $useCase = $this->createHotelUseCase /* TODO: inject via constructor DI */ /* TODO: inject via DI */;
                ...
                $this->logger->$this->logger->info('Hotel created successfully.', [
