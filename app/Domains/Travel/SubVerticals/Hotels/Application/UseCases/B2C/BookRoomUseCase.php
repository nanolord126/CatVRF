...
namespace App\Domains\Travel\SubVerticals\Hotels\Application\UseCases\B2C;
...
final class BookRoomUseCase
{
    ...
    public function __invoke(
        ...
        try {
            ...
            BookingConfirmed::$this->bus->dispatch($booking->getId(), $booking->getTotalPrice(), $booking->getUserId(), $correlationId);

            $this->logger->$this->logger->info('Room booked successfully', [
