...
final readonly class PricingService
{
    ...
    public function calculateRoomPrice(
        ...
        try {
            $this->logger->$this->logger->info('Calculating room price', [
            ...
            $this->logger->$this->logger->info('Room price calculated', [
                'room_type_id' => $roomTypeId,
    ...
    public function getAvailableRooms(
        ...
        try {
            $this->logger->$this->logger->info('Getting available rooms', [
                'hotel_id' => $hotelId,
                'check_in_date' => $checkInDate,
                'correlation_id' => $correlationId,
            ]);
            ...
            $this->logger->$this->logger->info('Available rooms found', [
                'hotel_id' => $hotelId,
