...
namespace App\Domains\Travel\SubVerticals\Hotels\Services\AI;
...
final readonly class AIStayConstructorService
{
    ...
    private function constructStay(
        ...
        $this->logger->$this->logger->info('AI Stay Constructor started', [
            'user_id' => $userId,
            'hotel_id' => $hotelId,
            'tenant_id' => $tenantId,
        ...
        $this->logger->$this->logger->info('AI Stay Constructor completed', [
            'user_id' => $userId,
            'hotel_id' => $hotelId,
