...
namespace App\Domains\Travel\SubVerticals\Hotels\Infrastructure\Providers;
...
final class HotelsServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        $this->loadMigrationsFrom(
            base_path('database' . DIRECTORY_SEPARATOR . 'migrations') /* TODO: inject via DI */
        );

        $this->loadRoutesIfFileExists(
            base_path(/* TODO: inject path via DI */'routes/hotels-api.php')
        );
