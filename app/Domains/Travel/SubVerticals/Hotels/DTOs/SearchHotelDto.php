...
final readonly class SearchHotelDto
{
    ...
    public static function fromRequest(Request $request): self
    {
        return new self(
            ...
            checkIn: Carbon::parse($request->input('check_in', CarbonImmutable::now()->addDay()->toDateString())),
            checkOut: Carbon::parse($request->input('check_out', CarbonImmutable::now()->addDays(2)->toDateString())),
