...
namespace App\Domains\Travel\SubVerticals\Hotels\Resources\B2B;
...
/**
 * B2B API Collection: Amenities.
 *
 * CANON 2026 — Layer 8: Resources (B2B namespace).
 */
final class AmenityCollection extends ResourceCollection
{
    ...
    public function paginationInformation(Request $request, array $paginated, array $default): array
    {
        return [
            'meta' => [
                ...
                'api_version'    => 'v1',
                'resource_type'  => 'amenity_collection',
