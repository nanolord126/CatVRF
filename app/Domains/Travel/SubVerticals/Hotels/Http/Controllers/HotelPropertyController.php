...
final class HotelPropertyController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        ...
        $this->logger->$this->logger->info('Hotel properties listed', [
            'tenant_id' => $tenantId,
    ...
    public function show(Request $request, int $propertyId): JsonResponse
    {
        ...
        $this->logger->$this->logger->info('Hotel property viewed', [
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        $this->logger->$this->logger->info('Hotel property created', [
    ...
    public function update(Request $request, int $propertyId): JsonResponse
    {
        ...
        $this->logger->$this->logger->info('Hotel property updated', [
            'property_id' => $propertyId,
            'correlation_id' => $correlationId,
        ]);
    ...
    public function destroy(Request $request, int $propertyId): JsonResponse
    {
        ...
        $this->logger->$this->logger->info('Hotel property deleted', [
            'property_id' => $propertyId,
            'correlation_id' => $correlationId,
        ]);
