...
namespace App\Domains\Travel\SubVerticals\Hotels\Http\Controllers;
...
final class HotelController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        $this->logger->$this->logger->info('Hotel create start', ['correlation_id' => $correlationId, 'user_id' => $request->user()?->id]);
        ...
        try {
            ...
            $this->logger->$this->logger->info('Hotel created', [
                'correlation_id' => $correlationId,
                'user_id'        => $request->user()?->id,
                'hotel_id'       => $hotel->id,
            ]);
    ...
    public function update(Request $request, string $id): JsonResponse
    {
        ...
        try {
            ...
            $this->logger->$this->logger->info('Hotel updated', [
                'correlation_id' => $correlationId,
                'user_id'        => $request->user()?->id,
                'hotel_id'       => $id,
                'before'         => $before,
    ...
    public function destroy(Request $request, string $id): JsonResponse
    {
        ...
        try {
            ...
            $this->logger->$this->logger->info('Hotel deleted', [
                'correlation_id' => $correlationId,
                'user_id'        => $request->user()?->id,
                'hotel_id'       => $id,
            ]);
    ...
    public function verify(Request $request, string $id): JsonResponse
    {
        ...
        try {
            ...
            $this->logger->$this->logger->info('Hotel verified', [
                'correlation_id' => $correlationId,
                'user_id'        => $request->user()?->id,
                'hotel_id'       => $id,
            ]);
