...
final class RoomTypeController extends Controller
{
    ...
    public function store(Request $request, string $hotelId): JsonResponse
    {
        ...
        try {
            ...
            $this->logger->$this->logger->info('RoomType created', [
    ...
    public function update(Request $request, string $id): JsonResponse
    {
        ...
        try {
            ...
            $this->logger->$this->logger->info('RoomType updated', [
                'correlation_id' => $correlationId,
                'room_type_id' => $room->id,
                'user_id' => $request->user()?->id,
                'before' => $before,
    ...
    public function destroy(Request $request, string $id): JsonResponse
    {
        ...
        try {
            ...
            $this->logger->$this->logger->info('RoomType deleted', [
                'correlation_id' => $correlationId,
                'room_type_id' => $room->id,
                'user_id' => $request->user()?->id,
            ]);
    ...
    public function checkAvailability(Request $request, string $hotelId): JsonResponse
    {
        try {
