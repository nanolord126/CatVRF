...
final class PropertyPolicy
{
     ...
     */
    public function $this->viewFactory->make(User $user, Property $property): bool
    {
    ...
    public function update(User $user, Property $property): bool
    {
        ...
        $this->logger->$this->logger->info('PropertyPolicy::update checked', [
            'user_id' => $user->id,
    ...
    public function delete(User $user, Property $property): bool
    {
        ...
        $this->logger->$this->logger->info('PropertyPolicy::delete checked', [
            'user_id' => $user->id,
            'property_id' => $property->id,
