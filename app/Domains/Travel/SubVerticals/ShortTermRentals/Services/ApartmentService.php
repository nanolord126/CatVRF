...
final readonly class ApartmentService
{
    ...
    public function createBooking(array $data, bool $isB2B): array
    {
        ...
        $this->logger->$this->logger->info('Apartment booking', ['correlation_id' => $cid, 'is_b2b' => $isB2B]);
        ...
        return $this->db->transaction(function () use ($data, $isB2B, $cid) {
            ...
            $nights = CarbonImmutable::now()->parse($data['check_in'])->diffInDays($data['check_out']);
