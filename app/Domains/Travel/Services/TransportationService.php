    ...
    public function bookTransportation(
        ...
        try {
            ...
            $this->db->transaction(function () use (
                ...
                $this->logger->$this->logger->info('Transportation booked', [
                ...
                TransportationBooked::$this->bus->dispatch($transportation, $correlationId);
    ...
    public function releaseTransportation(
        ...
        try {
            ...
            $this->db->transaction(function () use (
                ...
                $this->logger->$this->logger->info('Transportation spaces released', [
                    'transportation_id' => $transportation->id,
                    'type' => $transportation->type,
