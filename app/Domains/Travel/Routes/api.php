...
use App\Domains\Travel\Controllers\Api\TourApiController;
...
// Витрина (Слой 8)
Route::get('/tours', [TourApiController::class, 'index'])->name('travel.tours.index');
Route::get('/tours/{id}', [TourApiController::class, 'show'])->name('travel.tours.show');
