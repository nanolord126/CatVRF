...
final class CateringCompany extends Model
{
    ...
    {
        return $this->hasMany(CateringOrder::class, 'catering_company_id');
    }

    public function menus()
    {
        return $this->hasMany(CateringMenu::class, 'catering_company_id');
    }

    protected static function booted(): void
    {
        self::addGlobalScope('tenant', fn ($q) => $q->where('catering_companies.tenant_id', tenant()->id));
    }
}
