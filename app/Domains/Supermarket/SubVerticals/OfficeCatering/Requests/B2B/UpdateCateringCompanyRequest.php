...
namespace App\Domains\Supermarket\SubVerticals\OfficeCatering\Requests\B2B;

use Illuminate\Foundation\Http\FormRequest;

/**
 * B2B Form Request: обновление CateringCompany.
 *
 * CANON 2026 — Layer 7: Requests (B2B namespace).
 */
final class UpdateCateringCompanyRequest extends FormRequest
{
