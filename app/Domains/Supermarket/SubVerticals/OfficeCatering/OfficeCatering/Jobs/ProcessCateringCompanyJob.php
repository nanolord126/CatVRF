...
namespace App\Domains\Supermarket\SubVerticals\OfficeCatering\Jobs;
...
final class ProcessCateringCompanyJob implements ShouldQueue
{
    ...
    {
        $CateringCompany::findOrFail($this->modelId);

        $this->logger->$this->logger->info('ProcessCateringCompanyJob processed', [
            'model_id' => $model->id,
