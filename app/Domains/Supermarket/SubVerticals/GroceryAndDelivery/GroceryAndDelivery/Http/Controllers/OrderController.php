...
namespace App\Domains\Supermarket\SubVerticals\GroceryAndDelivery\Http\Controllers;
...
final class OrderController extends UniversalOrderController
{
    ...
    public function create(Request $request): JsonResponse
    {
        ...
        if (! $validation['valid']) {
            $this->log->channel('audit')->warning('GroceryAndDelivery order validation failed', [
