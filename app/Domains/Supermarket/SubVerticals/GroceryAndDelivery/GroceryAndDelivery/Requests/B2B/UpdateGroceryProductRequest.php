...
namespace App\Domains\Supermarket\SubVerticals\GroceryAndDelivery\Requests\B2B;

use Illuminate\Foundation\Http\FormRequest;

/**
 * B2B Form Request: обновление GroceryProduct.
 *
 * CANON 2026 — Layer 7: Requests (B2B namespace).
 */
final class UpdateGroceryProductRequest extends FormRequest
{
