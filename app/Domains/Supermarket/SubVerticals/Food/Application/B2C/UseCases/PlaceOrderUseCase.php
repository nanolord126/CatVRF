...
namespace App\Domains\Supermarket\SubVerticals\Food\Application\B2C\UseCases;
...
final readonly class PlaceOrderUseCase
{
    ...
    {
        $this->logger->$this->logger->info('Attempting to place a new order.', [
        ...
        $this->logger->$this->logger->info('Successfully placed a new order.', [
