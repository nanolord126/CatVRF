...
namespace App\Domains\Supermarket\SubVerticals\Food\Http\Controllers;
...
final class DeliveryOrderController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        try {
            ...
            return new JsonResponse(['success' => false, 'message' => 'Ошибка'], 500);
        }
    }
    ...
    public function start(Request $request, DeliveryOrder $delivery): JsonResponse
    {
        ...
        try {
            ...
            $this->logger->$this->logger->info('Delivery started', [
                'correlation_id' => $correlationId,
                'delivery_id' => $delivery->id,
            ...
            $this->eventDispatcher->dispatch(new DeliveryStarted($delivery, $correlationId));
            ...
            return new JsonResponse(['success' => false, 'correlation_id' => $correlationId], 500);
        }
    }
    ...
    public function cancel(Request $request, DeliveryOrder $delivery): JsonResponse
    {
        ...
        try {
            ...
            $this->logger->$this->logger->info('Delivery cancelled', [
                'correlation_id' => $correlationId,
                'delivery_id' => $delivery->id,
                'tenant_id' => $delivery->tenant_id ?? null,
                'before' => $before,
