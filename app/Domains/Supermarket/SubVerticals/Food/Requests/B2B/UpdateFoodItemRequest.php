...
namespace App\Domains\Supermarket\SubVerticals\Food\Requests\B2B;

use Illuminate\Foundation\Http\FormRequest;

/**
 * B2B Form Request: обновление FoodItem.
 *
 * CANON 2026 — Layer 7: Requests (B2B namespace).
 */
final class UpdateFoodItemRequest extends FormRequest
{
