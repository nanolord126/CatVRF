...
final class FoodOrderController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        ...
        $this->logger->$this->logger->info('Заказ еды listed', [
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        $this->logger->$this->logger->info('Заказ еды created', ['correlation_id' => $correlationId, 'id' => $id]);
    ...
    public function update(Request $request, int $id): JsonResponse
    {
        ...
        $this->logger->$this->logger->info('Заказ еды updated', ['correlation_id' => $correlationId, 'id' => $id]);
    ...
    public function destroy(Request $request, int $id): JsonResponse
    {
        ...
        $this->logger->$this->logger->info('Заказ еды deleted', ['correlation_id' => $correlationId, 'id' => $id]);
