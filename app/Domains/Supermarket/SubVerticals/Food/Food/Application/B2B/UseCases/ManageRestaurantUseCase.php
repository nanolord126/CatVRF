...
namespace App\Domains\Supermarket\SubVerticals\Food\Application\B2B\UseCases;
...
final readonly class ManageRestaurantUseCase
{
    ...
    public function createRestaurant(RestaurantDto $dto): Restaurant
    {
        ...
        $this->logger->$this->logger->info('Attempting to create a new restaurant.', [
            'name' => $dto->name,
        ...
        $restaurant = new Restaurant(
            ...
            menuSections: new Collection(),
            correlationId: $dto->correlationId
        );

        $this->restaurantRepository->save($restaurant);

        $this->logger->$this->logger->info('Successfully created a new restaurant.', [
    ...
    public function updateRestaurant(Uuid $id, RestaurantDto $dto): ?Restaurant
    {
        ...
        $this->logger->$this->logger->info('Attempting to update a restaurant.', [
        ...
        $this->logger->$this->logger->info('Successfully updated restaurant.', [
            'restaurant_id' => $id->toString(),
            'correlation_id' => $dto->correlationId?->toString(),
        ]);
    ...
    public function openRestaurant(Uuid $id, ?Uuid $correlationId = null): bool
    {
        ...
        $this->logger->$this->logger->info('Restaurant opened.', [
            'restaurant_id' => $id->toString(),
    ...
    public function closeRestaurant(Uuid $id, ?Uuid $correlationId = null): bool
    {
        ...
        $this->logger->$this->logger->info('Restaurant closed.', [
            'restaurant_id' => $id->toString(),
            'correlation_id' => $correlationId?->toString(),
        ]);
