...
namespace App\Domains\Supermarket\SubVerticals\MeatShops\Requests\B2B;

use Illuminate\Foundation\Http\FormRequest;

/**
 * B2B Form Request: обновление MeatBoxSubscription.
 *
 * CANON 2026 — Layer 7: Requests (B2B namespace).
 */
final class UpdateMeatBoxSubscriptionRequest extends FormRequest
{
