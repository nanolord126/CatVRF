...
namespace App\Domains\Supermarket\SubVerticals\MeatShops\Policies;
...
final class MeatBoxSubscriptionPolicy
{
     ...
     */
    public function $this->viewFactory->make(User $user, MeatBoxSubscription $meatBoxSubscription): bool
    {
