...
namespace App\Domains\Supermarket\SubVerticals\VeganProducts\Requests\B2B;

use Illuminate\Foundation\Http\FormRequest;

/**
 * B2B Form Request: обновление VeganModels.
 *
 * CANON 2026 — Layer 7: Requests (B2B namespace).
 */
final class UpdateVeganModelsRequest extends FormRequest
{
