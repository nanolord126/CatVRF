...
final readonly class VeganProductCreateDto
{
    public function __construct(
        ...
        public int $price,
        private readonly ?int $b2bPrice = null,
        private readonly array $nutritionInfo = [],
        private readonly array $allergenInfo = [],
        private readonly string $ingredients = '',
        private readonly int $initialStock = 0,
        private readonly ?int $shelfLifeDays = null,
        private readonly float $weightGrams = 0.0,
