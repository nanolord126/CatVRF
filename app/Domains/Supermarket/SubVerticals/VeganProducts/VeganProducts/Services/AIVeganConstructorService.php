...
final readonly class AIVeganConstructorService
{
    ...
    public function generatePersonalizedBox(
        ...
        $this->logger->$this->logger->info('LAYER-4: AI Vegan Box Generation START', [
            'goals' => $dietaryGoals,
            'allergies' => $allergies,
        ...
        try {
            ...
            $this->logger->$this->logger->info('LAYER-4: AI Vegan Box Generation SUCCESS', [
    ...
    private function selectProductsByDietaryGoals(Collection $products, array $goals, int $budget): Collection
    {
        ...
        if (in_array('high-protein', $goals, true)) {
