...
namespace App\Domains\Supermarket\SubVerticals\Confectionery\Jobs;
...
final class ProcessBakeryOrderJob implements ShouldQueue
{
    ...
    {
        $BakeryOrder::findOrFail($this->modelId);

        $this->logger->$this->logger->info('ProcessBakeryOrderJob processed', [
            'model_id' => $model->id,
