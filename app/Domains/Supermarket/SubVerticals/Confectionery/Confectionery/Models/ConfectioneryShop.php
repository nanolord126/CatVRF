...
namespace App\Domains\Supermarket\SubVerticals\Confectionery\Models;
...
final class ConfectioneryShop extends Model
{
    ...
    {
        return $this->hasMany(Cake::class, 'confectionery_shop_id');
    }
    ...
    {
        return $this->hasMany(CakeOrder::class, 'confectionery_shop_id');
    }
    ...
    {
        return $this->hasMany(CustomCakeDesign::class, 'confectionery_shop_id');
    }

    protected static function booted(): void
    {
        self::addGlobalScope('tenant', fn ($q) => $q->where('confectionery_shops.tenant_id', tenant()->id));
    }
}
