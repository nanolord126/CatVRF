...
namespace App\Domains\Supermarket\SubVerticals\Confectionery\Http\Controllers;
...
final class OrderController extends Controller
{
    ...
    public function uploadCustomDesign(int $orderId): JsonResponse
    {
        ...
        try {
            ...
            $this->logger->$this->logger->info('Custom cake design uploaded', [
                'order_id' => $order->id,
                'user_id' => $request->user()?->id,
                'photo_path' => $path,
                'correlation_id' => $correlationId,
    ...
    public function cancel(int $orderId): JsonResponse
    {
        ...
        try {
            ...
            $this->logger->$this->logger->info('Cake order cancelled via API', [
                'order_id' => $orderId,
                'user_id' => $request->user()?->id,
                'correlation_id' => $correlationId,
            ]);
