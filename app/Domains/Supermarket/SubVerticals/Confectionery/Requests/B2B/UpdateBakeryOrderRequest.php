...
namespace App\Domains\Supermarket\SubVerticals\Confectionery\Requests\B2B;

use Illuminate\Foundation\Http\FormRequest;

/**
 * B2B Form Request: обновление BakeryOrder.
 *
 * CANON 2026 — Layer 7: Requests (B2B namespace).
 */
final class UpdateBakeryOrderRequest extends FormRequest
{
