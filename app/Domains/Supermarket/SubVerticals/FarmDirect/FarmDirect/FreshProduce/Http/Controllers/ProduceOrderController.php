...
namespace App\Domains\Supermarket\SubVerticals\FarmDirect\FreshProduce\Http\Controllers;
...
final class ProduceOrderController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        ...
        try {
            ...
            $this->logger->$this->logger->info('FreshProduce: orders list', [
                'user_id'        => $requ<?php
    ...
    public function cancel(Request $request, int $id): JsonResponse
    {
        ...
        try {
            ...
            $this->db->transaction(function () use ($order, $correlationId): void {
                ...
                $this->logger->$this->logger->info('FreshProduce: Order cancelled', [
                    'order_id'       => $order->id,
                    'user_id'        => $request->user()?->id,
                    'correlation_id' => $correlationId,
                ]);
    ...
    public function subscribe(Request $request): JsonResponse
    {
        ...
        try {
            ...
            $sub = $this->db->transaction(function () use ($validated, $userId, $correlationId): ProduceSubscription {
                ...
                $this->logger->$this->logger->info('FreshProduce: Subscription created', [
    ...
    public function unsubscribe(Request $request, int $id): JsonResponse
    {
        ...
        try {
            ...
            $this->db->transaction(function () use ($sub, $correlationId): void {
                ...
                $this->logger->$this->logger->info('FreshProduce: Subscription cancelled', ['sub_id' => $sub->id, 'correlation_id' => $correlationId]);
            });
