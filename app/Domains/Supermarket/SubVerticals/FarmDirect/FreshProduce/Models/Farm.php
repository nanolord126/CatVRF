...
final class Farm extends Model
{
    ...
    {
        return $this->hasMany(ProduceProduct::class, 'farm_id');
    }
    ...
    {
        return $this->hasMany(ProduceOrder::class, 'farm_id');
    }

    protected static function booted(): void
    {
        self::addGlobalScope('tenant', fn ($q) => $q->where('produce_farms.tenant_id', tenant()->id));
    }
}
