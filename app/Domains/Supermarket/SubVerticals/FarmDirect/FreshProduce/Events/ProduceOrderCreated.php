...
/**
 * ProduceOrderCreated — CatVRF 2026 Component.
 *
 ...
 *
 * @see https://catvrf.ru/docs/produceordercreated
 */

namespace App\Domains\Supermarket\SubVerticals\FarmDirect\FreshProduce\Events;

use Illuminate\Foundation\Events\Dispatchable;
use Illuminate\Queue\SerializesModels;

final class ProduceOrderCreated
{
    use Dispatchable;
