...
namespace App\Domains\Freelance\Requests\B2B;

use Illuminate\Foundation\Http\FormRequest;

/**
 * B2B Form Request: обновление FreelanceContract.
 *
 * CANON 2026 — Layer 7: Requests (B2B namespace).
 */
final class UpdateFreelanceContractRequest extends FormRequest
{
