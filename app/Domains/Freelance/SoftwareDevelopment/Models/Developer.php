...
/**
 * Developer — CatVRF 2026 Component.
 *
 ...
 *
 * @see https://catvrf.ru/docs/developer
 */
...
final class Developer extends Model
{
    ...
    protected $fillable = ['uuid', 'tenant_id', 'user_id', 'correlation_id', 'name', 'technologies', 'price_kopecks_per_hour', 'rating', 'is_verified', 'tags'];

    protected $casts = ['technologies' => 'json', 'price_kopecks_per_hour' => 'integer', 'rating' => 'float', 'is_verified' => 'boolean', 'tags' => 'json'];

    protected static function booted()
    {
        self::addGlobalScope('tenant', fn ($q) => $q->where('developers.tenant_id', tenant()->id));
    }
