...
final readonly class OrderService
{
    ...
    public function validateOrder(array $data, string $correlationId): array
    {
        ...
        if ($fraudScore > 80) {
            $this->logger->warning('Freelance order rejected due to high fraud score', [
    ...
    {
        // Freelance: service-based, digital project initiation
        return 'Digital project initiation within 24 hours';
    }
}
