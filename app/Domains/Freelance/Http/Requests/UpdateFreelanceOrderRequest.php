...
/**
 * Валидация запроса на обновление FreelanceOrder.
 * Канон CatVRF 2026: declare(strict_types=1), final class, correlation_id.
 */
final class UpdateFreelanceOrderRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'freelancer_id' => 'sometimes|integer|min:1',
            'title' => 'sometimes|string|max:255',
            'requirements' => 'sometimes|string|max:255',
            'budget_kopecks' => 'sometimes|numeric|min:0',
