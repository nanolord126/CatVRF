    ...
    public function store(Request $request): JsonResponse
    {
        ...
        try {
            ...
            return $this->db->transaction(function () use ($validated, $correlationId) {
                ...
                $this->logger->$this->logger->info('Freelance job posted', [
                    'job_id' => $job->id,
                    'client_id' => $request->user()?->id,
                    'budget_min' => ($validated['budget_min'] ?? null),
                    'budget_max' => ($validated['budget_max'] ?? null),
    ...
    public function update(Request $request, int $id): JsonResponse
    {
        ...
        try {
            ...
            return $this->db->transaction(function () use ($job, $correlationId) {
                ...
                $this->logger->$this->logger->info('Freelance job updated', [
                    'job_id' => $job->id,
                    'correlation_id' => $correlationId,
                ]);
    ...
    public function destroy(int $id): JsonResponse
    {
        ...
        try {
            ...
            return $this->db->transaction(function () use ($job, $correlationId) {
                ...
                $this->logger->$this->logger->info('Freelance job deleted', [
                    'job_id' => $job->id,
                    'correlation_id' => $correlationId,
                ]);
    ...
    public function close(int $id): JsonResponse
    {
        try {
            ...
            return $this->db->transaction(function () use ($job, $correlationId) {
                ...
                $this->logger->$this->logger->info('Freelance job closed', [
                    'job_id' => $job->id,
                    'correlation_id' => $correlationId,
                ]);
