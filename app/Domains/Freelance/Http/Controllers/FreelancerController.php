    ...
    public function register(Request $request): JsonResponse
    {
        try {
            ...
            return $this->db->transaction(function () use ($validated, $correlationId) {
                ...
                $this->logger->$this->logger->info('Freelancer registered', [
    ...
    public function update(Request $request, int $id): JsonResponse
    {
        ...
        try {
            ...
            return $this->db->transaction(function () use ($freelancer, $correlationId) {
                ...
                $this->logger->$this->logger->info('Freelancer updated', [
                    'freelancer_id' => $freelancer->id,
                    'user_id' => $request->user()?->id,
                    'correlation_id' => $correlationId,
                ]);
    ...
    public function destroy(int $id): JsonResponse
    {
        ...
        try {
            ...
            return $this->db->transaction(function () use ($freelancer, $correlationId) {
                ...
                $this->logger->$this->logger->info('Freelancer deleted', [
                    'freelancer_id' => $freelancer->id,
                    'user_id' => $request->user()?->id,
                    'correlation_id' => $correlationId,
                ]);
    ...
    public function verify(int $id): JsonResponse
    {
        try {
            ...
            return $this->db->transaction(function () use ($freelancer, $correlationId) {
                ...
                $this->logger->$this->logger->info('Freelancer verified by admin', [
                    'freelancer_id' => $freelancer->id,
                    'correlation_id' => $correlationId,
                ]);
