...
/**
 * Copywriter — CatVRF 2026 Component.
 *
 ...
 *
 * @see https://catvrf.ru/docs/copywriter
 */
...
final class Copywriter extends Model
{
    ...
    protected $table = 'copywriters';

    protected $fillable = ['uuid', 'tenant_id', 'user_id', 'correlation_id', 'name', 'specializations', 'price_kopecks_per_word', 'rating', 'is_verified', 'tags'];

    protected $casts = ['specializations' => 'json', 'price_kopecks_per_word' => 'integer', 'rating' => 'float', 'is_verified' => 'boolean', 'tags' => 'json'];

    protected static function booted()
    {
        self::addGlobalScope('tenant', fn ($q) => $q->where('copywriters.tenant_id', tenant()->id));
    }
