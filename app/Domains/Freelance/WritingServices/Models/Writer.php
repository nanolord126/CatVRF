 ...
 *
 * @see https://catvrf.ru/docs/writer
 */
...
final class Writer extends Model
{
    ...
    protected $fillable = ['uuid', 'tenant_id', 'user_id', 'correlation_id', 'name', 'genres', 'price_kopecks_per_word', 'rating', 'is_verified', 'tags'];

    protected $casts = ['genres' => 'json', 'price_kopecks_per_word' => 'integer', 'rating' => 'float', 'is_verified' => 'boolean', 'tags' => 'json'];

    protected static function booted()
    {
        self::addGlobalScope('tenant', fn ($q) => $q->where('writers.tenant_id', tenant()->id));
    }
