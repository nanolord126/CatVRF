...
final readonly class OrderService
{
    ...
    {
        // Legal vertical: 15% for B2C, 12% for B2B
    ...
    public function validateOrder(array $data, string $correlationId): array
    {
        ...
        if ($fraudScore > 90) {
            $this->logger->warning('Legal order rejected due to high fraud score', [
    ...
    {
        // Legal: service-based, digital consultation scheduling
