...
namespace App\Domains\CloudStorage\Services;
use App\Domains\CloudStorage\Models\StorageProvider;
use App\Domains\CloudStorage\Models\StorageSubscription;
 ...
 * @version 1.0.0
 */
class CloudStorageService{public function __construct(private readonly FraudControlService $fraud,private readonly WalletService $wallet){
    /**
