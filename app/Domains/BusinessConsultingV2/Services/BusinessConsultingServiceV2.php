...
use App\Domains\BusinessConsulting\Models\ConsultingEngagement;
 ...
 * @version 1.0.0
 */
class BusinessConsultingServiceV2{public function __construct(private readonly FraudControlService $fraud,private readonly WalletService $wallet){
    /**
