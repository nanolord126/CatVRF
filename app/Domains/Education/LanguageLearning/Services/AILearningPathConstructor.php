...
use App\Domains\Education\LanguageLearning\Services\LanguagePricingService;
use Illuminate\Support\Collection;
use Illuminate\Support\Facades\Log;
use Illuminate\Support\Str;

/**
 * AI Сервис для генерации персонализированных планов изучения языков.
 * На базе канона 2026: ML + Продакт Маркетплейс.
 */
