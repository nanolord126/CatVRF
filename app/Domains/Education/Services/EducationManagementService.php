...
use App\Exceptions\BalanceInsufficientException;
use App\Exceptions\SlotLimitExceededException;

/**
 * EducationManagementService.
 * Канон 2026: Бизнес-логика Premium Education.
 * Управление B2B корпоративными контрактами и B2C прямой покупкой.
 */
