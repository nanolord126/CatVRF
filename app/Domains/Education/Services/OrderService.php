...
final readonly class OrderService
{
    ...
    {
        // Education vertical: 12% for B2C, 10% for B2B
    ...
    public function validateOrder(array $data, string $correlationId): array
    {
        ...
        if ($fraudScore > 80) {
            $this->logger->warning('Education order rejected due to high fraud score', [
    ...
    {
        // Education: service-based, instant digital access
