...
namespace App\Domains\Education\Requests\B2B;

use Illuminate\Foundation\Http\FormRequest;

/**
 * B2B Form Request: обновление CorporateContract.
 *
 * CANON 2026 — Layer 7: Requests (B2B namespace).
 */
final class UpdateCorporateContractRequest extends FormRequest
{
