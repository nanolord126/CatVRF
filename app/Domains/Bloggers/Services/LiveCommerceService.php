...
class LiveCommerceService
{
    ...
    public function addProductToStream(
        ...
        return $this->db->transaction(function () use (
            ...
            broadcast(new \App\Domains\Bloggers\Events\ProductAddedToStream($product))->toOthers();
    ...
    public function unpinProduct(int $productId, string $correlationId = ''): StreamProduct
    {
        ...
        return $this->db->transaction(function () use ($product, $correlationId) {
            ...
            broadcast(new \App\Domains\Bloggers\Events\ProductUnpinned($product))->toOthers();
