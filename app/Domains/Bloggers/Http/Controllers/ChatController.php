...
use App\Domains\Bloggers\Models\StreamChatMessage;
use App\Domains\Bloggers\Http\Requests\SendChatMessageRequest;
...
final class ChatController
{
    ...
    public function send(SendChatMessageRequest $request, string $roomId): JsonResponse
    {
        try {
            ...
            broadcast(new \App\Domains\Bloggers\Events\ChatMessagePosted(
                roomId: $roomId,
                message: $message,
            ))->toOthers();
