...
final readonly class Jewelry3DService
{
    ...
    public function uploadModel(array $data): Jewelry3DModel
    {
        ...
        $this->logger->$this->logger->info('Jewelry3DService: Uploading 3D model', [
    ...
    public function generateARView(int $modelId): string
    {
        ...
        $this->logger->$this->logger->info('Jewelry3DService: Generating AR view', [
            'model_id' => $modelId,
    ...
    public function generateVRView(int $modelId): string
    {
        ...
        $this->logger->$this->logger->info('Jewelry3DService: Generating VR view', [
            'model_id' => $modelId,
            'jewelry_item_id' => $model->jewelry_item_id,
            'correlation_id' => $this->request?->header('X-Correlation-ID', \Illuminate\Support\Str::uuid()->toString()),
        ]);
    ...
    public function changeMetalType(int $modelId, string $metalType): Jewelry3DModel
    {
        ...
        $this->logger->$this->logger->info('Jewelry3DService: Changing metal type', [
            'model_id' => $modelId,
    ...
    public function downloadModel(int $modelId, string $format = 'glb'): string
    {
        ...
        $this->logger->$this->logger->info('Jewelry3DService: Downloading model', [
            'model_id' => $modelId,
            'format' => $format,
            'correlation_id' => $this->request?->header('X-Correlation-ID', \Illuminate\Support\Str::uuid()->toString()),
        ]);
    ...
    public function createModelPreview(int $modelId, array $angles = []): array
    {
        ...
        return [
            'model_id' => $modelId,
            'previews' => new Collection($angles)->map(fn ($angle) => [
                'angle' => $angle,
