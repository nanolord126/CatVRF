...
namespace App\Domains\Luxury\Resources\B2B;
...
/**
 * B2B API Collection: LuxuryBrands.
 *
 * CANON 2026 — Layer 8: Resources (B2B namespace).
 */
final class LuxuryBrandCollection extends ResourceCollection
{
    public $collects = LuxuryBrandResource::class;
    ...
    public function paginationInformation(Request $request, array $paginated, array $default): array
    {
        return [
            'meta' => [
                ...
                'api_version'    => 'v1',
                'resource_type'  => 'luxury_brand_collection',
