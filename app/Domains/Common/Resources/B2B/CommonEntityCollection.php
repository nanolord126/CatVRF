...
namespace App\Domains\Common\Resources\B2B;
...
/**
 * B2B API Collection: CommonEntities.
 *
 * CANON 2026 — Layer 8: Resources (B2B namespace).
 */
final class CommonEntityCollection extends ResourceCollection
{
    public $collects = CommonEntityResource::class;
    ...
    public function paginationInformation(Request $request, array $paginated, array $default): array
    {
        return [
            'meta' => [
                ...
                'api_version'    => 'v1',
                'resource_type'  => 'common_entity_collection',
