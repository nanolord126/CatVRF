...
namespace App\Domains\Pharmacy\Resources\B2B;
...
/**
 * B2B API Collection: Medications.
 *
 * CANON 2026 — Layer 8: Resources (B2B namespace).
 */
final class MedicationCollection extends ResourceCollection
{
    public $collects = MedicationResource::class;
    ...
    public function paginationInformation(Request $request, array $paginated, array $default): array
    {
        return [
            'meta' => [
                ...
                'api_version'    => 'v1',
                'resource_type'  => 'medication_collection',
