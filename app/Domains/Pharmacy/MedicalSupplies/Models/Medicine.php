...
/**
 * Medicine — CatVRF 2026 Component.
 *
 ...
 * @see https://catvrf.ru/docs/medicine
 */
...
final class Medicine extends Model
{
    ...
    protected $fillable = ['uuid', 'tenant_id', 'pharmacy_id', 'correlation_id', 'name', 'price_kopecks', 'requires_rx', 'stock', 'tags'];
    protected $casts = ['price_kopecks' => 'integer', 'requires_rx' => 'boolean', 'stock' => 'integer', 'tags' => 'json'];

    protected static function booted()
    {
        static::addGlobalScope('tenant', fn ($q) => $q->where('medicines.tenant_id', tenant()->id));
    }
