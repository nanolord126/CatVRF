...
final readonly class TaxiGeoService
{
    ...
    public function calculateRoute(
        ...
        $this->logger->$this->logger->info('Taxi route calculated', [
    ...
    public function predictPickupETA(
        ...
        return [
            ...
            'predicted_at' => CarbonImmutable::now()->toIso8601String(),
        ];
    }
    ...
    public function createGeoZone(array $data, ?string $correlationId = null): TaxiGeoZone
    {
        ...
        $this->logger->$this->logger->info('Taxi geo zone created', [
            'correlation_id' => $correlationId,
            'zone_uuid' => $zone->uuid,
            'zone_name' => $zone->name,
            'zone_type' => $zone->type,
    ...
    public function updateDriverLocation(int $driverId, float $latitude, float $longitude, ?string $correlationId = null): void
    {
        ...
        $this->logger->$this->logger->info('Driver location updated', [
            'correlation_id' => $correlationId,
            'driver_id' => $driverId,
            'latitude' => $latitude,
            'longitude' => $longitude,
