...
final readonly class OrderService
{
    ...
    {
        // Taxi vertical: 15% for B2C, 12% for B2B
    ...
    public function validateOrder(array $data, string $correlationId): array
    {
        ...
        if ($fraudScore > 80) {
            $this->logger->warning('Taxi order rejected due to high fraud score', [
    ...
    {
        // Taxi: service-based, real-time service
        return 'Real-time service dispatch (5-15 min arrival)';
    }
}
