...
/**
 * Валидация запроса на обновление TaxiRide.
 * Канон CatVRF 2026: declare(strict_types=1), final class, correlation_id.
 */
final class UpdateTaxiRideRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'pickup_lat' => 'sometimes|string|max:255',
            'pickup_lon' => 'sometimes|string|max:255',
            'dropoff_address' => 'sometimes|string|max:255',
            'dropoff_lat' => 'sometimes|string|max:255',
            'dropoff_lon' => 'sometimes|string|max:255',
        ];
    }
