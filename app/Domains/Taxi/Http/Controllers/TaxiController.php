...
final class TaxiController extends Controller
{
    ...
    public function update(Request $request, Taxi $taxi): JsonResponse
    {
        ...
        try {
            ...
            $this->logger->$this->logger->info('Taxi updated', ['correlation_id' => $correlationId, 'taxi_id' => $taxi->id]);
    ...
    public function destroy(Taxi $taxi): JsonResponse
    {
        ...
        try {
            $taxi->delete();
            $this->logger->$this->logger->info('Taxi deleted', ['correlation_id' => $correlationId, 'taxi_id' => $taxi->id]);
