...
namespace App\Domains\Marketplace\Requests\B2B;

use Illuminate\Foundation\Http\FormRequest;

/**
 * B2B Form Request: обновление MarketplaceListing.
 *
 * CANON 2026 — Layer 7: Requests (B2B namespace).
 */
final class UpdateMarketplaceListingRequest extends FormRequest
{
