...
/**
 * PersonalShopper — CatVRF 2026 Component.
 *
 ...
 *
 * @see https://catvrf.ru/docs/personalshopper
 */
...
final class PersonalShopper extends Model
{
    ...
    protected $table = 'personal_shoppers';
    ...
    {
        self::addGlobalScope('tenant', fn ($q) => $q->where('personal_shoppers.tenant_id', tenant()->id));
    }
