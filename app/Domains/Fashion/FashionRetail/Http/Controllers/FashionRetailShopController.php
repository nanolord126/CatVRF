...
final class FashionRetailShopController extends Controller
{
    ...
    public function index(): JsonResponse
    {
        try {
            ...
            $this->logger->$this->logger->info('FashionRetail shops listed', [
                'count' => $shops->count(),
    ...
    public function store(): JsonResponse
    {
        ...
        try {
            ...
            $this->logger->$this->logger->info('FashionRetail shop created', [
                'shop_id' => $shop->id,
                'owner_id' => $request->user()?->id,
                'correlation_id' => $correlationId,
            ]);
    ...
    public function update(int $id): JsonResponse
    {
        ...
        try {
            ...
            $this->logger->$this->logger->info('FashionRetail shop updated', [
                'shop_id' => $id,
                'correlation_id' => $correlationId,
            ]);
