...
final class FashionRetailProductController extends Controller
{
    ...
    public function index(): JsonResponse
    {
        try {
            ...
            $this->logger->$this->logger->info('FashionRetail products listed', [
    ...
    public function store(): JsonResponse
    {
        ...
        try {
            ...
            $this->logger->$this->logger->info('FashionRetail product created', [
    ...
    public function update(int $id): JsonResponse
    {
        ...
        try {
            ...
            $this->logger->$this->logger->info('FashionRetail product updated', [
                'product_id' => $id,
                'correlation_id' => $correlationId,
            ]);
    ...
    public function destroy(int $id): JsonResponse
    {
        ...
        try {
            ...
            $this->logger->$this->logger->info('FashionRetail product deleted', [
                'product_id' => $id,
                'correlation_id' => $correlationId,
            ]);
