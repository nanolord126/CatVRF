...
final class FashionRetailReviewController extends Controller
{
    ...
    public function index(int $productId): JsonResponse
    {
        try {
            ...
            $this->logger->$this->logger->info('FashionRetail reviews listed', [
    ...
    public function store(int $productId): JsonResponse
    {
        ...
        try {
            ...
            $this->logger->$this->logger->info('FashionRetail review created', [
                'review_id' => $review->id,
                'product_id' => $productId,
                'user_id' => $request->user()?->id,
                'correlation_id' => $correlationId,
    ...
    public function destroy(int $productId, int $reviewId): JsonResponse
    {
        ...
        try {
            ...
            $this->logger->$this->logger->info('FashionRetail review deleted', [
                'review_id' => $reviewId,
                'correlation_id' => $correlationId,
            ]);
