...
{
    public function __construct(private readonly FashionOnlineStylistService $stylist) {}
    ...
    public function getStyleConsultation(Request $request): JsonResponse
    {
        ...
        return new JsonResponse(['success' => true, 'data' => $result, 'correlation_id' => $correlationId]);
    }
