...
final readonly class OrderService
{
    ...
    {
        // Delivery vertical: 10% for B2C, 8% for B2B
    ...
    public function validateOrder(array $data, string $correlationId): array
    {
        ...
        if ($fraudScore > 75) {
            $this->logger->warning('Delivery order rejected due to high fraud score', [
    ...
    {
        // Delivery: service-based, real-time dispatch
        return 'Real-time dispatch (30-90 min arrival)';
    }
}
