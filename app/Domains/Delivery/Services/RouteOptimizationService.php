...
final readonly class RouteOptimizationService
{
    ...
    public function optimizeForCourier(int $courierId, array $orderIds): array
    {
        ...
        $this->fraud->check((int) (auth()->id() ?? 0), 'route_optimization', 0, $this->request->ip(), null, $correlationId);
        ...
        $this->db->transaction(function () use ($finalRoute, $correlationId, $courierId, $previousTotalMin): void {
    ...
    private function maybeAwardEfficiencyBonus(
        ...
        $this->wallet->credit(
            ...
            amount: $bonusKopecks,
            reason: "Efficiency bonus: saved {$savedMinutes} min",
