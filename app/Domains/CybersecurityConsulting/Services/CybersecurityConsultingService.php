...
final /**
 * CybersecurityConsultingService
 * 
 ...
 * @version 1.0.0
 */
class CybersecurityConsultingService{public function __construct(private readonly FraudControlService $fraud,private readonly WalletService $wallet){
    /**
