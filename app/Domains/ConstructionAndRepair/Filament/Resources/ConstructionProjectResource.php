...
final class ConstructionProjectResource extends Resource
{
    ...
    {
        return [
            'index' => \App\Domains\ConstructionAndRepair\Filament\Resources\ConstructionProjectResource\Pages\ListConstructionProjects::route('/'),
            'create' => \App\Domains\ConstructionAndRepair\Filament\Resources\ConstructionProjectResource\Pages\CreateConstructionProject::route('/create'),
            'edit' => \App\Domains\ConstructionAndRepair\Filament\Resources\ConstructionProjectResource\Pages\EditConstructionProject::route('/{record}/edit'),
        ];
    }
}