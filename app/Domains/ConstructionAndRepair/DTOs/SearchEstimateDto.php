...
namespace App\Domains\ConstructionAndRepair\DTOs;

use Illuminate\Http\Request;

/**
 * Class SearchEstimateDto
 *
 ...
 * @package App\Domains\ConstructionAndRepair\DTOs
 */
final readonly class SearchEstimateDto
{
