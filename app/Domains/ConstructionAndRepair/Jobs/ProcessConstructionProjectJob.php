 ...
 * @package App\Domains\ConstructionAndRepair\Jobs
 */
final class ProcessConstructionProjectJob implements ShouldQueue
{
    ...
    {
        $model = ConstructionProject::findOrFail($this->modelId);

        $this->logger->info('ProcessConstructionProjectJob processed', [
            'model_id' => $model->id,
