...
namespace App\Domains\ConstructionAndRepair\Requests\B2B;

use Illuminate\Foundation\Http\FormRequest;

/**
 * B2B Form Request: обновление ConstructionProject.
 *
 * CANON 2026 — Layer 7: Requests (B2B namespace).
 */
final class UpdateConstructionProjectRequest extends FormRequest
{
