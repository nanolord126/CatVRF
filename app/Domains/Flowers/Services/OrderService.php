...
final readonly class OrderService
{
    ...
    {
        // Flowers vertical: 18% for B2C, 15% for B2B
        $rate = $isB2B ? 0.15 : 0.18;
    ...
    public function validateOrder(array $data, string $correlationId): array
    {
        ...
        if ($fraudScore > 75) {
            $this->logger->warning('Flowers order rejected due to high fraud score', [
        ...
        if (isset($data['items']) && is_array($data['items'])) {
            ...
            if (!$inventoryCheck['available']) {
                $this->logger->warning('Flowers order rejected due to insufficient inventory', [
    ...
    public function checkInventory(array $items): array
    {
        ...
        foreach ($items as $item) {
            ...
            // TODO: Implement actual inventory check for flowers (may have seasonal availability)
        }
    ...
    {
        // Flowers: product-based, physical delivery
        return '2-4 hours (physical delivery)';
    }
}
