...
use App\Domains\MeatShops\Models\MeatBox;
use App\Domains\MeatShops\Models\MeatSupplier;
...
/**
 * Сервис управления мясными лавками и разделкой - КАНОН 2026.
 * Контроль ветеринарных справок, холодная цепь, разделка и 14% комиссия.
 */
final class MeatService
{
