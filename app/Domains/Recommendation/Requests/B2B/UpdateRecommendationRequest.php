...
namespace App\Domains\Recommendation\Requests\B2B;

use Illuminate\Foundation\Http\FormRequest;

/**
 * B2B Form Request: обновление Recommendation.
 *
 * CANON 2026 — Layer 7: Requests (B2B namespace).
 */
final class UpdateRecommendationRequest extends FormRequest
{
