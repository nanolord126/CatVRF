...
namespace App\Domains\Recommendation\Resources\B2B;
...
/**
 * B2B API Collection: Recommendations.
 *
 * CANON 2026 — Layer 8: Resources (B2B namespace).
 */
final class RecommendationCollection extends ResourceCollection
{
    public $collects = RecommendationResource::class;
