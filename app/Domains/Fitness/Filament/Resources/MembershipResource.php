...
final class MembershipResource extends Resource
{
    ...
    {
        return [
            'index' => \App\Domains\Fitness\Filament\Resources\MembershipResource\Pages\ListMemberships::route('/'),
            'create' => \App\Domains\Fitness\Filament\Resources\MembershipResource\Pages\CreateMembership::route('/create'),
            'edit' => \App\Domains\Fitness\Filament\Resources\MembershipResource\Pages\EditMembership::route('/{record}/edit'),
        ];
    }
