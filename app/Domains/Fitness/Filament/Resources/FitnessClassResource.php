...
final class FitnessClassResource extends Resource
{
    ...
    {
        return [
            'index' => \App\Domains\Fitness\Filament\Resources\FitnessClassResource\Pages\ListFitnessClasses::route('/'),
            'create' => \App\Domains\Fitness\Filament\Resources\FitnessClassResource\Pages\CreateFitnessClass::route('/create'),
            'edit' => \App\Domains\Fitness\Filament\Resources\FitnessClassResource\Pages\EditFitnessClass::route('/{record}/edit'),
        ];
    }
