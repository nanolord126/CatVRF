...
final class PerformanceMetricResource extends Resource
{
    ...
    {
        return [
            'index' => \App\Domains\Fitness\Filament\Resources\PerformanceMetricResource\Pages\ListPerformanceMetrics::route('/'),
            'view' => \App\Domains\Fitness\Filament\Resources\PerformanceMetricResource\Pages\ViewPerformanceMetric::route('/{record}'),
            'edit' => \App\Domains\Fitness\Filament\Resources\PerformanceMetricResource\Pages\EditPerformanceMetric::route('/{record}/edit'),
        ];
    }
