...
final class B2BFitnessStorefrontResource extends Resource
{
    protected static ?string $model = B2BFitnessStorefront::class;

    protected static ?string $navigationIcon = 'heroicon-o-bolt';

    protected static ?string $navigationGroup = 'Fitness B2B';
