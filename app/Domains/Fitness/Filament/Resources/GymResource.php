...
final class GymResource extends Resource
{
    ...
    {
        return [
            'index' => \App\Domains\Fitness\Filament\Resources\GymResource\Pages\ListGyms::route('/'),
            'create' => \App\Domains\Fitness\Filament\Resources\GymResource\Pages\CreateGym::route('/create'),
            'edit' => \App\Domains\Fitness\Filament\Resources\GymResource\Pages\EditGym::route('/{record}/edit'),
        ];
    }
}