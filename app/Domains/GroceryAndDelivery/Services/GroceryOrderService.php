...
use App\Domains\GroceryAndDelivery\Models\{GroceryOrder, GroceryProduct, DeliverySlot};
...
final readonly class FastDeliveryService
{
    ...
    public function assignDeliveryPartner(
        GroceryOrder $order,
        string $correlationId,
    ): \App\Domains\GroceryAndDelivery\Models\DeliveryPartner {
        ...
        return \App\Domains\GroceryAndDelivery\Models\DeliveryPartner::findOrFail($partner->id);
    }
}
