...
final readonly class OrderService
{
    ...
    {
        // CRM vertical: 15% for B2C, 12% for B2B
    ...
    public function validateOrder(array $data, string $correlationId): array
    {
        ...
        if ($fraudScore > 80) {
            $this->logger->warning('CRM order rejected due to high fraud score', [
    ...
    {
        // CRM: service-based, instant digital activation
        return 'Instant digital platform access';
    }
}
