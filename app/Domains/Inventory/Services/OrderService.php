...
final readonly class OrderService
{
    ...
    public function validateOrder(array $data, string $correlationId): array
    {
        ...
        if ($fraudScore > 85) {
            $this->logger->warning('Inventory order rejected due to high fraud score', [
    ...
    {
        // Inventory: service-based, digital system setup
        return 'Digital system setup within 24-48 hours';
    }
}
