...
final readonly class OrderService
{
    ...
    public function validateOrder(array $data, string $correlationId): array
    {
        ...
        if ($fraudScore > 90) {
            $this->logger->warning('Wallet order rejected due to high fraud score', [
    ...
    {
        // Wallet: service-based, instant digital transaction
        return 'Instant digital transaction processing';
    }
}
