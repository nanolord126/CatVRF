...
use App\Domains\RitualServices\RitualServices\Ritual\Models\MemorialProduct;
...
/**
 * MemorialConstructor — Production Ready 2026
 * 
 * AI-конструктор для выбора памятников и ритуальных изделий.
 * Интегрирован с рекомендациями и инвентарным учетом.
 */
