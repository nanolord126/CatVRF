...
namespace App\Domains\Karaoke\Services;
use App\Domains\Karaoke\Models\KaraokeClub;
use App\Domains\Karaoke\Models\KaraokeBooking;
 ...
 * @version 1.0.0
 */
class KaraokeService{public function __construct(private readonly FraudControlService $fraud,private readonly WalletService $wallet){
    /**
