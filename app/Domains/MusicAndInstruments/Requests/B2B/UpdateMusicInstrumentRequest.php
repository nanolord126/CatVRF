...
namespace App\Domains\MusicAndInstruments\Requests\B2B;

use Illuminate\Foundation\Http\FormRequest;

/**
 * B2B Form Request: обновление MusicInstrument.
 *
 * CANON 2026 — Layer 7: Requests (B2B namespace).
 */
final class UpdateMusicInstrumentRequest extends FormRequest
{
