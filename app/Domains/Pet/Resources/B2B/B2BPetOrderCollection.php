...
namespace App\Domains\Pet\Resources\B2B;
...
/**
 * B2B API Collection: B2BPetOrders.
 *
 * CANON 2026 — Layer 8: Resources (B2B namespace).
 */
final class B2BPetOrderCollection extends ResourceCollection
{
    public $collects = B2BPetOrderResource::class;
    ...
    public function paginationInformation(Request $request, array $paginated, array $default): array
    {
        return [
            'meta' => [
                ...
                'api_version'    => 'v1',
                'resource_type'  => 'b2_b_pet_order_collection',
