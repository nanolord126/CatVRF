...
namespace App\Domains\FraudML\Resources\B2B;
...
/**
 * B2B API Collection: FraudModels.
 *
 * CANON 2026 — Layer 8: Resources (B2B namespace).
 */
final class FraudModelCollection extends ResourceCollection
{
    public $collects = FraudModelResource::class;
    ...
    public function paginationInformation(Request $request, array $paginated, array $default): array
    {
        return [
            'meta' => [
                ...
                'api_version'    => 'v1',
                'resource_type'  => 'fraud_model_collection',
