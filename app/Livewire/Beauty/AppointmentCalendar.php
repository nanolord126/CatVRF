...
final class AppointmentCalendar extends Component
{
    ...
    private readonly array $selectedDayAppointments = [];

    private readonly ?string $selectedDate = null;
    ...
    public function selectDay(string $date): void
    {
        ...
        $this->logger->channel('audit')->$this->logger->info('BeautyCalendar: day selected', [
    ...
    {
        return $this->viewFactory->make('livewire.beauty.appointment-calendar', [
    ...
    private function buildCalendar(): void
    {
        ...
        foreach ($period as $day) {
            ...
            $dayAppointments = $byDate->get($dateStr, new Collection());
