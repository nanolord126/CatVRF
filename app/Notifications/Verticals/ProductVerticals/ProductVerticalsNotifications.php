...
{
    private readonly string $type = 'cosmetics.order.shipped';

    private readonly string $template = 'emails.cosmetics.order_shipped';
...
{
    private readonly string $type = 'cosmetics.delivery.arrived';
...
{
    private readonly string $type = 'jewelry.order.shipped';

    private readonly string $template = 'emails.jewelry.order_shipped';
...
{
    private readonly string $type = 'jewelry.delivery.confirmed';
...
{
    private readonly string $type = 'gifts.order.shipped';

    private readonly string $template = 'emails.gifts.order_shipped';
...
{
    private readonly string $type = 'gifts.delivery.arrived';
...
{
    private readonly string $type = 'furniture.order.confirmed';

    private readonly string $template = 'emails.furniture.order_confirmed';
...
{
    private readonly string $type = 'furniture.delivery.scheduled';
...
{
    private readonly string $type = 'electronics.order.shipped';

    private readonly string $template = 'emails.electronics.order_shipped';
...
{
    private readonly string $type = 'electronics.delivery.confirmed';
...
{
    private readonly string $type = 'bonus.earned';
...
{
    private readonly string $type = 'bonus.expired';
...
{
    private readonly string $type = 'bonus.about_to_expire';
...
{
    private readonly string $type = 'wallet.deposit.received';

    private readonly string $template = 'emails.wallet.deposit_received';
...
{
    private readonly string $type = 'wallet.withdrawal.processed';

    private readonly string $template = 'emails.wallet.withdrawal_processed';
...
{
    private readonly string $type = 'wallet.low_balance';
...
{
    private readonly string $type = 'wallet.limit_reached';
...
{
    private readonly string $type = 'referral.invite.sent';
...
{
    private readonly string $type = 'referral.friend.joined';
...
{
    private readonly string $type = 'referral.bonus.earned';

    private readonly string $template = 'emails.referral.bonus_earned';
...
{
    private readonly string $type = 'referral.milestone.reached';
