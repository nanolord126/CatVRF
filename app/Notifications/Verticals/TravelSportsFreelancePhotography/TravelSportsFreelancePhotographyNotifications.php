...
{
    private readonly string $type = 'travel.booking.confirmed';

    private readonly string $template = 'emails.travel.booking_confirmed';
...
{
    private readonly string $type = 'travel.travel.reminder';
...
{
    private readonly string $type = 'photography.review.request';
