...
{
    private readonly string $type = 'medical.appointment.scheduled';

    private readonly string $template = 'emails.medical.appointment_scheduled';
...
{
    private readonly string $type = 'medical.doctor.changed';
...
{
    private readonly string $type = 'medical.prescription.ready';
...
{
    private readonly string $type = 'medical.lab_result.ready';

    private readonly string $template = 'emails.medical.lab_result_ready';
...
{
    private readonly string $type = 'pet.service.booked';

    private readonly string $template = 'emails.pet.service_booked';
...
{
    private readonly string $type = 'pet.service.reminder';
...
{
    private readonly string $type = 'pet.service.completed';
...
{
    private readonly string $type = 'tickets.ticket.purchased';

    private readonly string $template = 'emails.tickets.ticket_purchased';
...
{
    private readonly string $type = 'tickets.event.reminder';
...
{
    private readonly string $type = 'tickets.event.cancelled';

    private readonly string $template = 'emails.tickets.event_cancelled';
