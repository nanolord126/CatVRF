...
/**
 * SportingGoods3DService — CatVRF 2026 Component.
 *
 ...
 * @see https://catvrf.ru/docs/sportinggoods3dservice
 * @see https://catvrf.ru/docs/sportinggoods3dservice
 * @see https://catvrf.ru/docs/sportinggoods3dservice
 * @see https://catvrf.ru/docs/sportinggoods3dservice
 * @see https://catvrf.ru/docs/sportinggoods3dservice
 ...
 */
final class SportingGoods3DService
{
    /**
    ...
    {
        return "/3d-models/SportingGoods/" . ($productData['sku'] ?? 'default') . ".glb";
    }

    private function getPreviewPath(array $productData): string
    {
        return "/3d-previews/SportingGoods/" . ($productData['id'] ?? 'default') . ".png";
    }
}
