...
/**
 * PetServices3DService — CatVRF 2026 Component.
 *
 ...
 * @see https://catvrf.ru/docs/petservices3dservice
 * @see https://catvrf.ru/docs/petservices3dservice
 * @see https://catvrf.ru/docs/petservices3dservice
 * @see https://catvrf.ru/docs/petservices3dservice
 * @see https://catvrf.ru/docs/petservices3dservice
 ...
 */
final class PetServices3DService
{
    /**
    ...
    {
        return "/3d-models/PetServices/" . ($productData['sku'] ?? 'default') . ".glb";
    }

    private function getPreviewPath(array $productData): string
    {
        return "/3d-previews/PetServices/" . ($productData['id'] ?? 'default') . ".png";
    }
}
