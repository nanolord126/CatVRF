...
/**
 * Sports3DService — CatVRF 2026 Component.
 *
 ...
 * @see https://catvrf.ru/docs/sports3dservice
 * @see https://catvrf.ru/docs/sports3dservice
 * @see https://catvrf.ru/docs/sports3dservice
 * @see https://catvrf.ru/docs/sports3dservice
 * @see https://catvrf.ru/docs/sports3dservice
...
final class Sports3DService
{
    ...
    {
        return "/3d-models/Sports/" . ($productData['sku'] ?? 'default') . ".glb";
    }

    private function getPreviewPath(array $productData): string
    {
        return "/3d-previews/Sports/" . ($productData['id'] ?? 'default') . ".png";
    }
}
