...
/**
 * Auto3DService — CatVRF 2026 Component.
 *
 ...
 * @see https://catvrf.ru/docs/auto3dservice
 * @see https://catvrf.ru/docs/auto3dservice
 * @see https://catvrf.ru/docs/auto3dservice
 * @see https://catvrf.ru/docs/auto3dservice
 * @see https://catvrf.ru/docs/auto3dservice
...
final class Auto3DService
{
    ...
    {
        return "/3d-models/Auto/" . ($productData['sku'] ?? 'default') . ".glb";
    }

    private function getPreviewPath(array $productData): string
    {
        return "/3d-previews/Auto/" . ($productData['id'] ?? 'default') . ".png";
    }
}
