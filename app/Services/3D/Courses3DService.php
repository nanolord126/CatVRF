...
/**
 * Courses3DService — CatVRF 2026 Component.
 *
 ...
 * @see https://catvrf.ru/docs/courses3dservice
 * @see https://catvrf.ru/docs/courses3dservice
 * @see https://catvrf.ru/docs/courses3dservice
 * @see https://catvrf.ru/docs/courses3dservice
 * @see https://catvrf.ru/docs/courses3dservice
...
final class Courses3DService
{
    ...
    {
        return "/3d-models/Courses/" . ($productData['sku'] ?? 'default') . ".glb";
    }

    private function getPreviewPath(array $productData): string
    {
        return "/3d-previews/Courses/" . ($productData['id'] ?? 'default') . ".png";
    }
}
