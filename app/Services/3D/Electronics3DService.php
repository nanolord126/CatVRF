...
/**
 * Electronics3DService — CatVRF 2026 Component.
 *
 ...
 * @see https://catvrf.ru/docs/electronics3dservice
 * @see https://catvrf.ru/docs/electronics3dservice
 * @see https://catvrf.ru/docs/electronics3dservice
 * @see https://catvrf.ru/docs/electronics3dservice
 * @see https://catvrf.ru/docs/electronics3dservice
 ...
 */
final class Electronics3DService
{
    /**
    ...
    {
        return "/3d-models/Electronics/" . ($productData['sku'] ?? 'default') . ".glb";
    }

    private function getPreviewPath(array $productData): string
    {
        return "/3d-previews/Electronics/" . ($productData['id'] ?? 'default') . ".png";
    }
}
