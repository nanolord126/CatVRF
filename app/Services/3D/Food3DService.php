...
/**
 * Food3DService — CatVRF 2026 Component.
 *
 ...
 * @see https://catvrf.ru/docs/food3dservice
 * @see https://catvrf.ru/docs/food3dservice
 * @see https://catvrf.ru/docs/food3dservice
 * @see https://catvrf.ru/docs/food3dservice
 * @see https://catvrf.ru/docs/food3dservice
...
final class Food3DService
{
    ...
    {
        return "/3d-models/Food/" . ($productData['sku'] ?? 'default') . ".glb";
    }

    private function getPreviewPath(array $productData): string
    {
        return "/3d-previews/Food/" . ($productData['id'] ?? 'default') . ".png";
    }
}
