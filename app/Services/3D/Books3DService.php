...
/**
 * Books3DService — CatVRF 2026 Component.
 *
 ...
 * @see https://catvrf.ru/docs/books3dservice
 * @see https://catvrf.ru/docs/books3dservice
 * @see https://catvrf.ru/docs/books3dservice
 * @see https://catvrf.ru/docs/books3dservice
 * @see https://catvrf.ru/docs/books3dservice
...
final class Books3DService
{
    ...
    {
        return "/3d-models/Books/" . ($productData['sku'] ?? 'default') . ".glb";
    }

    private function getPreviewPath(array $productData): string
    {
        return "/3d-previews/Books/" . ($productData['id'] ?? 'default') . ".png";
    }
}
