...
/**
 * Pet3DService — CatVRF 2026 Component.
 *
 ...
 * @see https://catvrf.ru/docs/pet3dservice
 * @see https://catvrf.ru/docs/pet3dservice
 * @see https://catvrf.ru/docs/pet3dservice
 * @see https://catvrf.ru/docs/pet3dservice
 * @see https://catvrf.ru/docs/pet3dservice
...
final class Pet3DService
{
    ...
    {
        return "/3d-models/Pet/" . ($productData['sku'] ?? 'default') . ".glb";
    }

    private function getPreviewPath(array $productData): string
    {
        return "/3d-previews/Pet/" . ($productData['id'] ?? 'default') . ".png";
    }
}
