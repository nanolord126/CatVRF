...
/**
 * HomeServices3DService — CatVRF 2026 Component.
 *
 ...
 * @see https://catvrf.ru/docs/homeservices3dservice
 * @see https://catvrf.ru/docs/homeservices3dservice
 * @see https://catvrf.ru/docs/homeservices3dservice
 * @see https://catvrf.ru/docs/homeservices3dservice
 * @see https://catvrf.ru/docs/homeservices3dservice
 ...
 */
final class HomeServices3DService
{
    /**
    ...
    {
        return "/3d-models/HomeServices/" . ($productData['sku'] ?? 'default') . ".glb";
    }

    private function getPreviewPath(array $productData): string
    {
        return "/3d-previews/HomeServices/" . ($productData['id'] ?? 'default') . ".png";
    }
}
