...
/**
 * ConstructionMaterials3DService — CatVRF 2026 Component.
 *
 ...
 * @see https://catvrf.ru/docs/constructionmaterials3dservice
 * @see https://catvrf.ru/docs/constructionmaterials3dservice
 * @see https://catvrf.ru/docs/constructionmaterials3dservice
 * @see https://catvrf.ru/docs/constructionmaterials3dservice
 * @see https://catvrf.ru/docs/constructionmaterials3dservice
...
/**
 * Class ConstructionMaterials3DService
 *
 ...
 */
final class ConstructionMaterials3DService
{
    /**
    ...
    public function generateProductVisualization(array $productData): array
    {
        return [
            ...
            'vertical' => 'ConstructionMaterials',
    ...
    {
        return "/3d-models/ConstructionMaterials/" . ($productData['sku'] ?? 'default') . ".glb";
    }

    private function getPreviewPath(array $productData): string
    {
        return "/3d-previews/ConstructionMaterials/" . ($productData['id'] ?? 'default') . ".png";
    }
}
