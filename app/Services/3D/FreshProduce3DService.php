...
/**
 * FreshProduce3DService — CatVRF 2026 Component.
 *
 ...
 * @see https://catvrf.ru/docs/freshproduce3dservice
 * @see https://catvrf.ru/docs/freshproduce3dservice
 * @see https://catvrf.ru/docs/freshproduce3dservice
 * @see https://catvrf.ru/docs/freshproduce3dservice
 * @see https://catvrf.ru/docs/freshproduce3dservice
...
final class FreshProduce3DService
{
    ...
    {
        return "/3d-models/FreshProduce/" . ($productData['sku'] ?? 'default') . ".glb";
    }

    private function getPreviewPath(array $productData): string
    {
        return "/3d-previews/FreshProduce/" . ($productData['id'] ?? 'default') . ".png";
    }
}
