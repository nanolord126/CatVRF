...
/**
 * Jewelry3DService — CatVRF 2026 Component.
 *
 ...
 * @see https://catvrf.ru/docs/jewelry3dservice
 * @see https://catvrf.ru/docs/jewelry3dservice
 * @see https://catvrf.ru/docs/jewelry3dservice
 * @see https://catvrf.ru/docs/jewelry3dservice
 * @see https://catvrf.ru/docs/jewelry3dservice
...
final class Jewelry3DService
{
    ...
    {
        return "/3d-models/Jewelry/" . ($productData['sku'] ?? 'default') . ".glb";
    }

    private function getPreviewPath(array $productData): string
    {
        return "/3d-previews/Jewelry/" . ($productData['id'] ?? 'default') . ".png";
    }
}
