...
/**
 * Furniture3DService — CatVRF 2026 Component.
 *
 ...
 * @see https://catvrf.ru/docs/furniture3dservice
 * @see https://catvrf.ru/docs/furniture3dservice
 * @see https://catvrf.ru/docs/furniture3dservice
 * @see https://catvrf.ru/docs/furniture3dservice
 * @see https://catvrf.ru/docs/furniture3dservice
 ...
 */
final class Furniture3DService
{
    /**
    ...
    {
        return "/3d-models/Furniture/" . ($productData['sku'] ?? 'default') . ".glb";
    }

    private function getPreviewPath(array $productData): string
    {
        return "/3d-previews/Furniture/" . ($productData['id'] ?? 'default') . ".png";
    }
}
