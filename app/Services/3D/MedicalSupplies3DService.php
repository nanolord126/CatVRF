...
/**
 * MedicalSupplies3DService — CatVRF 2026 Component.
 *
 ...
 * @see https://catvrf.ru/docs/medicalsupplies3dservice
 * @see https://catvrf.ru/docs/medicalsupplies3dservice
 * @see https://catvrf.ru/docs/medicalsupplies3dservice
 * @see https://catvrf.ru/docs/medicalsupplies3dservice
 * @see https://catvrf.ru/docs/medicalsupplies3dservice
...
/**
 * Class MedicalSupplies3DService
 *
 ...
 */
final class MedicalSupplies3DService
{
    /**
    ...
    {
        return "/3d-models/MedicalSupplies/" . ($productData['sku'] ?? 'default') . ".glb";
    }

    private function getPreviewPath(array $productData): string
    {
        return "/3d-previews/MedicalSupplies/" . ($productData['id'] ?? 'default') . ".png";
    }
}
