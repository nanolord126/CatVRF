...
/**
 * Entertainment3DService — CatVRF 2026 Component.
 *
 ...
 * @see https://catvrf.ru/docs/entertainment3dservice
 * @see https://catvrf.ru/docs/entertainment3dservice
 * @see https://catvrf.ru/docs/entertainment3dservice
 * @see https://catvrf.ru/docs/entertainment3dservice
 * @see https://catvrf.ru/docs/entertainment3dservice
 ...
 */
final class Entertainment3DService
{
    /**
    ...
    {
        return "/3d-models/Entertainment/" . ($productData['sku'] ?? 'default') . ".glb";
    }

    private function getPreviewPath(array $productData): string
    {
        return "/3d-previews/Entertainment/" . ($productData['id'] ?? 'default') . ".png";
    }
}
