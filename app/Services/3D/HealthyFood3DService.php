...
/**
 * HealthyFood3DService — CatVRF 2026 Component.
 *
 ...
 * @see https://catvrf.ru/docs/healthyfood3dservice
 * @see https://catvrf.ru/docs/healthyfood3dservice
 * @see https://catvrf.ru/docs/healthyfood3dservice
 * @see https://catvrf.ru/docs/healthyfood3dservice
 * @see https://catvrf.ru/docs/healthyfood3dservice
 ...
 */
final class HealthyFood3DService
{
    /**
    ...
    {
        return "/3d-models/HealthyFood/" . ($productData['sku'] ?? 'default') . ".glb";
    }

    private function getPreviewPath(array $productData): string
    {
        return "/3d-previews/HealthyFood/" . ($productData['id'] ?? 'default') . ".png";
    }
}
