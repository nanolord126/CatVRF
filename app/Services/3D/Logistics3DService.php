...
/**
 * Logistics3DService — CatVRF 2026 Component.
 *
 ...
 * @see https://catvrf.ru/docs/logistics3dservice
 * @see https://catvrf.ru/docs/logistics3dservice
 * @see https://catvrf.ru/docs/logistics3dservice
 * @see https://catvrf.ru/docs/logistics3dservice
 * @see https://catvrf.ru/docs/logistics3dservice
 ...
 */
final class Logistics3DService
{
    /**
    ...
    {
        return "/3d-models/Logistics/" . ($productData['sku'] ?? 'default') . ".glb";
    }

    private function getPreviewPath(array $productData): string
    {
        return "/3d-previews/Logistics/" . ($productData['id'] ?? 'default') . ".png";
    }
}
