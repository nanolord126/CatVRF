...
/**
 * Cosmetics3DService — CatVRF 2026 Component.
 *
 ...
 * @see https://catvrf.ru/docs/cosmetics3dservice
 * @see https://catvrf.ru/docs/cosmetics3dservice
 * @see https://catvrf.ru/docs/cosmetics3dservice
 * @see https://catvrf.ru/docs/cosmetics3dservice
 * @see https://catvrf.ru/docs/cosmetics3dservice
 ...
 */
final class Cosmetics3DService
{
    /**
    ...
    {
        return "/3d-models/Cosmetics/" . ($productData['sku'] ?? 'default') . ".glb";
    }

    private function getPreviewPath(array $productData): string
    {
        return "/3d-previews/Cosmetics/" . ($productData['id'] ?? 'default') . ".png";
    }
}
