...
/**
 * TravelTourism3DService — CatVRF 2026 Component.
 *
 ...
 * @see https://catvrf.ru/docs/traveltourism3dservice
 * @see https://catvrf.ru/docs/traveltourism3dservice
 * @see https://catvrf.ru/docs/traveltourism3dservice
 * @see https://catvrf.ru/docs/traveltourism3dservice
 * @see https://catvrf.ru/docs/traveltourism3dservice
 ...
 */
final class TravelTourism3DService
{
    /**
    ...
    {
        return "/3d-models/TravelTourism/" . ($productData['sku'] ?? 'default') . ".glb";
    }

    private function getPreviewPath(array $productData): string
    {
        return "/3d-previews/TravelTourism/" . ($productData['id'] ?? 'default') . ".png";
    }
}
