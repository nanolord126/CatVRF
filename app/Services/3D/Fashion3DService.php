...
/**
 * Fashion3DService — CatVRF 2026 Component.
 *
 ...
 * @see https://catvrf.ru/docs/fashion3dservice
 * @see https://catvrf.ru/docs/fashion3dservice
 * @see https://catvrf.ru/docs/fashion3dservice
 * @see https://catvrf.ru/docs/fashion3dservice
 * @see https://catvrf.ru/docs/fashion3dservice
...
final class Fashion3DService
{
    ...
    {
        return "/3d-models/Fashion/" . ($productData['sku'] ?? 'default') . ".glb";
    }

    private function getPreviewPath(array $productData): string
    {
        return "/3d-previews/Fashion/" . ($productData['id'] ?? 'default') . ".png";
    }
}
