...
/**
 * Gifts3DService — CatVRF 2026 Component.
 *
 ...
 * @see https://catvrf.ru/docs/gifts3dservice
 * @see https://catvrf.ru/docs/gifts3dservice
 * @see https://catvrf.ru/docs/gifts3dservice
 * @see https://catvrf.ru/docs/gifts3dservice
 * @see https://catvrf.ru/docs/gifts3dservice
...
final class Gifts3DService
{
    ...
    {
        return "/3d-models/Gifts/" . ($productData['sku'] ?? 'default') . ".glb";
    }

    private function getPreviewPath(array $productData): string
    {
        return "/3d-previews/Gifts/" . ($productData['id'] ?? 'default') . ".png";
    }
}
