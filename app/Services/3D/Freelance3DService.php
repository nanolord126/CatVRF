...
/**
 * Freelance3DService — CatVRF 2026 Component.
 *
 ...
 * @see https://catvrf.ru/docs/freelance3dservice
 * @see https://catvrf.ru/docs/freelance3dservice
 * @see https://catvrf.ru/docs/freelance3dservice
 * @see https://catvrf.ru/docs/freelance3dservice
 * @see https://catvrf.ru/docs/freelance3dservice
 ...
 */
final class Freelance3DService
{
    /**
    ...
    {
        return "/3d-models/Freelance/" . ($productData['sku'] ?? 'default') . ".glb";
    }

    private function getPreviewPath(array $productData): string
    {
        return "/3d-previews/Freelance/" . ($productData['id'] ?? 'default') . ".png";
    }
}
