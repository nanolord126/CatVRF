...
/**
 * Hotels3DService — CatVRF 2026 Component.
 *
 ...
 * @see https://catvrf.ru/docs/hotels3dservice
 * @see https://catvrf.ru/docs/hotels3dservice
 * @see https://catvrf.ru/docs/hotels3dservice
 * @see https://catvrf.ru/docs/hotels3dservice
 * @see https://catvrf.ru/docs/hotels3dservice
...
final class Hotels3DService
{
    ...
    {
        return "/3d-models/Hotels/" . ($productData['sku'] ?? 'default') . ".glb";
    }

    private function getPreviewPath(array $productData): string
    {
        return "/3d-previews/Hotels/" . ($productData['id'] ?? 'default') . ".png";
    }
}
