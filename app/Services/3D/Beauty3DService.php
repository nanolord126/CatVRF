...
/**
 * Beauty3DService — CatVRF 2026 Component.
 *
 ...
 * @see https://catvrf.ru/docs/beauty3dservice
 * @see https://catvrf.ru/docs/beauty3dservice
 * @see https://catvrf.ru/docs/beauty3dservice
 * @see https://catvrf.ru/docs/beauty3dservice
 * @see https://catvrf.ru/docs/beauty3dservice
...
final class Beauty3DService
{
    ...
    {
        return "/3d-models/Beauty/" . ($productData['sku'] ?? 'default') . ".glb";
    }

    private function getPreviewPath(array $productData): string
    {
        return "/3d-previews/Beauty/" . ($productData['id'] ?? 'default') . ".png";
    }
}
