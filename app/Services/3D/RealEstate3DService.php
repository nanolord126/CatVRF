...
/**
 * RealEstate3DService — CatVRF 2026 Component.
 *
 ...
 * @see https://catvrf.ru/docs/realestate3dservice
 * @see https://catvrf.ru/docs/realestate3dservice
 * @see https://catvrf.ru/docs/realestate3dservice
 * @see https://catvrf.ru/docs/realestate3dservice
 * @see https://catvrf.ru/docs/realestate3dservice
 ...
 */
final class RealEstate3DService
{
    /**
    ...
    {
        return "/3d-models/RealEstate/" . ($productData['sku'] ?? 'default') . ".glb";
    }

    private function getPreviewPath(array $productData): string
    {
        return "/3d-previews/RealEstate/" . ($productData['id'] ?? 'default') . ".png";
    }
}
