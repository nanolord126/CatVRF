...
/**
 * Fitness3DService — CatVRF 2026 Component.
 *
 ...
 * @see https://catvrf.ru/docs/fitness3dservice
 * @see https://catvrf.ru/docs/fitness3dservice
 * @see https://catvrf.ru/docs/fitness3dservice
 * @see https://catvrf.ru/docs/fitness3dservice
 * @see https://catvrf.ru/docs/fitness3dservice
...
final class Fitness3DService
{
    ...
    {
        return "/3d-models/Fitness/" . ($productData['sku'] ?? 'default') . ".glb";
    }

    private function getPreviewPath(array $productData): string
    {
        return "/3d-previews/Fitness/" . ($productData['id'] ?? 'default') . ".png";
    }
}
