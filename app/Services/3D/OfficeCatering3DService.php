...
/**
 * OfficeCatering3DService — CatVRF 2026 Component.
 *
 ...
 * @see https://catvrf.ru/docs/officecatering3dservice
 * @see https://catvrf.ru/docs/officecatering3dservice
 * @see https://catvrf.ru/docs/officecatering3dservice
 * @see https://catvrf.ru/docs/officecatering3dservice
 * @see https://catvrf.ru/docs/officecatering3dservice
 ...
 */
final class OfficeCatering3DService
{
    /**
    ...
    {
        return "/3d-models/OfficeCatering/" . ($productData['sku'] ?? 'default') . ".glb";
    }

    private function getPreviewPath(array $productData): string
    {
        return "/3d-previews/OfficeCatering/" . ($productData['id'] ?? 'default') . ".png";
    }
}
