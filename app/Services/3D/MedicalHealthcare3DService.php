...
/**
 * MedicalHealthcare3DService — CatVRF 2026 Component.
 *
 ...
 * @see https://catvrf.ru/docs/medicalhealthcare3dservice
 * @see https://catvrf.ru/docs/medicalhealthcare3dservice
 * @see https://catvrf.ru/docs/medicalhealthcare3dservice
 * @see https://catvrf.ru/docs/medicalhealthcare3dservice
 * @see https://catvrf.ru/docs/medicalhealthcare3dservice
...
/**
 * Class MedicalHealthcare3DService
 *
 ...
 */
final class MedicalHealthcare3DService
{
    /**
    ...
    {
        return "/3d-models/MedicalHealthcare/" . ($productData['sku'] ?? 'default') . ".glb";
    }

    private function getPreviewPath(array $productData): string
    {
        return "/3d-previews/MedicalHealthcare/" . ($productData['id'] ?? 'default') . ".png";
    }
}
