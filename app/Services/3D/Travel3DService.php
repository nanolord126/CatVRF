...
/**
 * Travel3DService — CatVRF 2026 Component.
 *
 ...
 * @see https://catvrf.ru/docs/travel3dservice
 * @see https://catvrf.ru/docs/travel3dservice
 * @see https://catvrf.ru/docs/travel3dservice
 * @see https://catvrf.ru/docs/travel3dservice
 * @see https://catvrf.ru/docs/travel3dservice
...
final class Travel3DService
{
    ...
    {
        return "/3d-models/Travel/" . ($productData['sku'] ?? 'default') . ".glb";
    }

    private function getPreviewPath(array $productData): string
    {
        return "/3d-previews/Travel/" . ($productData['id'] ?? 'default') . ".png";
    }
}
