...
/**
 * Photography3DService — CatVRF 2026 Component.
 *
 ...
 * @see https://catvrf.ru/docs/photography3dservice
 * @see https://catvrf.ru/docs/photography3dservice
 * @see https://catvrf.ru/docs/photography3dservice
 * @see https://catvrf.ru/docs/photography3dservice
 * @see https://catvrf.ru/docs/photography3dservice
 ...
 */
final class Photography3DService
{
    /**
    ...
    {
        return "/3d-models/Photography/" . ($productData['sku'] ?? 'default') . ".glb";
    }

    private function getPreviewPath(array $productData): string
    {
        return "/3d-previews/Photography/" . ($productData['id'] ?? 'default') . ".png";
    }
}
