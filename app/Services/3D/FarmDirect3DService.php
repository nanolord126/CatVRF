...
/**
 * FarmDirect3DService — CatVRF 2026 Component.
 *
 ...
 * @see https://catvrf.ru/docs/farmdirect3dservice
 * @see https://catvrf.ru/docs/farmdirect3dservice
 * @see https://catvrf.ru/docs/farmdirect3dservice
 * @see https://catvrf.ru/docs/farmdirect3dservice
 * @see https://catvrf.ru/docs/farmdirect3dservice
 ...
 */
final class FarmDirect3DService
{
    /**
    ...
    {
        return "/3d-models/FarmDirect/" . ($productData['sku'] ?? 'default') . ".glb";
    }

    private function getPreviewPath(array $productData): string
    {
        return "/3d-previews/FarmDirect/" . ($productData['id'] ?? 'default') . ".png";
    }
}
