...
final readonly class AnalyticsService
{
    ...
    public function getMetrics(
        ...
        try {
            // Rate limiting check (simplified - implement proper rate limiter if needed)
            // if (! $this->rateLimiter->allowTenant($tenantId, 'analytics:metrics', 100, 60)) {
            //     throw new TooManyRequestsHttpException(message: 'Rate limit exceeded for analytics');
            // }
    ...
    public function trackEvent(
        ...
        try {
            ...
            //     throw new TooManyRequestsHttpException(message: 'Rate limit exceeded for event tracking');
            // }
    ...
    public function getHeatmap(
        ...
        try {
            ...
            //     throw new TooManyRequestsHttpException(message: 'Rate limit exceeded for heatmap');
            // }
