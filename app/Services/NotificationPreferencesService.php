...
final readonly class NotificationPreferencesService
{
    ...
    public function updateChannelPreferences(
        ...
        try {
            ...
            $this->logger->channel('audit')->$this->logger->info('Notification preferences updated', [
                'user_id' => $userId,
                'channel' => $channel,
                'correlation_id' => $correlationId,
            ]);
    ...
    public function setDoNotDisturb(int $userId, string $startTime, string $endTime): bool
    {
        try {
            ...
            $this->logger->channel('audit')->$this->logger->info('Do-not-disturb enabled', [
                'user_id' => $userId,
    ...
    public function disableDoNotDisturb(int $userId): bool
    {
        try {
            ...
            $this->logger->channel('audit')->$this->logger->info('Do-not-disturb disabled', [
                'user_id' => $userId,
            ]);
