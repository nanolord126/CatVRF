...
final readonly class LogManager
{
    ...
    public function $this->logger->info(string $message, array $context = []): void
    {
        $this->logger->$this->logger->info($message, array_merge($context, ['correlation_id' => $this->request?->header('X-Correlation-ID') ?? '']));
    }
