...
final readonly class TeamPresenceService
{
    ...
    public function registerPresence(
        ...
        try {
            ...
            $presence = [
                ...
                'last_active' => CarbonImmutable::now()->toIso8601String(),
            ...
            $presentUsers[$userId] = CarbonImmutable::now()->toIso8601String();
    ...
    public function updateStatus(
        ...
        try {
            ...
            $presence['last_active'] = CarbonImmutable::now()->toIso8601String();
