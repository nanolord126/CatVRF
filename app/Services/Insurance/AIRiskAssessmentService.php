...
final readonly class AIRiskAssessmentService
{
    ...
    public function generateRecommendations(
        ...
        $this->logger->channel('audit')->$this->logger->info('[AIRiskAssessmentService] Generating user risk recommendations', [
        ...
        try {
            ...
            foreach ($availableTypes as $type) {
                ...
                if (in_array($type->slug, ['osago', 'kasko'], true)) {
            ...
            $this->logger->channel('audit')->$this->logger->info('[AIRiskAssessmentService] Recommendations generated', [
                'correlation_id' => $correlationId,
    ...
    public function assessLossProbability(int $policyId, ?string $correlationId = null): float
    {
        ...
        $this->logger->channel('audit')->$this->logger->info('[AIRiskAssessmentService] Assessing loss probability for policy', [
            'correlation_id' => $correlationId,
            'policy_id' => $policyId,
        ]);
