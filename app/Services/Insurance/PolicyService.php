...
final readonly class PolicyService
{
    ...
    public function issuePolicy(
        ...
        $this->logger->channel('audit')->$this->logger->info('[PolicyService] Issuing new policy', [
        ...
        try {
            ...
            return $this->db->transaction(function () use (
                ...
                // 6. Success Log Audit
                $this->logger->channel('audit')->$this->logger->info('[PolicyService] Policy successfully issued', [
                    'correlation_id' => $correlationId,
    ...
    public function activatePolicy(int $policyId, ?string $correlationId = null): bool
    {
        ...
        return $this->db->transaction(function () use ($policyId, $correlationId) {
            ...
            $this->logger->channel('audit')->$this->logger->info('[PolicyService] Policy activated', [
                'policy_id' => $policyId,
                'correlation_id' => $correlationId,
            ]);
