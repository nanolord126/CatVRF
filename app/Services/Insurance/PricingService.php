...
final readonly class PricingService
{
    ...
    public function calculatePremium(
        ...
        $this->logger->channel('audit')->$this->logger->info('[PricingService] Calculating premium', [
        ...
        $this->logger->channel('audit')->$this->logger->info('[PricingService] Premium calculation success', [
            'correlation_id' => $correlationId,
