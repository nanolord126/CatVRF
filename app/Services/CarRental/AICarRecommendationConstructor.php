...
final readonly class AICarRecommendationConstructor
{
    ...
    public function __construct(private readonly LoggerInterface $logger,
        private readonly Client $openai, // AI Vision or GigaChat
    ...
    public function analyzeAndMatchVehicle(
        ...
        try {
            ...
            $this->logger->channel('audit')->$this->logger->info('[CarAI] Starting vehicle matching', [
            ...
            $this->logger->channel('recommend')->$this->logger->info('[CarAI] Vehicle matches found', [
