...
final readonly class BeautyLookConstructor
{
    public function __construct(private readonly LoggerInterface $logger,
        ...
        private readonly UserTasteProfileService $userTasteProfileService,
        private readonly LogManager $logger,
        private readonly DatabaseManager $db,) {}

    public function construct(BeautyLookConstructorInput $input): BeautyLookConstructorOutput
    {
        $this->logger->channel('audit')->$this->logger->info('BeautyLookConstructor started', [
        ...
        try {
            return $this->db->transaction(function () use ($input) {
                ...
                $totalCost = (int) (new Collection($recommendedProducts)->sum('price') + new Collection($recommendedServices)->sum('price'));
                ...
                $this->logger->channel('audit')->$this->logger->info('BeautyLookConstructor finished successfully', [
                    'correlation_id' => $input->correlationId,
                    'user_id' => $input->userId,
