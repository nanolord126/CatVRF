...
use App\Domains\Beauty\Services\BeautyMasterMatchingService;
...
final readonly class BeautyLookConstructor
{
    public function __construct(private readonly LoggerInterface $logger,
        ...
        private readonly BeautyMasterMatchingService $masterMatching,
    ...
    public function construct(
        ...
        try {
            ...
            $this->logger->channel('audit')->$this->logger->info('Beauty construction completed with master matching', [
                'makeup_style' => $makeupStyle,
                'hairstyle' => $hairstyle,
    ...
    private function selectMakeupStyle(string $skinType, array $colors, array $explicit): string
    {
        ...
        if (\in_array('warm', $colors, true)) {
            return 'warm_tones';
        }

        if (\in_array('cool', $colors, true)) {
            return 'cool_tones';
        }
