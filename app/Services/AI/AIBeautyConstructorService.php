...
final readonly class AIBeautyConstructorService
{
    ...
    public function analyzeFaceAndRecommend(
        ...
        try {
            $this->logger->channel('audit')->$this->logger->info('Beauty constructor: Starting face analysis', [
                'user_id' => $userId,
            ...
            // 5. Логировать
            $this->logger->channel('audit')->$this->logger->info('Beauty constructor: Analysis complete', [
                'user_id' => $userId,
