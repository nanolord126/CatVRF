...
/**
 * Prompt builder for Hotels AI
 * 
 * Vertical: hotels
 * Type: ai_constructor
 * 
 * Generates prompts for AI-powered features in Hotels vertical.
 */
final class HotelsPromptBuilder extends AbstractPromptBuilder
{
    protected string $version = '1.0.0';
    protected array $metadata = [
        'vertical' => 'hotels',
        'type' => 'ai_constructor',
        'description' => 'AI constructor for Hotels vertical',
        'language' => 'ru',
    ];
