...
/**
 * Prompt builder for EventPlanning AI
 * 
 * Vertical: eventplanning
 * Type: ai_constructor
 * 
 * Generates prompts for AI-powered features in EventPlanning vertical.
 */
final class EventPlanningPromptBuilder extends AbstractPromptBuilder
{
    protected string $version = '1.0.0';
    protected array $metadata = [
        'vertical' => 'eventplanning',
        'type' => 'ai_constructor',
        'description' => 'AI constructor for EventPlanning vertical',
        'language' => 'ru',
    ];
