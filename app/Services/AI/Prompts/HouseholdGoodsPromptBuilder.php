...
/**
 * Prompt builder for HouseholdGoods AI
 * 
 * Vertical: householdgoods
 * Type: ai_constructor
 * 
 * Generates prompts for AI-powered features in HouseholdGoods vertical.
 */
final class HouseholdGoodsPromptBuilder extends AbstractPromptBuilder
{
    protected string $version = '1.0.0';
    protected array $metadata = [
        'vertical' => 'householdgoods',
        'type' => 'ai_constructor',
        'description' => 'AI constructor for HouseholdGoods vertical',
        'language' => 'ru',
    ];
