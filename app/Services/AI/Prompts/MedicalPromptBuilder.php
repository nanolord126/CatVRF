...
/**
 * Prompt builder for Medical AI
 * 
 * Vertical: medical
 * Type: ai_constructor
 * 
 * Generates prompts for AI-powered features in Medical vertical.
 */
final class MedicalPromptBuilder extends AbstractPromptBuilder
{
    protected string $version = '1.0.0';
    protected array $metadata = [
        'vertical' => 'medical',
        'type' => 'ai_constructor',
        'description' => 'AI constructor for Medical vertical',
        'language' => 'ru',
    ];
    ...
    {
        $prompt = <<<PROMPT
Ты — эксперт в вертикали Medical. 
