...
/**
 * Prompt builder for ToysAndGames AI
 * 
 * Vertical: toysandgames
 * Type: ai_constructor
 * 
 * Generates prompts for AI-powered features in ToysAndGames vertical.
 */
final class ToysAndGamesPromptBuilder extends AbstractPromptBuilder
{
    protected string $version = '1.0.0';
    protected array $metadata = [
        'vertical' => 'toysandgames',
        'type' => 'ai_constructor',
        'description' => 'AI constructor for ToysAndGames vertical',
        'language' => 'ru',
    ];
