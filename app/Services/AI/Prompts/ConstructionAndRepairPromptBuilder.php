...
/**
 * Prompt builder for ConstructionAndRepair AI
 * 
 * Vertical: constructionandrepair
 * Type: ai_constructor
 * 
 * Generates prompts for AI-powered features in ConstructionAndRepair vertical.
 */
final class ConstructionAndRepairPromptBuilder extends AbstractPromptBuilder
{
    protected string $version = '1.0.0';
    protected array $metadata = [
        'vertical' => 'constructionandrepair',
        'type' => 'ai_constructor',
        'description' => 'AI constructor for ConstructionAndRepair vertical',
        'language' => 'ru',
    ];
    ...
    {
        $prompt = <<<PROMPT
Ты — эксперт в вертикали ConstructionAndRepair. 
Твоя задача — анализировать данные и предоставлять качественные рекомендации.

Контекст:
- Вертикаль: constructionandrepair
- Тип: ai_constructor
- Язык ответа: русский
