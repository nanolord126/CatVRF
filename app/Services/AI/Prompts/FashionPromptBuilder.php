...
/**
 * Prompt builder for Fashion AI
 * 
 * Vertical: fashion
 * Type: ai_constructor
 * 
 * Generates prompts for AI-powered features in Fashion vertical.
 */
final class FashionPromptBuilder extends AbstractPromptBuilder
{
    protected string $version = '1.0.0';
    protected array $metadata = [
        'vertical' => 'fashion',
        'type' => 'ai_constructor',
        'description' => 'AI constructor for Fashion vertical',
        'language' => 'ru',
    ];
    ...
    {
        $prompt = <<<PROMPT
Ты — эксперт в вертикали Fashion. 
