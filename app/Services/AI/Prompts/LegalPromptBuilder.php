...
/**
 * Prompt builder for Legal AI
 * 
 * Vertical: legal
 * Type: ai_constructor
 * 
 * Generates prompts for AI-powered features in Legal vertical.
 */
final class LegalPromptBuilder extends AbstractPromptBuilder
{
    protected string $version = '1.0.0';
    protected array $metadata = [
        'vertical' => 'legal',
        'type' => 'ai_constructor',
        'description' => 'AI constructor for Legal vertical',
        'language' => 'ru',
    ];
