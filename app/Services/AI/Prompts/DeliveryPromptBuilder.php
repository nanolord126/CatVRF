...
/**
 * Prompt builder for Delivery AI
 * 
 * Vertical: delivery
 * Type: ai_constructor
 * 
 * Generates prompts for AI-powered features in Delivery vertical.
 */
final class DeliveryPromptBuilder extends AbstractPromptBuilder
{
    protected string $version = '1.0.0';
    protected array $metadata = [
        'vertical' => 'delivery',
        'type' => 'ai_constructor',
        'description' => 'AI constructor for Delivery vertical',
        'language' => 'ru',
    ];
    ...
    {
        $prompt = <<<PROMPT
Ты — эксперт в вертикали Delivery. 
