...
/**
 * Prompt builder for Art AI
 * 
 * Vertical: art
 * Type: ai_constructor
 * 
 * Generates prompts for AI-powered features in Art vertical.
 */
final class ArtPromptBuilder extends AbstractPromptBuilder
{
    protected string $version = '1.0.0';
    protected array $metadata = [
        'vertical' => 'art',
        'type' => 'ai_constructor',
        'description' => 'AI constructor for Art vertical',
        'language' => 'ru',
    ];
