...
/**
 * Prompt builder for PersonalDevelopment AI
 * 
 * Vertical: personaldevelopment
 * Type: ai_constructor
 * 
 * Generates prompts for AI-powered features in PersonalDevelopment vertical.
 */
final class PersonalDevelopmentPromptBuilder extends AbstractPromptBuilder
{
    protected string $version = '1.0.0';
    protected array $metadata = [
        'vertical' => 'personaldevelopment',
        'type' => 'ai_constructor',
        'description' => 'AI constructor for PersonalDevelopment vertical',
        'language' => 'ru',
    ];
