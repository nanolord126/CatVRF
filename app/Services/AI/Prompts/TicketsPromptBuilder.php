...
/**
 * Prompt builder for Tickets AI
 * 
 * Vertical: tickets
 * Type: ai_constructor
 * 
 * Generates prompts for AI-powered features in Tickets vertical.
 */
final class TicketsPromptBuilder extends AbstractPromptBuilder
{
    protected string $version = '1.0.0';
    protected array $metadata = [
        'vertical' => 'tickets',
        'type' => 'ai_constructor',
        'description' => 'AI constructor for Tickets vertical',
        'language' => 'ru',
    ];
    ...
    {
        $prompt = <<<PROMPT
Ты — эксперт в вертикали Tickets. 
