...
/**
 * Prompt builder for Advertising AI
 * 
 * Vertical: advertising
 * Type: ai_constructor
 * 
 * Generates prompts for AI-powered features in Advertising vertical.
 */
final class AdvertisingPromptBuilder extends AbstractPromptBuilder
{
    protected string $version = '1.0.0';
    protected array $metadata = [
        'vertical' => 'advertising',
        'type' => 'ai_constructor',
        'description' => 'AI constructor for Advertising vertical',
        'language' => 'ru',
    ];
    ...
    {
        $prompt = <<<PROMPT
Ты — эксперт в вертикали Advertising. 
