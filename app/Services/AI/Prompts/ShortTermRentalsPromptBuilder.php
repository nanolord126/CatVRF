...
/**
 * Prompt builder for ShortTermRentals AI
 * 
 * Vertical: shorttermrentals
 * Type: ai_constructor
 * 
 * Generates prompts for AI-powered features in ShortTermRentals vertical.
 */
final class ShortTermRentalsPromptBuilder extends AbstractPromptBuilder
{
    protected string $version = '1.0.0';
    protected array $metadata = [
        'vertical' => 'shorttermrentals',
        'type' => 'ai_constructor',
        'description' => 'AI constructor for ShortTermRentals vertical',
        'language' => 'ru',
    ];
