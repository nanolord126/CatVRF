...
/**
 * Prompt builder for OfficeCatering AI
 * 
 * Vertical: officecatering
 * Type: ai_constructor
 * 
 * Generates prompts for AI-powered features in OfficeCatering vertical.
 */
final class OfficeCateringPromptBuilder extends AbstractPromptBuilder
{
    protected string $version = '1.0.0';
    protected array $metadata = [
        'vertical' => 'officecatering',
        'type' => 'ai_constructor',
        'description' => 'AI constructor for OfficeCatering vertical',
        'language' => 'ru',
    ];
