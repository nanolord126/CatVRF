...
/**
 * Prompt builder for Auto AI
 * 
 * Vertical: auto
 * Type: ai_constructor
 * 
 * Generates prompts for AI-powered features in Auto vertical.
 */
final class AutoPromptBuilder extends AbstractPromptBuilder
{
    protected string $version = '1.0.0';
    protected array $metadata = [
        'vertical' => 'auto',
        'type' => 'ai_constructor',
        'description' => 'AI constructor for Auto vertical',
        'language' => 'ru',
    ];
