...
/**
 * Prompt builder for HobbyAndCraft AI
 * 
 * Vertical: hobbyandcraft
 * Type: ai_constructor
 * 
 * Generates prompts for AI-powered features in HobbyAndCraft vertical.
 */
final class HobbyAndCraftPromptBuilder extends AbstractPromptBuilder
{
    protected string $version = '1.0.0';
    protected array $metadata = [
        'vertical' => 'hobbyandcraft',
        'type' => 'ai_constructor',
        'description' => 'AI constructor for HobbyAndCraft vertical',
        'language' => 'ru',
    ];
