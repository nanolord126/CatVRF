...
/**
 * Prompt builder for Beauty AI
 * 
 * Vertical: beauty
 * Type: ai_constructor
 * 
 * Generates prompts for AI-powered features in Beauty vertical.
 */
final class BeautyPromptBuilder extends AbstractPromptBuilder
{
    protected string $version = '1.0.0';
    protected array $metadata = [
        'vertical' => 'beauty',
        'type' => 'ai_constructor',
        'description' => 'AI constructor for Beauty vertical',
        'language' => 'ru',
    ];
