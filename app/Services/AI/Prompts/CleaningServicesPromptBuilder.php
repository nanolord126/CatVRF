...
/**
 * Prompt builder for CleaningServices AI
 * 
 * Vertical: cleaningservices
 * Type: ai_constructor
 * 
 * Generates prompts for AI-powered features in CleaningServices vertical.
 */
final class CleaningServicesPromptBuilder extends AbstractPromptBuilder
{
    protected string $version = '1.0.0';
    protected array $metadata = [
        'vertical' => 'cleaningservices',
        'type' => 'ai_constructor',
        'description' => 'AI constructor for CleaningServices vertical',
        'language' => 'ru',
    ];
