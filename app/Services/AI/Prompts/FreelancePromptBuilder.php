...
/**
 * Prompt builder for Freelance AI
 * 
 * Vertical: freelance
 * Type: ai_constructor
 * 
 * Generates prompts for AI-powered features in Freelance vertical.
 */
final class FreelancePromptBuilder extends AbstractPromptBuilder
{
    protected string $version = '1.0.0';
    protected array $metadata = [
        'vertical' => 'freelance',
        'type' => 'ai_constructor',
        'description' => 'AI constructor for Freelance vertical',
        'language' => 'ru',
    ];
    ...
    {
        $prompt = <<<PROMPT
Ты — эксперт в вертикали Freelance. 
