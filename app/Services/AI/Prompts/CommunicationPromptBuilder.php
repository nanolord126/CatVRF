...
/**
 * Prompt builder for Communication AI
 * 
 * Vertical: communication
 * Type: ai_constructor
 * 
 * Generates prompts for AI-powered features in Communication vertical.
 */
final class CommunicationPromptBuilder extends AbstractPromptBuilder
{
    protected string $version = '1.0.0';
    protected array $metadata = [
        'vertical' => 'communication',
        'type' => 'ai_constructor',
        'description' => 'AI constructor for Communication vertical',
        'language' => 'ru',
    ];
