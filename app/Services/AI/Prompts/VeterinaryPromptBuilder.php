...
/**
 * Prompt builder for Veterinary AI
 * 
 * Vertical: veterinary
 * Type: ai_constructor
 * 
 * Generates prompts for AI-powered features in Veterinary vertical.
 */
final class VeterinaryPromptBuilder extends AbstractPromptBuilder
{
    protected string $version = '1.0.0';
    protected array $metadata = [
        'vertical' => 'veterinary',
        'type' => 'ai_constructor',
        'description' => 'AI constructor for Veterinary vertical',
        'language' => 'ru',
    ];
