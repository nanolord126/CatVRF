...
/**
 * Prompt builder for GeoLogistics AI
 * 
 * Vertical: geologistics
 * Type: ai_constructor
 * 
 * Generates prompts for AI-powered features in GeoLogistics vertical.
 */
final class GeoLogisticsPromptBuilder extends AbstractPromptBuilder
{
    protected string $version = '1.0.0';
    protected array $metadata = [
        'vertical' => 'geologistics',
        'type' => 'ai_constructor',
        'description' => 'AI constructor for GeoLogistics vertical',
        'language' => 'ru',
    ];
    ...
    {
        $prompt = <<<PROMPT
Ты — эксперт в вертикали GeoLogistics. 
