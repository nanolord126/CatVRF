...
/**
 * Prompt builder for Geo AI
 * 
 * Vertical: geo
 * Type: ai_constructor
 * 
 * Generates prompts for AI-powered features in Geo vertical.
 */
final class GeoPromptBuilder extends AbstractPromptBuilder
{
    protected string $version = '1.0.0';
    protected array $metadata = [
        'vertical' => 'geo',
        'type' => 'ai_constructor',
        'description' => 'AI constructor for Geo vertical',
        'language' => 'ru',
    ];
