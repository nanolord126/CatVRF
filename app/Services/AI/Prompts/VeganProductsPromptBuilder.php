...
/**
 * Prompt builder for VeganProducts AI
 * 
 * Vertical: veganproducts
 * Type: ai_constructor
 * 
 * Generates prompts for AI-powered features in VeganProducts vertical.
 */
final class VeganProductsPromptBuilder extends AbstractPromptBuilder
{
    protected string $version = '1.0.0';
    protected array $metadata = [
        'vertical' => 'veganproducts',
        'type' => 'ai_constructor',
        'description' => 'AI constructor for VeganProducts vertical',
        'language' => 'ru',
    ];
