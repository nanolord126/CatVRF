...
/**
 * Prompt builder for Consulting AI
 * 
 * Vertical: consulting
 * Type: ai_constructor
 * 
 * Generates prompts for AI-powered features in Consulting vertical.
 */
final class ConsultingPromptBuilder extends AbstractPromptBuilder
{
    protected string $version = '1.0.0';
    protected array $metadata = [
        'vertical' => 'consulting',
        'type' => 'ai_constructor',
        'description' => 'AI constructor for Consulting vertical',
        'language' => 'ru',
    ];
    ...
    {
        $prompt = <<<PROMPT
Ты — эксперт в вертикали Consulting. 
