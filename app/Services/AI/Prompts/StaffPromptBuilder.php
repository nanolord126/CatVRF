...
/**
 * Prompt builder for Staff AI
 * 
 * Vertical: staff
 * Type: ai_constructor
 * 
 * Generates prompts for AI-powered features in Staff vertical.
 */
final class StaffPromptBuilder extends AbstractPromptBuilder
{
    protected string $version = '1.0.0';
    protected array $metadata = [
        'vertical' => 'staff',
        'type' => 'ai_constructor',
        'description' => 'AI constructor for Staff vertical',
        'language' => 'ru',
    ];
