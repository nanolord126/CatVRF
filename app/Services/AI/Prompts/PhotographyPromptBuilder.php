...
/**
 * Prompt builder for Photography AI
 * 
 * Vertical: photography
 * Type: ai_constructor
 * 
 * Generates prompts for AI-powered features in Photography vertical.
 */
final class PhotographyPromptBuilder extends AbstractPromptBuilder
{
    protected string $version = '1.0.0';
    protected array $metadata = [
        'vertical' => 'photography',
        'type' => 'ai_constructor',
        'description' => 'AI constructor for Photography vertical',
        'language' => 'ru',
    ];
