...
/**
 * Prompt builder for Insurance AI
 * 
 * Vertical: insurance
 * Type: ai_constructor
 * 
 * Generates prompts for AI-powered features in Insurance vertical.
 */
final class InsurancePromptBuilder extends AbstractPromptBuilder
{
    protected string $version = '1.0.0';
    protected array $metadata = [
        'vertical' => 'insurance',
        'type' => 'ai_constructor',
        'description' => 'AI constructor for Insurance vertical',
        'language' => 'ru',
    ];
    ...
    {
        $prompt = <<<PROMPT
Ты — эксперт в вертикали Insurance. 
