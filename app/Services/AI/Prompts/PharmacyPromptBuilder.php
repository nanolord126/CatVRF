...
/**
 * Prompt builder for Pharmacy AI
 * 
 * Vertical: pharmacy
 * Type: ai_constructor
 * 
 * Generates prompts for AI-powered features in Pharmacy vertical.
 */
final class PharmacyPromptBuilder extends AbstractPromptBuilder
{
    protected string $version = '1.0.0';
    protected array $metadata = [
        'vertical' => 'pharmacy',
        'type' => 'ai_constructor',
        'description' => 'AI constructor for Pharmacy vertical',
        'language' => 'ru',
    ];
    ...
    {
        $prompt = <<<PROMPT
Ты — эксперт в вертикали Pharmacy. 
