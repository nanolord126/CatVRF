...
/**
 * Prompt builder for Logistics AI
 * 
 * Vertical: logistics
 * Type: ai_constructor
 * 
 * Generates prompts for AI-powered features in Logistics vertical.
 */
final class LogisticsPromptBuilder extends AbstractPromptBuilder
{
    protected string $version = '1.0.0';
    protected array $metadata = [
        'vertical' => 'logistics',
        'type' => 'ai_constructor',
        'description' => 'AI constructor for Logistics vertical',
        'language' => 'ru',
    ];
    ...
    {
        $prompt = <<<PROMPT
Ты — эксперт в вертикали Logistics. 
