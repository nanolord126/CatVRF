...
/**
 * Prompt builder for HomeServices AI
 * 
 * Vertical: homeservices
 * Type: ai_constructor
 * 
 * Generates prompts for AI-powered features in HomeServices vertical.
 */
final class HomeServicesPromptBuilder extends AbstractPromptBuilder
{
    protected string $version = '1.0.0';
    protected array $metadata = [
        'vertical' => 'homeservices',
        'type' => 'ai_constructor',
        'description' => 'AI constructor for HomeServices vertical',
        'language' => 'ru',
    ];
