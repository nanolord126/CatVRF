...
/**
 * Prompt builder for MeatShops AI
 * 
 * Vertical: meatshops
 * Type: ai_constructor
 * 
 * Generates prompts for AI-powered features in MeatShops vertical.
 */
final class MeatShopsPromptBuilder extends AbstractPromptBuilder
{
    protected string $version = '1.0.0';
    protected array $metadata = [
        'vertical' => 'meatshops',
        'type' => 'ai_constructor',
        'description' => 'AI constructor for MeatShops vertical',
        'language' => 'ru',
    ];
    ...
    {
        $prompt = <<<PROMPT
Ты — эксперт в вертикали MeatShops. 
