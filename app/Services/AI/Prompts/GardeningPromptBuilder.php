...
/**
 * Prompt builder for Gardening AI
 * 
 * Vertical: gardening
 * Type: ai_constructor
 * 
 * Generates prompts for AI-powered features in Gardening vertical.
 */
final class GardeningPromptBuilder extends AbstractPromptBuilder
{
    protected string $version = '1.0.0';
    protected array $metadata = [
        'vertical' => 'gardening',
        'type' => 'ai_constructor',
        'description' => 'AI constructor for Gardening vertical',
        'language' => 'ru',
    ];
    ...
    {
        $prompt = <<<PROMPT
Ты — эксперт в вертикали Gardening. 
