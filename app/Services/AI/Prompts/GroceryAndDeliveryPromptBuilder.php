...
/**
 * Prompt builder for GroceryAndDelivery AI
 * 
 * Vertical: groceryanddelivery
 * Type: ai_constructor
 * 
 * Generates prompts for AI-powered features in GroceryAndDelivery vertical.
 */
final class GroceryAndDeliveryPromptBuilder extends AbstractPromptBuilder
{
    protected string $version = '1.0.0';
    protected array $metadata = [
        'vertical' => 'groceryanddelivery',
        'type' => 'ai_constructor',
        'description' => 'AI constructor for GroceryAndDelivery vertical',
        'language' => 'ru',
    ];
