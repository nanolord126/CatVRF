...
/**
 * Prompt builder for Content AI
 * 
 * Vertical: content
 * Type: ai_constructor
 * 
 * Generates prompts for AI-powered features in Content vertical.
 */
final class ContentPromptBuilder extends AbstractPromptBuilder
{
    protected string $version = '1.0.0';
    protected array $metadata = [
        'vertical' => 'content',
        'type' => 'ai_constructor',
        'description' => 'AI constructor for Content vertical',
        'language' => 'ru',
    ];
    ...
    {
        $prompt = <<<PROMPT
Ты — эксперт в вертикали Content. 
