...
/**
 * Prompt builder for Travel AI
 * 
 * Vertical: travel
 * Type: ai_constructor
 * 
 * Generates prompts for AI-powered features in Travel vertical.
 */
final class TravelPromptBuilder extends AbstractPromptBuilder
{
    protected string $version = '1.0.0';
    protected array $metadata = [
        'vertical' => 'travel',
        'type' => 'ai_constructor',
        'description' => 'AI constructor for Travel vertical',
        'language' => 'ru',
    ];
