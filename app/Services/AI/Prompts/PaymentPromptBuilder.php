...
/**
 * Prompt builder for Payment AI
 * 
 * Vertical: payment
 * Type: ai_constructor
 * 
 * Generates prompts for AI-powered features in Payment vertical.
 */
final class PaymentPromptBuilder extends AbstractPromptBuilder
{
    protected string $version = '1.0.0';
    protected array $metadata = [
        'vertical' => 'payment',
        'type' => 'ai_constructor',
        'description' => 'AI constructor for Payment vertical',
        'language' => 'ru',
    ];
    ...
    {
        $prompt = <<<PROMPT
Ты — эксперт в вертикали Payment. 
