...
/**
 * Prompt builder for Furniture AI
 * 
 * Vertical: furniture
 * Type: ai_constructor
 * 
 * Generates prompts for AI-powered features in Furniture vertical.
 */
final class FurniturePromptBuilder extends AbstractPromptBuilder
{
    protected string $version = '1.0.0';
    protected array $metadata = [
        'vertical' => 'furniture',
        'type' => 'ai_constructor',
        'description' => 'AI constructor for Furniture vertical',
        'language' => 'ru',
    ];
    ...
    {
        $prompt = <<<PROMPT
Ты — эксперт в вертикали Furniture. 
