...
/**
 * Prompt builder for RealEstate AI
 * 
 * Vertical: realestate
 * Type: ai_constructor
 * 
 * Generates prompts for AI-powered features in RealEstate vertical.
 */
final class RealEstatePromptBuilder extends AbstractPromptBuilder
{
    protected string $version = '1.0.0';
    protected array $metadata = [
        'vertical' => 'realestate',
        'type' => 'ai_constructor',
        'description' => 'AI constructor for RealEstate vertical',
        'language' => 'ru',
    ];
    ...
    {
        $prompt = <<<PROMPT
Ты — эксперт в вертикали RealEstate. 
