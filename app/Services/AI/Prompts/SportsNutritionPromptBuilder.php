...
/**
 * Prompt builder for SportsNutrition AI
 * 
 * Vertical: sportsnutrition
 * Type: ai_constructor
 * 
 * Generates prompts for AI-powered features in SportsNutrition vertical.
 */
final class SportsNutritionPromptBuilder extends AbstractPromptBuilder
{
    protected string $version = '1.0.0';
    protected array $metadata = [
        'vertical' => 'sportsnutrition',
        'type' => 'ai_constructor',
        'description' => 'AI constructor for SportsNutrition vertical',
        'language' => 'ru',
    ];
