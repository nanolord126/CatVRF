...
/**
 * Prompt builder for Confectionery AI
 * 
 * Vertical: confectionery
 * Type: ai_constructor
 * 
 * Generates prompts for AI-powered features in Confectionery vertical.
 */
final class ConfectioneryPromptBuilder extends AbstractPromptBuilder
{
    protected string $version = '1.0.0';
    protected array $metadata = [
        'vertical' => 'confectionery',
        'type' => 'ai_constructor',
        'description' => 'AI constructor for Confectionery vertical',
        'language' => 'ru',
    ];
    ...
    {
        $prompt = <<<PROMPT
Ты — эксперт в вертикали Confectionery. 
