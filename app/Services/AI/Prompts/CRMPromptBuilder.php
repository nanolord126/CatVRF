...
/**
 * Prompt builder for CRM AI
 * 
 * Vertical: crm
 * Type: ai_constructor
 * 
 * Generates prompts for AI-powered features in CRM vertical.
 */
final class CRMPromptBuilder extends AbstractPromptBuilder
{
    protected string $version = '1.0.0';
    protected array $metadata = [
        'vertical' => 'crm',
        'type' => 'ai_constructor',
        'description' => 'AI constructor for CRM vertical',
        'language' => 'ru',
    ];
