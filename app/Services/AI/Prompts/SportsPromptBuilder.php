...
/**
 * Prompt builder for Sports AI
 * 
 * Vertical: sports
 * Type: ai_constructor
 * 
 * Generates prompts for AI-powered features in Sports vertical.
 */
final class SportsPromptBuilder extends AbstractPromptBuilder
{
    protected string $version = '1.0.0';
    protected array $metadata = [
        'vertical' => 'sports',
        'type' => 'ai_constructor',
        'description' => 'AI constructor for Sports vertical',
        'language' => 'ru',
    ];
