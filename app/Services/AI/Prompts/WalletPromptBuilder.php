...
/**
 * Prompt builder for Wallet AI
 * 
 * Vertical: wallet
 * Type: ai_constructor
 * 
 * Generates prompts for AI-powered features in Wallet vertical.
 */
final class WalletPromptBuilder extends AbstractPromptBuilder
{
    protected string $version = '1.0.0';
    protected array $metadata = [
        'vertical' => 'wallet',
        'type' => 'ai_constructor',
        'description' => 'AI constructor for Wallet vertical',
        'language' => 'ru',
    ];
