...
/**
 * Prompt builder for Inventory AI
 * 
 * Vertical: inventory
 * Type: ai_constructor
 * 
 * Generates prompts for AI-powered features in Inventory vertical.
 */
final class InventoryPromptBuilder extends AbstractPromptBuilder
{
    protected string $version = '1.0.0';
    protected array $metadata = [
        'vertical' => 'inventory',
        'type' => 'ai_constructor',
        'description' => 'AI constructor for Inventory vertical',
        'language' => 'ru',
    ];
    ...
    {
        $prompt = <<<PROMPT
Ты — эксперт в вертикали Inventory. 
