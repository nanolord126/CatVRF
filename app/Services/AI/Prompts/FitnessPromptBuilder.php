...
/**
 * Prompt builder for Fitness AI
 * 
 * Vertical: fitness
 * Type: ai_constructor
 * 
 * Generates prompts for AI-powered features in Fitness vertical.
 */
final class FitnessPromptBuilder extends AbstractPromptBuilder
{
    protected string $version = '1.0.0';
    protected array $metadata = [
        'vertical' => 'fitness',
        'type' => 'ai_constructor',
        'description' => 'AI constructor for Fitness vertical',
        'language' => 'ru',
    ];
    ...
    {
        $prompt = <<<PROMPT
Ты — эксперт в вертикали Fitness. 
