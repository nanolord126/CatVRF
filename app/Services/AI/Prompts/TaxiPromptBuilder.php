...
/**
 * Prompt builder for Taxi AI
 * 
 * Vertical: taxi
 * Type: ai_constructor
 * 
 * Generates prompts for AI-powered features in Taxi vertical.
 */
final class TaxiPromptBuilder extends AbstractPromptBuilder
{
    protected string $version = '1.0.0';
    protected array $metadata = [
        'vertical' => 'taxi',
        'type' => 'ai_constructor',
        'description' => 'AI constructor for Taxi vertical',
        'language' => 'ru',
    ];
