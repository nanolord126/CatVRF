...
/**
 * Prompt builder for MusicAndInstruments AI
 * 
 * Vertical: musicandinstruments
 * Type: ai_constructor
 * 
 * Generates prompts for AI-powered features in MusicAndInstruments vertical.
 */
final class MusicAndInstrumentsPromptBuilder extends AbstractPromptBuilder
{
    protected string $version = '1.0.0';
    protected array $metadata = [
        'vertical' => 'musicandinstruments',
        'type' => 'ai_constructor',
        'description' => 'AI constructor for MusicAndInstruments vertical',
        'language' => 'ru',
    ];
