...
final readonly class AIStationeryConstructor
{
    ...
    {
        $this->logger->channel('recommend')->$this->logger->info('AI Stationery Matching started', [
            'occasion' => $occasion,
        ...
        $this->logger->channel('recommend')->$this->logger->info('AI Stationery Matching completed', [
    ...
    public function predictPopularity(int $productId): float
    {
        ...
        $this->logger->channel('audit')->$this->logger->info('AI Popularity Score generated', [
