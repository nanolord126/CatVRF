...
final readonly class SegmentationService
{
    ...
    public function segmentCustomers(
        ...
        $this->logger->channel('analytics')->$this->logger->info('Customer segmentation completed', [
    ...
    public function segmentByValue(int $tenantId, string $correlationId = ''): Collection
    {
        ...
        $this->logger->channel('analytics')->$this->logger->info('Value segmentation completed', [
            'correlation_id' => $correlationId,
            'tenant_id' => $tenantId,
    ...
    public function segmentByBehavior(int $tenantId, string $correlationId = ''): Collection
    {
        ...
        $this->logger->channel('analytics')->$this->logger->info('Behavior segmentation completed', [
            'correlation_id' => $correlationId,
            'tenant_id' => $tenantId,
            'segments_count' => count($segments),
        ]);
    ...
    public function compareSegments(
        ...
        $this->logger->channel('analytics')->$this->logger->info('Segment comparison completed', [
            'correlation_id' => $correlationId,
            'tenant_id' => $tenantId,
            'segment_1' => $segment1,
            'segment_2' => $segment2,
