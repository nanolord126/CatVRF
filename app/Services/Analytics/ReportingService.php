...
final readonly class ReportingService
{
    ...
    public function scheduleReport(
        ...
        $this->logger->channel('audit')->$this->logger->info('Report schedule created', [
            'correlation_id' => $correlationId,
            'tenant_id' => $tenantId,
            'report_type' => $reportType,
            'frequency' => $frequency,
    ...
    public function generateReport(
        ...
        $this->logger->channel('audit')->$this->logger->info('Report generated', [
            'correlation_id' => $correlationId,
            'tenant_id' => $tenantId,
            'report_type' => $reportType,
            'date_range' => $dateRange,
    ...
    public function getScheduledReports(int $tenantId, array $context = []): array
    {
        ...
        $schedules = [
            [
                ...
                'next_send_at' => CarbonImmutable::now()->addWeek()->toIso8601String(),
            ],
            [
                'id' => Str::uuid()->toString(),
                ...
                'next_send_at' => CarbonImmutable::now()->addMonth()->toIso8601String(),
            ],
        ];
    ...
    public function updateReportSchedule(
        ...
        $this->logger->channel('audit')->$this->logger->info('Report schedule updated', [
            'correlation_id' => $correlationId,
            'report_id' => $reportId,
            'tenant_id' => $tenantId,
        ]);
    ...
    public function deleteReportSchedule(string $reportId, int $tenantId, array $context = []): bool
    {
        ...
        $this->logger->channel('audit')->$this->logger->info('Report schedule deleted', [
            'correlation_id' => $correlationId,
            'report_id' => $reportId,
            'tenant_id' => $tenantId,
        ]);
    ...
    public function sendReport(
        ...
        $this->logger->channel('audit')->$this->logger->info('Report queued for sending', [
            'correlation_id' => $correlationId,
            'report_id' => $reportId,
            'tenant_id' => $tenantId,
            'recipients_count' => count($recipients),
    ...
    private function calculateNextSendTime(string $frequency): string
    {
        return match ($frequency) {
            'weekly' => CarbonImmutable::now()->addWeek()->format('Y-m-d H:i:s'),
            'monthly' => CarbonImmutable::now()->addMonth()->format('Y-m-d H:i:s'),
            default => CarbonImmutable::now()->addDay()->format('Y-m-d H:i:s'),
        };
    }
