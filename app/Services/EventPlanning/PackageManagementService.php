...
final readonly class PackageManagementService
{
    ...
    public function createPackage(
        ...
        $this->logger->channel('audit')->$this->logger->info('[PackageService] Creating new package', [
        ...
        try {
            ...
            return $this->db->transaction(function () use ($name, $description, $fixedPrice, $maxGuests, $servicesIds, $correlationId) {
                ...
                // 5. Success Log Audit
                $this->logger->channel('audit')->$this->logger->info('[PackageService] Package successfully created', [
                    'correlation_id' => $correlationId,
