...
final readonly class UserTasteAnalyzerService
{
    ...
    {
        $this->logger->channel('audit')->$this->logger->info('User taste profile analysis started', [
            'user_id' => $user->id,
        ...
        $this->logger->channel('audit')->$this->logger->info('User taste profile analyzed successfully', [
            'user_id' => $user->id,
            'correlation_id' => $this->correlationId(),
