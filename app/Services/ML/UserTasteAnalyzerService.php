...
/**
 * UserTasteAnalyzerService (v2.0)
 * Анализирует историю покупок, просмотры, оценки и поведение для формирования профиля вкусов.
 * КАНОН 2026: audit-log, DB::transaction, correlation_id
 */
