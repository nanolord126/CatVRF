...
/**
 * ML-сервис для работы с моделями вкусов, embeddings и рекомендациями
 *
 * Функции:
 * - Работа с embeddings (genery, store, retrieve)
 * - Cosine similarity поиск похожих товаров
 * - Гибридные рекомендации (ML + популярное + новинки + акции)
 * - ML decision logging для аудита
 *
 * CANON 2026: ML recommendation engine
 */
