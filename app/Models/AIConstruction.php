...
final class AIConstruction extends Model
{
    ...
    public function getPhotoUrl(): ?string
    {
        ...
        return $this->filesystemFactory /* TODO: inject via constructor DI */ /* TODO: inject via DI */->disk()->url($this->photo_path);
    }
    ...
    {
        if ($this->photo_path && $this->filesystemFactory /* TODO: inject via constructor DI */ /* TODO: inject via DI */->disk()->exists($this->photo_path)) {
            $this->filesystemFactory /* TODO: inject via constructor DI */ /* TODO: inject via DI */->disk()->delete($this->photo_path);
        }
    }
