...
/**
 * StationeryProductList.
 * Professional Livewire Catalog Component.
 * Supports Search, B2B Mode, and Instant Basket Addition.
 */
class StationeryProductList extends Component
{
    use WithPagination;
